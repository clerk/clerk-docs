...
The identity object should match the [openID spec](https://openid.net/specs/openid-connect-core-1_0.html#StandardClaims), you can update the JWT template to include them for example:
