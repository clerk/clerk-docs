...
1. Ensure that **Google** and **GitHub** are enabled. If they are not in the list of connections, select **Add connection**, and select **For all users**. Enable **Google** and **GitHub**.
1. Make sure you have your sign in and sign up URLs set in your [environment variables](/docs/guides/development/customize-redirect-urls#environment-variables).
