...
The following example expects the user to be signing up with an email and password, but you can modify it to support other [sign-up strategies](/docs/guides/configure/auth-strategies/sign-up-sign-in-options) such as phone number or social sign-up. It also demonstrates how to collect additional user information for the sign-up; you can either remove these fields or adjust them to fit your application.
