...
If you're starting from scratch, you can follow the [Expo quickstart](/docs/sdk/expo/quickstart), which showcases how to create a sign-in and sign-up page with the same code for all platforms Expo supports.
