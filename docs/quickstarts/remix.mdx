...
<Callout type='info' emoji='💡'>
  The next major version of the Clerk Remix SDK is coming soon! If you're just starting a project, consider [trying out the Core 2 beta](https://beta.clerk.com/docs/quickstarts/remix) instead.
</Callout>
