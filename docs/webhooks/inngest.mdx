...
To create an Inngest webhook endpoint and add it to your Clerk account, navigate to the [**Webhooks**](https://dashboard.clerk.com/last-active?path=webhooks) page in the Clerk Dashboard. Next, select the **Add Endpoint** button.
