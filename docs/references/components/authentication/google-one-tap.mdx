...
> [!NOTE]
> The examples in this section assume you have completed the [JavaScript quickstart](/docs/getting-started/quickstart) to set up the ClerkJS SDK in your project.
