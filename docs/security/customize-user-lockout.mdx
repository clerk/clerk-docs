...
description: Use Clerk to limit the number of times a user can attempt to log in before they are locked out of their account and how long such lockouts last.
---
