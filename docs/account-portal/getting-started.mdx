...
To access these links, click on the <DashboardLink path="account-portal">Account Portal</DashboardLink> page in the side nav of the Clerk Dashboard and then, click on the **Pages** tab.
