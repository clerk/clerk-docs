  ...
  head: function useHead() {
    ...
    const socialCard =
      route === "/" || !title
        ...
        : `https://clerk-docs.clerkpreview.com/api/og?title=${encodeURIComponent(
            title
          )}`;
    ...
    extraContent: () => {
      return (
        <>
          ...
          <a
            href="https://github.com/clerkinc/clerk-docs/"
            target="_blank"
            rel="noreferrer"
            className="nx-p-2 nx-text-current"
          >
  ...
  sidebar: {
    ...
    titleComponent: ({ title, type }) => {
      ...
      if (isHeader) {
        ...
        return <div style={{ fontSize: "1.2rem" }}>{headerTitle}</div>;
      }
      if (type === "separator") {
        return <hr />;
      }
