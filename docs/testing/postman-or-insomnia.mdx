...
Give your template a unique name, such as *'testing-template'*. Set the **Token Lifetime** to a value that suits your needs, or use the maximum of 315360000 seconds (10 years). If you have added custom Claims to the normal Session token, then you should add the same Claims to your JWT Template.
