...
<Steps>
  ...
  <Tabs items={["Environment variables", "Properties"]}>
    <Tab>
      ...
      <Tabs items={["Primary application", "Satellite application"]}>
        <Tab>
    ...
    <Tab>
      ...
      | `allowedRedirectOrigins` | A list of origins that are allowed to redirect back to from the primary domain. |
      ...
      <Tabs items={["Next.js", "JavaScript"]}>
        <Tab>
          ...
          <Tabs items={["Primary application", "Satellite application"]}>
            <Tab>
              In the Next project associated with your primary domain, configure your `<ClerkProvider>` as shown in the following example:
