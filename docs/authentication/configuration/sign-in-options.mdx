...
You can make changes to the redirect behavior of both Sign-in and Sign-up by visiting the [Paths](https://dashboard.clerk.com/last-active?path=paths) section of the Clerk Dashboard, or by passing in props if you are using Clerk's [custom components](/docs/components/overview).
