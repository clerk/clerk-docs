...
Revokes an [API key](/docs/guides/development/machine-auth/api-keys) by its ID. This will immediately invalidate the API key and prevent it from being used to authenticate any future requests. Returns an [`APIKeyResource`](/docs/reference/javascript/types/api-key) object.
