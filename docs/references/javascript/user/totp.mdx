...
<Callout type="warning">
  **Authenticator application** and **Backup codes** must be enabled as multi-factor strategies in your Clerk settings for these methods to work. See the [Multi-factor authentication](/docs/authentication/configuration/sign-up-sign-in-options#multi-factor-authentication) section to learn more.
</Callout>
...
| Type | Description |
| --- | --- |
| <code>Promise\<[TOTPResource](#totp-resource)\></code> | This method returns a `Promise` that resolves to the newly created TOTP object. |
...
| Type | Description |
| --- | --- |
| <code>Promise\<[TOTPResource](#totp-resource)\></code> | This method returns a `Promise` that resolves to the newly verified TOTP object. |
...
| Type | Description |
| --- | --- |
| <code>Promise\<[DeletedObject](/docs/references/javascript/types/deleted-object)\></code> | This method returns a `Promise` that resolves to the reference to the deleted TOTP object. |
...
| Type | Description |
| --- | --- |
| <code>Promise\<[BackupCodeResource](#backup-code-resource)\></code> | This method returns a `Promise` that resolves to the newly created backup code. |
