...
<Steps>
  ...
  <Tabs items={['iOS', 'Android']}>
    <Tab>
      ...
      1. In the Clerk Dashboard, navigate to the [**Native Applications**](https://dashboard.clerk.com/~/user-authentication/native-applications) page.      1. Select the **iOS** tab.
    ...
    <Tab>
      ...
      1. In the Clerk Dashboard, navigate to the [**Native Applications**](https://dashboard.clerk.com/~/user-authentication/native-applications) page.
