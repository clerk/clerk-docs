...
Then, in the same folder, create an `index.tsx` file and add the following code. It displays the user's name if they're signed in, or sign-in and sign-up links if they're not:
...
<div className="container mx-auto my-4">
  <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
    ...
    <Cards title="Sign-up and sign-in flow" description="Learn how to build a custom sign-up and sign-in authentication flow." link="/docs/references/custom-flows/email-password" cta="Learn More" />
  </div>
</div>
