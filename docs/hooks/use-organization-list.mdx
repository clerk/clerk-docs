...
<If sdk="react-router">
  ```tsx {{ filename: 'app/routes/user-organizations.tsx' }}
...
<If sdk="chrome-extension">
  ```jsx {{ filename: 'src/routes/user-organizations.tsx' }}
...
<If sdk="remix">
  ```jsx {{ filename: 'app/routes/user-organizations.tsx' }}
...
<If sdk="tanstack-react-start">
  ...
  export const Route = createFileRoute('/user-organizations')({
    component: JoinedOrganizations,
  })
...
<If sdk="react-router">
  ```tsx {{ filename: 'app/routes/user-invitations.tsx' }}
  import { useOrganizationList } from '@clerk/react-router'
...
<If sdk="chrome-extension">
  ```jsx {{ filename: 'src/routes/user-invitations.tsx' }}
  import { useOrganizationList } from '@clerk/chrome-extension'
...
<If sdk="remix">
  ```jsx {{ filename: 'app/routes/user-invitations.tsx' }}
  import { useOrganizationList } from '@clerk/remix'
...
<If sdk="tanstack-react-start">
  ...
  export const Route = createFileRoute('/user-invitations')({
    component: UserInvitationsTable,
  })
