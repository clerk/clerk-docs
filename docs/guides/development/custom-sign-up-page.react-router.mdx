...
> [!NOTE]
> Just getting started with Clerk and React Router? See the [quickstart tutorial](/docs/getting-started/quickstart)!

<Steps>
  ## Build a sign-up page

  The following example demonstrates how to render the [`<SignUp />`](/docs/references/components/authentication/sign-up) component on a dedicated sign-up page using the [React Router Splat route](https://reactrouter.com/start/framework/routing#splats).
