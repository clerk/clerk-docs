...
> [!NOTE]
> This documents the native `<UserProfileView />` from `@clerk/expo/native`. For web projects, use the [web `<UserProfileView />` component](/docs/reference/components/user/user-profile-view).
