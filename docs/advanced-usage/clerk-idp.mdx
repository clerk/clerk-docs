...
> [!CAUTION]
> This page is now deprecated. Please see the new [guide](/docs/oauth/oauth-single-sign-on) on how to use Clerk as an Identity Provider to facilitate Single Sign-On (SSO) with other clients that support the OAuth 2.0 and OpenID Connect protocol.
