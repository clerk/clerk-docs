...
> [!CAUTION]
> This guide is for users who want to build a _custom_ user interface using the Clerk API. To use a _prebuilt_ UI, you should use the [prebuilt components](/docs/components/overview).
