...
<Steps>
  ...
  1. `forgot-password` –  Renders [`<SignIn.SupportedStrategy>`](/docs/guides/customizing-clerk/elements/reference/sign-in#supportedstrategy), which initiates the reset process, whereby an email code is sent to the user for verification.
  ...
  For more extensive customization of the UI, see the additional Clerk Elements components such as [`<Loading>`](/docs/guides/customizing-clerk/elements/reference/common#loading) and [`<FieldState>`](/docs/guides/customizing-clerk/elements/reference/common#fieldstate).
</Steps>
