...
<Steps>
  ...
  Your application URLs should be structured to indicate which sections of your app are scoped to organizations versus [personal workspaces](/docs/organizations/overview#allow-personal-accounts).
