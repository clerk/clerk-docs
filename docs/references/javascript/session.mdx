...
> [!NOTE]
> For more information regarding the different session states, see the documentation on [session management](/docs/authentication/configuration/session-options).
