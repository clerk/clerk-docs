...
Refer to the appropriate provider's [guide](/docs/configure/auth-strategies/social-connections/overview) for implementation details.
...
In this case, Clerk is the IdP for your application. The [**client**](/docs/configure/auth-strategies/oauth/overview#key-terminology) is the third party site or tool that you want your users to authenticate to.
