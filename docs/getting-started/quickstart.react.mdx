...
Learn more about Clerk components, how to customize them, and how to use Clerk's React hooks using the following guides.
...
<Cards>
  ...
  - [Add routing](/docs/react/guides/development/declarative-mode)
  - Learn how to add React Router in declarative mode to your React app.
