...
1. On the **Overview** tab, find the **Identity provider attributes** section.
...
1. Scroll to the **Attribute mapping** section. Under **Custom attributes**, select **Map custom attribute**.
1. In the **SSO attribute** field, enter the SAML claim name your IdP sends (e.g., `http://schemas.xmlsoap.org/ws/2005/05/identity/claims/department`).
