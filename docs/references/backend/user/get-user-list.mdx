...
This method in the SDK is a wrapper around the BAPI endpoint `GET/users`. See the [BAPI reference](/docs/references/backend-api/tag/Users#operation/GetUserList){{ target: '_blank' }} for more information.
