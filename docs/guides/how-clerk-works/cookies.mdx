...
- Can be configured by modifying the [session token](/docs/guides/how-clerk-works/session-tokens) in the [Clerk Dashboard](https://dashboard.clerk.com/last-active?path=jwt-templates).
...
To learn more about how Clerk uses cookies to store user information, see the [guide on how Clerk works](/docs/how-clerk-works/overview).
