...
<Steps>
  ...
  Create a new Clerk application through the Clerk Dashboard. You can follow the [setup guide](/docs/getting-started) to help you get started.

  ### Set the environment variables

  Set the environment variables in your Clerk application. You can find instructions on how to do so in the appropriate [quickstart guide](/docs/quickstarts).
