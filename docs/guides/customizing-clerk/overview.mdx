...
> [!IMPORTANT]
> Native applications (iOS) use their own theming and customization system. They use [`ClerkTheme`](/docs/guides/customizing-clerk/clerk-theme) to control the appearance of Clerk views, allowing you to customize colors, fonts, and other design properties for a consistent visual experience across all screens.
...
### Directly through Clerk's Account Portal 

The [Account Portal](/docs/guides/account-portal/overview) is the fastest way to customize Clerk's prebuilt components with minimal code required. 
