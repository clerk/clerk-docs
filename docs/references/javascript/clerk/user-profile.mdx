...
<Tables
  ...
  <>The <code>{`<div>`}</code> element used to render in the `<UserProfile />` component</>
  ],
  },
  {
  cells: [
  "props?",
  <a href="#user-profile-props"><code>UserProfileProps</code></a>,
...
<Tables
  ...
  "node",
  <a href="https://developer.mozilla.org/en-US/docs/Web/API/HTMLDivElement"><code>HTMLDivElement</code></a>,
  <>The container <code>{`<div>`}</code> element with a rendered `<UserProfile />` component instance</>
  ],
  },
  ]}
/>
