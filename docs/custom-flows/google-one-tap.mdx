...
<Callout type="danger">
  This guide is for users who want to build a *custom* user interface using the Clerk API. To authenticate users with Google One Tap using a *prebuilt* UI, you should use Clerk's [`<GoogleOneTap>`](/docs/components/authentication/google-one-tap) component.
</Callout>
