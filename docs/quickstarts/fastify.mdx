...
<Callout type='info'>
  You're reading the quickstart guide for the **beta** of the next major version of the Fastify SDK. For more information about the changes from the current version, [check out the upgrade guide](/docs/upgrade-guides/core-2/fastify)!
</Callout>
