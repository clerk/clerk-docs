...
<Steps>
  ...
  1. Choose your configuration options, and then select **Activate Convex integration**. This will reveal the **Issuer** URL for your Clerk instance.
  1. Save the **Issuer** URL. This URL is your application's [Frontend API URL](!frontend-api-url). In development, its format is `https://verb-noun-00.clerk.accounts.dev`. In production, its format is `https://clerk.<your-domain>.com`.
