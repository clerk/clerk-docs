...
For an example of how to use these methods, see the [Passkeys custom flows documentation](/docs/guides/development/custom-flows/passkeys#rename-user-passkeys).
...
For an example of how to use these methods, see the [Passkeys custom flows documentation](/docs/guides/development/custom-flows/passkeys#delete-user-passkeys).
