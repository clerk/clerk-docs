...
1. In the sidenav, select **Environment Variables** and add your Clerk API keys. You can find your Clerk API keys by navigating to the [**API keys**](https://dashboard.clerk.com/~/settings/api-keys) page in the Clerk Dashboard.
