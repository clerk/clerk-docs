...
Core 3 is the latest version of Clerk's core libraries. It includes several breaking code changes and deprecations. We expect upgrades to take less than 30 minutes and provide a CLI to assist.
