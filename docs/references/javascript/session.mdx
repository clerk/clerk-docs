...
Checks if the user is authorized for the specified role or permission or requires the user to reverify their credentials if their last verification is older than allowed.
