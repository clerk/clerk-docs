...
In production, Clerk sends emails from your domain (e.g. `notifications@yourdomain.com`). If your domain is brand new or has no sending history, providers may throttle, defer, or spam-filter these messages regardless of how clean Clerk's IP addresses' reputations are.
