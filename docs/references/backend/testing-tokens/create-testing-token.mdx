...
This method in the SDK is a wrapper around the BAPI endpoint `POST/testing_tokens`. See the [BAPI reference](/docs/references/backend-api/tag/Testing-Tokens#operation/CreateTestingToken){{ target: '_blank' }} for more information.
