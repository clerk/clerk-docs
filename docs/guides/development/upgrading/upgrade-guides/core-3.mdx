...
- **Appearance up dates:** `appearance.layout` is now `appearance.options`, `showOptionalFields` defaults to `false`, and color variables apply at full opacity.
...
<Accordion
  titles={[
    ...
    "UI themes moved to <code>@clerk/ui/themes/experimental</code>",
