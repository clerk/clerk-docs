...
<Steps>
  ...
  Clerk Astro provides a set of useful [stores](/docs/reference/astro/overview#client-side-helpers) that give you access to the [`Clerk`](/docs/reference/objects/clerk) object, and helper methods for signing in and signing up.
