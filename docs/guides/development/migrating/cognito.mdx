...
Ensure that you are using Node.js 20.9.0 or later, and run the following to create a new script directory and project.
...
user@~/cognito_to_clerk: $ npm i @clerk/backend
