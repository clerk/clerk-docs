...
1. Create a `.cursor/mcp.json` file in your project root with the following configuration:
...
You are now ready to open an **Agent chat** in Cursor and prompt it to fetch your Clerk user data (e.g. What is my Clerk user data). Select the **Run tool** option once it becomes available. The response will vary based on your prompt, but it should include key details from your Clerk profile, such as:
