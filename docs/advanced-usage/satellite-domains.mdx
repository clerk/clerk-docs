  ...
  <Tabs items={["Environment variables", "Properties"]}>
    ...
    <Tab>
      ...
      <Tabs items={["Next.js", "Remix"]}>
        <Tab>
          In a Next.js application, you must set the properties in the [`<ClerkProvider>`](/docs/reference/components/clerk-provider) component _and_ in your [`clerkMiddleware()`](/docs/references/nextjs/clerk-middleware).
