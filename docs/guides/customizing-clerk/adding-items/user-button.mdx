...
<If sdk="js-frontend">
  To conditionally render menu items based on a user's Role or Custom Permissions, you can use the [`checkAuthorization()`](/docs/reference/objects/session#check-authorization) method to check if a user is authorized.
</If>
