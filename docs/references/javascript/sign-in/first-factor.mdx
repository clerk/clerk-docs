...
<Properties>
  ...
  Unique identifier for the user's Web3 wallet address. This parameter will work only when the `web3_metamask_signature`, `web3_coinbase_wallet_signature` or `web3_okx_wallet_signature` strategy is specified.
