...
Refer to the [Backend API](/docs/references/backend-api){{ target: '_blank' }} and [Frontend API](/docs/references/frontend-api){{ target: '_blank' }} reference docs for questions about object structures, requests, and responses.
