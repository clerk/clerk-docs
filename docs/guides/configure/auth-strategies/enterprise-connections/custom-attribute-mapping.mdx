...
1. **Connection-specific mappings** — For each connection type (SAML, OIDC, or SCIM), you map the shared attribute to the IdP's specific field name or schema attribute.
