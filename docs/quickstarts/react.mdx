...
React has many options for handling routing, and you are free to choose the option that suits you best. If you would like to learn how to integrate React Router see the [React Router quickstart](/docs/quickstarts/react-router) or the [library mode guide](/docs/references/react-router/library-mode).
