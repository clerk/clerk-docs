...
> [!NOTE]
> This theme is compatible with Tailwind CSS v4 usage. If you need support for Tailwind CSS v3, we recommend passing the shadcn variables manually to `<ClerkProvider />`'s [`variables`](/docs/customization/variables) object.
