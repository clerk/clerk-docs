...
For route setup guidance and security considerations, see [Customize the OAuth consent page](/docs/guides/configure/auth-strategies/oauth/custom-consent-page).
