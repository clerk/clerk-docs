...
<Steps>
  ...
  To protect your pages on the client-side, Clerk's [prebuilt control components](/docs/references/components/overview#control-components) control the visibility of content based on the user's authentication state.
