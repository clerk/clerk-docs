...
The `$clerkStore` store provides a convenient way to access the [`Clerk`](/docs/reference/objects/clerk) object. This provides access to some methods that are not available in other stores.
