...
To make the setup process easier, it's recommended to keep two browser tabs open: one for the [Clerk Dashboard](https://dashboard.clerk.com/last-active?path=user-authentication/sso-connections) and one for your [Xero Developer Console](https://developers.Xero.biz/console/).
...
<Steps>
  ...
  1. In the top-right of the [Xero Developer homepage](https://developer.xero.com/app/manage/), select **New app**. The **Add a new app** modal will open.
