...
If you are using a Clerk SDK, use the [`updateMetadata()`](/docs/reference/objects/user#updatemetadata) method on the `User` object instead of passing `unsafeMetadata` to `update()`.
