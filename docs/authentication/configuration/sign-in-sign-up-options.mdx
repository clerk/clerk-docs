...
Clerk provides various options for setting up a sign-in and sign-up flow. When a new application is created, you will be presented with the following application configuration screen:
...
You can always make changes to your sign-in and sign-up options after your application has been created by visiting the [Clerk Dashboard](https://dashboard.clerk.com/) and selecting the **User & Authentication** dropdown in the navigation sidebar.
...
{/* TODO(Shaquil): Should we add a bit of copy to each of these headings that explain to the user how to update their settings? For example, for this section, we could write:
...
5. Click **Continue** in the bottom right corner to save your changes.
*/}
...
1. Navigate to the Clerk Dashboard.
2. Select your application, then select **User & Authentication > [Social connections](https://dashboard.clerk.com/last-active?path=user-authentication/web3)** in the sidebar menu.
