...
<Tabs items={["Next.js", "JavaScript"]}>
  <Tab>
    ...
    1. Uses the [`useOrganization()`](/docs/references/general/hooks/use-organization) hook to get `membershipRequests`, which is a list of the active organization's membership requests.
