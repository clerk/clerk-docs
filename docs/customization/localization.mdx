...
<Tabs items={["Next.js", "Remix", "Astro"]}>
  <Tab>
    <CodeBlockTabs options={["App Router", "Pages Router"]}>
      ```tsx {{ filename: 'app/layout.tsx', mark: [8] }}
  ...
  <Tab>
    ```tsx {{ filename: 'app/root.tsx', mark: [[39, 41]] }}
  ...
  <Tab>
    ```js {{ filename: 'astro.config.mjs', mark: [3, 8] }}
