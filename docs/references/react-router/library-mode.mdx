...
React Router can be used as a standalone library or as a framework. This guide assumes you have followed the [React quickstart](/docs/quickstarts/react) and explains how to add React Router **as a library**.
...
This guide will cover how to set up React Router in **declarative mode**.
