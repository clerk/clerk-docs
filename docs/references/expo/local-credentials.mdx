...
> This feature works only for sign in attempts with the password strategy
...
<Steps>
  ...
  Use the `setCredentials` function from the `useLocalCredentials` hook in your custom flow for sign in.
