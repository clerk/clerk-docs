...
If you would like to learn how to hide a user's personal account in order to enforce an organization-centric application, see the [dedicated guide](/docs/guides/organizations/overview).
...
[createorg-ref]: /docs/references/general/components/organization/create-organization

[orgprofile-ref]: /docs/references/general/components/organization/organization-profile
