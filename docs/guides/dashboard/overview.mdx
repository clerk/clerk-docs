...
When you visit the Clerk Dashboard, a workspace is always selected/active. You can switch between workspaces or create a new one by selecting the workspace dropdown in the top-left of the Clerk Dashboard.
