...
>
  ...
  <AccordionPanel>
    The experimental property `Clerk.experimental_canUseCaptcha` has been removed. There is no replacement for this functionality currently. If this is problematic for your application, please [reach out to our support team](/contact/support){{ target: '_blank' }}!
  </AccordionPanel>

  <AccordionPanel>
    The experimental property `Clerk.experimental_captchaURL` has been removed. There is no replacement for this functionality currently. If this is problematic for your application, please [reach out to our support team](/contact/support){{ target: '_blank' }}!
  </AccordionPanel>

  <AccordionPanel>
    The experimental property `Clerk.experimental_captchaSiteKey` has been removed. There is no replacement for this functionality currently. If this is problematic for your application, please [reach out to our support team](/contact/support){{ target: '_blank' }}!
  </AccordionPanel>

  <AccordionPanel>
    The `Clerk.__unstable__invitationUpdate` experimental property has been removed, and has no current replacement. If this is an issue in your codebase, please [reach out to Clerk support](/contact/support){{ target: '_blank' }}!
  </AccordionPanel>

  <AccordionPanel>
    The `Clerk.__unstable__membershipUpdate` experimental property has been removed, and has no current replacement. If this is an issue in your codebase, please [reach out to Clerk support](/contact/support){{ target: '_blank' }}!
  </AccordionPanel>
...
>
  ...
  <AccordionPanel>
    If you are using [`Clerk.addListener`](/docs/references/javascript/clerk/clerk#add-listener) or `OrganizationContext` and utilizing either the `lastOrganizationInvitation` and/or `lastOrganizationMember` emitted events, these properties have been removed, as they were only relevant for internal use. We are not providing a way to backfill this functionality at the moment. If you are using it and this is an issue for you, please [reach out to Clerk support](/contact/support){{ target: '_blank' }} and we can find a way to resolve the issue!
  </AccordionPanel>
  ...
  <AccordionPanel>
    ...
    - If using a react-based SDK, [pass the desired values into ClerkProvider](/docs/components/clerk-provider#properties){{ target: '_blank' }}
