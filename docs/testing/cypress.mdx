...
The easiest way to test with Clerk is to create sign-in and sign-out helpers that you can re-use in all of your tests.
...
Now that some simple commands have been created, here are some examples on how to write some simple tests.

This example will be testing a simple dashboard page that displays different content depending on whether the user is signed in or not.
