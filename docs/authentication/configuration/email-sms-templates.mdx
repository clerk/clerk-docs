...
Clerk will deliver your SMS messages using its own SMS Gateway. However, if you wish to handle SMS delivery on your own or customize the content of the SMS messages, then you can toggle **Delivered by Clerk** off.
