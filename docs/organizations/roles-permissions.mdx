...
Clerk has a set of System Permissions that power [Clerk’s Frontend API](https://clerk.com/docs/reference/frontend-api) and [organization-related Clerk Components](/docs/components/overview#organization-components). They are a baseline set of permissions that Clerk needs to operate functionally.
