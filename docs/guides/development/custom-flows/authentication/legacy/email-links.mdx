...
1. The `SignUp` object is used to access the [`createEmailLinkFlow()`](/docs/reference/types/email-address#createemaillinkflow) method.
...
1. On the `/sign-up/verify` page, the [`useClerk()`](/docs/reference/hooks/use-clerk) hook is used to get the [`handleEmailLinkVerification()`](/docs/reference/objects/clerk#handleemaillinkverification) method.
...
1. The `SignIn` object is used to access the [`createEmailLinkFlow()`](/docs/reference/types/email-address#createemaillinkflow) method.
1. The `createEmailLinkFlow()` method is used to access the `startEmailLinkFlow()` method.
...
1. On the `/sign-in/verify` page, the [`useClerk()`](/docs/reference/hooks/use-clerk) hook is used to get the [`handleEmailLinkVerification()`](/docs/reference/objects/clerk#handleemaillinkverification) method.
1. The `handleEmailLinkVerification()` method is called to verify the email address. Error handling is included to handle any errors that occur during the verification process.
