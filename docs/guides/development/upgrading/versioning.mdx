...
For an overview of Core 3, see [Upgrading to Clerk Core 3](/docs/guides/development/upgrading/upgrade-guides/core-3).
...
- `npm i @clerk/nextjs` would install v6, which would be on top of Core 3.
- `npm i @clerk/nextjs@latest-v5` would install v5, which would be on top of Core 2.
...
| Core 2 | Supported | April 19, 2024 | TBD |
| Core 1 | Unsupported | - | - |
