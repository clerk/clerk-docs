...
<Steps>
  ...
  1. Fill out the form as follows:
     ...
     - **Redirect URLs**: Paste the **Redirect URI** value you saved from the Clerk Dashboard.
  1. Select **Create application**.
  1. Save the **Client ID** and **App Secret** somewhere secure. These are your **Client ID** and **Client Secret** in Clerk, respectively.
