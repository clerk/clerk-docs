...
> [!WARNING]
> This guide assumes that you have already installed Clerk in your application locally and are ready to deploy. If you haven't installed Clerk yet, please see the [guide to installing Clerk in your application](/docs/quickstarts/setup-clerk) first.
...
To configure Clerk within your Vercel preview environment, please see the guide for [configuring a preview environment](/docs/deployments/set-up-preview-environment).
