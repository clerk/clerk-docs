...
1. Open the three-dot menu next to the Subscription Item you want to update.
1. Select **Change price** or **Change plan** as needed.
...
1. Open the three-dot menu next to their Subscription Item, then select **Change price** (or **Change plan** if they are still on the default Plan).
