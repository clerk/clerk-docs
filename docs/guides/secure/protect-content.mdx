...
You can use the `isSignedIn` property from the [`useAuth()`](/docs/reference/hooks/use-auth) or [`useUser()`](/docs/reference/hooks/use-user) hook to protect your Client Components from unauthenticated users.
