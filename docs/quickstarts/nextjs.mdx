...
<div className="container mx-auto my-4">
  <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
    ...
    <Cards title="Use Clerk with Next.js 12 and older" description="Learn how to use Clerk with older versions of Next.js." link="/references/nextjs/usage-with-older-versions" cta="Learn More" />
  </div>
</div>
