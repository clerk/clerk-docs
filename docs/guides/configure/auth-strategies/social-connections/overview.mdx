...
Pass the [`additionalOAuthScopes`](/docs/references/general/components/user/user-profile) prop to the [`<UserProfile/>`](/docs/references/general/components/user/user-profile) or [`<UserButton />`](/docs/references/general/components/user/user-button) component, with any additional OAuth scope you would like per provider. The user will be prompted to reconnect their account on their user profile page.
...
When using the [prebuilt components](/docs/references/general/components/overview), you can use the [`<UserProfile/>`](/docs/references/general/components/user/user-profile) component to allow users to connect to further social providers.
