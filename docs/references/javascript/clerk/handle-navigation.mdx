...
<Properties>
  ...
  The full URL or path to navigate after successful email link verification on completed sign up or sign in on the same device.
  ...
  The full URL or path to navigate after successful email link verification on the same device, but not completed sign in or sign up.
