<If sdk="ios">
    To learn how to customize Clerk views, see the [dedicated guide](/docs/reference/ios/clerk-theme).
</If>

<If sdk="android">
    To learn how to customize Clerk views, see the [dedicated guide](/docs/reference/android/clerk-theme).
</If>
