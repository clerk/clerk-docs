...
> [!WARNING]
> Using JS Backend SDK methods can contribute towards rate limiting. To set an organization's logo, it's recommended to use the frontend [`organization.setLogo()`](/docs/references/javascript/organization#set-logo) method instead.
