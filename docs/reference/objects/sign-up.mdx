...
<Properties>
  ...
  The Web3 wallet address, made up of 0x + 40 hexadecimal characters or a `base58` encoded `ed25519` public key (for Solana wallets). Only supported if [Web3 authentication](/docs/guides/configure/auth-strategies/overview#web3-authentication) is enabled in the instance settings.
...
<Properties>
  ...
  **Required** if [Web3 authentication](/docs/guides/configure/auth-strategies/overview#web3-authentication) is enabled. The Web3 wallet address, made up of 0x + 40 hexadecimal characters or a `base58` encoded `ed25519` public key (for Solana wallets).
