...
This method in the SDK is a wrapper around the BAPI endpoint `GET/allowlist-identifiers`. See the [BAPI reference](/docs/references/backend-api/tag/Allow-list-Block-list#operation/ListAllowlistIdentifiers){{ target: '_blank' }} for more information.
