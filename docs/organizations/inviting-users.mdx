...
1. Use the [`getOrganizationMemberships()`](/docs/references/javascript/user/user#get-organization-memberships) method to get an array of `OrganizationMembership` objects, which is a list of organizations that the current user is a member of.
