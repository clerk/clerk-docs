...
The easiest way to allow your users to create and manage their sign-in options is to use the prebuilt [`<UserProfile>`](/docs/references/general/components/user/user-profile) component. If you're building a custom user interface using the Clerk API, refer to the [custom flow guides](/docs/custom-flows/overview).
