...
> [!NOTE]
> If you are using App Router, use the [`auth()` helper](/docs/references/nextjs/app-router/auth) instead.
...
See more detailed examples in the [dedicated guide](/docs/references/nextjs/read-session-data#pages-router).
