...
<Properties>
  ...
  - `totals`
  - <code>[CommerceStatementTotals](/docs/reference/javascript/types/commerce-statement-totals)</code>
  ...
  - `groups`
  - <code>[CommerceStatementGroup](/docs/reference/javascript/types/commerce-statement-group)\[]</code>
