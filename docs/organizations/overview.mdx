...
An enterprise connection can be configured for an organization. Users can sign in through the configured IdP and be automatically added as a member of the organization. See the [manage SSO](/docs/organizations/manage-sso) documentation for more information.
