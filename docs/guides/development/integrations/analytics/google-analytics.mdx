...
>
> As a workaround, you can implement your own analytics tracking by observing user state changes via Clerk's [`useUser()`](/docs/references/hooks/use-user) hook and firing events to your analytics provider. See the [FAQ section](#frequently-asked-questions-faq) below for an example.
...
Yes. You can implement your own analytics tracking by observing user state changes via Clerk's [`useUser()`](/docs/references/hooks/use-user) hook and firing events to your analytics provider.
