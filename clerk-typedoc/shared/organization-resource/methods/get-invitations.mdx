...
Returns a [`ClerkPaginatedResponse`](/docs/reference/types/clerk-paginated-response) of [`OrganizationInvitationResource`](/docs/reference/types/organization-invitation) objects.
...
| `status?` | <code>("pending" \| "accepted" \| "revoked" \| "expired")[]</code> | The status of the invitations to get. |
