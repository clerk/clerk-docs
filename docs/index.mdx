...
<Cards variant="plain" cols={3}>
  - [Next.js](/docs/references/nextjs/quickstart)
  ...
  - [Astro](/docs/references/astro/quickstart)
  ...
  - [Chrome Extension](/docs/references/chrome-extension/quickstart)
  ...
  - [iOS (beta)](/docs/references/ios/quickstart)
  ...
  - [JavaScript](/docs/references/javascript/quickstart)
  ...
  - [Nuxt](/docs/references/nuxt/quickstart)
  ...
  - [React Router](/docs/references/react-router/quickstart)
  ...
  - [Remix](/docs/references/remix/quickstart)
  ...
  - [Vue](/docs/references/vue/quickstart)
...
<Cards variant="plain" cols={3}>
  - [Backend SDK](/docs/references/backend/quickstart)
  ...
  - [Fastify](/docs/references/fastify/quickstart)
