...
*   [`prepareFirstFactor()`](/docs/references/javascript/sign-in/first-factor#preparefirstfactor)
*   [`attemptFirstFactor()`](/docs/references/javascript/sign-in/first-factor#attemptfirstfactor)

### Second Factor

*   [`prepareSecondFactor()`](/docs/references/javascript/sign-in/second-factor#preparesecondfactor)
*   [`attemptSecondFactor()`](/docs/references/javascript/sign-in/second-factor#attemptsecondfactor)

### Authenticate With

*   [`authenticateWithRedirect()`](/docs/references/javascript/sign-in/authenticate-with#authenticatewithredirect)
*   [`authenticateWithMetamask()`](/docs/references/javascript/sign-in/authenticate-with#authenticatewithmetamask)
*   [`authenticateWithWeb3()`](/docs/references/javascript/sign-in/authenticate-with#authenticatewithweb3)
