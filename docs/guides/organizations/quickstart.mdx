...
<Steps>
  ...
  Learn more about protecting routes and checking organization roles in the [authorization guide](/docs/guides/organizations/roles-and-permissions#authorization-checks).
...
<Cards>
  ...
  - [Organization components](/docs/reference/components/organization/overview)
