...
For an example on how to use `getMemberships()`, see the [custom flow on managing organization roles](/docs/guides/development/custom-flows/manage-roles).
...
For an example on how to use `getMembershipRequests()`, see the [custom flow guide on managing membership requests](/docs/guides/development/custom-flows/manage-membership-requests).
