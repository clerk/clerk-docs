---
title: Next.js Quickstart (Manual — Pages Router)
description: Manually add authentication and user management to your Next.js Pages Router app with Clerk.
sdk: nextjs
---
...
> [!TIP]
> Prefer a one-command setup? The [Next.js quickstart](/docs/getting-started/quickstart) uses the Clerk CLI's `clerk init` to install and configure Clerk for you.
