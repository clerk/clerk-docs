...
| Type | Description |
| --- | --- |
| <code>Promise\<[ClerkPaginatedResponse][pag-res-ref]\<[OrganizationDomain][org-domain-ref]\>></code> | This method returns a `Promise` which resolves with a list of [`OrganizationDomain`][org-domain-ref] objects. |
