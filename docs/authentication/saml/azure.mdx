...
Integrating Microsoft Azure AD with Clerk allows you to use it as an Identity Provider for your Clerk application to authenticate your users and manage their access to your application via SAML SSO.
...
3. Copy the "Reply URL (Assertion Consumer Service URL)" from the Clerk Dashboard and paste it into this field.
