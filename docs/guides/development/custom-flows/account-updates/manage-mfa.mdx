...
[Multi-factor verification (MFA)](/docs/guides/configure/auth-strategies/multi-factor-authentication) is an added layer of security that requires users to provide a second verification factor to access an account.
