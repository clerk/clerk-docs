...
<CodeBlockTabs items={["app/layout.tsx", "MultisessionAppSupport.tsx"]}>
  ```tsx {{ filename: 'app/layout.tsx' }}
  import React from 'react'
  import { ClerkProvider } from '@clerk/nextjs'
  import { MultisessionAppSupport } from './MultisessionAppSupport'
  ...
  ```tsx {{ filename: 'components/MultisessionAppSupport.tsx' }}
  'use client'
