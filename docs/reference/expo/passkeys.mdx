...
> [!WARNING]
> This API is available only for [`@clerk/clerk-expo >=2.2.0`, `@clerk/expo`](/docs/guides/development/upgrading/upgrade-guides/expo-v2).
...
<Steps>
  ...
  ```tsx {{ filename: 'app/_layout.tsx', mark: [4, 6, [8, 10], 15] }}
