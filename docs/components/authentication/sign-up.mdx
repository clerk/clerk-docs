...
| `routing` | `string` | The routing strategy for your pages.<br />Supported values are: <ul><li>hash (default): Hash-based routing.</li> <li>path: Path-based routing.</li> <li>virtual: Virtual-based routing</li></ul>Note: If you are using Environment Variables for Next or Remix to specify your routes, this will override to 'path'.|
