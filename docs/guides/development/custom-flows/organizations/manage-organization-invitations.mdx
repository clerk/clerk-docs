...
<If notSdk={["js-frontend", "ios", "android"]}>
  ...
  1. Use `organization` to call the [`inviteMember()`](/docs/reference/objects/organization#invite-member) method, with the recipient's email address and desired Role passed as arguments.
  ...
  1. `invitations` is an array of [`OrganizationInvitation`](/docs/reference/types/organization-invitation) objects. Each `OrganizationInvitation` object has a [`revoke()`](/docs/reference/types/organization-invitation#revoke) method that can be called to revoke the invitation.
  ...
  <If notSdk="expo">
    ...
    import type { OrganizationCustomRoleKey } from '@clerk/nextjs/types'
  ...
  <If sdk="expo">
    ```tsx {{ filename: 'src/components/manage-organization-invitations.tsx', collapsible: true }}
    import { ThemedText } from '@/components/themed-text'
    import { ThemedView } from '@/components/themed-view'
    import { useOrganization } from '@clerk/expo'
    import type { OrganizationCustomRoleKey } from '@clerk/expo/types'
...
<If sdk="js-frontend">
  ...
  1. Call the [`getOrganizationMemberships()`](/docs/reference/objects/user#get-organization-memberships) method to get a list of Organizations that the user is a member of. This method returns `data`, which is an array of `OrganizationMembership` objects.
  ...
  1. Use the active `organization` object to call the [`inviteMember()`](/docs/reference/objects/organization#invite-member) method, with the recipient's email address and desired Role passed as arguments.

  To revoke an invitation:

  1. Use the active `organization` object to call the [`getInvitations()`](/docs/reference/objects/organization#get-invitations) method to get an array of `OrganizationInvitation` objects.
  1. Each `OrganizationInvitation` object has a [`revoke()`](/docs/reference/types/organization-invitation#revoke) method that can be called to revoke the invitation.
