...
Subscription Plans are whatw your Users subscribe to. There is no limit to the number of Plans you can create.
...
You can use Clerk's Features and Plans to gate access to the content. There are a few ways to do this, but the recommended and simplest way is either using our [`has()`](/docs/references/backend/types/auth-object#has) method or our [`<Protect />`](/docs/components/protect) component.
