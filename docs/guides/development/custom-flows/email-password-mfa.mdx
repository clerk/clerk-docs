...
<Steps>
  ...
  > [!TIP]
  > For this example to work, the user must have MFA enabled on their account. You need to add the ability for your users to manage their MFA settings. See the [manage SMS-based MFA](/docs/guides/development/custom-flows/manage-sms-based-mfa) or the [manage TOTP-based MFA](/docs/guides/development/custom-flows/manage-totp-based-mfa) guide, depending on your needs.
...
Now that users can sign in with MFA, you need to add the ability for your users to manage their MFA settings. Learn how to build a custom flow for [managing TOTP MFA](/docs/guides/development/custom-flows/manage-totp-based-mfa) or for [managing SMS MFA](/docs/guides/development/custom-flows/manage-sms-based-mfa).
