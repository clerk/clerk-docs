...
With the [Billing](/docs/billing/overview) feature, users can subscribe to [plans](/docs/billing/overview#create-a-plan) and [features](/docs/billing/overview#add-features-to-a-plan), which can be used in authorization checks.
...
- If you are doing role or permission-based authorization checks, **it's recommended to use permission-based authorization over role-based authorization**, as it's more flexible, easier to manage, and more secure.
