...
![The \<TaskChooseOrganization /> component renders a UI for resolving the choose-organization after-auth task.](/docs/images/ui-components/create-organization.png){{ style: { maxWidth: '460px' } }}
