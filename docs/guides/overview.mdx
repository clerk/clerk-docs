...
<div className="container mx-auto my-4">
  <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
    ...
    <Cards title="Add different ways to sign up and log in" description="Add the ability for users to sign in with social accounts, SAML/SSO, magic links, one-time codes." link="/docs/guides/add-social-auth" cta="Add social auth to your app" />
