...
```json
{
 shortMessage: "belongs to a different user"
...
```json
{
 ...
 longMessage: "No second factors were found for strategy %s."
 code: "no_second_factors_for_strategy"
}
```
