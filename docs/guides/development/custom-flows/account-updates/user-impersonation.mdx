...
sdk: nextjs, react, nuxt, expressjs, go, ruby, vue, astro, expo, android, fastify, react-router, js-frontend, chrome-extension, tanstack-react-start
---

{/* DOCS NOTE: Not currently supported by iOS */}
...
<If notSdk={["expo", "android"]}>
  ...
  - The main page that gets the list of the application's users using the backend [`getUserList()`](/docs/reference/backend/user/get-user-list) method
  ...
  <CodeBlockTabs options={["Main page", "Client Component", "Server Action"]}>
    ...
    export default async function AccountPage() {
      ...
      // Fetch list of application's users using the `getUserList()` method
...
<If sdk="expo">
  ...
  <Steps>
    ...
    import type { UserJSON } from '@clerk/expo/types'
