...
If the pre-built user button doesn't cover your needs you can use the [`signOut()`](/docs/references/javascript/clerk/clerk#sign-out) function to build a custom solution.
