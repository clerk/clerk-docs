...
The [Clerk Go SDK](/docs/references/go/overview) is built on top of the [Clerk Backend API](/docs/reference/backend-api){{ target: '_blank' }}.
...
The following example demonstrates how to use the Clerk Go SDK to execute [Clerk Backend API](/docs/getting-started/quickstart) operations.
