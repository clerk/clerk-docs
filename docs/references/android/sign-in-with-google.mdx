...
To learn how to build a sign-up and sign-in flow that supports OAuth connections in your Android application, see the [custom flow guide](/docs/custom-flows/oauth-connections).
