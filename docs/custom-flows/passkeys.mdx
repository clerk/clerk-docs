...
Passkeys are tied to the domain they are created on and **can't be used across different domains**. This means the same passkey cannot be used for both your Account Portal and your app's sign-in pages. For example:
