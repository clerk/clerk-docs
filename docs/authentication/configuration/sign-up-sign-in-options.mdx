...
Enabling MFA allows users of your app to turn it on for their own accounts through their [User Profile](/docs/customization/account-portal/user-profile-org-profile#user-profile) page. Enabling MFA does not automatically turn on MFA for all users.
