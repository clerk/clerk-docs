...
| - | - | - | - |
| `secretKey` | Server key for `api.clerk.com`. Can be found on the [**API keys**](https://dashboard.clerk.com/last-active?path=api-keys) page of the Clerk Dashboard. | none | `CLERK_SECRET_KEY` |
