...
| `setActive()` | <code>(setActiveParams: [SetActiveParams](../types/set-active-params.mdx)) => Promise\<void\></code> | A function that sets the active session and/or organization. |
</Tab>
</Tabs>
