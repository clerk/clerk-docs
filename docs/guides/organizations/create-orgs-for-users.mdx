...
The simplest way to grant someone on your team access to all orgs in your app is to add them as a member to your [workspace](/docs/guides/dashboard/overview) in the Clerk Dashboard. Members of your workspace, also known as collaborators, can view all of the orgs for each of your apps and perform administrative actions, such as adding or removing members, renaming an org, or deleting an org.
