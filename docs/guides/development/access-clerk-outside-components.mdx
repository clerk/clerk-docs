...
The [`Clerk`](/docs/references/javascript/clerk) object is accessible using the [`useClerk()`](/docs/references/hooks/use-clerk) hook. However, if you need to access the [`Clerk`](/docs/references/javascript/clerk) object outside of React components, such as in utility functions or background tasks, you can use the `getClerkInstance()` function.
