...
To get started, navigate to the [**Integrations**](https://dashboard.clerk.com/last-active?path=integrations) page of the Clerk Dashboard. Turn on the Google Analytics integration.

![The Integrations page of the Clerk Dashboard. A red arrow points to the toggle next to 'Google Analytics'.](/docs/images/integrations/google/integrations.webp)
