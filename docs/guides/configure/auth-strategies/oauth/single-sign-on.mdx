---
title: Use Clerk as an OAuth provider
description: Learn how to configure Clerk as an OAuth 2.0 and OIDC Identity Provider so users can sign in to third-party apps with their Clerk credentials.
---
...
> [!NOTE]
> This guide covers making Clerk the identity provider so users can sign in to _other_ apps with their Clerk credentials. If you want to let users sign in to _your_ Clerk app using an external provider like Google or GitHub, see [Social login](/docs/guides/configure/auth-strategies/social-connections/overview).
