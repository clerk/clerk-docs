...
| - | - | - |
| [Personal accounts disabled (default)](/docs/organizations/overview#allow-personal-accounts) | `choose-organization` | Requires users to select or create an organization after authenticating. |
