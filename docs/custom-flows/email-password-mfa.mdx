...
In the following example, the user is prompted to enter their email and password. After submitting the form, the user is prompted to enter a TOTP or backup code. If the user successfully completes the second factor verification, the session is set as active and the user is redirected to the home page.
