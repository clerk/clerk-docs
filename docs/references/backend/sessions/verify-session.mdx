...
> [!CAUTION]
> This method is now deprecated. Refer to the [Manual JWT Verification](/docs/guides/development/manual-jwt) guide for the recommended way to verify sessions/tokens.
