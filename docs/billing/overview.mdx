...
Unforunately, credit cards from India are not supported at this time due to limitations when using Stripe as the payment processor: [https://docs.stripe.com/india-recurring-payments](https://docs.stripe.com/india-recurring-payments). We hope to add support for other payment processors in the future.
