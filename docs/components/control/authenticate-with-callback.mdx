...
| --- | --- | --- |
| `afterSignInUrl` | `string` | Full URL or path to navigate after successful sign in. Defaults to `/`. | 
| `afterSignUpUrl` | `string` | Full URL or path to navigate after successful sign up. Defaults to `/`. | 
