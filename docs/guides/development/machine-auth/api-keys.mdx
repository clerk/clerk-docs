...
- `$0.001` per key creation. The first 1,000 creations per month are free.
...
Usage stats and monitoring available in the Clerk Dashboard to make it easy to understand your usage and what you're being charged.
