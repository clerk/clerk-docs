---
title: Bitbucket
description: Learn how to setup social connection with Bitbucket.
---
...
Adding social connection with Bitbucket to your app with Clerk is simple - you will need to populate the **Client ID**, **Client Secret** and **Authorized redirect URI** in your instance settings.
