...
<Steps>
  ...
  1. Under **Customize session token**, enter the following JSON in the **Claims** editor and select **Save**. If you have already customized your session token, you may need to merge this with what you currently have.
