...
2. In the sidebar, select **[Integrations](https://dashboard.clerk.com/last-active?path=integrations)**.
...
The Firebase integration enables you to use Clerk to generate a valid authentication token to send to Firebase's API. To configure the integration, you can either:
- [upload your Firebase project's service account key JSON file to configure the integration automatically](#upload-service-account-key)
- [manually provide the required information about your Firebase project](#configure-firebase-manually)
...
3. Enable any sign-in method you want, such as **Email/Password**.
...
<div className="container mx-auto my-4">
  <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
    ...
    <Cards title="Create custom sign-up and sign-in pages in your Next.js app" description="Learn how add custom sign-up and sign-in pages with Clerk components in your Next.js application." link="/docs/references/nextjs/custom-signup-signin-pages" cta="Learn More" />
