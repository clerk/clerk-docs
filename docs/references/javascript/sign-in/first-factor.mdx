...
<Properties>
  ...
  - `'web3_metamask_signature'`: The verification will attempt to be completed using the user's web3 wallet public address. Currently Clerk supports [Metamask](https://metamask.io/).
