...
<Steps>
  ...
  You can control which content signed-in and signed-out users can see with the [prebuilt control components](/docs/references/components/overview#control-components). The following example creates a header using the following components:
  ...
  - [`<UserButton />`](/docs/references/components/user/user-button): Shows the signed-in user's avatar. Selecting it opens a dropdown menu with account management options.
...
<Cards>
  - [Prebuilt components](/docs/references/components/overview)
  ...
  - [Client-side helpers (hooks)](/docs/references/hooks/use-user)
