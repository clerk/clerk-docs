...
<Steps>
  ...
  <If notSdk={["ios", "android"]}>
    ...
    1. Send a one-time code to the provided email address with the [`signUp.verifications.sendEmailCode()`](/docs/reference/objects/sign-up-future#verifications-sendemailcode) method.
    1. Collect the user's one-time code and verify it with the [`signUp.verifications.verifyEmailCode()`](/docs/reference/objects/sign-up-future#verifications-verifyemailcode) method.
