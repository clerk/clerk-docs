---
title: Default plans
description: What are default plans and how they work in Clerk Billing
---
...
Not yet, but we plan to make it configurable. Once implemented, you could set a paid plan (usually with a free trial) as the default plan.
