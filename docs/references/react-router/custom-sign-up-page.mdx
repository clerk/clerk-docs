...
<Steps>
  ...
  The following example demonstrates how to render the [`<SignUp />`](/docs/reference/general/components/authentication/sign-up) component on a dedicated sign-up page using the [React Router Splat route](https://reactrouter.com/start/framework/routing#splats).
