...
This method in the SDK is a wrapper around the BAPI endpoint `GET/sessions/{session_id}`. See the [BAPI reference](/docs/references/backend-api/tag/Sessions#operation/GetSession){{ target: '_blank' }} for more information.
