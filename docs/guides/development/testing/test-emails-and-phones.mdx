...
Testing email links in E2E suites is an uphill task. We recommend turning on the [**Email verification code**](/docs/guides/configure/auth-strategies/sign-up-sign-in-options#identifiers) setting, and using that flow to authenticate your tests. The flows are very similar.
