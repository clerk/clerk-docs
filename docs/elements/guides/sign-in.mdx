...
The following example demonstrates how to conditionally render a form for the `email_codes` strategy:
  ...
  return (
    <SignIn.Root>
      ...
      <SignIn.Step name="forgot-password">
        ...
        <SignIn.SupportedStrategy name="reset_password_email_code">Reset password</SignIn.SupportedStrategy>
