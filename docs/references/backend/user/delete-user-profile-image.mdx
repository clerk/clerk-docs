...
This method in the SDK is a wrapper around the BAPI endpoint `POST/users/{user_id}/profile_image`. See the [BAPI reference](/docs/references/backend-api/tag/Users#operation/SetUserProfileImage){{ target: '_blank' }} for more information.
