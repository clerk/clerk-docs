...
> [!NOTE]
> Clerk Elements is for [advanced use-cases](/docs/guides/customizing-clerk/elements/overview#why-use-clerk-elements) that require a high-level of customization. If you are using our [all-in-one UI components](/docs/references/components/overview), learn more about customization through our [Appearance Prop](/docs/guides/customizing-clerk/appearance-prop/overview).
