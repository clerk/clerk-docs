...
Returns a [`ClerkPaginatedResponse`](/docs/reference/types/clerk-paginated-response) of [`UserOrganizationInvitation`](/docs/reference/types/user-organization-invitation) objects.
...
| `status?` | <code>"pending" \| "accepted" \| "revoked" \| "expired"</code> | The status an invitation can have. |
