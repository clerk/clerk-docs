...
<If sdk="nextjs">
  ...
  <Prompt variant="card" src="prompts/nextjs-quickstart.md" title="Add Clerk to Next.js" output="inline" />
</If>

<If sdk="react">
  ### React

  <Prompt variant="card" src="prompts/react-vite-quickstart.md" title="Add Clerk to React" output="inline" />
</If>

<If sdk="astro">
  ### Astro

  <Prompt variant="card" src="prompts/astro-quickstart.md" title="Add Clerk to Astro" output="inline" />
</If>
