...
Set your fallback host under [Paths](https://dashboard.clerk.com/last-active?path=paths) in the Clerk Dashboard. 
...
In the case of direct links, the values to be used for prefilling the fields for sign in/up can be specified via the following query parameters:
