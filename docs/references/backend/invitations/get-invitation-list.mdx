...
This method in the SDK is a wrapper around the BAPI endpoint `GET/invitations`. See the [BAPI reference](/docs/references/backend-api/tag/Invitations#operation/ListInvitations){{ target: '_blank' }} for more information.
