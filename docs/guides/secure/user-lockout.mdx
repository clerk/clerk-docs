...
When a user exceeds the maximum sign-in attempts, the Clerk [`<SignIn />`](/docs/reference/general/components/authentication/sign-in) component will inform them of how long they have been locked out for and to contact support for more information.
