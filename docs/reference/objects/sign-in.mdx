...
Attempts to complete the [second factor verification](!second-factor-verification) process, also known as [multi-factor authentication (MFA)](/docs/guides/configure/auth-strategies/multi-factor-authentication).
...
Begins the [second factor verification](!second-factor-verification) process, also known as [multi-factor authentication (MFA)](/docs/guides/configure/auth-strategies/multi-factor-authentication).
