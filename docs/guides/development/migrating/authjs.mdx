...
<Steps>
  ...
  **Pro tip!** If you are signed into the [Clerk Dashboard](https://dashboard.clerk.com/~/settings/api-keys), your Secret Key should become visible by clicking on the eye icon.
