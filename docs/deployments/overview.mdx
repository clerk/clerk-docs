...
If you accidentally set the wrong domain, you can change it through the Clerk Dashboard or backend API. For more information, see the [dedicated guide.](/docs/deployments/changing-domains)
