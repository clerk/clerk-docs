...
1. You will need social sign-in (OAuth) credentials for any providers that you would like to use in production. Each [OAuth provider](/docs/guides/configure/auth-strategies/social-connections/oauth) has a dedicated guide on how to set up OAuth credentials for Clerk production apps.
...
In production, these are not secure and you will need to provide your own. Each [OAuth provider](/docs/guides/configure/auth-strategies/social-connections/oauth) has a dedicated guide on how to set up OAuth credentials for Clerk production apps.
