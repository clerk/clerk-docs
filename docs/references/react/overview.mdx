...
You need to create a Clerk application in your Clerk Dashboard before you can set up Clerk React. For more information, check out the [Set up your application](/docs/guides/setup-clerk) guide.
