              ...
              await setActive({
                ...
                navigate: async ({ session }) => {
                  if (session?.currentTask) {
                    // If there's a pending session task, navigate the user to your custom task page to complete it
                    // See https://clerk.com/docs/custom-flows/overview#after-auth-flows
              ...
              await setActive({
                ...
                navigate: async ({ session }) => {
                  if (clerk.session?.currentTask) {
                    // If there's a pending session task, navigate the user to your custom task page to complete it. See https://clerk.com/docs/custom-flows/overview#after-auth-flows
                    router.push(`/sign-in/tasks/${clerk.session.currentTask.key}`)
                    return
                  }
