...
1. **Invite**: You can bring people into organizations in different ways depending on your needs:
   ...
   - **Verified domains** for company-wide rollouts where users with matching email domains are automatically invited (and can join immediately) or suggested to join (requiring admin approval)
