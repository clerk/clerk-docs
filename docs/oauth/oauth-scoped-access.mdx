...
<Steps>
  ...
  To create an OAuth app with Clerk:
  ...
  1. Select **Add**. A modal will open with your **Client Secret**. Save this somewhere secure as you'll need it later.
     > [!WARNING]
  ...
  To learn more about other OAuth application configuration settings, see the [dedicated guide](/docs/oauth/how-clerk-implements-oauth).

  ### Configure your client

  TODO: Is this the same guide as Clerk as an IdP? So it should reflect the same instructions from the [OAuth single sign-on guide](/docs/oauth/oauth-single-sign-on)?
