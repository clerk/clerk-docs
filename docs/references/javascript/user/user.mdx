...
Retrieves a list of organization memberships for the user. Returns a [`ClerkPaginatedResponse`](/docs/references/javascript/types/clerk-paginated-response) of [`OrganizationMembershipResource`](/docs/references/javascript/organization-membership) objects.
