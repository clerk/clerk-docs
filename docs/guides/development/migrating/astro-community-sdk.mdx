...
> [!IMPORTANT]
> The official SDK supports Astro 5, 6, and 7. If your app is on Astro 4, [upgrade to Astro 5](https://docs.astro.build/en/guides/upgrade-to/v5/) or later as part of this migration.
...
The prefix for environment variables used in client-side code has been updated to align with Astro's [best practices](https://docs.astro.build/en/guides/environment-variables/). This change affects all [environment variables](/docs/guides/development/clerk-environment-variables) supported by Clerk.
