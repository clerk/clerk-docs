...
This method in the SDK is a wrapper around the BAPI endpoint `GET/users/count`. See the [BAPI reference](/docs/references/backend-api/tag/Users#operation/GetUsersCount){{ target: '_blank' }} for more information.
