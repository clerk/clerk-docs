...
<Typedoc src="shared/react/hooks/use-organization-list-params.mdx" />
...
<Typedoc src="shared/react/types/interfaces/pages-or-infinite-options.mdx" />

<Typedoc src="shared/react/types/type-aliases/paginated-hook-config.mdx" />

## Returns

<Typedoc src="shared/react/hooks/use-organization-list-return.mdx" />

### `PaginatedResources`

<Typedoc src="shared/react/types/interfaces/paginated-resources.mdx" />
