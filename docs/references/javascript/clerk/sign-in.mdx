...
<Tables
  ...
  <>The <code>{`<div>`}</code> element used to render in the `<SignIn />` component</>
  ],
  },
  {
  cells: [
  "props?",
  <a href="#sign-in-props"><code>SignInProps</code></a>,
...
<Tables
  ...
  "node",
  <a href="https://developer.mozilla.org/en-US/docs/Web/API/HTMLDivElement"><code>HTMLDivElement</code></a>,
  <>The container <code>{`<div>`}</code> element with a rendered `<SignIn />` component instance</>
  ],
  },
  ]}
/>
