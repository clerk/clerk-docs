...
<Properties>
  ...
  Configuration options that affect the appearance of the CAPTCHA widget. For more information, see the [CAPTCHA customization](/docs/customization/captcha) section.
</Properties>
