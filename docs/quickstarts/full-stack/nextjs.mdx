...
With this, your entire application is protected and if you try to access it, it will redirect you to your Sign Up page. If you want to make other routes public, you can read more on the [authMiddleware reference page](https://clerk.com/docs/nextjs/middleware).


<Callout type="info" emoji=🎉">
 At this point, your application is fully protected by Clerk and uses our [Account Portal](/features/account-portal.mdx) pages which are available out of box. Start your Next.js application via npm run dev , visit http://localhost:3000 and sign up to get access to your application.
</Callout>
