...
PUBLIC_CLERK_PUBLISHABLE_KEY=pk_test_ZXZpZGVudC10aWNrLTY1LmNsZXJrLmFjY291bnRzLmRldiQ
CLERK_SECRET_KEY=sk_test_MVahbRZcq7nDdXfXxrMHMgK3wJWSMUimport { defineConfig } from 'astro/config'
