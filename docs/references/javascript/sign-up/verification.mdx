...
<Tables
 ...
 {cells: [
      ...
      <ul>
        ...
        <li><strong><code>oauth_*</code></strong>: Authenticate against <a href="/docs/references/javascript/sign-in/authenticate-with#o-auth-strategy">various OAuth providers</a>.</li>
