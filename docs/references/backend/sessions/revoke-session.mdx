...
This method in the SDK is a wrapper around the BAPI endpoint `POST/sessions/{session_id}/revoke`. See the [BAPI reference](/docs/reference/backend-api/tag/Sessions#operation/RevokeSession) for more details.
