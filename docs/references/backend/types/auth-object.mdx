...
<Tabs items={["Session", "Machine"]}>
  ...
  <Tab>
    <Properties>
      ...
      The ID of the current machine object.
      ...
      The ID of the user or organization that the machine object is associated with.
      ...
      The name of the machine object. For 'api_key' and 'machine_token' types.
      ...
      The current machine object's claims. For 'api_key' and 'machine_token' types.
      ...
      The scopes of the machine object.
      ...
      A function that gets the current machine object's token.
