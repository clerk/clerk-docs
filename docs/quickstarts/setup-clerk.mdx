...
Once the application is created in the Clerk dashboard, you will be redirected to the <DashboardLink path="api-keys">API Keys</DashboardLink> page, which will show you your application's API keys.
