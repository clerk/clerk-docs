...
For the custom flow that allows users to add a new payment method **during checkout**, see the [dedicated guide](/docs/guides/development/custom-flows/checkout-new-payment-method).
