...
<Callout type='info'>
  You're reading the quickstart guide for the **beta** of the next major version of the Expo SDK. For more information about the changes from the current version, [check out the upgrade guide](/docs/upgrade-guides/core-2/expo)!
</Callout>
...
<CodeBlockTabs type="installer" options={["npm", "yarn", "pnpm"]}>
  ...
  npm install @clerk/clerk-expo@beta
  ```

  ```bash filename="terminal"
  yarn add @clerk/clerk-expo@beta
  ```

  ```bash filename="terminal"
  pnpm add @clerk/clerk-expo@beta
  ```
</CodeBlockTabs>
