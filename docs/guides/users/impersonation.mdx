...
To add user impersonation functionality to your application, see the [custom flow for user impersonation](/docs/guides/development/custom-flows/user-impersonation).
