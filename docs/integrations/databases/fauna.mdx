...
<Steps>
  ### Get your Clerk publishable key and JWKS URL
  ...
  1. Fill out the form:
     ...
     - In **Issuer**, paste the Clerk publishable key you copied in the previous step.
  ...
  Clerk's JWT templates allow you to generate a new valid Fauna authentication token for each signed in user. These tokens allow authenticated users to access your data with Fauna's API.
  ...
  ### Authenticate queries in your Next.js app
