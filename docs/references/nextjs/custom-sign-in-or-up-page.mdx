...
This guide shows you how to use the [`<SignIn />`](/docs/reference/general/components/authentication/sign-in) component to build a custom page that **allows users to sign in or sign up within a single flow**.
...
<Steps>
  ...
  The following example demonstrates how to render the [`<SignIn />`](/docs/reference/general/components/authentication/sign-in) component on a dedicated page using the [Next.js optional catch-all route](https://nextjs.org/docs/pages/building-your-application/routing/dynamic-routes#catch-all-segments).
...
<Cards>
  ...
  - [Clerk components](/docs/reference/general/components/overview)
