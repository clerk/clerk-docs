...
You will remove the provider from NextAuth.js and replace it with the `<ClerkProvider />` provider from Clerk. This will need to wrap your application, or wrap the portion of your app where you want to handle authenication. 

1. Remove your NextAuth.js `<SessionProvider />`
...
1. Remove the NextAuth.js Middleware
