...
<If sdk="react">
  ...
  import { Show, RedirectToTasks } from '@clerk/react'
...
<If sdk="react-router">
  ...
  import { Show, RedirectToTasks } from '@clerk/react-router'
...
<If sdk="chrome-extension">
  ...
  import { Show, RedirectToTasks } from '@clerk/chrome-extension'
...
<If sdk="tanstack-react-start">
  ...
  import { Show, RedirectToTasks } from '@clerk/tanstack-react-start'
...
<If sdk="vue">
  ...
  import { Show, RedirectToTasks } from '@clerk/vue'
  </script>
