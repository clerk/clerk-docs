...
Clerk provides a set of [hooks and helpers](/docs/reference/remix/overview) that you can use to access the session and user data in your Remix application. Here are examples of how to use these helpers in both the client and server-side to get you started.
