...
| `setActive` | `undefined` | A function that sets the active session and/or organization. See the [reference doc](/docs/references/javascript/clerk#set-active). |
</Tab>
<Tab>
| Name | Type | Description |
| ------ | ------ | ------ |
...
| `setActive()` | <code>(setActiveParams: [SetActiveParams](../types/set-active-params.mdx)) => Promise\<void\></code> | A function that sets the active session and/or organization. See the [reference doc](/docs/references/javascript/clerk#set-active). |
</Tab>
</Tabs>
