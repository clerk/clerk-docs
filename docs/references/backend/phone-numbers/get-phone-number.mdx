...
This method in the SDK is a wrapper around the BAPI endpoint `GET/phone_numbers/{phone_number_id}`. See the [BAPI reference](/docs/reference/backend-api/tag/Phone-Numbers#operation/GetPhoneNumber) for more details.
