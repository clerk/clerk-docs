...
If the prebuilt components don't meet your specific needs or if you require more control over the logic, you can rebuild the existing Clerk flows using Clerk's API. For more information, see the [custom flow guides.](/docs/custom-flows/overview)
