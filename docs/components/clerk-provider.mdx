...
| `navigate?` (deprecated)               | `(to: string) => Promise<unknown> \| void`                                            | Deprecated in favor of `routerPush` or `routerReplace`, depending on your needs. Learn more in our [v4 to v5 upgrade guide](/docs/upgrade-guides/upgrading-from-v4-to-v5#replace-navigate-with-router-push-router-replace).                                                                                                                               |
