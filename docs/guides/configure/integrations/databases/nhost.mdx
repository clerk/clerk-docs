...
Here is an example of using [Apollo Client](https://github.com/apollographql/apollo-client) in conjunction with the [`useAuth()`](/docs/reference/general/hooks/use-auth) hook in a Next.js application to make a request to the Hasura GraphQL endpoint:
