...
| <a id="for"></a> `for?`                           | <code>"user" \| "organization"</code> | Specifies whether to fetch the statement for an organization or a user. Defaults to `'user'`.        |
...
| <a id="statementid"></a> `statementId?`           | <code>null \| string</code>           | The statement ID to fetch.                                                                           |
