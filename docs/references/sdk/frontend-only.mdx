...
<Steps>
  ...
  ```tsx {{ mark: [5], filename: 'create-clerk-instance.ts' }}
  ...
  ```tsx {{ mark: [1, [10, 17]], filename: 'create-clerk-instance.ts' }}
  ...
  ```tsx {{ mark: [18], filename: 'create-clerk-instance.ts' }}
  import { loadClerkJSScript } from '@clerk/shared/loadClerkJSScript'
  import { runOnce } from './utils'
  import { $clerk, $state } from './stores'
  ...
  ```tsx {{ mark: [[20, 27]], filename: 'create-clerk-instance.ts' }}
  import { loadClerkJSScript } from '@clerk/shared/loadClerkJSScript'
  import { runOnce } from './utils'
  import { $clerk, $state } from './stores'
