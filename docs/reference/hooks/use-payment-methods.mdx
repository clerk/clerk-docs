...
<Properties>
  - `data`
  - <code>[CommercePaymentSourceResource](/docs/reference/javascript/types/commerce-payment-source-resource)\[] | null</code>

  An array of [payment methods](/docs/reference/javascript/types/commerce-payment-source-resource), or `null` if the data hasn't been loaded yet.
