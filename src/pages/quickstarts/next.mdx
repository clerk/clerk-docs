...
Learn how to create use Clerk with Next.js including protecting pages and the auth state.
...
NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY=pk_xxxxxxxxxxx
CLERK_SECRET_KEY=test_xxxxxxxxxxxxxxxxxx
```
