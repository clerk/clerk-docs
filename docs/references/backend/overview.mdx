...
Testing tokens operations are exposed under `clerkClient.testingTokens`. The following methods are available:

### Testing tokens `create` operations

- [`createTestingToken()`](/docs/references/backend/testing-tokens/create-testing-token)
