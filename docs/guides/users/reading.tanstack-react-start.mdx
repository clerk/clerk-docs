...
description: Learn how to use Clerk's hooks and helpers to access the session and user data in your TanStack React Start application.
sdk: tanstack-react-start
---

Clerk provides a set of [hooks and helpers](/docs/reference/tanstack-react-start/overview#client-side-helpers) that you can use to access the session and user data in your TanStack React Start application. Here are examples of how to use these helpers in both the client and server-side to get you started.
