...
description: Learn how to use Clerk's hooks and helpers to access the session and user data in your Astro application.
sdk: astro
---

Clerk provides helpers that you can use to access the session and user data in your Astro application.
