...
| Name | Type | Description |
| --- | --- | --- |
| `afterSignUpUrl` | `string \| undefined \| null` | Full URL or path to navigate after successful sign up. Defaults to `/`. |
| `afterSignInUrl` | `string \| undefined \| null` | Full URL or path to navigate after successful sign in. Defaults to `/`. |
