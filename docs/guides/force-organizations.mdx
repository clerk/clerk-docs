...
<Steps>
  ...
  <Tabs items={["App Router Server Component", "App Router Client Component"]}>
    <Tab>
      ...
      export default function Layout() {
        ...
        const hasActiveOrg = orgId !== undefined;
        ...
      }
      ```
    </Tab>
  ...
  In the case of [Clerk components](/docs/components/overview), an organization will _automatically_ be set as active each time the user creates an organization, accepts an invitation, or selects a membership from the organization switcher. In the case of custom flows, you will need to implement the logic for setting an organization as active. Clerk's [`useOrganizationList()`](/docs/references/react/use-organization-list) hook provides a `setActive` method to help you with this.
  ...
  ```tsx {{ prettier: false, filename: 'app/utils/sync-active-organization.tsx' }}
  "use client"
  ...
  ```tsx {{ prettier: false, filename: 'app/[orgId]/layout.tsx' }}
  ...
  <Tabs type="router" items={["App Router", "Pages Router"]}>
    <Tab>
      ```tsx {{ prettier: false, filename: 'app/org-selection/page.tsx' }}
      "use client"
    ...
    <Tab>
      ```tsx {{ prettier: false, filename: 'pages/org-selection.tsx' }}
      import { OrganizationList } from "@clerk/nextjs"
  ...
  ```tsx {{ prettier: false, filename: 'app/(with-active-organization)/layout.tsx' }}
    import { OrganizationList } from "@clerk/nextjs"
    import { auth } from "@clerk/nextjs/server"
