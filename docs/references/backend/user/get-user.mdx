...
This method in the SDK is a wrapper around the BAPI endpoint `GET/users/{user_id}`. See the [BAPI reference](/docs/references/backend-api/tag/Users#operation/GetUser){{ target: '_blank' }} for more information.
