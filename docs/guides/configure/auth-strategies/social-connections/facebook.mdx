...
description: Learn how to allow users to sign up and sign in to your Clerk application with their Facebook account using OAuth.
---
...
Enabling OAuth with [Facebook](https://developers.facebook.com/docs/facebook-login/) allows your users to sign up and sign in to your Clerk app with their Facebook account.
...
Keep two browser tabs open during setup: one for the [Clerk Dashboard](https://dashboard.clerk.com/~/user-authentication/sso-connections) and one for your [Facebook Developer](https://developers.facebook.com) page.

<Steps>
  ### Enable Facebook as a social connection in Clerk
