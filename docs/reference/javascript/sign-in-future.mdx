...
<Properties>
  ...
  - `'needs_first_factor'`: One of the following [first factor verification](!first-factor-verification) strategies is missing: `'email_link'`, `'email_code'`, `passkey`, `password`, `'phone_code'`, `'web3_base_signature'`, `'web3_metamask_signature'`, `'web3_coinbase_wallet_signature'`, `'web3_okx_wallet_signature'`, `'web3_solana_signature'`, [`OAuthStrategy`](/docs/reference/javascript/types/sso#o-auth-strategy), or `'enterprise_sso'`.
...
<Properties>
  ...
  - `strategy?`
  - <code>[OAuthStrategy](/docs/reference/javascript/types/sso#o-auth-strategy) | "enterprise\_sso" | "passkey"</code>
