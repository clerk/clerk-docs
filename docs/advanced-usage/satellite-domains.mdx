...
>
> Due to the nature of satellite domains, it is not recommended to use **passkeys** as a form of authentication. [Learn more about domain restrictions for passkeys](/docs/custom-flows/passkeys#domain-restrictions-for-passkeys).
>
