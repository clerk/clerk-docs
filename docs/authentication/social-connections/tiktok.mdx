...
<Steps>
  ...
  > [!TIP]
  > If you're creating an app as an organization rather than as an individual developer, you must first [create an organization](https://developers.tiktok.com/organizations). For guidance on which option to choose, refer to the [Working with organizations guide](https://developers.tiktok.com/doc/working-with-organizations/).
