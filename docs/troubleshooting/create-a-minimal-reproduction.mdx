...
<Steps>
  ...
  Create a new Clerk application through the Clerk Dashboard. You can follow Clerk's [setup guide](/docs/quickstarts/setup-clerk){{ target: '_blank' }} to help you get started.
