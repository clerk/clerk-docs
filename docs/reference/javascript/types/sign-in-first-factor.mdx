...
<Properties>
  - `strategy`
  - `'email_code'` | `'email_link'` | `'phone_code'` | `'password'` | `'passkey'` | `'reset_password_phone_code'` | `'reset_password_email_code'` | `'web3_base_signature'` | `'web3_metamask_signature'` | `'web3_coinbase_wallet_signature'` | `'web3_okx_wallet_signature'` | [`OAuthStrategy`](/docs/reference/javascript/types/sso) | `'saml'` | `'enterprise_sso'`
