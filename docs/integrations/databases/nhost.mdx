...
After your Clerk application has been created, go to the Clerk Dashboard and navigate to the [**JWT template**](https://dashboard.clerk.com/last-active?path=jwt-templates) page. Click on the **New template** button to create a new template based on Nhost.
