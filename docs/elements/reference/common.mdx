...
| `children` | `(state: 'valid' \| 'invalid') => React.ReactNode` (optional) | Provide a function as children and access the field's state. |
...
| Name       | Type                                               | Description                                         |
| ---------- | -------------------------------------------------- | --------------------------------------------------- |
| `children` | `(state: 'valid' \| 'invalid') => React.ReactNode` | Use this function to access the field's state. |
