...
<Steps>
  ...
  1. Select the **Package Dependencies** tab, then select **+**.
  ...
  `Clerk.Settings` is now `Clerk.Options`. See the [iOS configuration reference](/docs/reference/native-mobile/configuration#configuration-options) for the full list of options.
  ...
  See [Authentication flows](/docs/reference/native-mobile/auth) for more authentication options and examples.
