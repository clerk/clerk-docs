              ...
              await setActive({
                ...
                navigate: async ({ session }) => {
                  if (session?.currentTask) {
                    ...
                    // See https://clerk.com/docs/custom-flows/overview#after-auth-flow
          ...
          try {
            ...
            if (signUpAttempt.status === 'complete') {
              await setActive({
                ...
                navigate: async ({ session }) => {
                  if (session?.currentTask) {
                    // If there's a pending session task, navigate the user to your custom task page to complete it. See https://clerk.com/docs/custom-flows/overview#after-auth-flow
                    router.push(`/sign-in/tasks/${session.currentTask.key}`)
                    return
                  }
