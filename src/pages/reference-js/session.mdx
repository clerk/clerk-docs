...
{cells: [<code>publicUserData</code>, <code>PublicUserData</code>, <>Public information about the user that this session belongs to.</>]},
{cells: [<code>status</code>, <code>SessionStatus</code>, <>The current state of the session.</>]},
