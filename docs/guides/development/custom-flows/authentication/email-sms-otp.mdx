...
<Steps>
  ...
  <If notSdk={["ios", "android"]}>
    ...
    1. Send a one-time code to the provided phone number for verification with the [`signUp.verifications.sendPhoneCode()`](/docs/reference/objects/sign-up-future#verifications-sendphonecode) method (or [`signUp.verifications.sendEmailCode()`](/docs/reference/objects/sign-up-future#verifications-sendemailcode) if you're modifying this example for email OTP).
    1. Collect the one-time code and verify it with the [`signUp.verifications.verifyPhoneCode()`](/docs/reference/objects/sign-up-future#verifications-verifyphonecode) method (or [`signUp.verifications.verifyEmailCode()`](/docs/reference/objects/sign-up-future#verifications-verifyemailcode) if you're modifying this example for email OTP).
  ...
  <If notSdk={["ios", "android"]}>
    ...
    1. Initiate the sign-in process by collecting the user's phone number with the [`signIn.phoneCode.sendCode()`](/docs/reference/objects/sign-in-future#phonecode-sendcode) method.
    1. Collect the one-time code and verify it with the [`signIn.phoneCode.verifyCode()`](/docs/reference/objects/sign-in-future#phonecode-verifycode) method (or [`signIn.emailCode.verifyCode()`](/docs/reference/objects/sign-in-future#emailcode-verifycode) if you're modifying this example for email OTP).
       <Include src="_partials/custom-flows/phone-number" />
