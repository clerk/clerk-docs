...
<Steps>
  ...
  <Tabs items={["Server-side","Client-side"]}>
    <Tab>
      ...
      To access additional organization information like the organization name, you'll need to [customize the Clerk session token](/docs/configure/session-token) to include these details:
