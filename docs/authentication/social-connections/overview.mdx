...
Clerk provides a wide range of authentication providers to simplify your users' sign-up and sign-in processes. Add any of the following providers to your Clerk application.
