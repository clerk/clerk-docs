...
<Tables
  ...
  <>The <code>{`<div>`}</code> element used to render in the `<SignUp />` component</>
  ],
  },
  {
  cells: [
  "props?",
  <a href="#sign-up-props"><code>SignUpProps</code></a>,
...
<Tables
  ...
  "node",
  <a href="https://developer.mozilla.org/en-US/docs/Web/API/HTMLDivElement"><code>HTMLDivElement</code></a>,
  <>The container <code>{`<div>`}</code> element with a rendered `<SignUp />` component instance</>
  ],
  },
  ]}
/>
