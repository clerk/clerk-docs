...
| --- | --- | --- |
| `publishableKey` | `string` | Clerk publishable key for your instance. This can be found in your [Clerk Dashboard](https://dashboard.clerk.com/last-active?path=api-keys). |
| `frontendApi` | `string` | The frontend API host for your instance. This can be found in your [Clerk Dashboard](https://dashboard.clerk.com/last-active?path=api-keys) under the **Advanced** section. |
