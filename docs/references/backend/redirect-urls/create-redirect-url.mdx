...
This method in the SDK is a wrapper around the BAPI endpoint `POST/redirect_urls`. See the [BAPI reference](/docs/references/backend-api/tag/Redirect-URLs#operation/CreateRedirectURL){{ target: '_blank' }} for more information.
