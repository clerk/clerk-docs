...
A type that represents a [custom OAuth strategy](/docs/configure/auth-strategies/social-connections/custom-provider).
...
A type that represents an [Enterprise SSO](/docs/configure/auth-strategies/enterprise-connections/authentication-flows) strategy.
