...
The basic Middleware above will not protect any routes, meaning the entire application is public. 

With the recommended matcher written above, all routes are matched by Clerk's authentication Middleware, with the exception of internal `/_next/` routes and static files. Static files are detected by matching on paths that end in `.+\..+`. 
...
{/* TODO: i don't think this code example is complete ? i don't think this is what you would copy and paste into middleware.tsx */}
...
| `strict?`                       | `boolean`             |                                                                                                                                                                                                                                                                                                                     |
{/* TODO: strict is missing a description */}
