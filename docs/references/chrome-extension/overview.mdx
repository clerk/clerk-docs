...
The Clerk Chrome Extension SDK gives you access to prebuilt components, React hooks, and helpers to make user authentication easier. Refer to the [quickstart guide](/docs/getting-started/quickstart) to get started.
...
- **Sync Host** - Deployed alongside a web app that uses [Sync Host](/docs/guides/development/sync-host).
...
Clerk allows you to sync the authentication state from your web app to your Chrome Extension using the Sync Host feature. When a user authenticates in your web app, they will also be authenticated in your Chrome Extension. See [the dedicated guide](/docs/guides/development/sync-host) for more information.
