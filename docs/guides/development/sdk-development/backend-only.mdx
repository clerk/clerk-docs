...
The source of truth for all BAPI endpoints is the [BAPI reference docs](/docs/reference/backend-api){{ target: '_blank' }}. For Node.js backend frameworks, you can build on top of the [JavaScript Backend SDK](/docs/js-backend/getting-started/quickstart).
...
<Steps>
  ...
  > [!TIP]
  > See the Next.js [`getAuth()`](/docs/references/nextjs/pages-router/get-auth) reference to see how it's implemented.
