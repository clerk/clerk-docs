...
**If no redirect URL is specified**, the user will be redirected to the appropriate Account Portal page (either [sign-in](/docs/account-portal/overview#sign-in) or [sign-up](/docs/account-portal/overview#sign-up)), or to the custom sign-in/sign-up pages configured in the [**Paths**](https://dashboard.clerk.com/last-active?path=paths) section of the Clerk Dashboard.
