...
<Steps>
  ...
  <If notSdk={["ios", "android"]}>
    ...
    <If sdk="expo">
      > [!IMPORTANT]
      > If you're using [native components](/docs/reference/expo/native-components/overview), Sign-up is automatically available in [`<AuthView />`](/docs/reference/expo/native-components/auth-view). This guide applies to applications that implement a custom sign-up UI.
  ...
  <If notSdk={["ios", "android"]}>
    ...
    <If sdk="expo">
      > [!IMPORTANT]
      > If you're using [native components](/docs/reference/expo/native-components/overview), Sign-in is automatically available in [`<AuthView />`](/docs/reference/expo/native-components/auth-view). This guide applies to applications that implement a custom sign-in UI.
