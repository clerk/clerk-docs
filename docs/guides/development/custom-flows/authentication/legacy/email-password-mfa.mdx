...
<Steps>
  ...
  1. Prepare the [first factor verification](!first-factor-verification).
  1. Attempt to complete the first factor verification.
  1. Prepare the [second factor verification](!second-factor-verification). (This is where MFA comes into play.)
