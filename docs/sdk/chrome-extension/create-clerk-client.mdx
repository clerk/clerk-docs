...
> [!WARNING]
> The following example assumes that you have followed the [Chrome Extension Quickstart](/docs/sdk/chrome-extension/quickstart) and then the [Add React Router](/docs/sdk/chrome-extension/add-react-router) guide, but you can apply these concepts to your own application.
...
<Properties>
  ...
  The host to sync the session with. For more information, see [the dedicated guide](/docs/sdk/chrome-extension/sync-host).
</Properties>
