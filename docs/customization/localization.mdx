...
> [!CAUTION]
> The localizations will only update the text in the [Clerk components](/docs/reference/general/components/overview) used in your application. The hosted [Clerk Account Portal](/docs/account-portal/overview) will remain in English.
