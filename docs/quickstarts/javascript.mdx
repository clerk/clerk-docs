...
Let's use [the `UserButton` component](/docs/references/javascript/clerk/user-button) for an example, which will allow the user to sign in and out of our application.
