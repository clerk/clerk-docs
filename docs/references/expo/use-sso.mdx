...
<Properties>
  ...
  - [`EnterpriseSSOStrategy`](/docs/references/javascript/types/sso#o-auth-strategy)
...
```ts
const startFlow: (startSSOFlowParams?: StartSSOFlowParams) => Promise<StartSSOFlowReturnType>
```
