...
You can change a user's role in the Clerk Dashboard, or in your application, such as in the [`<OrganizationSwitcher />`](/docs/references/components/prganization/organization-switcher) component.
