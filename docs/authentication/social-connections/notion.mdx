...
To make the setup process easier, it's recommended to keep two browser tabs open: one for the [Clerk Dashboard](https://dashboard.clerk.com/last-active?path=user-authentication/sso-connections) and one for your [Notion Developer Console](https://developers.Notion.biz/console/).
...
<Steps>
  ...
  1. In the top-right of the [Notion Developer homepage](https://developers.notion.com/), select **View my integrations**. You'll be redirected to the **Integrations** page.
  1. Select **New integration**.
  1. Fill out the necessary information. In the **Type** dropdown, select **Public**. Under **Redirect URIs**, paste the **Redirect URI** value you saved from the Clerk Dashboard and then select it.
