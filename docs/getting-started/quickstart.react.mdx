...
<PromptOnly>
  ...
  <Prompt variant="card" src="prompts/cli-setup.md" title="Add Clerk to React" output="replace" />

  Or set up Clerk yourself by following the step-by-step instructions.
</PromptOnly>

This quickstart creates a new React app with Vite and adds Clerk authentication to it. If you're using the React Router framework, follow the [React Router quickstart](/docs/react-router/getting-started/quickstart) instead.
