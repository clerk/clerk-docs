...
The following example shows two files: the first is a Next.js [Server Action](https://nextjs.org/docs/app/building-your-application/data-fetching/server-actions-and-mutations) and the second is a Next.js [Client Component](https://nextjs.org/docs/app/building-your-application/rendering/client-components). The Server Action is used to update the organization's logo, and the Client Component is used to upload the file.
