...
- Give users access to [`Client`](/docs/reference/objects/client){{ target: '_blank' }}, [`Session`](/docs/reference/objects/session){{ target: '_blank' }}, [`User`](/docs/reference/objects/user){{ target: '_blank' }}, and [`Organization`](/docs/reference/objects/organization){{ target: '_blank' }} properties through the framework’s choice of state management
- User should be able to use [ClerkJS options](/docs/reference/objects/clerk#clerk-options){{ target: '_blank' }}
