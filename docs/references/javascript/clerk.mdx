...
1. On verification failure:
   - Throws an [`EmailLinkError`](/docs/guides/development/custom-flows/email-links).
...
See the [custom flow](/docs/guides/development/custom-flows/email-links) guide for a comprehensive example of how to use the `handleEmailLinkVerification()` method.
...
See the [custom flow](/docs/guides/development/custom-flows/oauth-connections) guide for implementation details on how to implement a custom OAuth flow.
...
Another example is when a user switches organizations in a multi-organization application. `setActive()` needs to be used to set the new organization as the active organization. See the implementation of this in the [Custom organization switcher](/docs/guides/development/custom-flows/organization-switcher) guide.
