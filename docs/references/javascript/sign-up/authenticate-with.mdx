  ...
  rows={[
        {
            ...
            <>
                ...
                Typically, this will be a simple <code>/sso-callback</code> route that calls <a href="/docs/references/javascript/clerk/handle-navigation#handle-redirect-callback"><code>Clerk.handleRedirectCallback</code></a>
