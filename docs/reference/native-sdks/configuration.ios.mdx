...
<Properties>
  ...
  - `keychainConfig`
  - [`Clerk.ClerkOptions.KeychainConfig`](#keychain-config)
  ...
  - `redirectConfig`
  - [`Clerk.ClerkOptions.RedirectConfig`](#redirect-config)
  ...
  - `middleware`
  - [`Clerk.ClerkOptions.MiddlewareConfig`](#middleware-config)
