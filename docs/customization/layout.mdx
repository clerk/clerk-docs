...
<Properties>
  ...
  The CAPTCHA widget theme. Can take the following values: 'light', 'dark', 'auto'. Defaults to `'auto'`.
  ...
  The CAPTCHA widget size. Can take the following values: 'normal', 'flexible', 'compact'. Defaults to `'normal'`.
  ...
  The CAPTCHA widget language. Must be either: 'auto' (default) to use the language that the visitor has chosen, or an ISO 639-1 two-letter language code (e.g. 'en') or language and country code (e.g. 'en-US').
  Refer to the list of supported languages for more information: [https://developers.cloudflare.com/turnstile/reference/supported-languages](https://developers.cloudflare.com/turnstile/reference/supported-languages)
</Properties>
