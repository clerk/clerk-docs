...
[Setting up CNAME records and using DNS is the simplest way](/docs/deployments/overview). However, if you're unable to use this approach, or would like more control over your integration with Clerk, you can use a proxy.
...
<Tabs items={['Dashboard', 'Backend API']}>
  <Tab>
    ...
    3. Click on **Advanced**.
    4. Enter your proxy URL in the **Proxy URL** field. (The proxy URL must be a valid URL and resolve correctly.)
  </Tab>
