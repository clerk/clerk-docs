...
Also be sure to read our [long term support policy](/docs/guides/development/upgrading/long-term-support) to understand which level of support for your version you can expect.
