...
This method in the SDK is a wrapper around the BAPI endpoint `GET/invitations`. See the [BAPI reference](/docs/reference/backend-api/tag/Invitations#operation/ListInvitations) for more details.
