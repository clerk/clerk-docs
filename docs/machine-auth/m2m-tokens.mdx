...
![Create machine modal in Clerk dashboard, showing the creation of "Machine A"](/images/machine-auth/create-machine.jpg)

Then, we can create `Machine B`:

![Create machine modal in Clerk dashboard, showing the creation of "Machine B"](/images/machine-auth/machine-b.jpg)
...
![Selecting "edit" machine for Machine A from the list of machines in the Clerk dashboard](/images/machine-auth/edit-machine-a.jpg)

...and add Machine B as an access scope as well to complete the configuration.

![Adding Machine B as an access scope for Machine A in the Clerk dashboard](/images/machine-auth/add-machine-b.jpg)
...
![Both machines configured to be able to communicate with each other in the Clerk dashboard](/images/machine-auth/final-config.jpg)
