...
1. Ensure that **Google** and **GitHub** are enabled. If they are not in the list of providers, select the **Add connection** button, and select **For all users**. Enable **Google** and **GitHub**.
