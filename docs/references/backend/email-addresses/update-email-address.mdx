...
description: Updates an email address with a given ID with attribute values provided in a params object.
---

# `updateEmailAddress()`

Updates an email address with a given ID with attribute values provided in a params object.
