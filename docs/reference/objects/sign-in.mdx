...
For a comprehensive example, see the [custom flow for multi-factor authentication](/docs/guides/development/custom-flows/authentication/multi-factor-authentication).
