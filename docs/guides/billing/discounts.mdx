...
> [!NOTE]
> Discounts are applied by you, on behalf of a specific customer — they are not codes that customers redeem themselves at checkout.
...
1. Set how long the Discount lasts: a number of billing cycles, or enable **Applies forever**.
