...
Users can connect their Solana enabled wallet to their account at any time through their user profile page. You can configure your application to use the [Account Portal user profile page](/docs/guides/account-portal/overview#user-profile) or the prebuilt [`<UserProfile />`](/docs/reference/components/user/user-profile) component.
