...
<Steps>
  ...
  The [`<Waitlist />`](/docs/references/general/components/authentication/waitlist) component renders a form that allows users to join for early access to your app.
