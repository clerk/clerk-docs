...
This method in the SDK is a wrapper around the BAPI endpoint `POST/phone_numbers`. See the [BAPI reference](/docs/references/backend-api/tag/Phone-Numbers#operation/CreatePhoneNumber){{ target: '_blank' }} for more information.
