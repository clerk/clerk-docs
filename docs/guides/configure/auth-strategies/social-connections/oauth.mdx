...
<Cards>
  ...
  - [Hugging Face](/docs/guides/configure/auth-strategies/social-connections/huggingface)
  ...
  - [Twitter](/docs/guides/configure/auth-strategies/social-connections/twitter)
  - Add Twitter as an authentication provider for your Clerk app.
  - ![](/docs/images/logos/auth_providers/twitter.svg)

  ---

  - [X/Twitter v2](/docs/guides/configure/auth-strategies/social-connections/twitter)
