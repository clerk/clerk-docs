...
Enabling MFA in the Clerk Dashboard allows users of your app to turn it on for their own accounts through their user profile; it does not automatically activate MFA for all users.
