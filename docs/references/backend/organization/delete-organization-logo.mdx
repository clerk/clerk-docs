...
This method in the SDK is a wrapper around the BAPI endpoint `DELETE/organizations/{organization_id}/logo`. See the [BAPI reference](/docs/reference/backend-api/tag/Organizations#operation/DeleteOrganizationLogo) for more details.
