...
> [!NOTE]
>
> - Clerk Elements is for [advanced use-cases](/docs/customization/elements/overview#why-use-clerk-elements) that require a high-level of customization. The easiest way to implement Clerk is with our [all-in-one UI components](/docs/reference/components/overview).
