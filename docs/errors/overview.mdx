...
- `ActorTokenCanBeUsedOnlyInSignIn`actor-tokens#actor-token-can-be-used-only-in-sign-in)
...
- `InvalidAuthorizationHeaderFormat`authentication#invalid-authorization-header-format)
- `InvalidAuthorization`
- `InvalidCSRFToken`
- `MissingRequestHeaders`
- `InvalidOriginHeader`
- `DevBrowserUnauthenticated`
- `URLBasedSessionSyncingDisabled`authentication#url-based-session-syncing-disabled)
- `InvalidRequestForEnvironment`authentication#invalid-request-for-environment)
- `RequestInvalidForInstance`
- `InvalidHost`
- `IdentificationExists`
- `IdentifierNotAllowedAccess`authentication#identifier-not-allowed-access)
- `SignedOut`
- `InvalidUserSettings`
- `InvalidHandshake`
