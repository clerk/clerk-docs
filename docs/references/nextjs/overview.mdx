...
The Clerk Next.js SDK gives you access to prebuilt components, React hooks, and helpers to make user authentication easier. Refer to the [quickstart guide](/docs/getting-started/quickstart/app-router) to get started.
...
- [`auth()`](/docs/references/nextjs/app-router/auth)
- [`currentUser()`](/docs/references/nextjs/app-router/current-user)
- [Route Handlers](/docs/references/nextjs/app-router/route-handlers)
- [Server Actions](/docs/references/nextjs/app-router/server-actions)
...
- [`getAuth()`](/docs/references/nextjs/pages-router/get-auth)
- [`buildClerkProps()`](/docs/references/nextjs/pages-router/build-clerk-props)
