...
- A [production domain already configured](/docs/guides/development/deployment/production) in your [Clerk Dashboard](https://dashboard.clerk.com/~/domains)
...
<Steps>
  ...
  <Tabs items={["macOS", "Windows", "Linux"]}>
    <Tab>
      ...
      ```sh {{ filename: 'terminal' }}
      sudo sed -i.bak '/local\.your-domain\.com/d' /etc/hosts
      ```

      Enter your password if prompted. The line will be removed from your hosts file, and a backup of the previous version will be saved to `/etc/hosts.bak`. Once you've confirmed everything works, you can delete the backup.
    </Tab>
    ...
    <Tab>
      ...
      1. Delete the line containing `local.your-domain.com`.
      1. Save the file.
    </Tab>
    ...
    <Tab>
      ...
      The line will be removed from your hosts file, and a backup of the previous version will be saved to `/etc/hosts.bak`. Once you've confirmed everything works, you can delete the backup.
    </Tab>
  </Tabs>
</Steps>
