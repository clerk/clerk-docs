...
![The \<PricingTable /> component displays a table of Plans and Features that users can subscribe to.](/docs/images/ui-components/pricing-table.png){{ style: { maxWidth: '460px' } }}
