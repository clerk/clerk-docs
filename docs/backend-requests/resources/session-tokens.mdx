...
<Tabs items={["Version 2", "Version 1"]}>
  <Tab>
    ...
    > As a result, they can be difficult to decode manually. We strongly recommend using one of our SDKs that support API version 2025-04-10 to handle decoding reliably.
