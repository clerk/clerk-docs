...
Creates a new domain for the currently active organization. Returns an [`OrganizationDomain`](/docs/references/javascript/organization-domain) object.
...
Retrieves the list of domains for the currently active organization. Returns a [`ClerkPaginatedResponse`](/docs/references/javascript/types/clerk-paginated-response) of [`OrganizationDomain`](/docs/references/javascript/organization-domain) objects.
...
Retrieves a domain for an organization based on the given domain ID. Returns an [`OrganizationDomain`](/docs/references/javascript/organization-domain) object.
