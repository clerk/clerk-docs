...
Returns the configured url where [`SignUp`](/docs/references/javascript/clerk/sign-up) is mounted or a custom sign-up page is rendered.
...
Returns the url where [`UserProfile`](/docs/references/javascript/clerk/user-profile) is mounted or a custom user-profile page is rendered.
...
Returns the configured url where [`CreateOrganization`](/docs/references/javascript/clerk/create-organization) is mounted or a custom create-organization page is rendered.
...
Returns the configured url where [`OrganizationProfile`](/docs/references/javascript/clerk/organization-profile) is mounted or a custom organization-profile page is rendered.
