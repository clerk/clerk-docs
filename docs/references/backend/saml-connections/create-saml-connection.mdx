...
Creates a new [`SamlConnection`](/docs/references/backend/types/saml-connection) for an organization.
...
const response = await clerkClient.samlConnections.createSamlConnection({
  ...
  domain: 'clerk.dev',
  idpMetadataUrl:
    'https://trial-3980938.okta.com/app/exkgcjh0w9GGT8c93697/sso/saml/metadata',
  attributeMapping: {
