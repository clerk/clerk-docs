---
title: Sharing browser replays with Clerk Support
description: Learn how to record replays and share them with Clerk Support.
---

When you report an issue with your appliation to Clerk Support, we may ask you to record a browser replay, which will allow us to see the sequence of events that led to the issue and help us diagnose and resolve the problem.

## Record a replay with Jam
...
In the event that you're unable to install the Jam extension, you can generate a HAR file to share with Clerk Support.

> [!WARNING]
> We only recommend generating a HAR file if you're unable to install the Jam extension. Jam recordings contain more information than a HAR file, and are therefore more helpful for debugging issues.
