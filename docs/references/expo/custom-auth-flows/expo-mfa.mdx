...
1. Enable email and password authentication:
    1. Navigate to the Clerk Dashboard and in the navigation sidebar, go to **User & Authentication > [Email, Phone, and Username](https://dashboard.clerk.com/last-active?path=user-authentication/email-phone-username)**.
