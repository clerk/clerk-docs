...
<Steps>
  ...
  When following the [Chrome Extension Quickstart](/docs/quickstart/chrome-extension), you created a `.env.developmnet` file and added your development instances' publishable and frontend API key. You will need to do the same for your production instance.
