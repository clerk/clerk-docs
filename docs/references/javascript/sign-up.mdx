...
<Properties>
  ...
  The username supplied to the current sign-up. Only supported if [username](/docs/guides/configure/auth-strategies/sign-up-sign-in-options#identifiers) is enabled in the instance settings.
  ...
  The email address supplied to the current sign-up. Only supported if [email address](/docs/guides/configure/auth-strategies/sign-up-sign-in-options#identifiers) is enabled in the instance settings.
  ...
  The user's phone number in [E.164 format](https://en.wikipedia.org/wiki/E.164). Only supported if [phone number](/docs/guides/configure/auth-strategies/sign-up-sign-in-options#identifiers) is enabled in the instance settings.
  ...
  The value of this attribute is true if a password was supplied to the current sign-up. Only supported if [**Password**](/docs/guides/configure/auth-strategies/sign-up-sign-in-options#sign-in-options) is enabled in the instance settings.
  ...
  The first name supplied to the current sign-up. Only supported if [**First and last name**](/docs/guides/configure/auth-strategies/sign-up-sign-in-options#identifiers) is enabled in the instance settings.
  ...
  The last name supplied to the current sign-up. Only supported if [**First and last name**](/docs/guides/configure/auth-strategies/sign-up-sign-in-options#identifiers) is enabled in the instance settings.
...
<Properties>
  ...
  The user's password. Only supported if [**Password**](/docs/guides/configure/auth-strategies/sign-up-sign-in-options#sign-in-options) is enabled.
  ...
  The user's email address. Only supported if [**Email address**](/docs/guides/configure/auth-strategies/sign-up-sign-in-options#identifiers) is enabled. Keep in mind that the email address requires an extra verification process.
  ...
  The user's phone number in [E.164 format](https://en.wikipedia.org/wiki/E.164). Only supported if [phone number](/docs/guides/configure/auth-strategies/sign-up-sign-in-options#identifiers) is enabled. Keep in mind that the phone number requires an extra verification process.
  ...
  **Required** if [Web3 authentication](/docs/guides/configure/auth-strategies/sign-up-sign-in-options#web3-authentication) is enabled. The Web3 wallet address, made up of 0x + 40 hexadecimal characters.
  ...
  The user's username. Only supported if [**Username**](/docs/guides/configure/auth-strategies/sign-up-sign-in-options#identifiers) is enabled.
  ...
  If `strategy` is set to `'email_link'`, this specifies The full URL that the user will be redirected to when they visit the email link. See the [custom flow](/docs/guides/development/custom-flows/email-links) for implementation details.
  ...
  **Required** if `strategy` is set to `'ticket'`. The [ticket _or token_](/docs/guides/development/custom-flows/application-invitations) generated from the Backend API.
