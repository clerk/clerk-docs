...
This method in the SDK is a wrapper around the BAPI endpoint `PATCH/users/{user_id}/metadata`. See the [BAPI reference](/docs/references/backend-api/tag/Users#operation/UpdateUserMetadata){{ target: '_blank' }} for more information.
