...
<Tabs items={["Cursor", "VSCode", "Claude Code", "Claude Desktop", "Windsurf"]}>
  ...
  <Tab>
    ...
    Claude Desktop has two different ways to connect to MCP servers. The first is under an "Integrations" menu in the main UI, and the second is under a "Developer" menu in the settings. We will cover both methods here.


    ### Method 1: Using the "Integrations" menu
