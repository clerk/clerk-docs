...
description: Add Clerk authentication to any project with framework detection and templates.
---

The `adding-auth` skill helps AI agents add Clerk authentication to any project. It detects your framework and provides the appropriate setup.
...
- **Always await `auth()`** in Server Components - it returns a Promise
...
View the skill source on [GitHub](https://github.com/clerk/skills/tree/main/skills/adding-auth).
