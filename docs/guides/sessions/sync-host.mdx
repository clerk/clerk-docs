...
<Steps>
  ...
  <Tabs items={["Development", "Production"]}>
    ...
    <Tab>
      ...
      PLASMO_PUBLIC_CLERK_SYNC_HOST=https://clerk.yourwebsite.com
      ```
    </Tab>
  </Tabs>
  ...
  2. Copy your Secret Key. It should start with `sk_test_` or `sk_live_` for your development and production instances, respectively.
