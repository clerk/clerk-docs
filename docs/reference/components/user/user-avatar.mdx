...
![The \<UserAvatar /> component renders the authenticated user's avatar on its own, a common UI element found across many websites and applications.](/docs/images/ui-components/user-avatar.svg)
...
<If notSdk="js-frontend">
  ...
  <If sdk="react">
    ...
    import { SignedIn, UserAvatar, SignInButton, SignedOut } from '@clerk/react'
  ...
  <If sdk="expo">
    ...
    import { SignedIn, UserAvatar, SignInButton, SignedOut } from '@clerk/expo/web'
