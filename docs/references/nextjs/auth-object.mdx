...
| Level | Description |
| --- | --- |
| strict_mfa | User should have verified credentials in the past 10 minutes, otherwise ask for both first factor and second factor |
...
<Properties>
  ...
  The age of the factor level to check for. Value should be ≥ 1 < 99_999.
</Properties>
