...
The `useClerk()` composable provides access to the [`Clerk`](/docs/references/javascript/clerk) object, giving you the ability to build alternatives to any [Clerk component](/docs/reference/general/components/overview).
