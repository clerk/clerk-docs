The following example demonstrates how to use the [`$clerkStore`](/docs/reference/astro/client-side-helpers/clerk-store) to access the [`Clerk`](/docs/reference/objects/clerk) object.
