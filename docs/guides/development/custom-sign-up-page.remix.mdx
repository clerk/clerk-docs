...
<Steps>
  ...
  The following example demonstrates how to render the [`<SignUp />`](/docs/references/general/components/authentication/sign-up) component on a dedicated sign-up page using the [Remix optional route](https://reactrouter.com/en/main/route/route#optional-segments).
