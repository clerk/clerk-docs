...
```typescript
function attemptFirstFactorVerification(params: SessionVerifyAttemptFirstFactorParams): Promise<[SessionVerificationResource](/docs/references/javascript/session-verification)>
