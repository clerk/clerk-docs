...
To execute API operations, you must configure Clerk Go with your Clerk [Secret Key](!secret-key).
...
> [!NOTE]
> Your Clerk [Secret Key](!secret-key) is required. If you're signed into the Clerk Dashboard, your Secret Key should become visible by selecting the eye icon. Otherwise, you can retrieve your Clerk Secret Key on the [**API keys**](https://dashboard.clerk.com/~/api-keys) page in the Clerk Dashboard.
