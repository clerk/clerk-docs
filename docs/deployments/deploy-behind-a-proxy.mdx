...
- [NextJS on AWS ECS](https://aws.com)
...
To forward the correct headers, simply add this object to your nextjs.config.ts/js file
```
  serverRuntimeConfig: {
    // This tells Next.js to trust the X-Forwarded-* headers coming from the load balancer
