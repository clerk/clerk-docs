...
Some types in Clerk's JavaScript SDK, such as [`User`](/docs/reference/objects/user), [`PublicUserData`](/docs/reference/types/public-user-data#properties), and [`Organization`](/docs/reference/objects/organization#properties), have an `imageUrl`. The URL returned from this property can be scaled down with the following image optimization options:
