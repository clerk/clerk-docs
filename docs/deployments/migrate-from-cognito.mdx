...
<Steps>
  ...
  update your application to use Clerk’s managed [Account Portal](/docs/account-portal/overview) or the [`<SignIn />`](/docs/reference/general/components/authentication/sign-in) component.
