...
For help choosing between a Discount, a free trial, or a complimentary price, see [Free and complimentary access](/docs/guides/billing/free-and-complimentary-access).
...
1. In the Clerk Dashboard, navigate to the [**Billing**](https://dashboard.clerk.com/~/billing/subscriptions) page.
1. Select the subscriber you want to apply a Discount to.
1. Open the three-dot menu next to the Subscription Item you want to discount.
1. Select **Apply discount** and select the Discount to apply.
...
1. Open the three-dot menu next to the discounted Subscription Item.
1. Select **Revoke discount**.
