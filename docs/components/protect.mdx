...
<If sdk="remix">
  ```jsx {{ filename: 'app/routes/dashboard.tsx' }}
...
<If sdk="remix">
  ```jsx {{ filename: 'app/routes/invoices.tsx' }}
  import { Protect } from '@clerk/remix'
...
<If sdk="remix">
  ```jsx {{ filename: 'app/routes/billing.tsx' }}
  import { Protect } from '@clerk/remix'
...
<If sdk="remix">
  ```jsx {{ filename: 'app/routes/bronze.tsx' }}
  import { Protect } from '@clerk/remix'
...
<If sdk="remix">
  ```jsx {{ filename: 'app/routes/premium-access.tsx' }}
  import { Protect } from '@clerk/remix'
...
<If sdk="remix">
  ```jsx {{ filename: 'app/routes/settings.tsx' }}
  import { Protect } from '@clerk/remix'
