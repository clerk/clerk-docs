...
description: Learn how to use Clerk's hooks and helpers to read user data in your TanStack React Start application.
metadata:
  title: Read session and user data in your TanStack React Start app with Clerk
sdk: tanstack-react-start
---

Clerk provides a set of [hooks and helpers](/docs/reference/tanstack-react-start/overview#client-side-helpers) that you can use to read user data in your TanStack React Start application. Here are examples of how to use these helpers in both the client and server-side to get you started.
