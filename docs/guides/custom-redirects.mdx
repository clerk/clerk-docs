...
- `signInFallbackRedirectUrl` – For sign-in related component, such as [`<SignIn>`](/docs/components/authentication/sign-in), use `fallbackRedirectUrl` instead.
- `signUpFallbackRedirectUrl` – For sign-up related component, such as [`<SignUp>`](/docs/components/authentication/sign-up), use `fallbackRedirectUrl` instead.
...
- `signInForceRedirectUrl` – For sign-in related component, such as [`<SignIn>`](/docs/components/authentication/sign-in), use `forceRedirectUrl` instead.
- `signUpForceRedirectUrl` – For sign-up related component, such as [`<SignUp>`](/docs/components/authentication/sign-up), use `forceRedirectUrl` instead.
