...
This method in the SDK is a wrapper around the BAPI endpoint `POST/testing_tokens`. See the [BAPI reference](/docs/reference/backend-api/tag/Testing-Tokens#operation/CreateTestingToken) for more details.
