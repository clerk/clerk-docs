...
3. Open the [Clerk dashboard](https://dashboard.clerk.com/) in a new tab.
...
2. Next, define a component with methods for sending and getting a user's addresses from your database:
<Tabs type="framework" items={["Next.js", "React"]}>
  <Tab>
    <CodeBlockTabs type="router" options={["App Router", "Pages Router"]}>
...
3. Edit your component to return a basic UI that allows you to list all your addresses and send new ones:
<Tabs type="framework" items={["Next.js", "React"]}>
  <Tab>
    <CodeBlockTabs type="router" options={["App Router", "Pages Router"]}>
    ```tsx filename="app/supabase/page.tsx"
