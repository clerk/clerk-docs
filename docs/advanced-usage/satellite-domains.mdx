...
<Steps>
  ...
  > [!IMPORTANT]
  > To use a satellite domain in production, add a **CNAME record** to your domain provider pointing to your deployed app. Ensure you have access to your domain provider's DNS settings to complete this step.
