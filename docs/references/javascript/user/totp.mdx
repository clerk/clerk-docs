...
- you have followed the [quickstart](/docs/references/javascript/quickstart) in order to add Clerk to your JavaScript application
- you have [enabled **authenticator application** and **backup codes** as multi-factor strategies in the Clerk Dashboard](/docs/authentication/configuration/sign-up-sign-in-options#authentication-strategies)
    ...
    <html lang="en">
      ...
      <body>
        ...
        <div id="totp-container" hidden>
          ...
          <label for="totp-code"> Enter the code from your authenticator app </label>
