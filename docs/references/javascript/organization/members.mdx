...
| `role?` | `('admin' \| 'org:member' \| 'guest_member')[]` | The roles of memberships that will be included in the response. |
...
| `role` | `'admin' \| 'org:member' \| 'guest_member'` | The role that the user will have in the organization. |
...
| `role` | `'admin' \| 'org:member' \| 'guest_member'` | The role of the new member. |
