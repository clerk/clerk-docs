...
| Name | Type     | Description                                                       |
| ---- | -------- | ----------------------------------------------------------------- |
| `name` | `'email_code' \| 'email_link' \| 'password' \| 'phone_code' \| 'reset_password_email_code' \| 'reset_password_phone_code' \| 'web3_metamask_signature'` | The name of the strategy to switch to. Also accepts social connection names.                           |
