<Properties>
  ...
  Controls whether a satellite app automatically syncs authentication state with the primary domain on first page load. Defaults to `false`. See [satellite domains](/docs/guides/dashboard/dns-domains/satellite-domains) for more details.
