...
The `$userStore` store provides a convenient way to access current [`User`](/docs/reference/objects/user) data and helper methods for managing the active user.
...
For more information on the `update()` method, see the [`User` reference](/docs/reference/objects/user#update).
...
For more information on the `reload()` method, see the [`User` reference](/docs/reference/objects/user#reload).
