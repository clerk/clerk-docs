...
This method in the SDK is a wrapper around the BAPI endpoint `POST/organizations`. See the [BAPI reference](/docs/references/backend-api/tag/Organizations#operation/CreateOrganization){{ target: '_blank' }} for more information.
