...
To enable this feature, click on the **User & Authentication** drop down in the side nav of the [Clerk Dashboard](https://dashboard.clerk.com). Click on the <DashboardLink path="user-authentication/restrictions">Restrictions</DashboardLink> page and go to the **Allowlist** section. Turn on the **Enable allowlist** toggle.
...
To enable this feature, click on the **User & Authentication** drop down in the side nav of the [Clerk Dashboard](https://dashboard.clerk.com). Click on the <DashboardLink path="user-authentication/restrictions">Restrictions</DashboardLink> page and go to the **Blocklist** section. Turn on the **Enable blocklist** toggle.
...
To enable this feature, click on the **User & Authentication** drop down in the side nav of the [Clerk Dashboard](https://dashboard.clerk.com). Click on the <DashboardLink path="user-authentication/restrictions">Restrictions</DashboardLink> page and go to the **Restrictions** section. Turn on the **Block email subaddresses** toggle.
