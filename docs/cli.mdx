...
<If
  sdk={["nextjs", "react", "react-router", "tanstack-react-start", "astro", "vue", "js-frontend", "expo", "nuxt", "expressjs", "fastify", "hono"]}
>
  ## Get started
...
<If
  notSdk={["nextjs", "react", "react-router", "tanstack-react-start", "astro", "vue", "js-frontend", "expo", "nuxt", "expressjs", "fastify", "hono"]}
>
  > [!NOTE]
...
The CLI supports frameworks such as Next.js, React, Vue, Nuxt, Astro, React Router, TanStack Start, and more. Some frameworks like Expo, Express, Fastify, and Hono are supported for SDK installation but don't yet include full scaffolding. Run `clerk init --help` for the current list.
