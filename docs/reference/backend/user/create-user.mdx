...
<Properties>
  ...
  - [`pbkdf2_sha512`](https://en.wikipedia.org/wiki/PBKDF2)
    ...
    - The salt is expected to be a string literal and the hash should be hex encoded
  - [`pbkdf2_sha512_hex`](https://en.wikipedia.org/wiki/PBKDF2)
    ...
    - Both the salt and hash are expected to be hex encoded. Use this if your salt was originally generated in bytes.
