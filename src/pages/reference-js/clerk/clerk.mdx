...
<div className="container mx-auto my-4">
  <div className="grid lg:grid-cols-2 lg:grid-rows-4 justify-center gap-x-7">
    ...
    <ComponentPreviewCards title="Create Organization" image="/images/ui-components/component-org_create.svg" link="/reference-js/clerk/create-organization-component" cta="Read docs"/>
  </div>
</div>
