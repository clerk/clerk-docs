...
<Steps>
  ...
  1. From your app's overview, save the **Application (client) ID** somewhere secure. This is your **Client ID** in Clerk.
  ...
  1. Save the new **Client Secret**'s **Value** somewhere secure. This is your **Client Secret** in Clerk.
