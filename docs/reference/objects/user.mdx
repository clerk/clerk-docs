...
Creates a passkey for the signed-in user. Returns a [`PasskeyResource`](/docs/reference/types/passkey-resource) object. For an example on how to use `createPasskey()`, see the [custom flow guide](/docs/guides/development/custom-flows/authentication/passkeys#create-user-passkeys).
