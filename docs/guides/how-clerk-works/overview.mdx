...
>
> Clerk intentionally scopes the `__session` cookie to your app's exact domain for security reasons, as described above, so it can't be shared across subdomains.
>
