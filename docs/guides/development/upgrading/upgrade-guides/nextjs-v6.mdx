...
Note that this isn't recommended, and in most cases you should use `auth()` to access auth data at request time instead. For more information, see the guide on [Next.js rendering modes and Clerk](/docs/guides/development/rendering-modes).

## Removed deprecated APIs

The following deprecated APIs have been removed.

- `authMiddleware()` - [Migrate to `clerkMiddleware()`](/docs/guides/development/upgrading/upgrade-guides/core-2/nextjs#migrating-to-clerk-middleware)
