...
1. If you have not already, [create a new user](https://clerk.com/docs/reference/backend-api/tag/users/post/users).
1. [Create a new session](https://clerk.com/docs/reference/backend-api/tag/sessions/post/sessions) for the user.
1. [Create a session token](https://clerk.com/docs/reference/backend-api/tag/sessions/post/sessions/{session_id}/tokens) using the session ID returned in the previous step.
