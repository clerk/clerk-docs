...
If you have not set up your Astro application to work with Clerk, see the [quickstart guide](/docs/getting-started/quickstart).
...
<Steps>
  ...
  You can use the [prebuilt components](/docs/references/general/components/overview) in your Astro pages or regular React components.
