...
Setting up CNAME records and using DNS is the simplest way. However, if you're unable to use this approach, or would like more control over your integration with Clerk, you can use a proxy.
