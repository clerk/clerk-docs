...
<Tabs items={["Next.js", "JavaScript"]}>
  <Tab>
    ...
    1. Uses the [`useOrganizationList()`](/docs/references/general/hooks/use-organization) hook to get `userInvitations`, which is a list of the user's organization invitations.
