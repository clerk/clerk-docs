...
- [Build a custom flow](/docs/guides/development/custom-flows/multi-session-applications) if you want to rebuild the existing Clerk flow using the Clerk API.
