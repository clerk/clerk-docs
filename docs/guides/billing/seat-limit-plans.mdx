...
> - Organizations subscribed to plans without seat limits will have their membership limit set to the instance's max member limit. This can be overridden on a per-organization basis.
