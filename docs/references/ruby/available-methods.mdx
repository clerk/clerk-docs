...
The Ruby SDK mirrors the [Backend API](/docs/reference/backend-api). The SDK is organized into resources, which are listed below. Each resource has a set of methods that correspond to the API endpoints.
...
The following methods are available for managing [allowlist identifiers](/docs/reference/backend-api/tag/Allow-list-Block-list).
...
The following methods are available for the [`clients`](/docs/reference/backend-api/tag/Clients) resource.
...
The following methods are available for managing [sessions](/docs/reference/backend-api/tag/Sessions).
...
The following methods are available for managing [users](/docs/reference/backend-api/tag/Users).
