...
To enable a social connection provider, go to the [Social Connections](https://dashboard.clerk.com/last-active?path=user-authentication/social-connections) page in the Clerk Dashboard. 
...
<Images
  width={3024}
  height={1654}
  src="/docs/images/authentication/social-connections-scopes.webp"
...
You can retrieve the OAuth access tokens of your users via the [OAuth Access Token Wallet](/docs/reference/backend-api/tag/Users#operation/GetOAuthAccessToken) endpoint that's available in the Clerk Backend API.
