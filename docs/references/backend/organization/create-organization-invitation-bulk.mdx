...
This method in the SDK is a wrapper around the BAPI endpoint `POST/organizations/{organization_id}/invitations/bulk`. See the [BAPI reference](/docs/references/backend-api/tag/Organization-Invitations#operation/CreateOrganizationInvitationBulk){{ target: '_blank' }} for more information.
