...
<Steps>
  ...
  1. In the left sidebar, select **Settings**. You'll be redirected to your shop's **General** settings page.
  1. In the left sidebar, select **Customer accounts**. You'll be redirected to the **Customer accounts** page.
