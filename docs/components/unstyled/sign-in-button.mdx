  ...
  rows={[
    ...
    },
    {
      cells: [
        ...
        <>Determines what happens when a user clicks on the <code><SignInButton /></code>. Setting this to <code>'redirect'</code> will redirect the user to the sign-in route. Setting this to <code>'modal'</code> will open a modal on the current route.<br />Defaults to <code>'redirect'</code>.</>
      ]
    }
  ]}
/>
