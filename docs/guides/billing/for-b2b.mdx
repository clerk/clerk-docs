...
<Include src="./_partials/create-an-organization-pricing-table" />
...
<Tabs items={[ "Plan", "Feature", "Permission"]}>
  ...
  <Tab>
    ...
    <Include src="./_partials/checking-permission-using-has-function" />
  </Tab>
</Tabs>
...
<Tabs items={["Plan", "Feature", "Permission"]}>
  ...
  <Tab>
    ...
    <Include src="./_partials/checking-permission-using-protect" />
  </Tab>
</Tabs>
