...
Add End-to-End tests to regularly test hot paths of your SDK. Functionality like sign-in, sign-up, and other UI components must work. Read the [testing guide](https://clerk.com/docs/testing/overview) to learn more.
