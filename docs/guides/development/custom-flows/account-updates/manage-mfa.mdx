...
> [!TIP]
> A user who has saved their backup codes can sign in after losing their phone without an admin resetting their MFA, so make saving them a required step in your enrollment UI. A user who signs in with a passkey can too when the instance has [**Passkeys satisfy multi-factor authentication**](/docs/guides/configure/auth-strategies/sign-up-sign-in-options#passkeys-and-multi-factor-authentication) enabled. For users who are locked out, see [MFA account recovery](/docs/guides/secure/mfa-recovery).
...
<Steps>
  ...
  <If notSdk={["expo", "ios", "android"]}>
    ...
    <Tabs items={["Manage MFA page", "Add phone number page"]}>
      <Tab>
        ```tsx {{ filename: 'src/app/account/manage-mfa/page.tsx', collapsible: true }}
        'use client'

        import * as React from 'react'
        import { useUser, useReverification, useClerk, useSession } from '@clerk/nextjs'
        import type { BackupCodeResource, PhoneNumberResource } from '@clerk/nextjs/types'
  ...
  <If sdk="expo">
    ...
    <Tabs items={["Layout", "Manage MFA page", "Add phone number page"]}>
      ...
      <Tab>
        ...
        import type { BackupCodeResource, PhoneNumberResource } from '@clerk/expo/types'
  ...
  <If notSdk={["expo", "ios", "android"]}>
    ...
    <Tabs items={["Manage MFA page", "Add TOTP page"]}>
      <Tab>
        ...
        import { useUser, useReverification, useClerk, useSession } from '@clerk/nextjs'
        import Link from 'next/link'
        import type { BackupCodeResource } from '@clerk/nextjs/types'
        import { useRouter } from 'next/navigation'
      ...
      <Tab>
        ...
        import { useUser, useReverification, useClerk, useSession } from '@clerk/nextjs'
        import type { TOTPResource } from '@clerk/nextjs/types'
        import Link from 'next/link'
        import * as React from 'react'
  ...
  <If sdk="expo">
    ...
    <Tabs items={["Layout", "Account page", "Add TOTP page"]}>
      ...
      <Tab>
        ...
        import { useUser, useReverification, useClerk } from '@clerk/expo'
        import { Href, useRouter } from 'expo-router'
        import type { BackupCodeResource } from '@clerk/expo/types'
      ...
      <Tab>
        ...
        import type { TOTPResource } from '@clerk/expo/types'
        import * as React from 'react'
        import {
          View,
          Text,
