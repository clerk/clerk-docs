...
| `afterSignInUrl` | `string \| undefined` | The default URL to use after the user signs in. Defaults to `/`. |
| `afterSignUpUrl` | `string \| undefined` | The default URL to use after the user signs up. Defaults to `/`. |
