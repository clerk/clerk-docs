...
- Give users access to [`Client`](/docs/references/javascript/client), [`Session`](/docs/references/javascript/session), [`User`](/docs/references/javascript/user/user), and [`Organization`](/docs/references/javascript/organization/organization) properties through the framework’s choice of state management
