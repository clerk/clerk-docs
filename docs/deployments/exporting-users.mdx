...
While we don't expose this via our Backend APIs, if you wish to get your user's data that *includes their hashed passwords*, please reach out to [support@clerk.dev](https://clerk.com/support) where we can assist you in a secure data exchange.
