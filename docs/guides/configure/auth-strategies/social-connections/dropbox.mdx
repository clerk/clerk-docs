...
description: Learn how to allow users to sign up and sign in to your Clerk application with their Dropbox account using OAuth.
---
...
Enabling OAuth with [Dropbox](https://developers.dropbox.com/oauth-guide) allows your users to sign up and sign in to your Clerk app with their Dropbox account.
...
Keep two browser tabs open during setup: one for the [Clerk Dashboard](https://dashboard.clerk.com/~/user-authentication/sso-connections) and one for your [Dropbox App Console](https://www.dropbox.com/developers/apps).

<Steps>
  ### Enable Dropbox as a social connection in Clerk
