...
<Steps>
  ...
  1. Navigate to the **Authentication** tab and under **Client Authentication Method**, select the appropriate method for your app. For server-side applications, `client_secret_basic` or `client_secret_post` are recommended.
