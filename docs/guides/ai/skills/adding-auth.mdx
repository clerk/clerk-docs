...
You'll need to set your [Publishable Key](!publishable-key) and [Secret Key](!secret-key) in your environment variables. You can get your keys from the [**API keys**](https://dashboard.clerk.com/last-active?path=api-keys) page in the Clerk Dashboard.
