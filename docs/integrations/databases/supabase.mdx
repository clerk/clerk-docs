...
After your Clerk application has been created, navigate to the [JWT Templates](https://dashboard.clerk.com/last-active?path=jwt-templates) screen from the Clerk Dashboard. Click on the **New template** button to create a new template based on Supabase.
...
You can find your Frontend API value by navigating to the [API keys](https://dashboard.clerk.com/last-active?path=api-keys) page in the Clerk Dashboard and copying your **Publishable key**.
...
<Images
  width={2392}
  height={1300}
  src="/docs/images/integrations/api-keys.webp"
