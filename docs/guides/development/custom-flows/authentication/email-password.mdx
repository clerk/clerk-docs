...
<Steps>
  ...
  1. Check if the sign-in requires a second factor. [Client Trust](/changelog/2025-11-14-client-trust-credential-stuffing-killer), which is enabled by default for new Clerk applications, may require users to verify their identity with a one-time code sent to their email when signing in from a new device.
        ...
        const handleSubmit = async (e: React.FormEvent) => {
          ...
          try {
            ...
            if (signInAttempt.status === 'complete') {
              ...
              // See https://clerk.com/changelog/2025-11-14-client-trust-credential-stuffing-killer
