...
Clerk offers [a set of pre-built themes](/docs/components/customization/themes) that can be used to quickly style Clerk components.
...
1. [Using global CSS styling](#use-global-css-to-style-clerk-components)
