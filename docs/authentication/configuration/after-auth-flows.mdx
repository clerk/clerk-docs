...
- [Disabling personal workspace](/docs/organizations/overview#disabling-personal-workspace)
...
Taking [disabling personal workspace](/docs/organizations/overview#disabling-personal-workspace) as example:
