...
> [!WARNING]
> We're working on a replacement for Clerk Elements that takes a different approach to customization. This new solution will serve as the successor to Elements, and we'll be sharing details soon.
>
> We're not planning any further feature development for Clerk Elements as we focus on building what's next.
