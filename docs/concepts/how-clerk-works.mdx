...
Production instances are used for production, pre-production, or staging environments with fixed domains. Production instances offer the strongest security and performance guarantees. Development instances contain certain trade-offs meant to support ease of active development. For more details on the differences, read the [Instances / Environments](/docs/deployments/environments) doc.
