...
This applies to all of the React-based packages, like [Next.js](/docs/quickstarts/nextjs) and [Gatsby](/docs/quickstarts/gatsby), as well as [the pure JavaScript ClerkJS package](/docs/references/javascript/clerk/clerk#components).

## Using a Pre-built Theme

We offer [a set of themes that can be used with the `appearance` prop](/docs/components/customization/themes). The themes are available as a package called `@clerk/themes`.
...
> [You can see a list of the themes we offer in our reference docs.](/docs/components/customization/themes)
