---
title: Build a custom forgot password flow (Legacy)
...
<Steps>
  ...
  <If notSdk="expo">
    ...
    import { useSignIn } from '@clerk/nextjs'
    import { useRouter } from 'next/navigation'
    import type { ClerkAPIError, EmailCodeFactor, SignInFirstFactor } from '@clerk/nextjs/types'
  ...
  <If sdk="expo">
    ...
    import type { ClerkAPIError, EmailCodeFactor, SignInFirstFactor } from '@clerk/shared/types'
