...
```json
{
  ...
  "longMessage": "Unable to authenticate this browser for your development instance. Check your Clerk cookies and try again. If the issue persists, please reach out to support@clerk.com.",
