---
title: Verify OAuth access tokens in your Next.js app with Clerk
...
You can also protect entire route groups using [`clerkMiddleware()`](/docs/references/nextjs/clerk-middleware). See how to implement this in this [the middleware docs](/docs/references/nextjs/clerk-middleware#protect-routes-based-on-token-types).
