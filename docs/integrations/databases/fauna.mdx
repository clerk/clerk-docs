...
<Steps>
  ...
  1. Configure your template:
     ...
     - You can leave all other fields as their default settings or customize them to your needs. See the [JWT template guide](/docs/backend-requests/jwt-templates#creating-a-template) to learn more about these settings.
