...
<Properties>
  ...
  To enable, pass the URL of the web application that the extension will sync the authentication state from. See the [dedicated guide](/docs/guides/development/sync-host) for more information.
</Properties>
