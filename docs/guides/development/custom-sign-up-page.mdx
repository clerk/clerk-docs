...
<Steps>
  ...
  If your `clerkMiddleware()` includes auth checks, this pattern is no longer recommended. See [Migrating away from Middleware-based auth checks](/docs/guides/development/upgrading/upgrade-guides/migrate-from-create-route-matcher).
