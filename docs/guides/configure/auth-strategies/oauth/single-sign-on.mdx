...
In this case, Clerk is the IdP for your application. The [**client**](/docs/guides/configure/auth-strategies/oauth/overview#key-terminology) is the third party site or tool that you want your users to authenticate to.
...
1. In the Clerk Dashboard, navigate to the [**OAuth Applications**](https://dashboard.clerk.com/~/user-authentication/oauth-applications) page.
