...
<Steps>
  ...
  - Use Clerk's [`SignInWithAppleHelper`](https://clerk.github.io/clerk-ios/documentation/clerk/signinwithapplehelper) class.
  ...
  Once you have obtained your [Apple ID Credential](https://developer.apple.com/documentation/authenticationservices/asauthorizationappleidcredential), you can use it to authenticate with Clerk by calling [`SignIn.authenticateWithIdToken(provider:idToken:)`](https://clerk.github.io/clerk-ios/documentation/clerk/signin/authenticatewithidtoken\(provider:idtoken:\)) with a provider of `.apple` and the `idToken` you have obtained.
