...
Next, you will want to retrieve the Webhook signing secret. You can find this in the Clerk Dashboard on the **[Webhooks](https://dashboard.clerk.com/last-active?path=webhooks)** page. You will need to set this as an environment variable in your Next.js project.
...
Next, you will want to retrieve the Webhook signing secret. You can find this in the Clerk Dashboard on the **[Webhooks](https://dashboard.clerk.com/last-active?path=webhooks)** page. You will need to set this as an environment variable in your Node project.
...
If you are testing webhooks outside of your development, you can use our webhook test requests to test your webhook. You can find these in the Clerk Dashboard on the **[Webhooks](https://dashboard.clerk.com/last-active?path=webhooks)** page.
