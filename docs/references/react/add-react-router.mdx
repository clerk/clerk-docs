...
<Callout type="warning">
  [Loaders](https://reactrouter.com/en/main/route/loader) and [Actions](https://reactrouter.com/en/main/route/action) are currently not supported by Clerk at the moment with React Router.
</Callout>
