...
2. The message’s contents were not modified from how they were written by the sender (integrity)
...
- Some fancy math is used to generate a pair of keys: a public key and a private key. This process is referred to as "public key cryptography".
