...
sdk: chrome-extension, nextjs, react, react-router, tanstack-react-start
---
...
<Tabs items={["Prebuilt UI", "Custom UI"]}>
  <Tab>
    ...
    <If sdk="react-router">
      ...
      import { isReverificationCancelledError } from '@clerk/react-router/errors'
    ...
    <Tabs items={["UpdateUserEmail", "VerificationComponent"]}>
      <Tab>
        ...
        <If sdk="react-router">
          ...
          import { isReverificationCancelledError } from '@clerk/react-router/errors'
          import { useState } from 'react'
          import type { SessionVerificationLevel } from '@clerk/react-router/types'
          import { VerificationComponent } from './VerificationComponent'
        ...
        <If sdk="chrome-extension">
          ...
          import { useReverification, useUser } from '@clerk/chrome-extension'
          import { useState } from 'react'
          import type { SessionVerificationLevel } from '@clerk/chrome-extension/types'
          import { VerificationComponent } from './VerificationComponent'
        ...
        <If sdk="tanstack-react-start">
          ...
          import { isReverificationCancelledError } from '@clerk/tanstack-react-start/errors'
          import { useState } from 'react'
          import type { SessionVerificationLevel } from '@clerk/tanstack-react-start/types'
          import { VerificationComponent } from './VerificationComponent'
      ...
      <Tab>
        ...
        <If sdk="chrome-extension">
          ...
          import type {
            ...
            SessionVerificationLevel,
            SessionVerificationResource,
          } from '@clerk/chrome-extension/types'
