...
>
> It is not recommended to use **passkeys** as a form of authentication. [Learn more about domain restrictions for passkeys](/docs/guides/development/custom-flows/passkeys#domain-restrictions-for-passkeys).
>
