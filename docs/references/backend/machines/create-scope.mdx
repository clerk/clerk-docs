...
Creates a new machine scope, allowing the specified machine to access another machine. Machine scopes define which machines can interact with each other in your application.
