...
| [/clerk-nuxt-patterns](https://github.com/clerk/skills/blob/main/skills/frameworks/clerk-nuxt-patterns/SKILL.md) | Nuxt patterns | Middleware, composables, server API routes, SSR |
...
| [/clerk-expo](https://github.com/clerk/skills/blob/main/skills/mobile/clerk-expo/SKILL.md) | Expo / React Native authentication with `@clerk/expo` | Adding Clerk to an Expo app — prebuilt AuthView/UserButton or custom hook-driven flows |
...
| "Use SecureStore and OAuth deep linking in Expo" | `/clerk-expo` |
...
| "Add auth to my Nuxt app" | `/clerk-nuxt-patterns` |
