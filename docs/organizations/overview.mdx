...
A user within one of your applications can create *up to* 100 organizations in that application. However, the number of [MAOs](#monthly-active-organization-mao) for that application must be kept in mind.
