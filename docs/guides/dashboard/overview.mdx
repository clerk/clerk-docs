...
If you need help or have feedback about the Clerk Dashboard, reach out to the [support team](/contact/support).
...
1. Select **Create workspace**. The newly created workspace will be set as the active workspace.

### Invite and manage team members

1. At the top of the Clerk Dashboard, select **Invite**, or navigate to the [**Team**](https://dashboard.clerk.com/team) page and select **Invite user**.
