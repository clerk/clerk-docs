...
{/* TODO: Add JavaScript, iOS, Nuxt example. */}
...
<Steps>
  ...
  {/* TODO: Add example for JavaScript, Expo, iOS, Android, Nuxt. */}
  ...
  1. Now, the user will be redirected to the URL you've set with the `taskUrls` option. This page is where you will add the forgot/reset password code, such as the [reset user's password with an email address](#reset-user-s-password-with-an-email-address) example from the previous section.
