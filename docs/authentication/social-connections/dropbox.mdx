...
For _production instances_, you must provide custom credentials, which involves generating your own **Client ID** and **Client Secret** using your Dropbox Developer account.
...
<Steps>
  ...
  ### Create a Dropbox Developer project
