...
<Tabs items={["Next.js", "Node", "Remix"]}>
  <Tab>
    ...
    - In App Router applications, use the [`auth()`](/docs/sdk/nextjs/auth) helper.
    - In Pages Router applications, use the [`getAuth()`](/docs/sdk/nextjs/get-auth) helper.
  ...
  <Tab>
    To use the `getToken()` method in the backend, you can access it using the [`getAuth()`](/docs/sdk/nextjs/get-auth) function.
