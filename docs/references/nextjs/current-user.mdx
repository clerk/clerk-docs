...
The `currentUser` helper returns the [`Backend API User`](/docs/reference/backend-api/tag/Users#operation/GetUser){{ target: '_blank' }} object of the currently active user. It can be used in Server Components, Route Handlers, and Server Actions.
