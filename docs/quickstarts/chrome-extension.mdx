...
[Email & email link](/docs/authentication/configuration/sign-up-sign-in-options#email-link), [social sign in (OAuth)](/docs/authentication/configuration/sign-up-sign-in-options#social-connections-o-auth), [SAML](/docs/authentication/saml/overview), and invites are not supported.
