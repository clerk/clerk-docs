...
<Images
  width={3024}
  height={1648}
  src="/docs/images/custom-flows/jwt-templates-select.jpg"
...
<Images
  width={3024}
  height={1648}
  src="/docs/images/custom-flows/convex-create-template.jpg"
...
<Images
  width={3024}
  height={1648}
  src="/docs/images/custom-flows/convex-template-shortcodes.jpg"
...
<Images
  width={3024}
  height={1648}
  src="/docs/images/custom-flows/convex-template-issuer.jpg"
  alt="The 'Create new template' page of the JWT Templates page in the Clerk Dashboard. The page is scrolled down to the 'Claims' section."
/>
