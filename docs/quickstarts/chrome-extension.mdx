...
To make your development experience easier, the following examples include some basic styles for your application. You can customize these styles to fit your application's design.
