...
<Properties>
  - `data`
  - <code>[BillingPaymentSourceResource](/docs/reference/javascript/types/billing-payment-source-resource)\[] | null</code>

  An array of [payment methods](/docs/reference/javascript/types/billing-payment-source-resource), or `null` if the data hasn't been loaded yet.
