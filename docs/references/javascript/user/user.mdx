...
| Type | Description |
| - | - |
| `Promise<SessionWithActivities[]>` | This method returns a `Promise` which resolves with an array of [`SessionWithActivities`](/docs/references/javascript/types/session-with-activities) objects. |
