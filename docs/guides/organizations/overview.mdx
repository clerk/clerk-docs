...
> [!IMPORTANT]
> Personal accounts being disabled by default was released on August 22nd, 2025. Applications created before this date will not be able to see the **Allow personal accounts** setting, because personal account were enabled by default.
...
> [!IMPORTANT]
> Organization slugs are disabled by default for applications created after October 7th, 2025. For applications created before this date, you can opt to disable it.
