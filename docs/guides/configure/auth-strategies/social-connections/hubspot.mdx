...
description: Learn how to allow users to sign up and sign in to your Clerk application with their HubSpot account using OAuth.
---
...
Enabling OAuth with [HubSpot](https://developers.hubspot.com/docs/apps/developer-platform/build-apps/authentication/oauth/oauth-quickstart-guide) allows your users to sign up and sign in to your Clerk app with their HubSpot account.
...
Keep two browser tabs open during setup: one for the [Clerk Dashboard](https://dashboard.clerk.com/~/user-authentication/sso-connections) and one for your [HubSpot developer account](https://app.hubspot.com/signup-hubspot/developers).

<Steps>
  ### Enable HubSpot as a social connection in Clerk
