...
This method in the SDK is a wrapper around the BAPI endpoint `GET/sessions`. See the [BAPI reference](/docs/references/backend-api/tag/Sessions){{ target: '_blank' }} for more information.
