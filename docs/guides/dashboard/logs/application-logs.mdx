...
> [!WARNING]
> Application Logs are currently in beta. If you run into any issues, please reach out to our [support team](https://clerk.com/support).
...
| Event type | Description |
| - | - |
| `web3_wallet.created` | Web3 wallet was added to user account |
| `web3_wallet.verified` | Web3 wallet was verified for user account |
| `web3_wallet.deleted` | Web3 wallet was removed from user account |
