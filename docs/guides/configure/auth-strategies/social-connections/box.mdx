...
description: Learn how to allow users to sign up and sign in to your Clerk application with their Box account using OAuth.
---
...
Enabling OAuth with [Box](https://developer.box.com/guides/authentication/oauth2/) allows your users to sign up and sign in to your Clerk app with their Box account.
...
Keep two browser tabs open during setup: one for the [Clerk Dashboard](https://dashboard.clerk.com/~/user-authentication/sso-connections) and one for your [Box Developer Console](https://app.box.com/developers/console).

<Steps>
  ### Enable Box as a social connection in Clerk
