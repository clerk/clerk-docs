...
> [!NOTE]
> If you are using [passkeys](https://clerk.com/blog/what-are-passkeys), only the first scenario in the above example will work, due to restrictions in the [webauthn standard](https://www.w3.org/TR/webauthn-2/#sctn-rp-operations).
