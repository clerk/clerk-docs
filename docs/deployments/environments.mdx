...
A `Development` instance is our default instanced type and has characteristics that allow it to be more useful for local development, and therefore has a more relaxed overall security posture.
