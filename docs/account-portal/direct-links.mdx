...
2. In the navigation sidebar, select **Paths**.
3. For development, set your static fallback localhost with the port that you use (e.g. `http://localhost:3000`). Clerk will use this fallback host if a dev browser fails to be retrieved for your client.
