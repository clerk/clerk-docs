...
This method in the SDK is a wrapper around the BAPI endpoint `POST/users/{user_id}/unlock`. See the [BAPI reference](/docs/references/backend-api/tag/Users#operation/UnlockUser){{ target: '_blank' }} for more information.
