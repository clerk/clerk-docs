...
> [!WARNING]
> If you would like to deploy to production, you will need to add your **production** API keys to your Vercel project. Refer to the [Deploy to production](/docs/guides/development/production) guide for more information.
...
To configure Clerk within your Vercel preview environment, see the [guide for configuring a preview environment](/docs/guides/development/deployment/managing-environments).

## Deploy to production

If you would like to deploy your Vercel project to production, you will need to add your **production** API keys to your Vercel project. You will also need a domain that you own, as you cannot use a `*.vercel.app` domain for production. Refer to the [Deploy to production](/docs/guides/development/production) guide for more information.
