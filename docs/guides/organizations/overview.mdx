...
> [!IMPORTANT]
> Organization slugs are disabled by default for applications created after 10-07-2025. For applications created before this date, you can opt to disable it.
