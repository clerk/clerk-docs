...
Returns the configured URL where [`<CreateOrganization />`](/docs/references/components/prganization/create-organization) is mounted or a custom create-organization page is rendered.
...
Returns the configured URL where [`<OrganizationProfile />`](/docs/references/components/prganization/organization-profile) is mounted or a custom organization-profile page is rendered.
...
> [!NOTE]
> For React-based apps, consider using the [`<CreateOrganization />`](/docs/references/components/prganization/create-organization) component.
...
Redirects to the configured URL where [`<CreateOrganization />`](/docs/references/components/prganization/create-organization) is mounted. This method uses the [`navigate()`](#navigate) method under the hood.
...
Redirects to the configured URL where [`<OrganizationProfile />`](/docs/references/components/prganization/organization-profile) is mounted. This method uses the [`navigate()`](#navigate) method under the hood.
...
- [`mountOrganizationProfile()`](/docs/references/components/prganization/organization-profile#mount-organization-profile)
- [`unmountOrganizationProfile()`](/docs/references/components/prganization/organization-profile#unmount-organization-profile)
- [`openOrganizationProfile()`](/docs/references/components/prganization/organization-profile#open-organization-profile)
- [`closeOrganizationProfile()`](/docs/references/components/prganization/organization-profile#close-organization-profile)

### `<OrganizationSwitcher />`

- [`mountOrganizationSwitcher()`](/docs/references/components/prganization/organization-switcher#mount-organization-switcher)
- [`unmountOrganizationSwitcher()`](/docs/references/components/prganization/organization-switcher#unmount-organization-switcher)

### `<CreateOrganization />`

- [`mountCreateOrganization`](/docs/references/components/prganization/create-organization#mount-create-organization)
- [`unmountCreateOrganization`](/docs/references/components/prganization/create-organization#unmount-create-organization)
- [`openCreateOrganization`](/docs/references/components/prganization/create-organization#open-create-organization)
- [`closeCreateOrganization`](/docs/references/components/prganization/create-organization#close-create-organization)

### `<OrganizationList />`

- [`mountOrganizationList`](/docs/references/components/prganization/organization-list#mount-organization-list)
- [`unmountOrganizationList`](/docs/references/components/prganization/organization-list#unmount-organization-list)
