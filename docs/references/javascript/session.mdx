...
| Name | Type | Description |
| --- | --- | --- |
| `role` | `string` | You can pass any of the clerk default role keys or the ones that you have defined. |
| `permission` | `string` | You can pass any of the clerk default permissoin keys or the ones that you have defined. |
