...
The [Clerk Go SDK](https://github.com/clerk/clerk-sdk-go) is a wrapper over the [Clerk Backend API](/docs/reference/backend-api).
...
The Clerk Go SDK is organized using a resource-based structure similar to the [Clerk Backend API](/docs/reference/backend-api).
