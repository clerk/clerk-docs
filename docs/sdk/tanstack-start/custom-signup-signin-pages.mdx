...
> [!NOTE]
> Just getting started with Clerk and TanStack Start? See the [quickstart tutorial](/docs/sdk/tanstack-start/quickstart)!
...
<Cards>
  - [Read user and session data](/docs/sdk/tanstack-start/read-session-data)
