...
<Properties>
  ...
  Deprecated: use [`updateMetadata()`](#update-metadata) instead, which deep-merges with the existing value rather than replacing it. This parameter will be removed in a future major version.
</Properties>
