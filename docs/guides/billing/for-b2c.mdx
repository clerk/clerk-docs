...
<Include src="./_partials/enable-billing" />
...
<Include src="./_partials/create-a-pricing-table" />
...
<Tabs items={[ "Plan", "Feature"]}>
  <Tab>
    ...
    <Include src="./_partials/checking-plan-using-has-function" />
  </Tab>

  <Tab>
    The following example demonstrates how to use `has()` to check if a user has a feature.

    <Include src="./_partials/checking-feature-using-has-function" />
  </Tab>
</Tabs>
