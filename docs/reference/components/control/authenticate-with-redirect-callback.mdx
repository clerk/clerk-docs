...
This component automatically handles the OAuth callback, completing the authentication process and managing the user's session. It uses the [`handleRedirectCallback()`](/docs/reference/objects/clerk#handleredirectcallback) method under the hood.
