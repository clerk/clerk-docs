...
<If sdk="js-frontend">
  ...
  1. Calls the [`getOrganizationInvitations()`](/docs/reference/objects/user#getorganizationinvitations) method to retrieve the list of Organization invitations for the active user. This method returns `data`, which is an array of [`UserOrganizationInvitation`](/docs/reference/types/user-organization-invitation) objects.
