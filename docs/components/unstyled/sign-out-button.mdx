...
You can sign out of a specific session by passing in a `sessionId` to the `signOutOptions` prop. This is useful for signing a single account out of a [multi-session application](/docs/authentication/configuration/session-options#multi-session-applications).
...
<Properties>
  ...
  **For Astro only:** If `true`, the `<SignOutButton>` component will render its children as a child of the component.
  ...
  Options for signing out. Includes `sessionId` which if passed, signs the user out of a specific session. Useful for [multi-session applications](/docs/authentication/configuration/session-options#multi-session-applications).
...
<Properties>
  ...
  The ID of a specific session to sign out of. Useful for [multi-session applications](/docs/authentication/configuration/session-options#multi-session-applications).
