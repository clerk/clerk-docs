...
<If sdk="js-frontend">
  The following example uses the [`clerk.createOrganization()`](/docs/reference/objects/clerk#create-organization) method to create a new Organization with the provided name.
