...
This method in the SDK is a wrapper around the BAPI endpoint `PATCH/users/{user_id}`. See the [BAPI reference](/docs/reference/backend-api/tag/Users#operation/UpdateUser) for more details.
