...
Use the code below to configure the @clerk [registry namespace](https://ui.shadcn.com/docs/registry/namespace) for your project. Copy and paste the code into your `components.json` file.
