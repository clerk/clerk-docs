...
This method in the SDK is a wrapper around the BAPI endpoint `PATCH/organizations/{organization_id}/metadata`. See the [BAPI reference](/docs/references/backend-api/tag/Organizations#operation/MergeOrganizationMetadata){{ target: '_blank' }} for more information.
