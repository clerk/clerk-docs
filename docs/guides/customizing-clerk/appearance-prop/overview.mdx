...
The `elements` property lets you apply custom styles to the underlying DOM elements of Clerk's prebuilt components. See the [Bring your own CSS](/docs/guides/customizing-clerk/bring-your-own-css) docs for more information.
