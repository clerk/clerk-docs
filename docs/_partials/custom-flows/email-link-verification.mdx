...
<If sdk="ios">
  Clerk's iOS SDK doesn't currently support email link verification flows. Use [email code verification](/docs/guides/development/custom-flows/account-updates/add-email#email-code-verification) instead.
</If>

<If sdk="android">
  Clerk's Android SDK doesn't currently support email link verification flows. Use [email code verification](/docs/guides/development/custom-flows/account-updates/add-email#email-code-verification) instead.
</If>
