...
<Steps>
  ...
  1. In the Clerk Dashboard, in the modal you left open, select the **Upload file** button.
  1. Upload the metadata file you downloaded from Google.
  1. Select **Add connection**. You will be redirected to the connection's configuration page. Leave this page open.
  ...
  1. In the Clerk Dashboard, in the modal you left open, select **Use manual configuration**.
