...
This method in the SDK is a wrapper around the BAPI endpoint `GET/saml_connections`. See the [BAPI reference](/docs/reference/backend-api/tag/SAML-Connections#operation/ListSAMLConnections) for more details.
