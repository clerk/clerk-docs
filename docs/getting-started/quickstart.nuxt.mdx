...
Learn more about Clerk components, route protection, and how to use Clerk's client-side helpers using the following guides.
...
<Cards>
  ...
  - [Protect API routes with clerkMiddleware()](/docs/reference/nuxt/clerk-middleware)
  - Learn how to protect API routes from unauthenticated users.

  ---

  - [Read user data](/docs/nuxt/guides/users/reading)
  - Learn how to use Clerk's composables and helpers to read user data in your Nuxt app.
