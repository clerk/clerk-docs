...
<div className="container mx-auto my-4">
  <div className="grid lg:grid-cols-2 lg:grid-rows-4 justify-center gap-x-7">
    ...
    <ComponentPreviewCards title="User Profile" image="/docs/images/ui-components/component-user_profile.svg" link="/docs/components/user/user-profile" cta="Read docs"/>
    <ComponentPreviewCards title="User Button" image="/docs/images/ui-components/component-user_button.svg" link="/docs/components/user/user-button" cta="Read docs"/>
