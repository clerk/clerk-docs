...
We offer [a set of themes that can be used with the `appearance` prop](/reference-general/appearance/themes). The themes are available as a package called `@clerk/themes`.
...
> [You can see a list of the themes we offer in our reference docs.](/reference-general/appearance/themes)
...
![The inspect element tab opened with an element selected. It shows a list of classes and a lock icon in between human-readible classnames and randomly generated ones](/images/customization/identifying_elements.png)

When you select an element that's part of a Clerk component, you'll notice a list of classes like so:
...
![The previously blue "Continue" button is now purple](/images/customization/purple_button.png)
...
If we look back to the list of classes applied to a Clerk component's element, we'll see a list of classes like so:
...
![A previously blue "Sign in" button is now Slate gray](/images/customization/tailwind_class.png)
...
<div className="container mx-auto my-4">
  <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
    <Cards title="Localization" description="Learn how to localize the Clerk components." link="/customization/localization" cta="Learn More" />

    <Cards title="Pre-built Themes" description="See which pre-built theme you'd like to use as a base." link="/reference-general/appearance/themes" cta="Learn More" />

    <Cards title="Component Layout Customization" description="Learn how to change the layout and links of the Clerk components." link="/reference-general/appearance/layout" cta="Learn More" />
  </div>
</div>
