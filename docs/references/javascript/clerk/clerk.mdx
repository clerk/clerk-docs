...
You must call this method before using the `Clerk` object in your code. Refer to the [quickstart guide](/docs/references/javascript/quickstart) for more information.
