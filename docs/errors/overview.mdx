...
- [`passkey_exists`](/docs/errors/passkeys#passkey-exists)
- [`passkey_registration_cancelled`](/docs/errors/passkeys#passkey-registration-cancelled)
- [`passkey_authentication_cancelled`](/docs/errors/passkeys#passkey-authentication-cancelled)
- [`passkeys_unsupported`](/docs/errors/passkeys#passkeys-unsupported)
- [`passkeys_unsupported_platform_authenticator`](/docs/errors/passkeys#passkeys-unsupported-platform-authenticator)
