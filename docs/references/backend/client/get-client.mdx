...
This method in the SDK is a wrapper around the BAPI endpoint `GET/clients/{client_id}`. See the [BAPI reference](/docs/references/backend-api/tag/Clients#operation/GetClient){{ target: '_blank' }} for more information.
