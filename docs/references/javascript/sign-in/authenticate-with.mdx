...
<Properties>
  ...
  - `saml` (deprecated): The user will be authenticated with SAML. **Deprecated in favor of `enterprise_sso`.**
  ...
  The email address to use for targeting an enterprise connection at sign-in.
