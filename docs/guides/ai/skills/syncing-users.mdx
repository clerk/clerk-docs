...
description: Add the `syncing-users` skill to your AI agent to help it set up webhooks to sync Clerk users, organizations, and events to your database.
---
...
1. Copy your endpoint's Signing Secret and add it to your environment variables. Clerk's `verifyWebhook()` method will use it to verify the webhook.

For a detailed tutorial with code examples, see the [dedicated guide](https://clerk.com/docs/guides/development/webhooks/syncing).
