...
You can use [`/v1/me/organization_creation_defaults`](https://clerk.com/docs/reference/frontend-api/tag/user/post/v1/me/organization_creation_defaults) to retrieve suggested organization name and logo, based on your application's [default naming rules](https://clerk.com/docs/guides/organizations/configure#default-naming-rules).
