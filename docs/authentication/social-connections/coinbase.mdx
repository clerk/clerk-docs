...
<Images
  width={1303}
  height={1027}
  src="/docs/images/authentication-providers/coinbase/copying-values-into-clerk-dashboard.jpg"
  alt="Copying the Client ID and Client Secret into the Clerk dashboard"
/>
