...
- [The `taskUrls` option](#using-the-taskurls-option): Redirect across your entire application
...
<If sdk={["chrome-extension", "expo", "nextjs", "nuxt", "react", "react-router", "tanstack-react-start", "vue"]}>
  - [The `<RedirectToTasks />` component](#using-the-redirecttotasks-control-component): Redirect from routes, route groups (in a layout), or individual pages
</If>
