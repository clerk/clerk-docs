                ...
                await setActive({
                  ...
                  navigate: async ({ session }) => {
                    if (session?.currentTask) {
                      // Navigate to task page (see https://clerk.com/docs/custom-flows/overview#session-tasks)
          ...
          try {
            ...
            if (signUpAttempt.status === 'complete') {
              await setActive({
                ...
                navigate: async ({ session }) => {
                  if (session?.currentTask) {
                    // If there's a pending session task, navigate the user to your custom task page to complete it. See https://clerk.com/docs/custom-flows/overview#session-tasks
      ...
      <CodeBlockTabs options={["app/sign-in/[[...sign-in]]/page.tsx", "app/tasks/[[...task]]/page.tsx"]}>
        ...
        export default function Page() {
          ...
          if (currentTask?.key === 'choose-organization') {
            ...
            // https://clerk.com/docs/custom-flows/overview#session-tasks
            return <TaskChooseOrganization redirectUrlComplete="/" />
          }
