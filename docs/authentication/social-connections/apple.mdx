...
Navigate to the [Clerk Dashboard](https://dashboard.clerk.com/last-active?path=user-authentication/social-connections). In the top navbar, select **Configure**. In the sidebar, select **User & Authentication -> Social Connections**. In the list of **Auth Providers**, enable Apple.
...
<Steps>
  ...
  1. In the top navbar, select **Configure**. In the sidebar, select **User & Authentication > Social Connections**.
  ...
  1. In the top navbar of the [Clerk Dashboard](https://dashboard.clerk.com/last-active?path=account-portal), select **Configure.** In the sidebar, select **Account Portal**
