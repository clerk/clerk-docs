...
<Steps>
  ...
  If you protect access [close to the resource](/docs/guides/secure/protect-pages) instead of gating routes in `clerkMiddleware()`, you don't need to mark the sign-in route public. This step only applies if you're protecting all routes in your middleware.
