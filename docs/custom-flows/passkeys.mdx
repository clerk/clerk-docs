...
This guide is for users who want to build a custom user interface using the Clerk API. To authenticate users with passkeys using a prebuilt UI, you should use Clerk's [`<SignIn />`](/docs/components/authentication/sign-in) component. See [the sign-in and sign-out options docs](/docs/authentication/configuration/sign-up-sign-in-options) to learn more.
</Callout>
...
This guide will teach you how to build custom flows for creating, signing users in with, and managing passkeys.
