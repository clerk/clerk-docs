...
The `appearance` prop can be applied to [`<ClerkProvider>`](/docs/reference/general/components/clerk-provider) to share styles across every component, or individually to any of the Clerk components.
...
The `layout` property is used to adjust the layout of the [`<SignIn/>`](/docs/reference/general/components/authentication/sign-in) and [`<SignUp/>`](/docs/reference/general/components/authentication/sign-up) components, as well as set important links to your support, terms, and privacy pages. See the [Layout](/docs/guides/customizing-clerk/appearance-prop/layout) docs for more information.
