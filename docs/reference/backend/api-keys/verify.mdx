...
Verifies an [API key](/docs/guides/development/machine-auth/api-keys) secret. Returns an [`APIKeyResource`](/docs/reference/javascript/types/api-key-resource) object.
