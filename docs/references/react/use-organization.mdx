...
| --- | --- |
| `invitations?` | [`ClerkPaginationParams`](#clerk-pagination-params) and [`OrganizationInvitationStatus[]`](#organization-invitation-status) |
| `membershipRequests?` | [`ClerkPaginationParams`](#clerk-pagination-params) and [`OrganizationInvitationStatus`](#organization-invitation-status) |
| `memberships?` | [`ClerkPaginationParams`](#clerk-pagination-params) and [`OrganizationCustomRoleKey?`](#organization-custom-role-key) |
| `domains?` | [`ClerkPaginationParams`](#clerk-pagination-params) and [`OrganizationEnrollmentMode`](#organization-enrollment-mode) |
...
```typescript
type OrganizationCustomRoleKey = string; // or a custom union provided via the ClerkAuthorization interface
```
