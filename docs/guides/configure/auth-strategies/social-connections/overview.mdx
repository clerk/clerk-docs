...
> [!TIP]
> Looking for the reverse? If you want users to sign in to _other_ apps using their Clerk credentials — making Clerk the identity provider — see [Use Clerk as an OAuth provider](/docs/guides/configure/auth-strategies/oauth/single-sign-on).
