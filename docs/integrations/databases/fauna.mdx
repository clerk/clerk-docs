...
![he Access Providers tab in the Fauna dashboard.](/docs/images/integrations/fauna/security-providers.webp)
...
![he access provider form in Fauna.](/docs/images/integrations/fauna/new-access-provider.webp)
