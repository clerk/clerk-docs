...
| Type | Description |
| --- | --- |
| <code>Promise\<[ClerkPaginatedResponse][pag-res-ref]\<[OrganizationDomain][org-domain-ref]\>></code> | A `Promise` which resolves with a [`ClerkPaginatedResponse`][pag-res-ref] of [`OrganizationDomain`][org-domain-ref] objects. |
