  ...
  <Tabs items={["Manage MFA page", "Add phone number page"]}>
    <Tab>
      ...
      const ManageAvailablePhoneNumbers = () => {
        ...
        const setReservedForSecondFactor = useReverification(phone: PhoneNumberResource) => {
          return await phone.setReservedForSecondFactor({ reserved: true })
        }
    ...
    <Tab>
      ...
      export default function Page() {
        ...
        const createPhoneNumber = useReverification((phone: PhoneNumberResource) => user?.createPhoneNumber({ phoneNumber: phone }))
        ...
        const handleSubmit = async (e: React.FormEvent) => {
          ...
          try {
            ...
            const res = await createPhoneNumber({ phoneNumber: phone })
