...
Brings more consistency and clarity to the Clerk Billing API endpoints.
See the [migration guide](/docs/guides/development/upgrading/upgrade-guides/2025-11-10) for more details.
