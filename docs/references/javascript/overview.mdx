...
> You need to create a Clerk Application in your [Clerk Dashboard](https://dashboard.clerk.com/) before you can set up ClerkJS. For more information, check out our [Set up your application](/docs/guides/setup-clerk) guide.
