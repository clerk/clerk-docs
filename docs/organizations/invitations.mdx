...
You can either use a cURL command or Clerk's [JavaScript Backend SDK](/docs/references/backend/quickstart) to create an invitation. Use the following tabs to see examples for each method.
