---
title: Applications errors
description: An index of Clerk's applications errors.
type: reference
---

# Application errors index

## `ApplicationNotFound`

Signifies an error when no application with given appID was found.
...
Signifies an error when trying to delete a system application.
...
Signifies an error when trying to move an application to an organization that the requesting user doesn't belong to.
