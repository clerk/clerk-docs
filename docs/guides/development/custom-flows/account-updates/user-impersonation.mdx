...
> [!IMPORTANT]
> You can handle up to **5 user impersonations per month for free**. This allows you to try user impersonation before purchasing the **Enhanced Administration Add-on**, which is required for higher usage. Head to the [pricing page](/pricing) to get the full details on how Clerk charges for user impersonation.
