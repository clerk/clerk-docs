...
| `allowSubdomains` | `boolean` | Indicates whether the connection allows subdomains or not. |
...
| `syncUserAttributes` | `boolean` | Indicates whether the connection syncs user attributes or not. |
