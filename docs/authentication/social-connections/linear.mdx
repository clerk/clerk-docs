...
<Steps>
  ...
  1. In the top-left of [Linear](https://linear.app/), select your workspace, then select **Settings**. You'll be redirected to the **Preferences** page.
  1. In the sidebar, under **Administration**, select **API**.
  1. Under **OAuth Applications**, select **+ New OAuth Application**. You'll be navigated to the **Create new application** page.
