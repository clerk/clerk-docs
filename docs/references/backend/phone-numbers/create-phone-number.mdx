...
description: Creates a phone number for the specified user.
---

# `createPhoneNumber()`

Creates a [`PhoneNumber`](/docs/references/javascript/phone-number/phone-number) for the specified user.
