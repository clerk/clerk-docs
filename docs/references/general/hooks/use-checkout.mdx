    ...
    <Tabs items={["<SubscriptionPage />", "<CheckoutFlow />"]}>
      ...
      <Tab>
        ...
        function PaymentSection() {
          ...
          return (
            <>
              {/* A component that lists a user's payment methods and allows them to select one. See an example: https://clerk.com/docs/references/general/hooks/use-payment-methods#examples */}
