...
To use seat-based billing, you need to be using the following Clerk SDK versions:
...
- When a new member is added to the Organization does not have an unfilled seat, they will be prompted to checkout for the new seat.
