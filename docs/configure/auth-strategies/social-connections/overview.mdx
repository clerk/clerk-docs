...
For **production** instances, you will need to configure the provider with custom OAuth credentials. See the social provider's [dedicated guide](/docs/configure/auth-strategies/social-connections/oauth) for more information.
...
- You have already [enabled the Notion social connection in the Clerk Dashboard](/docs/configure/auth-strategies/social-connections/notion).
...
For additional information on how to configure Apple as a social provider for your Clerk instance, see the [dedicated guide](/docs/configure/auth-strategies/social-connections/apple).
