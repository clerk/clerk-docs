...
When building Expo applications, you might need to access the [`Clerk`](/docs/references/javascript/clerk) instance outside of React components, such as in utility functions or background tasks.
