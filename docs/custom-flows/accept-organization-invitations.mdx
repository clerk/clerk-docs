...
When a user visits an [organization invitation](/docs/organizations/invitations) link, and no custom redirect URL was specified, then they will be redirected to the [Account Portal sign-in page](/docs/customization/account-portal/overview#sign-in-or-up).
...
This guide demonstrates how to use Clerk's API to build a custom flow for accepting organization invitations.
