...
description: Learn how to allow users to sign up and sign in to your Clerk application with their Notion account using OAuth.
---
...
Enabling OAuth with [Notion](https://developers.notion.com/guides/get-started/authorization) allows your users to sign up and sign in to your Clerk app with their Notion account.
...
Keep two browser tabs open during setup: one for the [Clerk Dashboard](https://dashboard.clerk.com/~/user-authentication/sso-connections) and one for your [Notion Developer](https://developers.notion.com) page.

<Steps>
  ### Enable Notion as a social connection in Clerk
