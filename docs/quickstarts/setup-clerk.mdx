...
<Steps>
  ...
  Otherwise, you'll be redirected to the [Clerk Dashboard](https://dashboard.clerk.com/). To create a new app, select the **Create application** card to be taken to the interactive authentication setup form.
