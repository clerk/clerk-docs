...
On the next page, select the **Transformation template** tab and the **Inngest** template, then select **Connect to Inngest**.
...
A popup window will open to complete the setup. Select **Approve** to authorize the connection.
