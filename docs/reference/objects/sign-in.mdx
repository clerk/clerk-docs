...
> [!WARNING]
> This page describes our legacy API, which will be removed in a future release. We recommend upgrading to [Core 3](/docs/development/upgrading/upgrade-guides/core-3) and using the [`SignInFuture`](/docs/reference/objects/sign-in-future) object instead.
