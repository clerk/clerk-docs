...
The Vue SDK provides access to custom composables that include access to the [`Clerk`](/docs/references/javascript/clerk/clerk) object, [`User` object](/docs/references/javascript/user), [`Organization` object](/docs/references/javascript/organization), and a set of useful helper methods for signing in and signing up.
