...
1. You'll be redirected to the template's page where you can see what the template looks like, plus options to toggle the [**Delivered by Clerk**](#delivered-by-clerk) setting.
