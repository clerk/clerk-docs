...
```typescript
function getOrganizationMemberships: () => <insert return>;
```

#### `getOrganizationMemberships()` returns

{/* TODO: add type and description for return values */}
| Type | Description |
| --- | --- |
| TODO: insert return type | TODO: insert return description |
