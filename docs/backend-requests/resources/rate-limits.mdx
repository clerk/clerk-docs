---
title: Rate limits
description: Learn about rate limiting on APIs.
---

Clerk rate limits certain endpoints to help protect users against brute-force attacks or to stop abuse of the platform.
