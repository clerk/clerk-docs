...
<Steps>
  ...
  1. Select **Save application**. You'll be redirected to your app's settings page. Save the **Application ID** and **Secret** somewhere secure. These are your **Client ID** and **Client Secret** in Clerk, respectively.
