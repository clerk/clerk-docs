...
For an example of how to use the `<AuthenticateWithRedirectCallback />` component, see the [custom flow](/docs/guides/development/custom-flows/oauth-connections) guide.
