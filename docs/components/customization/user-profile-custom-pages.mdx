...
description: How to add custom pages to the `<UserProfile />` component
---
...
<Tabs items={['Next.js', 'React', 'Remix']}>
    <Tab>
        `<UserProfile.Page />` can be rendered **only on the client**, and in Next.js app-router projects, they need to be under the `"use client";` flag.
...
In addition to custom pages, you can add external links to the `<UserProfile />` navigation sidebar using the `<UserProfile.Link />` component.

### Usage

<Tabs items={['Next.js', 'React', 'Remix']}>
    <Tab>
        `<UserProfile.Link />` can be rendered **only on the client**, and in Next.js app-router projects, they need to be under the `"use client";` flag.
...
<Tabs items={['Next.js', 'React', 'Remix']}>
    <Tab>
        `<UserProfile.Page />` and `<UserProfile.Link />` can be rendered **only on the client**, and in Next.js app-router projects, they need to be under the `"use client";` flag.
...
<Tabs items={['Next.js', 'React', 'Remix']}>
    <Tab>
        `<UserButton.UserProfilePage />` and `<UserButton.UserProfileLink />` can be rendered **only on the client**, and in Next.js app-router projects, they need to be under the `"use client";` flag.
