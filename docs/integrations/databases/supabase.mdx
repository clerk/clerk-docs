...
This guide will have you create a new table in your Supabase project, but you can apply these concepts to your existing tables as well. If you would like to create a new Supabase project to follow this guide, navigate to the [Supabase dashboard](https://supabase.com/dashboard/projects), select **New project**, and configure your project however you would like.
