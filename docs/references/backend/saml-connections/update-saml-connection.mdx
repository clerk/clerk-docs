...
description: Use Clerk's Backend SDK to update a SAML connection for an organization.
---

# `updateSamlConnection()`

Updates a [`SamlConnection`](/docs/references/backend/types/saml-connection) for an organization by its ID.
...
```tsx {{ mark: [[3,6], 13]}}
const samlConnectionId = 'samlc_2ikRhHFfvZFL7nANDoBhPKok7hB';
