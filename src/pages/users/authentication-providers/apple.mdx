...
- You need to have an Apple Developer account. To create one, visit the Apple Developer portal.
...
Next, go to Clerk's [Dashboard](https://dashboard.clerk.com/), select your application and instance and go to **Authentication -> Social Connections**. Click the gear icon next to the Apple provider and copy the **Authorized redirect URI** value. Paste the value into the **Return URLs** in Apple Developer Portal and click **Next**.
