...
However, if you require more precise customization or prefer having your application self-contained, then you can use Clerk's fully customizable [prebuilt components](/docs/reference/components/overview), or you can build your own [custom user interface using the Clerk API](/docs/custom-flows/overview).
...
> [!IMPORTANT]
> These pages cannot be customized beyond the options provided in the [Clerk Dashboard](https://dashboard.clerk.com). If you need more customization such as [localization](/docs/customization/localization), consider using [prebuilt components](/docs/reference/components/overview) or building your own [custom user interface](/docs/custom-flows/overview).
...
The waitlist page hosts the prebuilt [`<Waitlist />`](/docs/reference/components/waitlist) component which renders a form that allows users to join for early access to your app.
