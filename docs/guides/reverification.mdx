...
<Tabs items={["Next.js Server Action", "Next.js Route Handler", "Ruby & React", "Other"]}>
  ...
  <Tab>
    > [!NOTE]
    > `reverificationMismatchResponse` requires `@clerk/shared@2.17.0` or later, and `@clerk/clerk-js@5.35.0` or later.
