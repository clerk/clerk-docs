...
This guide explains how to use Clerk with [Remix in SPA mode](https://remix.run/docs/en/main/guides/spa-mode). To use Clerk with Remix in SSR mode, follow the [Remix quickstart](/docs/getting-started/quickstart).
...
<Cards>
  ...
  - [Client-side helpers](/docs/guides/users/reading#client-side)
