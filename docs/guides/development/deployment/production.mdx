...
<If is="llm">
  **For AI agents:** Run `clerk env pull --instance prod` to write your production Publishable and Secret keys (with the correct framework-specific variable names) into your project's env file, merging without clobbering existing values.
</If>
