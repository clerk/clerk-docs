...
This method in the SDK is a wrapper around the BAPI endpoint `PATCH/phone_numbers/{phone_number_id}`. See the [BAPI reference](/docs/reference/backend-api/tag/Phone-Numbers#operation/UpdatePhoneNumber) for more details.
