...
Users can connect their OKX Wallet to their account at any time through their user profile page. You can configure your application to use the [Account Portal user profile page](/docs/account-portal/overview#user-profile) or the prebuilt [`<UserProfile />`](/docs/reference/general/components/user/user-profile) component.
