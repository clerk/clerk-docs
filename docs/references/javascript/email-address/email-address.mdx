...
*   [`prepareVerification()`](/docs/references/javascript/email-address/verification#prepareverification)
*   [`attemptVerification()`](/docs/references/javascript/email-address/verification#attemptverification)
