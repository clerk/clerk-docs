...
Once you have a Gatsby application ready, you need to install Clerk's `gatsby-plugin-clerk` SDK. This gives you access to our prebuilt components and hooks for React applications.
