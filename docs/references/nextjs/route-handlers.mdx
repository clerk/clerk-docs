...
The [JavaScript Backend SDK](/docs/references/backend/overview) exposes [Clerk's backend API](/docs/reference/backend-api){{ target: '_blank' }} resources and low-level authentication utilities for JavaScript environments.
