...
The logo used in Clerk emails comes from your application's settings in the Clerk Dashboard. To add or update it, navigate to your application's [**Settings**](https://dashboard.clerk.com/~/settings) and under **Branding**, upload your application logo.
