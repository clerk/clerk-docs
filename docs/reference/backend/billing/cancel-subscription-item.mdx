...
This method in the SDK is a wrapper around the BAPI endpoint `DELETE /commerce/subscription_items/{id}`. See the [BAPI reference](/docs/reference/backend-api/tag/commerce/delete/commerce/subscription_items/%7Bsubscription_item_id%7D){{ target: '_blank' }} for more information.
