...
export default function SignInPage() {
  return (
    <div className="grid w-full flex-grow items-center overflow-hidden bg-zinc-100 px-4 sm:justify-center">
      <SignIn.Root>
        <SignIn.Step
          name="start"
          ...
          <div className="space-y-4">
            <Clerk.Field name="code" className="space-y-2">
              ...
              <Clerk.Input
                ...
                render={({ value, status }) => (
                  <div
                    className={`relative grid h-9 w-8 place-content-center rounded-md bg-white text-zinc-950 ring-1 ring-inset ring-zinc-300 ${status === 'selected' ? 'bg-sky-400/10 shadow-[0_0_8px_2px_theme(colors.sky.400/30%)] ring-sky-400' : ''}`}
                  >
                    <AnimatePresence>
                      {value && (
                        <motion.span
