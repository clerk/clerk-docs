...
- [`AuthView`](/docs/reference/ios/auth-view) - Renders a full authentication interface, supporting multiple sign-up and sign-in methods, multi-factor authentication (MFA), and password recovery flows.
- [`UserButton`](/docs/reference/ios/user-button) - Displays the signed-in user's profile image.
- [`UserProfileView`](/docs/reference/ios/user-profile-view) - Renders a complete user profile interface with personal information, security settings, account switching, and sign-out options.
