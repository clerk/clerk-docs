...
<If notSdk={["ios", "android"]}>
  <Cards cols={4} level={2}>
    ...
    - ![Quickstarts & Tutorials icon](/docs/images/icons/play.svg)
    ...
    - ![UI Components icon](/docs/images/icons/cube.svg)
    ...
    - ![SDK Reference icon](/docs/images/icons/code.svg)
    ...
    - ![Customizing Clerk icon](/docs/images/icons/swatch.svg)
  </Cards>
</If>
...
<If sdk={["ios", "android"]}>
  <Cards cols={4} level={2}>
    ...
    - ![Views icon](/docs/images/icons/cube.svg)
...
<Cards variant="plain">
  ...
  - ![Authentication icon](/docs/images/icons/key.svg)
  ...
  - ![User management icon](/docs/images/icons/user-circle.svg)
  ...
  - ![Organizations icon](/docs/images/icons/buildings.svg)
  ...
  - ![Billing icon](/docs/images/icons/credit-card.svg)
  ...
  - ![Waitlist icon](/docs/images/icons/waitlist.svg)
</Cards>
...
<Cards variant="plain" cols={2}>
  ...
  - ![Security icon](/docs/images/icons/fingerprint.svg)
  ...
  - ![Database integrations icon](/docs/images/icons/database.svg)
  ...
  - ![Development icon](/docs/images/icons/cog.svg)
  ...
  - ![Clerk Dashboard icon](/docs/images/icons/chart.svg)
  ...
  - ![SDKs icon](/docs/images/icons/layers.svg)
  ...
  - ![How Clerk works icon](/docs/images/icons/connections.svg)
</Cards>
