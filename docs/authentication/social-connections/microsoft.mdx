...
Configuring this feature requires populating the **Client ID**, **Client Secret** and **Authorized redirect URI** in your Clerk app's settings.


Clerk uses preconfigured shared OAuth credentials and redirect URIs for development instances - no other configuration is needed. For production instances, you must generate your own **Client ID** and **Client Secret** as shown in the instructions in this guide.
