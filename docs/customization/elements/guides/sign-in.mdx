  ...
  beforeYouStart={[
    {
      ...
      link: "/docs/references/nextjs/quickstart",
      icon: "nextjs",
    },
    {
...
<Steps>
  ...
  For more extensive customization of the UI, see the additional Clerk Elements components such as [`<Loading>`](/docs/customization/elements/reference/common#loading) and [`<FieldState>`](/docs/customization/elements/reference/common#fieldstate).
</Steps>
