...
<Steps>
  ...
  <If sdk="android">
    ...
    Initialize Clerk first with your Clerk [Publishable Key](!publishable-key), then create a `ConvexClientWithAuth` using the extension function `ClerkConvexAuthProvider().createConvexClientWithAuth(...)`. Refer to the [Convex deployment docs](https://docs.convex.dev/dashboard/deployments/deployment-settings) for more info.
    ...
    class MyApplication : Application() {
      ...
      override fun onCreate() {
        ...
        convex = authProvider.createConvexClientWithAuth(
