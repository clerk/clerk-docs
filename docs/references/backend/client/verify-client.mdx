...
This method in the SDK is a wrapper around the BAPI endpoint `GET/clients/verify`. See the [BAPI reference](/docs/references/backend-api/tag/Clients#operation/VerifyClient){{ target: '_blank' }} for more information.
