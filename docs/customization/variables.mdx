...
- `spacingUnit` (use `spacingUnit` instead)
...
It is also possible to theme Clerk components within your CSS files. Avoiding the need to pass the `variables` prop to the Clerk component.

```css
:root {
  --clerk-color-primary: #0000ff;
  --clerk-color-foreground: #000000;
}
```