...
<If
  sdk={["nextjs", "react", "expo", "react-router", "chrome-extension", "tanstack-react-start", "expressjs", "js-backend", "android", "ios", "go"]}
>
  For React-based SDKs, pass the `localization` prop to the [`<ClerkProvider>`](/docs/reference/components/clerk-provider) component.
