...
<Steps>
  ...
  **Pro tip!** If you are signed into the Clerk Dashboard, your secret key should become visible by clicking on the eye icon. Otherwise, you can find your keys in the Clerk Dashboard on the [**API keys**](https://dashboard.clerk.com/last-active?path=api-keys) page.
