...
However, if you require more precise customization or prefer having your application self-contained, then you can use Clerk's fully customizable [prebuilt components](/docs/components/overview), or you can build your own [custom user interface](/docs/custom-flows/overview).

## How the Account Portal works

The Account Portal uses the [prebuilt components](/docs/components/overview), which are embedded into dedicated pages hosted on Clerk servers.
...
> [!IMPORTANT]
> These pages cannot be customized beyond the options provided in the [Clerk Dashboard](https://dashboard.clerk.com). If you need more customization such as [localization](/docs/customization/localization), consider using the [prebuilt components](/docs/components/overview) or building your own [custom user interface](/docs/custom-flows/overview).
