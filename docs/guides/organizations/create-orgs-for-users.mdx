...
If this isn't an option, you can use the [Backend API](/docs/reference/backend-api){{ target: '_blank' }} or a backend SDK, such as the [JS Backend SDK](/docs/getting-started/quickstart), along with [roles and permissions](/docs/guides/organizations/roles-and-permissions) to create a custom admin dashboard where authorized users can take administrative actions for orgs.
