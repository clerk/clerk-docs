...
If your initial sign-in choices aren't working out or if you want to add more options for your users, you can make changes by navigating to the **User & Authentication** drop down in the side nav of the Clerk Dashboard.
...
Ensure that **Email address** is enabled as an identifier. Click on the **User * Authentication** drop down in the side nav of the Clerk Dashboard. Click on the <DashboardLink path="user-authentication/email-phone-username">Email, Phone, Username</DashboardLink> page. The toggle next to **Email address** should be on. If it's not, toggle it on and hit **Apply Changes**. Users can now sign up and sign in with their email.
...
Click on the **User & Authentication** drop down in the side nav of the Clerk Dashboard. Click on the <DashboardLink path="user-authentication/email-phone-username">Email, Phone, Username</DashboardLink> page. In the **Authentication factors** section, toggle on **Email verification link** and **Email verification code**. This will allow users to sign in with either a link or a code sent to their email.
...
To make changes to the redirect behavior of both sign-in and sign-up flows, click on the <DashboardLink path="paths">Paths</DashboardLink> page in the side nav of the Clerk Dashboard. You can also pass in props if you are using Clerk's [custom components](/docs/components/overview).
...
Ensure that **Phone number** is enabled as an identifier. Click on the **User & Authentication** drop down in the side nav of the Clerk Dashboard. Click on the <DashboardLink path="user-authentication/email-phone-username">Email, Phone, Username</DashboardLink> page. The toggle next to **Phone number** should be on. If it's not, toggle it on and hit **Apply Changes**. Users can now sign up and sign in with their phone number.
...
Click on the **User & Authentication** drop down in the side nav of the Clerk Dashboard. Click on the <DashboardLink path="user-authentication/email-phone-username">Email, Phone, Username</DashboardLink> page. In the **Authentication factors** section, toggle on **SMS verification code**. This will allows users to sign in with a code sent to their phone.
...
You can make changes to the redirect behavior of both sign-in and sign-up flows by visiting the <DashboardLink path="paths">Paths</DashboardLink> page in the side nav of the Clerk Dashboard, or by passing in props if you are using Clerk's [custom components](/docs/components/overview).
...
Users won't need an email or password, so you can turn those off. Click on the **User & Authentication** drop down in the side nav of the Clerk Dashboard. Click on the <DashboardLink path="user-authentication/email-phone-username">Email, Phone, Username</DashboardLink> page. Toggle off **Email address** and **Phone number**. Click **Apply changes** in the bottom right corner.
...
Click on the **User & Authentication** drop down in the side nav of the Clerk Dashboard. Click on the <DashboardLink path="user-authentication/social-connections">Social Connections</DashboardLink> page.
...
Click on the **User & Authentication** drop down in the side nav of the Clerk Dashboard. Click on the <DashboardLink path="user-authentication/web3">Web3</DashboardLink> page. Toggle on the Web3 provider.
