...
You can find the **JWKS URL** on the [**API keys**](https://dashboard.clerk.com/~/settings/api-keys) page in the Clerk Dashboard.
...
Replace `<YOUR_FRONTEND_API>` with the Frontend API value. This value can be found on the [**API keys**](https://dashboard.clerk.com/~/settings/api-keys) page in the Clerk Dashboard.
