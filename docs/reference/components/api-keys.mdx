...
<If sdk="js-frontend">
  ...
  The following methods available on an instance of the [`Clerk`](/docs/reference/objects/clerk) class are used to render and control the `<APIKeys />` component:

  - [`mountAPIKeys()`](#mountapikeys)
  - [`unmountAPIKeys()`](#unmountapikeys)
