...
![Add endpoint](/docs/images/users/sync-backend/enable-webhook.png)
...
![Add endpoint form](/docs/images/users/sync-backend/webhook-form.png)
...
<Images
  width={2000}
  height={1125}
  src="/images/users/sync-backend/sign-secret.png"
...
<Images
  width={1433}
  height={1256}
  src="/images/users/sync-backend/testing-webhooks.webp"
