...
First, you need to find the key for the element that you want to customize. To find the key for your translation, open up our [English localization file](https://github.com/clerk/javascript/blob/main/packages/localizations/src/en-US.ts). Search the file for the term that you want to customize.
