...
Use the returned matcher inside `clerkMiddleware()` for non-auth request handling, such as applying a redirect, header, or geo rule to a group of routes. For an example, see [Geo blocking](/docs/guides/development/geo-blocking).
