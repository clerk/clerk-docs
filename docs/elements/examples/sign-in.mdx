...
export default function SignInPage() {
  return (
    <div className="grid w-full flex-grow place-content-center bg-zinc-100">
      <SignIn.Root>
        <SignIn.Step
          name="start"
          className="w-96 space-y-6 rounded-2xl bg-white px-8 py-10 shadow-md ring-1 ring-inset ring-zinc-200"
        >
          <header className="text-center">
            ...
            <h1 className="mt-4 text-xl font-medium tracking-tight text-zinc-950">Sign in to Clover</h1>
          </header>
...
export default function SignInPage() {
  return (
    <div className="grid w-full flex-grow place-content-center bg-black">
      <SignIn.Root>
        <SignIn.Step
          name="start"
          className="w-96 space-y-6 rounded-2xl bg-neutral-900 bg-[radial-gradient(circle_at_50%_0%,theme(colors.white/10%),transparent)] px-8 py-10 ring-1 ring-inset ring-white/5"
        >
          <header className="text-center">
...
export default function SignInPage() {
  return (
    <div className="relative grid w-full flex-grow place-content-center bg-black">
      <SignIn.Root>
        <SignIn.Step
          name="start"
          className="relative isolate w-96 space-y-8 rounded-2xl bg-emerald-950 px-8 py-10 shadow-md ring-1 ring-inset ring-white/10 before:absolute before:inset-0 before:-z-10 before:rounded-2xl before:bg-black/50"
        >
          <header className="text-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 40 40" className="mx-auto size-10">
              <mask id="a" width="40" height="40" x="0" y="0" maskUnits="userSpaceOnUse">
...
export default function SignInPage() {
  return (
    <div className="grid w-full flex-grow place-content-center bg-white">
      <SignIn.Root>
        <SignIn.Step name="start" className="w-96 space-y-6 rounded-2xl px-8 py-10">
          <header className="text-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 40 40" className="mx-auto size-10">
              <mask id="a" width="40" height="40" x="0" y="0" maskUnits="userSpaceOnUse">
                <circle cx="20" cy="20" r="20" fill="#D9D9D9" />
        ...
        <SignIn.Step name="verifications" className="w-96 space-y-6 rounded-2xl px-8 py-10">
