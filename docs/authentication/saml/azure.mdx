...
<SignedIn>
1. In the Clerk Dashboard, navigate to the [Enterprise Connections](https://dashboard.clerk.com/last-active?path=user-authentication/enterprise-connections) page.
</SignedIn>
<SignedOut>
...
4. You will be presented with a modal to create a new connection. Fill in the required fields and for the **Identity Provider**, select **Microsoft Azure AD**.
...
4. In the Azure Portal, in the **Basic SAML Configuration** modal, paste these values into their respective fields.
