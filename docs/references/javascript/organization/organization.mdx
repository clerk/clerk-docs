...
The `Organization` object holds information about an organization, as well as methods for managing it. It's returned from the [`Clerk.createOrganization()`](/docs/references/javascript/clerk/organization-methods#create-organization) and [`Clerk.getOrganization()`](/docs/references/javascript/clerk/organization-methods#get-organization) methods.
...
- [`getPendingInvitations()` (deprecated)](/docs/references/javascript/organization/invitations#get-pending-invitations)
