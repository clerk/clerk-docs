...
<Steps>
  ...
  1. In the top-right, select your avatar and select **Settings**.
  ...
  1. Complete the form as follows:
     ...
     - **Homepage URL**: Enter the homepage URL of your app.
     - **Logo URL**: Enter the URL of the logo for your app.
     - **Token Expiration**: Set the duration that the token will be valid.
     - **Scopes**: Select the scopes that your app requires. Ensure that **openid**, **profile**, and **email** are included.
     - **Redirect URLs**: Paste the **Redirect URL** value you saved from the Clerk Dashboard.
  1. Select **Create application**. The page should refresh and display the **Client ID** and **App Secret** under **Application Name**.
  1. Save the **Client ID** and **App Secret** somewhere secure.
