...
description: Learn how to allow users to sign up and sign in to your Clerk application with their X/Twitter account using OAuth.
---
...
<TutorialHero
  beforeYouStart={[
    ...
    },
    {
      ...
      link: "https://docs.x.com/fundamentals/developer-apps",
      icon: "x",
    },
  ]}
/>

Enabling OAuth with [X/Twitter](https://docs.x.com/fundamentals/authentication/oauth-2-0/authorization-code) allows your users to sign up and sign in to your Clerk app with their X/Twitter account.
...
Keep two browser tabs open during setup: one for the [Clerk Dashboard](https://dashboard.clerk.com/~/user-authentication/sso-connections) and one for your [X/Twitter Developer Portal](https://developer.x.com/en/portal/dashboard).

<Steps>
  ### Enable X/Twitter as a social connection in Clerk

  To enable X/Twitter as a social connection for your Clerk app:
  ...
  1. In the X/Twitter Developer Portal, under [**Projects**](https://developer.x.com/en/portal/projects-and-apps), select **Add App**. You'll be redirected to the **App name** tab. If you have a **Free** account, you can only have one app at a time, so you'll need to delete the existing app before being able to create a new one.
