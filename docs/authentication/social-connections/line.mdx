...
<TutorialHero
  beforeYouStart={[
    ...
    {
      title: "A LINE Developer account is required.",
...
To make the setup process easier, it's recommended to keep two browser tabs open: one for the [Clerk Dashboard](https://dashboard.clerk.com/last-active?path=user-authentication/sso-connections) and one for your [LINE Developer Console](https://developers.line.biz/console/).
...
<Steps>
  ...
  1. In the [LINE Developer Console](https://developers.line.biz/console/), select **Create a new provider**. A modal will open.
