...
<Steps>
  ...
  1. The [`useSignUp()`](/docs/references/hooks/use-sign-up) hook is used to get the [`SignUp`](/docs/references/javascript/sign-up) object.
  ...
  1. On the `/sign-up/verify` page, the [`useClerk()`](/docs/references/hooks/use-clerk) hook is used to get the [`handleEmailLinkVerification()`](/docs/references/javascript/clerk#handle-email-link-verification) method.
  ...
  1. The [`useSignIn()`](/docs/references/hooks/use-sign-in) hook is used to get the [`SignIn`](/docs/references/javascript/sign-in) object.
  ...
  1. On the `/sign-in/verify` page, the [`useClerk()`](/docs/references/hooks/use-clerk) hook is used to get the [`handleEmailLinkVerification()`](/docs/references/javascript/clerk#handle-email-link-verification) method.
  1. The `handleEmailLinkVerification()` method is called to verify the email address. Error handling is included to handle any errors that occur during the verification process.
