...
```tsx
function createOrganizationInvitation: (params: CreateOrganizationInvitationParams) => Promise<ClerkBackendApiResponse<OrganizationInvitation>>;
```
...
/* In this example, you can see that data is an OrganizationInvitation object.
{
