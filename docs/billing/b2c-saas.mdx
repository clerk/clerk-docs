...
Clerk billing for B2C SaaS allows you to create plans and manage subscriptions for **users** in your application. If you'd like to charge companies or organizations, see [Billing for B2B SaaS](/docs/billing/b2b-saas). You can also combine both B2C and B2B billing in the same application.

<Include path="_partials/billing/enable-billing" />
