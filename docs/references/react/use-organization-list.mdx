...
<Properties>
  ...
  - `userMemberships`
  - <code>[PaginatedResources](/docs/references/javascript/types/paginated-resources)[\<OrganizationMembership>](/docs/references/javascript/types/organization-membership)</code>
  ...
  - `userInvitations`
  - <code>[PaginatedResources](/docs/references/javascript/types/paginated-resources)[\<OrganizationInvitation>](/docs/references/javascript/types/organization-invitation)</code>
  ...
  - `userSuggestions`
  - <code>[PaginatedResources](/docs/references/javascript/types/paginated-resources)[\<OrganizationSuggestion>](/docs/references/javascript/types/organization-suggestion)</code>
