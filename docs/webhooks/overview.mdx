...
You can find the Webhook signing secret when you click on the endpoint you created on the [**Webhooks**](https://dashboard.clerk.com/last-active?path=webhooks) page of the Clerk Dashboard.
