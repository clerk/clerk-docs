...
Returns the configured URL where [`<CreateOrganization />`](/docs/references/components/organization/create-organization) is mounted or a custom create-organization page is rendered.
...
Returns the configured URL where [`<OrganizationProfile />`](/docs/references/components/organization/organization-profile) is mounted or a custom organization-profile page is rendered.
...
Returns the configured URL where [`<SignIn />`](/docs/references/components/authentication/sign-in) is mounted or a custom sign-in page is rendered.
...
Returns the configured URL where [`<SignUp />`](/docs/references/components/authentication/sign-up) is mounted or a custom sign-up page is rendered.
...
Returns the URL where [`<UserProfile />`](/docs/references/components/user/user-profile) is mounted or a custom user-profile page is rendered.
...
> [!NOTE]
> For React-based apps, consider using the [`<CreateOrganization />`](/docs/references/components/organization/create-organization) component.
...
Redirects to the configured URL where [`<CreateOrganization />`](/docs/references/components/organization/create-organization) is mounted. This method uses the [`navigate()`](#navigate) method under the hood.
...
Redirects to the configured URL where [`<OrganizationProfile />`](/docs/references/components/organization/organization-profile) is mounted. This method uses the [`navigate()`](#navigate) method under the hood.
...
- [`mountSignIn()`](/docs/references/components/authentication/sign-in#mount-sign-in)
- [`unmountSignIn()`](/docs/references/components/authentication/sign-in#unmount-sign-in)
- [`openSignIn()`](/docs/references/components/authentication/sign-in#open-sign-in)
- [`closeSignIn()`](/docs/references/components/authentication/sign-in#close-sign-in)

### `<SignUp />`

- [`mountSignUp()`](/docs/references/components/authentication/sign-up#mount-sign-up)
- [`unmountSignUp()`](/docs/references/components/authentication/sign-up#unmount-sign-up)
- [`openSignUp()`](/docs/references/components/authentication/sign-up#open-sign-up)
- [`closeSignUp()`](/docs/references/components/authentication/sign-up#close-sign-up)

### `<GoogleOneTap />`

- [`openGoogleOneTap()`](/docs/references/components/authentication/google-one-tap#open-google-one-tap)
- [`closeGoogleOneTap()`](/docs/references/components/authentication/google-one-tap#close-google-one-tap)
- [`authenticateWithGoogleOneTap()`](/docs/references/components/authentication/google-one-tap#authenticate-with-google-one-tap)
- [`handleGoogleOneTapCallback()`](/docs/references/components/authentication/google-one-tap#handle-google-one-tap-callback)

### `<UserButton />`

- [`mountUserButton()`](/docs/references/components/user/user-button#mount-user-button)
- [`unmountUserButton()`](/docs/references/components/user/user-button#unmount-user-button)

### `<UserProfile />`

- [`mountUserProfile()`](/docs/references/components/user/user-profile#mount-user-profile)
- [`unmountUserProfile()`](/docs/references/components/user/user-profile#unmount-user-profile)
- [`openUserProfile()`](/docs/references/components/user/user-profile#open-user-profile)
- [`closeUserProfile()`](/docs/references/components/user/user-profile#close-user-profile)

### `<OrganizationProfile />`

- [`mountOrganizationProfile()`](/docs/references/components/organization/organization-profile#mount-organization-profile)
- [`unmountOrganizationProfile()`](/docs/references/components/organization/organization-profile#unmount-organization-profile)
- [`openOrganizationProfile()`](/docs/references/components/organization/organization-profile#open-organization-profile)
- [`closeOrganizationProfile()`](/docs/references/components/organization/organization-profile#close-organization-profile)

### `<OrganizationSwitcher />`

- [`mountOrganizationSwitcher()`](/docs/references/components/organization/organization-switcher#mount-organization-switcher)
- [`unmountOrganizationSwitcher()`](/docs/references/components/organization/organization-switcher#unmount-organization-switcher)

### `<CreateOrganization />`

- [`mountCreateOrganization`](/docs/references/components/organization/create-organization#mount-create-organization)
- [`unmountCreateOrganization`](/docs/references/components/organization/create-organization#unmount-create-organization)
- [`openCreateOrganization`](/docs/references/components/organization/create-organization#open-create-organization)
- [`closeCreateOrganization`](/docs/references/components/organization/create-organization#close-create-organization)

### `<OrganizationList />`

- [`mountOrganizationList`](/docs/references/components/organization/organization-list#mount-organization-list)
- [`unmountOrganizationList`](/docs/references/components/organization/organization-list#unmount-organization-list)

### `<Waitlist />`

- [`mountWaitlist()`](/docs/references/components/authentication/waitlist#mount-waitlist)
- [`unmountWaitlist()`](/docs/references/components/authentication/waitlist#unmount-waitlist)
- [`openWaitlist()`](/docs/references/components/authentication/waitlist#open-waitlist)
- [`closeWaitlist()`](/docs/references/components/authentication/waitlist#close-waitlist)
...
[components-ref]: /docs/references/components/overview
