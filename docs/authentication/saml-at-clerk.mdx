...
- An `email_address` enabled as a strategy. To do so, click on the **User & Authentication** drop down in the side nav of the Clerk Dashboard. Then, click on the <DashboardLink path="user-authentication/email-phone-username">Email, Phone, Username</DashboardLink> page. In the **Contact information** section, enable the **Email address** strategy by toggling on the switch.
...
To create a SAML Connection, click on the **User & Authentication** drop down in the Clerk Dashboard. Then, click on the <DashboardLink path="user-authentication/enterprise-connections">Enterprise Connections</DashboardLink> page.
