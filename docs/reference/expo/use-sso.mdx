...
<Properties>
  ...
  - `'oauth_<provider>'`: The user will be authenticated with their [social connection account](/docs/guides/configure/auth-strategies/social-connections/overview). [See a list of supported values for `<provider>`](/docs/reference/javascript/types/sso#o-auth-provider).
