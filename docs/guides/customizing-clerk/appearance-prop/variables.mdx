...
To customize all Clerk components, pass the `variables` property to the `appearance` prop of the [`<ClerkProvider>`](/docs/reference/components/clerk-provider) component.
