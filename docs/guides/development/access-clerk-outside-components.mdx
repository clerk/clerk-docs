...
The [`Clerk`](/docs/reference/objects/clerk) object is accessible using the [`useClerk()`](/docs/reference/hooks/use-clerk) hook. However, if you need to access the [`Clerk`](/docs/reference/objects/clerk) object outside of React components, such as in utility functions or background tasks, you can use the `getClerkInstance()` function.
