...
- [The user has an email address as an identifier](#custom-flow-for-resetting-a-user-s-password-with-an-email-address)
- [The user has a phone number as an identifier](#custom-flow-for-resetting-a-user-s-password-with-a-phone-number)

## Custom flow for resetting a user's password with an email address

{/* TODO: Add JavaScript, Expo, Nuxt example. */}
...
## Custom flow for resetting a user's password with a phone number

{/* TODO: Add JavaScript, Expo, iOS, Nuxt example. */}
