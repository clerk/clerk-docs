...
There are many operations available for managing users, such as `getUser()`, `createUser()`, and `deleteUser()`. For more information, see the [Backend SDK reference docs](/docs/js-backend/getting-started/quickstart).
