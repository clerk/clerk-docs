...
>
  ...
  <AccordionPanel>
    The experimental property `Clerk.experimental_canUseCaptcha` has been removed. There is no replacement for this functionality currently. If this is problematic for your application, please [reach out to Clerk support](/contact/support){{ target: '_blank' }}!
  </AccordionPanel>

  <AccordionPanel>
    The experimental property `Clerk.experimental_captchaURL` has been removed. There is no replacement for this functionality currently. If this is problematic for your application, please [reach out to Clerk support](/contact/support){{ target: '_blank' }}!
  </AccordionPanel>

  <AccordionPanel>
    The experimental property `Clerk.experimental_captchaSiteKey` has been removed. There is no replacement for this functionality currently. If this is problematic for your application, please [reach out to Clerk support](/contact/support){{ target: '_blank' }}!
  </AccordionPanel>
