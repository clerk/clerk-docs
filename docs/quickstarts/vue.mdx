...
<TutorialHero
  ...
  beforeYouStart={[
    ...
    {
      title: "Create a Vue app using Vite",
...
Clerk's Vue SDK provides prebuilt components and composables to make it easy to integrate authentication and user management in your Vue app. This guide assumes that you're using [Vue 3](https://vuejs.org/) with [TypeScript](https://www.typescriptlang.org/).
