...
> [!WARNING]
> If you are looking to connect users via [Coinbase.com](https://www.coinbase.com/), [enable Coinbase as an OAuth provider](/docs/authentication/social-connections/coinbase) instead.
