---
title: Layout
description: Utilize Clerk's layout key in order to change the layout of the <SignIn /> and <SignUp /> components, as well as important links to your support, terms and privacy page
---
