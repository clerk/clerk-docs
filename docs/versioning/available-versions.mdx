...
| SDK | Version |
| - | - |
| Clerk.js | @clerk/clerk-js v5.60.0 or higher |
| Next.js | @clerk/nextjs v6.14.3 or higher |
| Astro | @clerk/astro v2.6.3 or higher |
| Express | @clerk/express v1.4.4 or higher |
| Fastify | @clerk/fastify v2.2.4 or higher |
| Go | clerk-sdk-go v2.3.0 or higher |
| JavaScript Backend | @clerk/backend v1.27.3 or higher |
| Nuxt.js | @clerk/nuxt v1.5.4 or higher |
| React Router | @clerk/react-router v1.2.4 or higher |
| Remix | @clerk/remix v4.5.16 or higher |
| Ruby | clerk-sdk-ruby v4.1.0 or higher |
| TanStack React Start | @clerk/tanstack-react-start v0.13.4 or higher |
