...
<Tabs items={["Next.js", "JavaScript"]}>
  ...
  - Uses the [`update()`](/docs/references/javascript/organization/organization#update) method to update the active organization's name.

  This example is written for Next.js App Router but can be adapted for any React meta framework, such as Remix or Gatsby.

  ```jsx {{ filename: 'app/components/UpdateOrganization.tsx' }}
  'use client';
