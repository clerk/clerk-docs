...
<Steps>
  ...
  To protect your pages on the client-side, you can use Clerk's [prebuilt control components](/docs/references/general/components/overview#control-components) that control the visibility of content based on the user's authentication state.
