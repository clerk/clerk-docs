...
React Router can be used as a framework or as a standalone library. This tutorial explains how to use React Router as a framework. To use React Router as a library instead, see the [library mode tutorial](/docs/guides/development/library-mode).
...
<Cards>
  ...
  - [Library mode](/docs/guides/development/library-mode)
