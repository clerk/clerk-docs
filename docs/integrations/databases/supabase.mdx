...
<Steps>
  ...
  <Tabs items={["Supabase interface", "SQL Editor"]}>
    ...
    <Tab>
      1. In the sidebar of your [Supabase dashboard](https://supabase.com/dashboard/projects), navigate to **SQL Editor**, and paste the following into the editor:
         ```sql
  ...
  <Tabs items={["Supabase interface", "SQL Editor"]}>
    ...
    <Tab>
      1. In the sidebar of your [Supabase dashboard](https://supabase.com/dashboard/projects), navigate to **SQL Editor**.
  ...
  1. Configure your template:
     ...
     - You can leave all other fields at their default settings or customize them to your needs. See the [JWT template guide](/docs/backend-requests/session-requests/making/jwt-templates#creating-a-template) to learn more about these settings.
