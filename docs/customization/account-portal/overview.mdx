...
The unauthorized sign-in page does not host any prebuilt Clerk component. It renders a UI as a confirmation that a session from an unrecognized device was successfully revoked. For more information see the [Unauthorized sign-in](/docs/security/unauthorized-sign-in) feature.
