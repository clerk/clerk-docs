...
If you've just created an account for the first time, you'll be taken directly to our interactive sign-in form builder.
...
To create a new app, press the **Add application** card to be taken to the interactive sign-in form builder.
...
You will be taken to a page that shows you your app's API keys.
