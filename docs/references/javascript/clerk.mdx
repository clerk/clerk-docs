...
Returns the configured URL where [`<CreateOrganization />`](/docs/reference/general/components/organization/create-organization) is mounted or a custom create-organization page is rendered.
...
Returns the configured URL where [`<OrganizationProfile />`](/docs/reference/general/components/organization/organization-profile) is mounted or a custom organization-profile page is rendered.
...
Returns the configured URL where [`<SignIn />`](/docs/reference/general/components/authentication/sign-in) is mounted or a custom sign-in page is rendered.
...
Returns the configured URL where [`<SignUp />`](/docs/reference/general/components/authentication/sign-up) is mounted or a custom sign-up page is rendered.
...
Returns the URL where [`<UserProfile />`](/docs/reference/general/components/user/user-profile) is mounted or a custom user-profile page is rendered.
...
> [!NOTE]
> For React-based apps, consider using the [`<CreateOrganization />`](/docs/reference/general/components/organization/create-organization) component.
...
Redirects to the configured URL where [`<CreateOrganization />`](/docs/reference/general/components/organization/create-organization) is mounted. This method uses the [`navigate()`](#navigate) method under the hood.
...
Redirects to the configured URL where [`<OrganizationProfile />`](/docs/reference/general/components/organization/organization-profile) is mounted. This method uses the [`navigate()`](#navigate) method under the hood.
...
- [`mountSignIn()`](/docs/reference/general/components/authentication/sign-in#mount-sign-in)
- [`unmountSignIn()`](/docs/reference/general/components/authentication/sign-in#unmount-sign-in)
- [`openSignIn()`](/docs/reference/general/components/authentication/sign-in#open-sign-in)
- [`closeSignIn()`](/docs/reference/general/components/authentication/sign-in#close-sign-in)

### `<SignUp />`

- [`mountSignUp()`](/docs/reference/general/components/authentication/sign-up#mount-sign-up)
- [`unmountSignUp()`](/docs/reference/general/components/authentication/sign-up#unmount-sign-up)
- [`openSignUp()`](/docs/reference/general/components/authentication/sign-up#open-sign-up)
- [`closeSignUp()`](/docs/reference/general/components/authentication/sign-up#close-sign-up)

### `<GoogleOneTap />`

- [`openGoogleOneTap()`](/docs/reference/general/components/authentication/google-one-tap#open-google-one-tap)
- [`closeGoogleOneTap()`](/docs/reference/general/components/authentication/google-one-tap#close-google-one-tap)
- [`authenticateWithGoogleOneTap()`](/docs/reference/general/components/authentication/google-one-tap#authenticate-with-google-one-tap)
- [`handleGoogleOneTapCallback()`](/docs/reference/general/components/authentication/google-one-tap#handle-google-one-tap-callback)

### `<UserButton />`

- [`mountUserButton()`](/docs/reference/general/components/user/user-button#mount-user-button)
- [`unmountUserButton()`](/docs/reference/general/components/user/user-button#unmount-user-button)

### `<UserProfile />`

- [`mountUserProfile()`](/docs/reference/general/components/user/user-profile#mount-user-profile)
- [`unmountUserProfile()`](/docs/reference/general/components/user/user-profile#unmount-user-profile)
- [`openUserProfile()`](/docs/reference/general/components/user/user-profile#open-user-profile)
- [`closeUserProfile()`](/docs/reference/general/components/user/user-profile#close-user-profile)

### `<OrganizationProfile />`

- [`mountOrganizationProfile()`](/docs/reference/general/components/organization/organization-profile#mount-organization-profile)
- [`unmountOrganizationProfile()`](/docs/reference/general/components/organization/organization-profile#unmount-organization-profile)
- [`openOrganizationProfile()`](/docs/reference/general/components/organization/organization-profile#open-organization-profile)
- [`closeOrganizationProfile()`](/docs/reference/general/components/organization/organization-profile#close-organization-profile)

### `<OrganizationSwitcher />`

- [`mountOrganizationSwitcher()`](/docs/reference/general/components/organization/organization-switcher#mount-organization-switcher)
- [`unmountOrganizationSwitcher()`](/docs/reference/general/components/organization/organization-switcher#unmount-organization-switcher)

### `<CreateOrganization />`

- [`mountCreateOrganization`](/docs/reference/general/components/organization/create-organization#mount-create-organization)
- [`unmountCreateOrganization`](/docs/reference/general/components/organization/create-organization#unmount-create-organization)
- [`openCreateOrganization`](/docs/reference/general/components/organization/create-organization#open-create-organization)
- [`closeCreateOrganization`](/docs/reference/general/components/organization/create-organization#close-create-organization)

### `<OrganizationList />`

- [`mountOrganizationList`](/docs/reference/general/components/organization/organization-list#mount-organization-list)
- [`unmountOrganizationList`](/docs/reference/general/components/organization/organization-list#unmount-organization-list)

### `<Waitlist />`

- [`mountWaitlist()`](/docs/reference/general/components/authentication/waitlist#mount-waitlist)
- [`unmountWaitlist()`](/docs/reference/general/components/authentication/waitlist#unmount-waitlist)
- [`openWaitlist()`](/docs/reference/general/components/authentication/waitlist#open-waitlist)
- [`closeWaitlist()`](/docs/reference/general/components/authentication/waitlist#close-waitlist)
...
[components-ref]: /docs/reference/general/components/overview
