...
> [!WARNING]
> This quickstart is meant for use with Next.js App router. Use [this guide](/docs/quickstarts/nextjs) if you're using the Pages router.
...
<Steps>
  ...
  <CodeBlockTabs options={["npm", "yarn", "pnpm"]}>
    ...
    npm install @clerk/nextjs@6.10.0-snapshot.v20250121161600
    ```

    ```bash {{ filename: 'terminal' }}
    yarn add @clerk/nextjs@6.10.0-snapshot.v20250121161600
    ```

    ```bash {{ filename: 'terminal' }}
    pnpm add @clerk/nextjs@6.10.0-snapshot.v20250121161600
    ```
  </CodeBlockTabs>
