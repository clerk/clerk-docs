...
Learn how to use Clerk with Next.js App Layout including protecting pages.
...
Your layout must be configured as a server component
</Callout>
  ...
  return (
    <ClerkProvider>
      <html lang="en">
        ...
        <SignedOut>
          // Handle what happens when a user is signed out. 
        </SignedOut>
      </html>
    </ClerkProvider>
  );
