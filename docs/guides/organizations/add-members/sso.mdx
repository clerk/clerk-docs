...
1. Alternatively, re-enable JIT provisioning: in the Clerk Dashboard, go to the [**SSO connections**](https://dashboard.clerk.com/~/user-authentication/sso-connections) page, select the connection, select the **Settings** tab, and toggle on the **Create users during sign-in** option.
