...
<Tabs items={["npm", "yarn", "pnpm"]}>
  <Tab>
    ``` bash filename="your-project" copy npm install @clerk/clerk-expo ```
  </Tab>
  <Tab>
    ``` bash filename="your-project" copy yarn add @clerk/clerk-expo ```
  </Tab>
  <Tab>``` bash filename="your-project" copy pnpm i @clerk/clerk-expo ```</Tab>
</Tabs>
...
<Callout type="warning">
  The following flows are built on the default instance settings for Clerk. If
  you have changed your instance settings, you may need to make changes to the
  following code.
</Callout>
...
<Callout type="info">
  Now would be good a time to test your sign in flow. Restart your server to
  remove the session.
</Callout>
...
<Callout type="info">
  Now would be good a time to test your OAuth flow. Restart your server to
  remove the session.
</Callout>
...
<Tabs items={["npm", "yarn", "pnpm"]}>
  <Tab>``` bash filename="terminal" copy npm install expo-secure-store ```</Tab>
  <Tab>``` bash filename="terminal" copy yarn add expo-secure-store ```</Tab>
  <Tab>
    ``` bash filename="your-project" copy pnpm install install expo-secure-store
    ```
  </Tab>
</Tabs>
