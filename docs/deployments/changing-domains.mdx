...
For more information on how to update your instance settings using the backend API, see our [backend API reference](/docs/reference/backend-api/tag/Beta-Features#operation/UpdateInstanceAuthConfig).
