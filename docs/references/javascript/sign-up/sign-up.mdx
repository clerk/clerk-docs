...
The `SignUp` object holds the state of the current sign up and provides helper methods to navigate and complete the [sign up flow](/docs/custom-flows). Once a sign up is complete, a new user is created.
