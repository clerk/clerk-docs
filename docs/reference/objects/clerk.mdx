...
<Properties>
  ...
  Configuration. `ListenerOptions` is an object that accepts the following properties:
...
<Properties>
  ...
  Initial values to prefill the waitlist form (e.g. email).
</Properties>
...
<Properties>
  ...
  Configuration. `NavigateOptions` is an object that accepts the following properties:
...
<Properties>
  ...
  An object to control the behavior of the event handler. If true, and the event was previously dispatched, handler will be called immediately with the latest payload
</Properties>
...
- [`mountConfigureSSO()`](/docs/reference/components/authentication/configure-sso#mount-configure-sso)
- [`unmountConfigureSSO()`](/docs/reference/components/authentication/configure-sso#unmount-configure-sso)
