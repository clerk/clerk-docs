...
<Callout type="danger">
  This guide is for users who want to build a *custom* user interface using the Clerk API. To allow users to reset their password using a *prebuilt* UI, you should use Clerk's [Account Portal pages](/docs/account-portal/overview) or [prebuilt components](/docs/components/overview)
</Callout>

This guide will show you how to build a custom forgot password flow for your users using Clerk's API.
