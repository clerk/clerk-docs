...
<Steps>
  ...
  <Tabs items={["Next.js", "Express", "Nginx", "Cloudflare Workers"]}>
    <Tab>
      ...
      - Use [`createFrontendApiProxyHandlers()`](/docs/reference/nextjs/clerk-middleware#createfrontendapiproxyhandlers) in a Next.js App Router route handler. **This is useful if you prefer to keep proxy logic separate from your middleware.**
