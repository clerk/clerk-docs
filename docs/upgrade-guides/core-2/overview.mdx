...
In Febrary 2024, [we updated](https://clerk.com/changelog/2024-02-29-core-2) Clerk's SDKs to include Core 2. This new core includes:
...
Note that the `Gatsby`, `Go`, and `Ruby` SDKs do not yet have a beta release ready - if you are using any of these SDKs there is nothing actionable right now.
