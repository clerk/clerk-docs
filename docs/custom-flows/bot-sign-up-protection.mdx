...
> [!TIP]
> The **Invisible** widget automatically blocks suspected bot traffic without user intervention. Therefore, it's strongly recommended that you ensure the `<div id="clerk-captcha" />` element exists in your DOM.
