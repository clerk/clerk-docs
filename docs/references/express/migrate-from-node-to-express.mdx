...
To enforce strict authentication, replace your existing Node SDK middleware with the Express SDK middleware, [`requireAuth()`](/docs/references/express/require-auth).
