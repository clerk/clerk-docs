...
<Tabs items={["Next.js", "JavaScript"]}>
  <Tab>
    The following example uses the [`useOrganizationList()`](/docs/sdk/react/use-organization) hook to get `userInvitations`, which is a list of the user's organization invitations.
