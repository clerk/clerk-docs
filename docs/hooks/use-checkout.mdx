...
<Properties>
  ...
  - `paymentSource`
  - <code>[BillingPaymentSourceResource](/docs/references/javascript/types/billing-payment-source-resource) | null</code>
  ...
  - `plan`
  - <code>[BillingPlanResource](/docs/references/javascript/types/billing-plan-resource) | null</code>
  ...
  - `totals`
  - [`BillingCheckoutTotals`](/docs/references/javascript/types/billing-checkout-totals)
