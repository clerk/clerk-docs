...
The following example demonstrates how to use [`auth().getToken()`](/docs/reference/backend/types/auth-object#gettoken) to retrieve a token from a JWT template and use it to fetch data from the external source.
