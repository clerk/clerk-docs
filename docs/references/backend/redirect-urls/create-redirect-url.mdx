...
This method in the SDK is a wrapper around the BAPI endpoint `POST/redirect_urls`. See the [BAPI reference](/docs/reference/backend-api/tag/Redirect-URLs#operation/CreateRedirectURL) for more details.
