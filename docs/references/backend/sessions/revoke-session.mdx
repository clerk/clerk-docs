...
This method in the SDK is a wrapper around the BAPI endpoint `POST/sessions/{session_id}/revoke`. See the [BAPI reference](/docs/references/backend-api/tag/Sessions#operation/RevokeSession){{ target: '_blank' }} for more information.
