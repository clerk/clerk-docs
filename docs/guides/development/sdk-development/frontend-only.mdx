...
In non-browser environments, you’ll need to re-implement the [Clerk class](/docs/references/javascript/clerk) in the SDK’s programming language, interacting with the [FAPI](/docs/guides/development/sdk-development/terminology).
...
- User can use [Clerk’s components](/docs/references/general/components/overview) in their choice of framework (e.g. in a React-based framework you import these components as React components)
