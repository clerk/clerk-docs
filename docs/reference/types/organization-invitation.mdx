...
The following example demonstrates how to revoke an Organization invitation. It first gets the list of Organization invitations using [`getInvitations()`](/docs/reference/objects/organization#getinvitations) and then revokes the first invitation in the list.
