...
The Next.js SDK provides hooks that give you access to the [`Clerk`](/docs/references/javascript/clerk/clerk) object and helper methods for authentication flows.
