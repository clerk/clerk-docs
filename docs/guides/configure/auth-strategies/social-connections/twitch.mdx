...
description: Learn how to allow users to sign up and sign in to your Clerk application with their Twitch account using OAuth.
---
...
Enabling OAuth with [Twitch](https://dev.twitch.tv/docs/authentication/getting-tokens-oauth/#authorization-code-grant-flow) allows your users to sign up and sign in to your Clerk app with their Twitch account.
...
Keep two browser tabs open during setup: one for the [Clerk Dashboard](https://dashboard.clerk.com/~/user-authentication/sso-connections) and one for your [Twitch Developer Console](https://dev.twitch.tv/console).
