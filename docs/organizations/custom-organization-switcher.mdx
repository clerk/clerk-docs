...
The following example shows how you can build a custom organization switcher. For the sake of this guide, the example is written for Next.js App Router, but it is supported by any React meta framework, such as Remix or Gatsby. 
