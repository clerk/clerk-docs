...
If you'd like to force a redirect regardless of whether the user was on another page previously, you can use the following `FORCE` environment variables instead:
