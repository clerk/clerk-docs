...
Native Google Sign-In is provided by the `@clerk/expo-google-signin` package. Install it along with its `expo-crypto` peer dependency:
...
<Include src="_partials/expo/hooks/use-sign-in-hooks-properties" />

## Examples

### Reusable component

<Include src="_partials/expo/hooks/use-sign-in-with-google-example" />
