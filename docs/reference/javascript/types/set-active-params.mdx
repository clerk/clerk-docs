...
<Properties>
  ...
  - `decorateUrl`: A function that wraps your destination URL to enable [Safari ITP cookie refresh](/docs/reference/javascript/clerk#safari-cookie-limitations) when needed. Always use this to wrap your destination URLs.
</Properties>
