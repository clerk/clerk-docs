...
<Properties>
  ...
  **Deprecated. Use [`updateMetadata()`](#update-metadata) instead.** Deep-merges with the existing value rather than replacing it. This parameter will be removed in a future major version.
</Properties>
