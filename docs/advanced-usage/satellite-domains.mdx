...
Click on the <DashboardLink path="domains">Domains</DashboardLink> page in the side nav of the Clerk dashboard and then, click on the **Satellite** tab. Click on the **Add satellite domain** button to add a new satellite domain of your choice. Then, follow the instructions provided.
