...
This method in the SDK is a wrapper around the BAPI endpoint `POST/users/{user_id}/verify_totp`. See the [BAPI reference](/docs/references/backend-api/tag/Users#operation/VerifyTOTP){{ target: '_blank' }} for more information.
