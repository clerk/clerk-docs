...
<Steps>
  ...
  update your application to use Clerk’s managed [Account Portal](/docs/guides/customizing-clerk/account-portal) or the [`<SignIn />`](/docs/components/authentication/sign-in) component.
