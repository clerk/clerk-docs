  ...
  extension SignInOrSignUpView {
    ...
    func submit(emailAddress: String, password: String) async {
      do {
        ...
        case .needsSecondFactor:
          // Email code is used as second factor for existing users.
        ...
        // If the email doesn't exist yet, start sign-up and send an email code.
    ...
    func verify(code: String) async {
      do {
        ...
        // Verify sign-in second factor email code.
