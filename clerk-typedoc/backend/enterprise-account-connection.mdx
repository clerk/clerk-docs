...
| <a id="createdat"></a> `createdAt`                                               | `number`                    | The Unix timestamp when this connection was created.                                          |
...
| <a id="updatedat"></a> `updatedAt`                                               | `number`                    | The Unix timestamp when this connection was last updated.                                     |
