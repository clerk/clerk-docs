...
- Can be configured by modifying the [session token](/docs/backend-requests/session-requests/session-tokens) in the [Clerk Dashboard](https://dashboard.clerk.com/last-active?path=jwt-templates).
