...
This step only applies to users that have turned on two-factor authentication, also known as [multifactor authentication](/docs/custom-flows/email-password-mfa), for their user.
