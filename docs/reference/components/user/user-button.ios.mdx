...
The `UserButton` component is a circular button that displays the signed-in user's profile image. When tapped, it presents a sheet with the [`UserProfileView`](/docs/reference/ios/user-profile-view).
