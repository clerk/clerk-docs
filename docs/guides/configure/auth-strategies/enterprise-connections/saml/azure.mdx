...
When you configure a SAML connection with Microsoft Entra ID (formerly [Azure Active Directory](https://learn.microsoft.com/en-us/entra/fundamentals/new-name)), your users can sign up and sign in to your application with their Microsoft account. In this guide, **you** configure the connection in the Clerk Dashboard, while **the customer** (whoever manages the Microsoft Entra ID application) configures it on the Microsoft side.
