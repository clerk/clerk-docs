...
| - | - | - |
| **Namespace** | Best for ongoing work. **Cleaner commands** after a one-time setup. | `bash npx shadcn@latest add @clerk/nextjs-sign-in-page ` |
| **shadcn CLI** | Best for quick one-off installs. Doesn't require editing `components.json`. | `bash npx shadcn@latest add https://clerk.com/r/nextjs-sign-in-page.json ` |
