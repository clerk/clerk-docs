...
1. Check for any pending tasks that need to be completed by accessing [`Session.currentTask`](/docs/references/javascript/types/session-task). Refer to [after-auth flows](/docs/authentication/configuration/after-auth-flows)
