...
This tutorial assumes that you have already [set up a Clerk application](/docs/quickstarts/setup-clerk){{ target: '_blank' }} and a [React + Convex application](https://docs.convex.dev/quickstart/react). This tutorial will also assume that you have not added Clerk to your application yet.
