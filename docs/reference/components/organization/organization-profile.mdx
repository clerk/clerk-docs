...
![The \<OrganizationProfile /> component allows users to manage their Organization membership and security settings.](/docs/images/ui-components/organization-profile.svg)
