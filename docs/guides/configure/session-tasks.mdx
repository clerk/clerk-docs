...
| [Require multi-factor authentication](/docs/guides/configure/auth-strategies/multi-factor-authentication) | [`<TaskSetupMFA />`](/docs/reference/components/authentication/task-setup-mfa) |
