...
<Tabs items={["Next.js", "React", "Remix"]}>
  <Tab>
    <CodeBlockTabs options={["App Router", "Pages Router"]}>
      ```tsx {{ filename: '/src/app/layout.tsx', mark: [2, [11, 13]] }}
  ...
  <Tab>
    ```tsx {{ filename: 'app/root.tsx', mark: [3, [43, 45]] }}
    // Import ClerkApp
...
<Tabs items={["Next.js", "React", "Remix"]}>
  <Tab>
    <CodeBlockTabs options={["App Router", "Pages Router"]}>
      ```tsx {{ filename: '/src/app/layout.tsx', mark: [2, [11, 14]] }}
      import { ClerkProvider } from '@clerk/nextjs';
      import { dark, neobrutalism } from '@clerk/themes';
  ...
  <Tab>
    ```tsx {{ filename: 'app/root.tsx', mark: [3, [43, 46]] }}
    // Import ClerkApp
    import { ClerkApp } from "@clerk/remix";
    import { dark } from '@clerk/themes';
    import type { MetaFunction,LoaderFunction } from "@remix-run/node";
...
<Tabs items={["Next.js", "React", "Remix"]}>
  <Tab>
    <CodeBlockTabs options={["App Router", "Pages Router"]}>
      ```tsx {{ filename: '/app/sign-in/[[...sign-in]]/page.tsx', mark: [2, [6, 8]] }}
...
<Tabs items={["Next.js", "React", "Remix"]}>
  <Tab>
    <CodeBlockTabs options={["App Router", "Pages Router"]}>
      ```tsx {{ filename: '/src/app/layout.tsx', mark: [2, [11, 18]] }}
      import { ClerkProvider } from '@clerk/nextjs';
  ...
  <Tab>
    ```tsx {{ filename: 'app/root.tsx', mark: [3, [43, 50]] }}
    // Import ClerkApp
    import { ClerkApp } from "@clerk/remix";
    import { dark, neobrutalism, shadesOfPurple } from '@clerk/themes';
    import type { MetaFunction,LoaderFunction } from "@remix-run/node";
