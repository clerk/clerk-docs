...
Safari's Intelligent Tracking Prevention (ITP) limits cookies set via JavaScript to 7 days. This means sessions can unexpectedly expire for Safari users who don't visit your app frequently.
