...
This method in the SDK is a wrapper around the BAPI endpoint `DELETE/organizations/{organization_id}`. See the [BAPI reference](/docs/references/backend-api/tag/Organizations#operation/DeleteOrganization){{ target: '_blank' }} for more information.
