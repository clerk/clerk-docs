...
Marks this phone number as the default second factor for [multi-factor authentication](/docs/guides/development/custom-flows/email-password-mfa)(2FA). A user can have exactly one default second factor.
...
Marks this phone number as reserved for [multi-factor authentication](/docs/guides/development/custom-flows/email-password-mfa) (2FA) or not.
