...
<If sdk={["ios", "android"]}>
  <Steps>
    ...
    If there are any pending session tasks, you need to display the appropriate task UI based on the task that the user needs to complete. You can use the custom flow guide associated with the task to help get you started:
