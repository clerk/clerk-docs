...
By default, `createToken()` creates an [opaque token](!opaque-token). To create a [JWT](/docs/guides/how-clerk-works/tokens-and-signatures#json-web-tokens-jwts) instead, pass `tokenFormat: 'jwt'`:
