...
To create a SAML Connection, get started by visiting the [Enterprise Connections](https://dashboard.clerk.com/last-active?path=user-authentication/enterprise-connections) section in the Clerk Dashboard.
