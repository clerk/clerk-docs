...
> This guide assumes that you have already [set up a Clerk application](/docs/guides/setup-clerk) that you're ready to deploy. If you haven't yet, be sure to [check out our guide to creating a new Clerk app](/docs/guides/setup-clerk).
