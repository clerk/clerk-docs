...
```json
{
  ...
  "public_metadata": {},
  "private_metadata": {},
  "created_at": 1726084341153,
  "updated_at": 1726084341153
}
```
...
Once the user visits the invitation link, they will be redirected to the page you specified, which means you must handle the authentication flow in your code for that page. See the [custom flow](/docs/organizations/accept-organization-invitations) guide for more information.
