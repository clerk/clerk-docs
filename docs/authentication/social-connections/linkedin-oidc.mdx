...
To make the setup process easier, it's recommended to keep two browser tabs open: one for the [Clerk Dashboard](https://dashboard.clerk.com/last-active?path=user-authentication/sso-connections) and one for your [Linked Developer Portal](https://discord.com/developers/applications).
...
<Steps>
  ...
  1. Fill out the form then select **Create app**. You'll be redirected to the app's **Products** page.
