...
<Steps>
  ...
  You can control which content signed in and signed out users can see with Clerk's [prebuilt components](/docs/components/overview). Create a header using the following components:
