...
1. Create a `src/middleware.ts` file. If your application does not use the `src/` directory, your `middleware.ts` file should be placed inside the root directory alongside `.env.local`.
