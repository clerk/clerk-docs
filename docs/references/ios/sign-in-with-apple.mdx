...
<Steps>
  ...
  To support native Sign in with Apple, you need to add your iOS application to the [Native Applications](https://dashboard.clerk.com/last-active?path=/native-applications) page in the dashboard.
