...
This method in the SDK is a wrapper around the BAPI endpoint `POST/email_addresses`. See the [BAPI reference](/docs/references/backend-api/tag/Email-Addresses#operation/CreateEmailAddress){{ target: '_blank' }} for more information.
