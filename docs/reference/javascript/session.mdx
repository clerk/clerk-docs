...
<Properties>
  ...
  - `currentTask`
  - <code>[SessionTask](/docs/reference/javascript/types/session-task) | undefined</code>
...
Attempts to complete the [first factor verification](!first-factor-verification) process. Returns a [`SessionVerification`](/docs/reference/javascript/types/session-verification) instance with its status and supported factors.
...
Attempts to complete the [second factor verification](!second-factor-verification) process. Returns a [`SessionVerification`](/docs/reference/javascript/types/session-verification) instance with its status and supported factors.
...
Initiates the [first factor verification](!first-factor-verification) process. This is a required step to complete a reverification flow when using a preparable factor. Returns a [`SessionVerification`](/docs/reference/javascript/types/session-verification) instance with its status and supported factors.
...
Initiates the [second factor verification](!second-factor-verification) process. This is a required step to complete a reverification flow when using a preparable factor. Returns a [`SessionVerification`](/docs/reference/javascript/types/session-verification) instance with its status and supported factors.
...
Initiates a verification flow using passkeys. Returns a [`SessionVerification`](/docs/reference/javascript/types/session-verification) instance with its status and supported factors.
