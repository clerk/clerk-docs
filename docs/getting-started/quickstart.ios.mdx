...
<Steps>
  ...
  1. Add a `.task` modifier that configures Clerk with your Clerk Publishable Key and loads it when the app starts.<Show when="signed-out">You can retrieve your Publishable Key from the [**API keys**](https://dashboard.clerk.com/~/api-keys) page in the Clerk Dashboard.</Show>
