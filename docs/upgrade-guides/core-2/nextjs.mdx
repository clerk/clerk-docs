...
For more details on route protection, check out the following guides:
- [Requiring authentication for route protection](/docs/references/nextjs/route-protection-requiring-authentication)
- [Required authorization for route protection](/docs/references/nextjs/route-protection-requiring-authorization)
...
Of course, in most cases you'll have a more complicated setup than this. You can find some examples below for how to migrate a few common use cases. Be sure to review the following guides if your specific use case is not mentioned:

- [`clerkMiddleware()` documentation](/docs/references/nextjs/clerk-middleware)
- [Requiring authentication for route protection](/docs/references/nextjs/route-protection-requiring-authentication)
- [Required authorization for route protection](/docs/references/nextjs/route-protection-requiring-authorization)
