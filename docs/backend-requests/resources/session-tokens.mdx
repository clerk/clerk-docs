...
<Tabs items={["Version 2", "Version 1"]}>
  ...
  <Tab>
    > [!IMPORTANT]
    > Version 1 was deprecated on April 14, 2025. To upgrade to version 2, go to the [**Updates**](https://dashboard.clerk.com/last-active?path=updates) page in the Clerk Dashboard. To read about the differences between the two versions, see [TODO](#TODO).
