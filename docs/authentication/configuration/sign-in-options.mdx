...
<Callout type="info">
  For more information about the steps required for a user to sign-in, see our [sign-in flow documentation](/docs/authentication/custom-flows#sign-in-flow).
</Callout>
...
Once you've selected the first methods you would like to try, click **Create Application**. If you're not totally sure about what you want to use, don't worry. You can change any of these settings from the Clerk Dashboard later on.

## Making changes

If your initial sign-in choices aren't working out (or if you want to add more options for your users), you can make changes by navigating to the **User & Authentication** section of the Clerk Dashboard.

<Images 
width={3024}
height={1652}
src="/docs/images/authentication/user-and-authentication.png"
...
Ensure that **Email address** is enabled as an identifier. Navigate to the **Email, Phone, Username** tab under the **User & Authentication** section in the Clerk Dashboard. The toggle next to **Email address** should be on. If it's not, toggle it on and hit **Apply Changes**. Users can now sign-up and sign-in with their email.

<Images 
width={3024}
height={1652}
src="/docs/images/authentication/email-address.png"
...
width={3024}
height={1652}
src="/docs/images/authentication/email-address-configuration.png"
...
width={2490}
height={1398}
src="/docs/images/authentication/email-address-verification-methods.png"
...
In the **Authentication factors** section under **Email, Phone, Username**, toggle on **Email verification link** and **Email verification code**. This will allow users to sign-in with either a link or a code sent to their email.
...
You can make changes to the redirect behavior of both Sign-in and Sign-up by visiting the **Paths** section of the Clerk Dashboard, or by passing in props if you are using our [custom Clerk components]().

<Callout type="info">
  For more information on one-time passcodes, see our [OTP documentation](/docs/custom-flows/email-sms-otp).
</Callout>
...
<Callout>
  Phone number identifiers and SMS verification are Premium features that are only available on some plans. For more information visit the **Plan & Billing** section of the Clerk Dashboard.
</Callout>
...
Ensure that **Phone number** is enabled as an identifier. Navigate to the **Email, Phone, Username** tab under the **User & Authentication** section in the Clerk Dashboard. The toggle next to **Phone number** should be on. If it's not, toggle it on and hit **Apply Changes**. Users can now sign-up and sign-in with their phone number.

<Images 
width={3024}
height={1652}
src="/docs/images/authentication/phone-number.png"
...
width={3024}
height={1652}
src="/docs/images/authentication/phone-number-configuration.png"
...
width={3024}
height={1652}
src="/docs/images/authentication/phone-number-configuration-settings.png"
alt="The 'Phone number' configuration settings with all options toggled on."
/>

### Allow users to sign-in with an SMS code

In the **Authentication factors** section under **Email, Phone, Username**, toggle on **SMS verification code**. This will allows users to sign-in with a code sent to their phone.

<Images 
width={3024}
height={1652}
src="/docs/images/authentication/sms-verification.png"
...
Users won't need an email or password, so you can turn those off in the **Email, Phone, Username** tab under the **User & Authentication** section in the Clerk Dashboard.

<Images 
width={3024}
height={1652}
src="/docs/images/authentication/email-phone-off.png"
...
Navigate to the **Social Connections** tab under the **User & Authentication** section in the Clerk Dashboard. 
...
width={3024}
height={1652}
src="/docs/images/authentication/social-connection-google.png"
...
Navigate to the **Web3** tab under the **User & Authentication** section in the Clerk Dashboard. Toggle on the Web3 provider.

<Images 
width={3024}
height={1652}
src="/docs/images/authentication/web3.png"
...
Now, when a user signs up or signs in to your application, users can do so with Google or Metamask. For more information on setting up different social providers, see our [Social Connections documentation](/docs/authentication/social-connections/overview).
