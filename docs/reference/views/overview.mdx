...
<If sdk="ios">
  * [`OrganizationSwitcher`](/docs/reference/views/organization/organization-switcher) - A prebuilt control for switching between personal and organization accounts.
  * [`OrganizationListView`](/docs/reference/views/organization/organization-list-view) - A prebuilt view for choosing a personal or organization account from a standalone list.
  * [`OrganizationProfileView`](/docs/reference/views/organization/organization-profile-view) - A prebuilt view for managing the active organization.
</If>

<If sdk="android">
  - [`OrganizationSwitcher`](/docs/reference/views/organization/organization-switcher) - A prebuilt component for switching between personal and organization accounts.
  - [`OrganizationListView`](/docs/reference/views/organization/organization-list-view) - A prebuilt component for choosing a personal or organization account from a standalone list.
  - [`OrganizationProfileView`](/docs/reference/views/organization/organization-profile-view) - A prebuilt component for managing the active organization.
</If>
