...
<Steps>
  ...
  Clerk's [TanStack Start SDK](/docs/sdk/tanstack-start/methods) gives you access to prebuilt components, React hooks, and helpers to make user authentication easier.
  ...
  Clerk's [`createClerkHandler()`](/docs/sdk/tanstack-start/create-clerk-handler) configures Clerk to handle authentication state for TanStack routes, allowing you to easily access user session information within your app.
...
<Cards>
  - [Create custom sign-up and sign-in pages](/docs/sdk/tanstack-start/custom-signup-signin-pages)
