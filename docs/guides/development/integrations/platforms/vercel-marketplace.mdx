...
1. Select **Install** to add Clerk to your Vercel team.
...
Most of your Clerk application configuration will be done through the Clerk Dashboard. To access the Dashboard after installing the Clerk integration, navigate to your installation details page and select **Open in Clerk**.
