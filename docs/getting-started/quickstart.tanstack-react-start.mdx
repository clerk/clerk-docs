...
<Steps>
  ## Create a TanStack React Start application

  Run the following commands to create a new TanStack React Start application.

  ```npm
  npm create tanstack-react-start@latest clerk-tanstack-react-start
