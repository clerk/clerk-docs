...
<Properties>
  ...
  The formatted price for a single billing period, including currency symbol. For example, `$10.00`.
  ...
  The formatted price for a full year of the plan, including currency symbol. For example, `$100.00`.
  ...
  The formatted effective monthly price when billed annually, including currency symbol. For example, `$8.33`.
