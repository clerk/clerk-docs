...
| `path` | `string` | The path where the component is mounted when path-based routing is used.<br/>For example, `/user-profile`<br />This prop is ignored in hash- and virtual-based routing. |
