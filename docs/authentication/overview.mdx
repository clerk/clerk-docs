...
- [OAuth SSO, also known as social connections or social providers](/docs/guides/configure/auth-strategies/social-connections/oauth)
- [Enterprise SSO](/docs/guides/configure/auth-strategies/enterprise-connections/overview)
  - SAML
  - OIDC
    - EASIE
...
- [Coinbase Wallet](/docs/guides/configure/auth-strategies/web3/coinbase-wallet)
- [Metamask](/docs/guides/configure/auth-strategies/web3/metamask)
- [OKX Wallet](/docs/guides/configure/auth-strategies/web3/okx-wallet)
