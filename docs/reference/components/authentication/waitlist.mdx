...
The `<Waitlist />` component renders a form that allows users to join for early access to your app. Users will get sent an email confirming their request to join the waitlist. Once [approved](/docs/guides/secure/restricting-access#manage-waitlist-entries), users will receive an email with instructions on how to join your app.
