...
If you have [account lockout](/docs/guides/secure/best-practices/user-lockout) enabled on your instance and the user reaches the maximum allowed attempts ([see list of relevant actions here](/docs/guides/secure/best-practices/user-lockout)), you will receive an HTTP status of `403 (Forbidden)` and the following error payload:
...
The admin might have [configured](/docs/guides/secure/best-practices/user-lockout#customize-max-sign-in-attempts-and-lockout-duration) e.g. a 45-minute lockout duration.
