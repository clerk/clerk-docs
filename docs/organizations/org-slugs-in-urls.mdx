...
<Steps>
  ...
  <Tabs items={["Server-side","Client-side"]}>
    <Tab>
      ...
      To access additional organization information like the organization name, you'll need to [customize the Clerk session token](/docs/session-requests/making/custom-session-token) to include these details:
