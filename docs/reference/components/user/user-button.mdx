...
![The \<UserButton /> component renders the familiar user button UI popularized by Google.](/docs/images/ui-components/user-button.svg){{ style: { maxWidth: '436px' } }}
...
<If notSdk="js-frontend">
  ...
  <If sdk="react">
    ...
    import { SignedIn, UserButton, SignInButton, SignedOut } from '@clerk/react'
  ...
  <If sdk="expo">
    ...
    import { SignedIn, UserButton, SignInButton, SignedOut } from '@clerk/expo/web'
