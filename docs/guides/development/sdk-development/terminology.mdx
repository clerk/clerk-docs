...
| Organization | An [organization](/docs/references/javascript/organization){{ target: '_blank' }} represents the current organization of the session. Users can belong to many organizations. One of them will be the [active organization](/docs/guides/organizations/overview#active-organization) of the session. |
...
| UI components | All components displayed in the [component reference](/docs/references/general/components/overview) and available through the [`Clerk`](/docs/references/javascript/clerk) class. |
