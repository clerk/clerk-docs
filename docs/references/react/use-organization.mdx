...
The `useOrganization()` hook gives you access to the current active organization attributes. This hook accepts [`useOrganizationParams`](/docs/references/javascript/types/use-organization-params).
