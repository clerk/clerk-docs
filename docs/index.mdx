...
<Cards variant="plain" cols={3}>
  ...
  - [React Router](/docs/getting-started/quickstart)
...
<Cards variant="plain" cols={3}>
  - [JS Backend SDK](/docs/getting-started/quickstart)
  ...
  - [Go](/docs/getting-started/quickstart)
  ...
  - [Ruby on Rails](/docs/getting-started/quickstart)
...
<Cards variant="plain">
  ...
  - [Database integrations](/docs/guides/configure/integrations/overview)
