...
<Images
  width={2279}
  height={1135}
  src="/images/advance/clerk-idp-flow-2.svg"
  alt="Clerk IDP Flow"
/>


## Step 1: Retrieve Callback URL from the client application

From the client that you want to configure, retrieve the **Callback URL**. This is where your users will be redirected to after a successful authentication and is required to successfully create your OAuth application in the next step.


## Step 2: Create an OAuth Application in Clerk

Next, you need to create an OAuth Application in Clerk via the [Backend API](https://clerk.com/docs/reference/backend-api/tag/OAuth-Applications) by providing the Callback URL and a Name. Note that in this context the name is used as an identifier for the application and is not displayed anywhere publicly.
...
## Step 3: Configure OAuth Application in client
