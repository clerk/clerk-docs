    ...
    <Tab>
      ...
      <Tabs items={["Primary app", "Satellite app"]}>
        <Tab>
          ...
          ```env {{ filename: '.env' }}
          # In development, your API keys will start with with `pk_test_` and `sk_test_`.
          # In production, your API keys will start with with `pk_live_` and `sk_live_`.
        ...
        <Tab>
          ...
          <CodeBlockTabs options={["Development", "Production"]}>
            ```env {{ filename: '.env' }}
            # In development, your API keys will start with with `pk_test_` and `sk_test_` respectively.
            # Ensure you load the correct keys.
            NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY={{pub_key}}
            CLERK_SECRET_KEY={{secret}}
              ...
              <Tab>
                ...
                <CodeBlockTabs options={["Development", "Production"]}>
                  ```js {{ filename: 'src/main.js' }}
                    ...
                    // In development, your API keys will start with with `pk_test_` and `sk_test_` respectively. Ensure you load the correct keys.
                  ...
                  ```js {{ filename: 'src/main.js' }}
                    ...
                    // In production, your API keys will start with with `pk_live_` and `sk_live_` respectively. Ensure you load the correct keys.
