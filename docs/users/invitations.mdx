...
```json
{
  ...
  "public_metadata": {},
  "status": "pending",
  "url": "https://prepared-phoenix-98.clerk.accounts.dev/v1/tickets/accept?ticket=eyJabCdeFgHIJkL1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3MjgwNTc3MzYsImlpZCI6Imluc18yZWJrMlRkUnhHWkFXS1E1NWdnWVdPUWJBR1oiLCJzaWQiOiJpbnZfMmxjM3JhbjJrY1dFcDd5ZFo0RDAxa0ZKQVlWIiwic3QiOiJpbnZpdGF0aW9uIn0.CnJDY2iNSeamUVgKHu2-X_HCowdSF4ifUUGj_z8lwd8OMNEdCYQpIWZ64i2OhgjTa344zj3lsoldcRLFsS60PzOCh9KrxrVFnZakCYMiaP-bZA_EnPD9hclZ3LHLyRpRVYEwS0wN-LNyABcap6GdpI_Pv6BKvT5oLXUDASYv5lCUR1c4HWBmI3wolQ0b8Qglk7t2mojPXjA-yyo7YKCfndDJfO5jMODq_xKcaFA7Tvu45am6KSWC0T8SwsNTZWgwnWfZXYNNX_oxOiKmEsN5plKnxcTCb2GMA_-JH1oWvc8in2oDqy9imIKsYqkpdy3Wted1uok-Xv9v9MMmr6eAbC",
  "created_at": 1725465736284,
  "updated_at": 1725465736284
}
```
...
Once the user visits the invitation link, they will be redirected to the page you specified, which means you must handle the sign-up flow in your code for that page. See the [custom flow](/docs/custom-flows/invitations) guide for more information.
