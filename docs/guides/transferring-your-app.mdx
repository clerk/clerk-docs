---
title: Transfer ownership of your application
description: Learn how to transfer ownership of your Clerk application
---

To transfer ownership of your application:

1. Navigate to your application's [**Settings**](https://dashboard.clerk.com/last-active?path=settings) page in the Clerk Dashboard.
