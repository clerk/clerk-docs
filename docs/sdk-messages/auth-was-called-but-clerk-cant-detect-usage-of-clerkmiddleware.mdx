...
This error commonly appears when using Clerk with Next.js and the `clerkMiddleware()` helper is configured _not_ to run on static asset routes. Which is part of the default setup.
