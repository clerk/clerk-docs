...
<Steps>
  ...
  > [!TIP]
  > If you closed your connection's configuration page of the Clerk Dashboard, you can find it by navigating to the [**SSO connections**](https://dashboard.clerk.com/last-active?path=user-authentication/sso-connections) page and selecting the settings icon next to the connection you want to configure.
