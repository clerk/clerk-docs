          ...
          async function verify() {
            try {
              ...
              await handleEmailLinkVerification({
                // URL to navigate to if sign-up flow needs more requirements
                redirectUrl: `${protocol}//${host}/sign-up`,
                // URL to navigate to if sign-up flow is complete
                redirectUrlComplete: `${protocol}//${host}/sign-up/verify`,
              })
        ...
        export default function SignInPage() {
          ...
          async function submit(e: React.FormEvent) {
            ...
            try {
              ...
              // Handle if user visited the link and completed sign-up from /sign-in/verify
              if (verification.verifiedFromTheSameClient()) {
                setVerifying(false)
                setVerified(true)
                return
