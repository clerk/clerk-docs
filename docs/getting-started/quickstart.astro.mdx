...
<PromptOnly>
  Hand this prompt to your agent to add auth to your app with the [Clerk CLI](/docs/cli). No need to leave your terminal or copy and paste API keys.

  <Prompt variant="card" src="prompts/cli-setup.md" title="Add Clerk to Astro" output="replace" />
