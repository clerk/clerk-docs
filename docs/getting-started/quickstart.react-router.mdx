...
<PromptOnly>
  ...
  <Prompt variant="card" src="prompts/cli-setup.md" title="Add Clerk to React Router" output="replace" />

  Or set up Clerk yourself by following the step-by-step instructions.
</PromptOnly>

> [!NOTE]
> React Router has three modes: **declarative**, **data**, and **framework**. This quickstart uses **framework** mode — for **declarative** mode, see the [dedicated guide](/docs/guides/development/declarative-mode).
>
