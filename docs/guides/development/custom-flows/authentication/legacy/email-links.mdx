...
sdk: nextjs, react, nuxt, expressjs, go, ruby, vue, astro, fastify, react-router, js-frontend, chrome-extension, tanstack-react-start, js-backend
---

{/* DOCS NOTE: Not currently supported by Expo, iOS, and Android */}
...
1. The [`useSignUp()`](/docs/reference/hooks/use-sign-up) hook is used to get the [`SignUp`](/docs/reference/objects/sign-up) object.
1. The `SignUp` object is used to access the [`createEmailLinkFlow()`](/docs/reference/types/email-address#create-email-link-flow) method.
...
1. On the `/sign-up/verify` page, the [`useClerk()`](/docs/reference/hooks/use-clerk) hook is used to get the [`handleEmailLinkVerification()`](/docs/reference/objects/clerk#handle-email-link-verification) method.
...
1. The [`useSignIn()`](/docs/reference/hooks/use-sign-in) hook is used to get the [`SignIn`](/docs/reference/objects/sign-in) object.
1. The `SignIn` object is used to access the [`createEmailLinkFlow()`](/docs/reference/types/email-address#create-email-link-flow) method.
1. The `createEmailLinkFlow()` method is used to access the `startEmailLinkFlow()` method.
...
1. On the `/sign-in/verify` page, the [`useClerk()`](/docs/reference/hooks/use-clerk) hook is used to get the [`handleEmailLinkVerification()`](/docs/reference/objects/clerk#handle-email-link-verification) method.
1. The `handleEmailLinkVerification()` method is called to verify the email address. Error handling is included to handle any errors that occur during the verification process.
