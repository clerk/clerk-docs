...
<Steps>
  ...
  1. `forgot-password` –  Renders [`<SignIn.SupportedStrategy>`](/docs/customization/elements/reference/sign-in#supportedstrategy), which initiates the reset process, whereby an email code is sent to the user for verification.
  ...
  For more extensive customization of the UI, check out additional Clerk Elements components such as [`<Loading>`](/docs/customization/elements/reference/common#loading) and [`<FieldState>`](/docs/customization/elements/reference/common#fieldstate).
</Steps>
