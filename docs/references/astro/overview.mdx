...
The Clerk Astro SDK gives you access to prebuilt components, stores, and helpers to make user authentication easier. Refer to the [quickstart guide](/docs/getting-started/quickstart) to get started.

## Integration

To configure Clerk with Astro, you must pass [the `clerk()` integration](/docs/references/astro/integration) to the `integrations` array in your `astro.config.mjs` file. See the [quickstart](/docs/getting-started/quickstart#update-astro-config-mjs) for more information on configuring the integration.
...
- [`$authStore`](/docs/references/astro/client-side-helpers/auth-store)
- [`$clerkStore`](/docs/references/astro/client-side-helpers/clerk-store)
- [`$userStore`](/docs/references/astro/client-side-helpers/user-store)
- [`$signInStore`](/docs/references/astro/client-side-helpers/sign-in-store)
- [`$signUpStore`](/docs/references/astro/client-side-helpers/sign-up-store)
- [`$sessionStore`](/docs/references/astro/client-side-helpers/session-store)
- [`$sessionListStore`](/docs/references/astro/client-side-helpers/session-list-store)
- [`$organizationStore`](/docs/references/astro/client-side-helpers/organization-store)
