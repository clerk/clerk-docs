...
![The \<Waitlist /> component renders a form that allows users to join for early access to your app.](/docs/images/ui-components/waitlist.svg){{ style: { maxWidth: '460px' } }}
