...
<Steps>
  ...
  To protect your API routes, use the `event.context.auth` object in your event handlers. This object exposes the `Auth` object containing the `userId`, allowing you to determine if the user is authenticated.
