...
This method in the SDK is a wrapper around the BAPI endpoint `DELETE/users/{user_id}`. See the [BAPI reference](/docs/references/backend-api/tag/Users#operation/DeleteUser){{ target: '_blank' }} for more information.
