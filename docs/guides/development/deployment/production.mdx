...
- If you're using a Next.js proxy, include `/(api|trpc|__clerk)(.*)` in your matcher.
...
- **Next.js matcher:** If you're using a Next.js proxy, include `/(api|trpc|__clerk)(.*)` in the matcher so Clerk proxy requests are handled.
