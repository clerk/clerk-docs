...
| Type | Description |
| --- | --- |
| <code>Promise\<[ClerkPaginatedResponse][pag-res-ref]\<[OrganizationInvitation][orginv-ref]\>></code> | This method returns a `Promise` which resolves with a list of [`OrganizationInvitation`][orginv-ref] objects. |
