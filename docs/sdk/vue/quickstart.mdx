...
Clerk's [Vue SDK](/docs/sdk/vue/methods) provides prebuilt components and composables to make it easy to integrate authentication and user management in your Vue app. This guide assumes that you're using [Vue 3](https://vuejs.org/) with [TypeScript](https://www.typescriptlang.org/).
...
<Steps>
  ...
  Clerk's [Vue SDK](/docs/sdk/vue/methods) gives you access to prebuilt components, composables, and helpers to make user authentication easier.
