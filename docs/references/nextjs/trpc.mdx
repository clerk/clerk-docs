...
Two environment variables for Clerk's SDK need to be set. Below is an example of an `.env.local` file. If you are signed into your Clerk Dashboard, your keys should become visible by clicking on the eye icon.
