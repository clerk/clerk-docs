...
To create a sign-up flow using the invitation token, you need to extract the token from the URL and pass it to the [`signUp.create()`](/docs/reference/objects/sign-up#create) method, as shown in the following example.
