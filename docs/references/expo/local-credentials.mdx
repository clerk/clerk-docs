...
This guide shows you how to take advantage of local authentication and allow users that have **already signed in** once to re-login by using the biometric authenticator from their device.
