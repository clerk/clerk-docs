...
<Steps>
  ...
  `Clerk.Settings` is now `Clerk.ClerkOptions`. See the [iOS configuration reference](/docs/reference/native-sdks/configuration#configuration-options) for the full list of options.
