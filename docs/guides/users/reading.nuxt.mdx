...
description: Learn how to use Clerk's composables to access the session and user data in your Nuxt application.
sdk: nuxt
---

Clerk provides [composables](/docs/reference/nuxt/overview#client-side-helpers) to access the session and user data in your Nuxt application.
