...
<Tabs items={["npm", "yarn", "pnpm"]}>
  <Tab>
    ``` bash filename="your-project" copy npm install @clerk/localizations ```
  </Tab>
  <Tab>
    ``` bash filename="your-project" copy yarn add @clerk/localizations ```
  </Tab>
  <Tab>
    ``` bash filename="your-project" copy pnpm install @clerk/localizations ```
  </Tab>
</Tabs>
