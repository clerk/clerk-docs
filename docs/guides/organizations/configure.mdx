...
> [!IMPORTANT]
> This feature requires the [Default naming rules](#default-naming-rules) setting to be enabled. The naming rules are used to generate the name for the automatically created Organization. 
...
- When **Create first organization automatically** is disabled, these rules are used to prefill the Organization name when the user created their first Organization manually. 
