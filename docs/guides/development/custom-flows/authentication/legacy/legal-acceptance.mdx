...
<If notSdk="expo">
  ...
  To support legal acceptance, you need to add a checkbox to your sign-up form, capture the checkbox value, and pass it to the [`SignUp.create()`](/docs/reference/objects/sign-up#create) method.
