...
This method in the SDK is a wrapper around the BAPI endpoint `POST/users`. See the [BAPI reference](/docs/references/backend-api/tag/Users#operation/CreateUser){{ target: '_blank' }} for more information.
