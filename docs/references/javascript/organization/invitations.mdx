...
| Type | Description |
| --- | --- |
| <code>Promise\<[ClerkPaginatedResponse][pag-res-ref]\<[OrganizationInvitation][orginv-ref]\>></code> | A `Promise` which resolves with a [`ClerkPaginatedResponse`][pag-res-ref] of [`OrganizationInvitation`][orginv-ref] objects. |
...
| Type | Description |
| --- | --- |
| <code>Promise\<[OrganizationInvitation][orginv-ref]\></code> | A `Promise` which resolves to the [`OrganizationInvitation`][orginv-ref] for the created invitation. |
...
| Type | Description |
| --- | --- |
| <code>Promise\<[OrganizationInvitation][orginv-ref][]\></code> | A `Promise` which resolves to a list of [`OrganizationInvitation`][orginv-ref]s for the created invitations. |
