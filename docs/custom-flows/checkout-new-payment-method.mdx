...
For the custom flow that allows users to add a new payment method to their account, **outside of a checkout flow**, see the [dedicated guide](/docs/custom-flows/add-payment-method-outside-checkout).
      ...
      function PaymentSection() {
        ...
        return (
          <form onSubmit={handleSubmit}>
            <PaymentElement fallback={<PaymentSkeleton />} />
