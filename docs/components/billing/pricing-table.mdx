...
<Properties>
  ...
  - [`appearance`](/docs/guides/customizing-clerk/appearance-prop/overview): an object used to style your components. Will only affect [Clerk components](/docs/components/overview) and not [Account Portal](/docs/guides/customizing-clerk/account-portal) pages.
