...
Don't forget that you also need to make sure you've configured your application instance to request the user's email address. Users can receive magic links only via email messages. Make sure you toggle on **Email address** under the **Contact information** section. You can toggle on **Require** if you want to make sure that all users have an email address associated with their profile.
...
- Start the magic link verification flow. 
