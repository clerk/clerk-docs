...
<Steps>
  ...
  Once you have obtained your [Apple ID Credential](https://developer.apple.com/documentation/authenticationservices/asauthorizationappleidcredential), you can use it to authenticate with Clerk by calling [`SignIn.signInWithAppleIdToken()`](https://swiftpackageindex.com/clerk/clerk-ios/main/documentation/clerksdk/signin/signinwithappleidtoken\(idtoken:code:\)) or [`SignUp.signUpWithAppleIdToken`](https://swiftpackageindex.com/clerk/clerk-ios/main/documentation/clerksdk/signup/signupwithappleidtoken\(idtoken:code:firstname:lastname:captchatoken:\))
