...
[Learn more](/docs/guides/users/reading).

## Protect pages and API routes

To protect pages, use the `useAuth()` helper to protect a single page, or use Nuxt's built-in [route middleware](https://nuxt.com/docs/4.x/guide/directory-structure/middleware) to protect multiple pages. [Learn more](/docs/guides/secure/protect-content).
