...
<Steps>
  ...
  <div style={{filter: "drop-shadow(rgba(0, 0, 0, 0.16) 0px 12px 24px)", maxWidth: "400px"}}>![An interactive "Create your account" card which provides sign-up options for a GitHub or Google account as well as email and password.](/docs/images/setup-clerk/create-clerk-account.png)</div>
