...
This is equivalent to calling [`SignUp.prepareVerification("web3_metamask_signature")`](/docs/references/javascript/sign-up/verification#prepareverification).
...
This is equivalent to calling [`SignUp.attemptVerification({strategy: "web3_metamask_signature", signature: "..." })`](/docs/references/javascript/sign-up/verification#attemptverification).
