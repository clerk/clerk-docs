...
Note that this isn't recommended, and in most cases you should use `auth()` to access auth data at request time instead. For more information, see the guide on [Next.js rendering modes and Clerk](/docs/sdk/nextjs/rendering-modes).
