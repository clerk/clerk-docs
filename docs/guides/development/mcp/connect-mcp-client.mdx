...
> Before proceeding, ensure you have toggled on the **Dynamic client registration** option in the [OAuth Applications](https://dashboard.clerk.com/~/user-authentication/oauth-applications) page in the Clerk Dashboard.
