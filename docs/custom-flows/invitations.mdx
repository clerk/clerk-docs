...
Inviting users to your Clerk application or organization begins with creating an invitation for an email address. Once the invitation is created, an email with an invitation link will be sent to the user's email address.

If there was no custom redirect URL specified, then when the user visits the invitation link, they will be redirected to the application's sign up page and **their email address will be automatically verified.**
