...
<Properties>
  ...
  - `'needs_first_factor'`: One of the following [first factor verification strategies](/docs/references/javascript/sign-in) is missing: `'email_link'`, `'email_code'`, `'phone_code'`, `'web3_base_wallet_signature'`, `'web3_metamask_signature'`, `'web3_coinbase_wallet_signature'` or `'oauth_provider'`.
...
<Properties>
  - `strategy`
  - `'email_code' | 'phone_code' | 'password' | 'web3_base_wallet_signature' | 'web3_metamask_signature' | 'web3_coinbase_wallet_signature' | 'web3_okx_wallet_signature' | 'passkey' | 'reset_password_phone_code' | 'reset_password_email_code'`
  ...
  - `'web3_base_wallet_signature'`: The verification will attempt to be completed using the user's Web3 wallet address via [Base Wallet](https://docs.base.org/base-account/guides/authenticate-users).
  ...
  **Required** if `strategy` is set to `'web3_base_wallet_signature'`, `'web3_metamask_signature'`, `'web3_coinbase_wallet_signature'`, or `'web3_okx_wallet_signature'`. The Web3 wallet generated signature to be verified.
</Properties>
...
```typescript
function authenticateWithBaseWallet(): Promise<SignInResource>
```
...
<Properties>
  - `strategy?`
  - `'password' | 'email_link' | 'email_code' | 'phone_code' | 'oauth_<provider>' | 'saml' | 'enterprise_sso' | 'passkey' | 'web3_base_wallet_signature' | 'web3_metamask_signature' | 'web3_coinbase_wallet_signature' | 'web3_okx_wallet_signature' | 'ticket' | 'google_one_tap'`
  ...
  - `'web3_base_wallet_signature'`: The verification will attempt to be completed using the user's Web3 wallet address via [Base Wallet](/docs/authentication/web3/base-wallet). The `identifier` parameter can also be specified to select which of the user's known Web3 wallets will be used.
...
<Properties>
  - `strategy`
  - `'email_link' | 'email_code' | 'phone_code' | 'web3_base_wallet_signature' | 'web3_metamask_signature' | 'web3_coinbase_wallet_signature' | 'web3_okx_wallet_signature' | 'passkey' | 'oauth_<provider>' | 'saml' | 'enterprise_sso' | 'reset_password_phone_code' | 'reset_password_email_code'`
  ...
  - `'web3_base_wallet_signature'`: The verification will attempt to be completed using the user's Web3 wallet address via [Base Wallet](https://docs.base.org/base-account/guides/authenticate-users). Requires `web3WalletId` parameter to be set.
  ...
  **Required** if `strategy` is set to `'web3_base_wallet_signature'`, `'web3_metamask_signature'`, `'web3_coinbase_wallet_signature'`, or `'web3_okx_wallet_signature'`. The ID for the user's Web3 wallet address.
