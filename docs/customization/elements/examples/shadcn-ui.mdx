...
3. Make sure you have your sign in and sign up URLs set in your [environment variables](https://clerk.com/docs/guides/custom-redirects#environment-variables).
