...
Add the following code to your `.env.local` file to set your public and secret keys. If you are signed into your [Clerk Dashboard](https://dashboard.clerk.com/), your keys should become visible by clicking on the eye icon.
...
- [Clerk + Next.js App Router Demo](https://github.com/clerkinc/clerk-nextjs-demo-app-router)
- [Clerk + Next.js Pages Router Demo](https://github.com/clerkinc/clerk-nextjs-demo-pages-router)
