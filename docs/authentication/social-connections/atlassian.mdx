...
<Steps>
  ...
  1. In the left sidebar of your app's **Overview** page, select **Permissions**. Configure the OAuth 2.0 scopes that should be requested from your users when they attempt to connect with Atlassian. At minimum, next to **User identity API**, select **Add**.
