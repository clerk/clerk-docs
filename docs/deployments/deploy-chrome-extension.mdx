...
<Steps>
  ...
  <SignedOut>
    ...
    1. If you are using the [Sync Host]() feature, add a line with the key of `PLASMO_PUBLIC_CLERK_SYNC_HOST` with the value of your domain. eg, `PLASMO_PUBLIC_CLERK_SYNC_HOST=http://clerk.com` 
...
> [!WARNING]
> You will have likvely added the Extension ID already, but using your development secret key. You must also add the Extension to the production instance's `allowed_origins`
