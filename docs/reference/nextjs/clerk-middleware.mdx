...
If you currently gate routes inside `clerkMiddleware()`, see [Migrating from middleware-based auth checks](/docs/guides/secure/protect-content#migrating-from-middleware-based-auth-checks).
