...
Once you have ClerkJS integrated into your project and have access to the [`Clerk` class](/docs/references/javascript/clerk), you're able to access and call a myriad of attributes and methods to control your user management and authentication.
