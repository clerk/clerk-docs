...
If your client is a backend service, you can create a [machine token](/docs/machine-requests/overview) and use it in the `Authorization` header of outgoing request.
