...
This tutorial will demonstrate how to create a new React app using Vite and add authentication to it using Clerk. If you would like to create an application using the React Router framework, see the [React Router quickstart](/docs/getting-started/quickstart).
