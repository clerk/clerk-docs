...
To access the email templates, navigate to the [Emails](https://dashboard.clerk.com/last-active?path=customization/email) tab under the **Customization** section in the Clerk Dashboard.
...
| [Reset password]((https://dashboard.clerk.com/last-active?path=customization/sms/reset_password/edit)) | SMS containing an OTP (One Time Password) code that allows the user to reset their password |
