...
Oftentimes such applications will also allow users to create personal workspaces that are separate from other organizations. For example, GitHub allows users to create repositories under their own personal workspace or an organization they are part of.
