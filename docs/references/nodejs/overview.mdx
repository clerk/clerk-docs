...
<Steps>
  ...
  You need to create a Clerk application in your Clerk Dashboard before you can set up Clerk Node.js. For more information, see the [Set up your application](/docs/quickstarts/setup-clerk) guide.
