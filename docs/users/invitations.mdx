...
> [!TIP]
> Invitations are only used to invite users to your application. The application will still be available to everyone even without an invitation. If you're looking to restrict access to invited users only, see the [**Restricted** sign-up mode guide](/docs/authentication/configuration/restrictions#sign-up-modes).
...
> [!WARNING]
> Revoking an invitation does **not** prevent the user from signing up on their own. If you're looking to restrict access to invited users only, see the [**Restricted** sign-up mode guide](/docs/authentication/configuration/restrictions#sign-up-modes).
