...
This method in the SDK is a wrapper around the BAPI endpoint `POST/sign_in_tokens`. See the [BAPI reference](/docs/reference/backend-api/tag/Sign-in-Tokens#operation/CreateSignInToken) for more details.
