...
<Steps>
  ...
  ---
  import { SignedIn, SignedOut, UserButton, SignInButton, OrganizationSwitcher } from '@clerk/astro/components'
  ---
  ...
  <Layout title="Protected Page">
    ...
    {isAuthenticated && organization && has({ role: 'org:admin' }) && organization.name !== requiredOrgName && (
      <>
        <p>
