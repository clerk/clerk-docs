...
<If sdk="ios">
  Clerk's iOS SDK doesn't currently include Frontend API key management methods. Use the JavaScript example or manage API keys from your backend.
</If>

<If sdk="android">
  Clerk's Android SDK doesn't currently include Frontend API key management methods. Use the JavaScript example or manage API keys from your backend.
</If>
