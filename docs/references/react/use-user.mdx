...
For more information on the `update()` method, see the [`User`](/docs/references/javascript/user/user) reference.
...
For more information on the `reload()` method, see the [`User`](/docs/references/javascript/user/user) reference.
