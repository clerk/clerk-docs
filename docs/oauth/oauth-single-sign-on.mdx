...
4. Select **Add**. A modal will open with your **Client Secret**.
    ...
    > 
5. You'll be redirected to your app's settings page. Under **Application credentials**, you can find your **Client ID**, which will be useful for configuring the client to work with your Clerk instance. 
6. In the **Redirect URIs** field, add the redirect URI provided by your client. This is the URL that Clerk will redirect to after the user has authenticated.
