...
1. **[Account Portal (default)](/docs/guides/customizing-clerk/account-portal)**: A fully hosted solution providing a complete user management interface out of the box. Every Clerk application has this enabled by default. This is the quickest way to get started with Clerk and requires minimal setup.
