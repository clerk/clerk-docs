...
The [`<ClerkProvider />`](/docs/components/clerk-provider.mdx) component is required to integrate Clerk into your React application, providing session and user context to Clerk's hooks and components.
...
The [`clerkMiddleware()`](/docs/references/nextjs/clerk-middleware.mdx) helper integrates Clerk authentication into your Next.js application through Middleware.
