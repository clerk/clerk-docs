...
<Cards variant="plain">
  - [Authentication](/docs/configure/auth-strategies/sign-up-sign-in-options)
...
<Cards cols={3} variant="image">
  - [What is Clerk authentication?](/docs/configure/auth-strategies/sign-up-sign-in-options)
