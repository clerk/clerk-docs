...
<If sdk="chrome-extension">
  > [!WARNING]
  > While the pricing table will show up in the extension, clicking on any of the buttons crashes the extension.
...
<If sdk="expo">
  > [!NOTE]
  > Expo doesn't currently support the `<PricingTable />` component.
</If>
