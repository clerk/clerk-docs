...
<Steps>
  ...
  **Pro tip!** If you are signed into the [Clerk Dashboard](https://dashboard.clerk.com/last-active?path=api-keys), your Secret Key should become visible by clicking on the eye icon.
  ...
  - use the [prebuilt components](/docs/references/nextjs/custom-sign-in-or-up-page), such as the [`<SignIn />`](/docs/references/general/components/authentication/sign-in) and [`<SignUp />`](/docs/references/general/components/authentication/sign-up) components
