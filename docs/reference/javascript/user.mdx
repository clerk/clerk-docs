...
Adds a Web3 wallet for the user. A new [`Web3WalletResource`](/docs/reference/javascript/types/web3-wallet) will be created and associated with the user.
...
Retrieves organization creation defaults for the current user. Returns a [`OrganizationCreationDefaultsResource`](/docs/reference/javascript/types/organization-creation-defaults) object.
