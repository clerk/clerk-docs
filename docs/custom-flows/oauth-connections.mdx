...
You must configure your application instance through the Clerk Dashboard for the social connection(s) that you want to use. Visit [the appropriate guide for your platform](/docs/configure/auth-strategies/social-connections/oauth) to learn how to configure your instance.
