...
description: Learn how to use Clerk's hooks and helpers to protect content and access user data in your React Router application.
sdk: react-router
---

Clerk provides a set of [hooks and helpers](/docs/references/react-router/overview#client-side-helpers) that you can use to access the active session and user data in your React Router application. This guide demonstrates how to use these helpers in both the client and server-side to get you started.
...
To access active session and user data on the client-side, you can use the `useAuth()` and `useUser()` hooks.
