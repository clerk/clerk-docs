...
<Properties>
  ...
  - `portalId`: the ID of the portal element used to render the Subscription details drawer.
  - `portalRoot`: the HTML element in which to render the Subscription details drawer.
</Properties>
