...
This method in the SDK is a wrapper around the BAPI endpoint `PUT/organizations/{organization_id}/logo`. See the [BAPI reference](/docs/references/backend-api/tag/Organizations#operation/UploadOrganizationLogo){{ target: '_blank' }} for more information.
