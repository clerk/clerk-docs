...
For a comprehensive example, see the [custom flow for multi-factor authentication](/docs/guides/development/custom-flows/email-password-mfa).
...
<Properties>
  ...
  - `'oauth_<provider>'`: The user will be authenticated with their [social connection account](/docs/guides/configure/auth-strategies/social-connections/oauth). See a list of [supported values for `<provider>`](/docs/references/javascript/types/sso).
...
For OAuth connections, see the [custom flow for OAuth connections](/docs/guides/development/custom-flows/oauth-connections).
For enterprise connections, see the [custom flow for enterprise connections](/docs/guides/development/custom-flows/enterprise-connections).
...
<Properties>
  ...
  **Required** if `strategy` is set to `'ticket'`. The [ticket _or token_](/docs/guides/development/custom-flows/embedded-email-links#generate-a-sign-in-token) generated from the Backend API.
  ...
  If `strategy` is set to `'email_link'`, this specifies the URL that the user will be redirected to when they visit the email link. See the [custom flow](/docs/guides/development/custom-flows/email-links) for implementation details.
...
For a comprehensive example, see the [custom flow for email links](/docs/guides/development/custom-flows/email-links).
...
<Properties>
  ...
  **Required** if `strategy` is set to `'email_link'`. The full URL that the user will be redirected to when they visit the email link. See the [custom flow](/docs/guides/development/custom-flows/email-links) for implementation details.
...
Resets a user's password. It's recommended to use the [custom flow for resetting a user's password](/docs/guides/development/custom-flows/forgot-password) instead.
