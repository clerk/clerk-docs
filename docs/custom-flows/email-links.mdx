...
<Steps>
  ...
  1. The [`useSignUp()`](/docs/references/react/use-sign-up) hook is used to get the [`SignUp`](/docs/references/javascript/sign-up/sign-up) object.
  ...
  1. On the `/sign-up/verify` page, the [`useClerk()`](/docs/references/react/use-clerk) hook is used to get the [`handleEmailLinkVerification()`](/docs/references/javascript/clerk/handle-navigation#handle-email-link-verification) method.
  ...
  1. The [`useSignIn()`](/docs/references/react/use-sign-in) hook is used to get the [`SignIn`](/docs/references/javascript/sign-in/sign-in) object.
  ...
  1. On the `/sign-in/verify` page, the [`useClerk()`](/docs/references/react/use-clerk) hook is used to get the [`handleEmailLinkVerification()`](/docs/references/javascript/clerk/handle-navigation#handle-email-link-verification) method.
  1. The `handleEmailLinkVerification()` method is called to verify the email address. Error handling is included to handle any errors that occur during the verification process.
