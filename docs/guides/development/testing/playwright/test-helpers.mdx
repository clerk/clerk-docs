...
<Properties>
  ...
  The Frontend API URL for your Clerk dev instance, without the protocol. If provided, it overrides the Frontend API URL parsed from the Publishable Key. To retrieve your Frontend API URL, navigate to the [**Domains**](https://dashboard.clerk.com/~/settings/api-keys) page in the Clerk Dashboard.
</Properties>
