...
| Authentication model | Benefits | Drawbacks |
|--------|--------|--------|
| Stateful | Relatively simple and easy to revoke sessions. | Hits the database on every request. |
| Stateless | Scalable and performant. | Difficult to revoke sessions. |
| Clerk | Scalable, performant, and easy to revoke sessions. | None. | 
