...
The [`<UserProfile />`][userbutton-ref] component is used to render a beautiful, full-featured account management UI that allows users to manage their profile and security settings.

## `mountUserProfile()`

Render the [`<UserProfile />`][userbutton-ref] component to an HTML `<div>` element.
...
| --- | --- | --- |
| `node` | [`HTMLDivElement`](https://developer.mozilla.org/en-US/docs/Web/API/HTMLDivElement) | The `<div>` element used to render in the [`<UserProfile />`][userbutton-ref] component |
| `props?` | [`UserProfileProps`](#user-profile-props) | The properties to pass to the [`<UserProfile />`][userbutton-ref] component |

## `unmountUserProfile()`

Unmount and run cleanup on an existing [`<UserProfile />`][userbutton-ref] component instance.
...
| Name | Type | Description |
| --- | --- | --- |
| `node` | [`HTMLDivElement`](https://developer.mozilla.org/en-US/docs/Web/API/HTMLDivElement) | The container `<div>` element with a rendered [`<UserProfile />`][userbutton-ref] component instance. |

## `openUserProfile()`

Opens the [`<UserProfile />`][userbutton-ref] component as an overlay at the root of your HTML `body` element.
...
[userbutton-ref]: /docs/components/user/user-profile