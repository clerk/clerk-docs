...
<TutorialHero
  beforeYouStart={[
    ...
    },
    {
      ...
      link: "/docs/elements/overview#getting-started",
      icon: "application-2",
    },
  ]}
>
...
> - Clerk Elements currently only works with Next.js App Router and [Clerk Core 2](/changelog/2024-04-19). As it gets closer to a stable release, support for additional frameworks will be added.
