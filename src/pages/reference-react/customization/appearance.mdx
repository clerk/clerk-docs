...
<Tabs items={["npm", "yarn", "pnpm"]}>
  <Tab>``` bash filename="your-project" copy npm install @clerk/themes ```</Tab>
  <Tab>``` bash filename="your-project" copy yarn add @clerk/themes ```</Tab>
  <Tab>
    ``` bash filename="your-project" copy pnpm install @clerk/themes ```
  </Tab>
</Tabs>
