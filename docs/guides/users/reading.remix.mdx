...
The following example uses the [`useUser()`](/docs/reference/hooks/use-user) hook to access the [`User`](/docs/reference/objects/user) object, which contains the current user's data such as their ID.
