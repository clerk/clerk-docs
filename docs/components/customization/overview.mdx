...
Clerk offers [a set of themes that can be used with the `appearance` prop](/reference-general/appearance/themes). The themes are available as a package called `@clerk/themes`.
...
> [You can see a list of the themes Clerk offers in our reference docs.](/reference-general/appearance/themes)
