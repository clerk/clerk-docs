...
<Steps>
  ...
  <Tabs items={["Next.js", "Remix", "JavaScript"]}>
    <Tab>
      To configure your proxy setup using properties in your Next.js application, set the `proxyUrl` property on the [`<ClerkProvider>`](/docs/references/components/clerk-provider) component.
