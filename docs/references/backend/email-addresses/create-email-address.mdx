...
description: Creates an email address for the specified user.
---
...
This method in the SDK is a wrapper around the BAPI endpoint `POST/email_addresses`. See the [BAPI reference](https://clerk.com/docs/reference/backend-api/tag/Email-Addresses#operation/CreateEmailAddress) for more details.