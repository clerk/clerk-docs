...
See the [Backend API guide](/docs/reference/backend-api/tag/Invitations#operation/CreateInvitation) for an example of the response.
...
See the [Backend API guide](/docs/reference/backend-api/tag/Invitations#operation/RevokeInvitation) for an example of the response.
