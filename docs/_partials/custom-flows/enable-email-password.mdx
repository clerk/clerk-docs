...
1. Select the **Password** tab and enable **Sign-up with password**.
   - [**Device Trust**](/docs/guides/secure/device-trust) is enabled by default. The sign-in example supports it using email verification codes because it's the default second factor strategy.
