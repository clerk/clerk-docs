...
The easiest way to require authentication before showing a protected page is to use Clerk's [Control Components](/docs/components/overview):
...
The following example shows you how to compose Clerk's Control Components to build authentication flows that match your needs. Please note that you don't need to use any additional APIs, everything shown below is just Javascript.
