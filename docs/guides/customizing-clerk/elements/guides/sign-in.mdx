...
> [!NOTE]
>
> - Clerk Elements is for [advanced use-cases](/docs/guides/customizing-clerk/elements/overview#why-use-clerk-elements) that require a high-level of customization. The easiest way to implement Clerk is with our [all-in-one UI components](/docs/references/components/overview).
