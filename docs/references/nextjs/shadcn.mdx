...
The [`<ClerkProvider />`](/docs/nextjs/components/clerk-provider) component is required to integrate Clerk into your React application, providing session and user context to Clerk's hooks and components.
