...
> [!WARNING]
> The following example assumes that you have followed the [Chrome Extension Quickstart](/docs/getting-started/quickstart) and then the [Add React Router](/docs/guides/development/add-react-router) guide, but you can apply these concepts to your own application.
...
<Properties>
  ...
  The host to sync the session with. For more information, see [the dedicated guide](/docs/guides/development/sync-host).
</Properties>
