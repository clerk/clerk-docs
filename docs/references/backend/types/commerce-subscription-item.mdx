...
<Properties>
  - `amount`
  - `undefined | null | [CommerceMoneyAmount](/docs/references/javascript/types/commerce-money)`
  ...
  - `lifetimePaid?`
  - `null | [CommerceMoneyAmount](/docs/references/javascript/types/commerce-money)`
  ...
  - `plan`
  - [`CommercePlan`](/docs/references/backend/types/commerce-plan)
