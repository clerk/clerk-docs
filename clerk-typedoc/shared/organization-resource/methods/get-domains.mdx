...
| ------ | ------ | ------ |
| `enrollmentMode?` | <code>"manual_invitation" \| "automatic_invitation" \| "automatic_suggestion"</code> | The [enrollment mode](/docs/guides/organizations/add-members/verified-domains#enable-verified-domains) will decide how new users join an organization. |
