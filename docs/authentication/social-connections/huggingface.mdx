...
description: Learn how to allow users to sign into your Clerk app with their Hugging Face account using OAuth.
---
...
<Steps>
  ...
  1. In the list of **Auth Providers**, enable Hugging Face.
