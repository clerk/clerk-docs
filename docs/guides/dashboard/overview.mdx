...
- The [`<UserButton />`](/docs/components/user/user-button): Allows you to manage your account and sign out.
...
When creating a new application within Clerk, you are provided with two instances: `Development` and `Production`. The names are self-explanatory, but you can learn more about the differences between the two in the [dedicated guide](/docs/deployments/environments).
