...
> [!WARNING]
> This guide assumes that you have already installed Clerk in your application locally and are ready to deploy. If you haven't installed Clerk yet, see the [setup guide](/docs/getting-started).
...
1. In the sidebar, select **Environment Variables** and add your Clerk API keys. You can find your Clerk API keys by navigating to the [**API keys**](https://dashboard.clerk.com/last-active?path=api-keys) page in the Clerk Dashboard.
