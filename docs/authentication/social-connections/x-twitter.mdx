...
When signing up for a new X/Twitter Developer account, you'll be required to describe your app's use cases. After completing this step, you'll be redirected to the **Dashboard** home page where you can see your new app under **Projects** with a randomly generated string as its name.

If you want to create a new X/Twitter application, follow these steps:

  1. In the X/Twitter Developer Portal, under **Projects**, select **+ Add App**. You'll be redirected to the **App name** tab.
  ...
  1. Under **App permissions**, choose the permissions you want to request from your user. For this tutorial, select the **Read** permission.
  1. Under **Type of App**, select **Web App, Automated App or Bot**.
  1. Under **App info**, in the **Callback URI / Redirect URL** input, paste the **Callback URI / Redirect URL** value you copied from the Clerk Dashboard.
