...
<Steps>
  ...
  <If sdk={["nextjs", "react", "expo", "js-frontend", "react-router", "tanstack-react-start"]}>
    ...
    <If sdk="expo">
      > [!TIP]
      > Using [native components](/docs/reference/expo/native-components-overview)? Sign-up is handled automatically by [`<AuthView />`](/docs/reference/expo/auth-view). This guide is for building custom sign-up UI.
  ...
  <If sdk={["nextjs", "react", "expo", "js-frontend", "react-router", "tanstack-react-start"]}>
    ...
    <If sdk="expo">
      > [!TIP]
      > Using [native components](/docs/reference/expo/native-components-overview)? Sign-in is handled automatically by [`<AuthView />`](/docs/reference/expo/auth-view). This guide is for building custom sign-in UI.
