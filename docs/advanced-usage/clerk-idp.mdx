...
<Callout type="warning" emoji="⚠️">
  For security reasons, we do not store your Client Secret and cannot show it to you again, so we recommend you download the secret and store it someplace secure.
</Callout>
