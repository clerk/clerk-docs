...
<Steps>
  ...
  Update your `ContentView` to use Clerk's prebuilt views. Replace the `ClerkKit` import with `ClerkKitUI`, then replace the existing content with the following code:
