...
[Setting up CNAME records and using DNS is the simplest way](/docs/deployments/overview#dns-records). However, if you're unable to use this approach, or would like more control over your integration with Clerk, you can use a proxy.
...
In order to enable proxying, you need to set a proxy URL for your Clerk instance's domain.
