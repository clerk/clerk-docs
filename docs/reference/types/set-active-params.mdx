...
<Properties>
  ...
  - `decorateUrl`: A function that wraps your destination URL to enable Safari ITP cookie refresh when needed. **Always use this to wrap your destination URLs.** Learn more about [`decorateUrl` and Safari ITP cookie refresh](/docs/reference/objects/clerk#using-the-navigate-parameter).
</Properties>
