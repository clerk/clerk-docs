...
To read about customizing your session token and retrieving that data, see the [session token customization guide](/docs/backend-requests/making/custom-session-token).
...
To read about customization your session token and retrieving that data, see the [session token customization guide](/docs/backend-requests/making/custom-session-token).
