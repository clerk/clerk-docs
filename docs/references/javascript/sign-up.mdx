...
<Properties>
  ...
  The [username](/docs/authentication/configuration/sign-up-sign-in-options#username) supplied to the current sign-up. Only supported if username is enabled in the instance settings.
...
<Properties>
  ...
  **Required** if [Web3 authentication](/docs/authentication/configuration/sign-up-sign-in-options#web3-authentication) is enabled. The Web3 wallet address, made up of 0x + 40 hexadecimal characters.
  ...
  The user's [username](/docs/authentication/configuration/sign-up-sign-in-options#username). Only supported if username is enabled in the instance settings.
