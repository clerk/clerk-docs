...
<Properties>
  ...
  **Deprecated. Use [`updateUserMetadata()`](/docs/reference/backend/user/update-user-metadata) instead.** Deep-merges with the existing value rather than replacing it. This parameter will be removed in a future major API version.
