...
<If sdk="ios">
  ...
  @MainActor
  func createPasskey(clerk: Clerk) async {
...
<If sdk="ios">
  ...
  @MainActor
  func signInWithPasskey(clerk: Clerk) async {
    do {
...
<If sdk="ios">
  ...
  @MainActor
  func renamePasskey(passkeyId: String, newName: String, clerk: Clerk) async {
    guard
...
<If sdk="ios">
  ...
  @MainActor
  func deletePasskey(passkeyId: String, clerk: Clerk) async {
    guard
      let passkey = clerk.user?.passkeys.first(where: { $0.id == passkeyId })
    else { return }
