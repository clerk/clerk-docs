...
description: The SessionVerification object is used to describe the progress of a session reverification flow.
---

An interface that represents the state of the session verification process, also know as a reverification flow.
