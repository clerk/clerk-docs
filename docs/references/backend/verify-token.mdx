...
{/* clerk/javascript file: https://github.com/clerk/javascript/blob/843e96e505cd91d676f0736e24465726b55014a7/packages/backend/src/tokens/verify.ts#L13 */}

> [!WARNING]
> This is a lower-level method intended for more advanced use-cases. It's recommended to use [`authenticateRequest()`](/docs/references/backend/sessions/authenticate-request), which fully authenticates a token passed from the `request` object.
