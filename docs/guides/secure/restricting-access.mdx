...
**Restricted** mode can be enabled from the [**Restrictions**](https://dashboard.clerk.com/~/user-authentication/restrictions) page in the Clerk Dashboard.
...
**Waitlist** mode can be enabled from the [**Waitlist settings**](https://dashboard.clerk.com/~/user-authentication/waitlist) page in the Clerk Dashboard.
