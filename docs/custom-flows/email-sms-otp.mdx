...
For more information on how to configure passwordless authentication, check out the [Sign-in and sign-up options](/docs/authentication/configuration/sign-in-sign-up-options#authentication-strategies) guide.
