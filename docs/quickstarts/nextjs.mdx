...
<CodeBlockTabs items={["App Router", "Pages"]}>
...
In some cases, you may need the full user object. For example, if you wanted to access the user's email address or name. You can use the `clerkClient` helper to get the full user object.
