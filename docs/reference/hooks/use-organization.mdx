...
> [!NOTE]
> These attributes are updating automatically and will re-render their respective components whenever you set a different Organization using the [`setActive({ organization })`](/docs/reference/objects/clerk#setactive) method or update any of the memberships or invitations. No need for you to manage updating anything manually.
