...
<Callout type="info">
When using the `asChild` prop, you must ensure that the component is open for extension. Meaning your component should spread the incoming props and forward ref to the underlying element. Here's an example of how you might implement a custom `<Input />` component:
</Callout>
