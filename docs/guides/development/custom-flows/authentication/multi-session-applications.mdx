...
<If notSdk={["js-frontend", "ios", "android"]}>
  Use the [`useClerk()`](/docs/reference/hooks/use-clerk) hook to access the [`Client`](/docs/reference/objects/client) object and the [`setActive()`](/docs/reference/objects/clerk#setactive) method. You can use the `Client` object to access available sessions, and then use `setActive()` to set a specific session as active.
...
<If sdk="js-frontend">
  Use the [`Clerk`](/docs/reference/objects/clerk) object to access the [`Client`](/docs/reference/objects/client) object and the [`setActive()`](/docs/reference/objects/clerk#setactive) method. You can use the `Client` object to access available sessions, and then use `setActive()` to set a specific session as active.
...
<If notSdk={["js-frontend", "ios", "android"]}>
  Use the [`useClerk()`](/docs/reference/hooks/use-clerk) hook to access the [`signOut()`](/docs/reference/objects/clerk#signout) method and sign out of all sessions on the current client.
...
<If sdk="js-frontend">
  Use [`signOut()`](/docs/reference/objects/clerk#signout) to deactivate all sessions on the current client.
...
<If notSdk={["js-frontend", "ios", "android"]}>
  Use the [`useClerk()`](/docs/reference/hooks/use-clerk) hook to access the current session and the [`signOut()`](/docs/reference/objects/clerk#signout) method. Sign out of the current active session by passing the session ID.
...
<If sdk="js-frontend">
  Use [`signOut()`](/docs/reference/objects/clerk#signout) to sign out of a specific session by passing the session ID.
