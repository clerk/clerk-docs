...
<Steps>
  ...
  Next, you need to create an OAuth Application in Clerk via the [Backend API](/docs/reference/backend-api/tag/OAuth-Applications) by providing the Callback URL and a Name. Note that in this context the name is used to help you identify your application and is not displayed anywhere publicly.
