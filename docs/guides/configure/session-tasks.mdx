...
| [Force password reset](/docs/guides/secure/password-protection-and-rules#manually-marking-passwords-as-compromised) | `reset-password` | When the user is required to reset their password on their next sign-in. |
