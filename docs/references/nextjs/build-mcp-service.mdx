...
<Steps>
  ...
  Once this is complete, the `clerk-user-data` tool can be invoked to securely fetch user data from your app, assuming the request is properly authorized with a Clerk OAuth token.
</Steps>
