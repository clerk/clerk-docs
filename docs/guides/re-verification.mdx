...
<Tabs type="framework" items={["Next.js App Router", "Ruby", "Other"]}>
  ### Authorizing your server endpoints
  <Tab>
    <Tabs type="endpoints" items={["Server Actions", "Route Handler"]}>
      <Tab>
