...
This method in the SDK is a wrapper around the BAPI endpoint `DELETE/organizations/{organization_id}/logo`. See the [BAPI reference](/docs/references/backend-api/tag/Organizations#operation/DeleteOrganizationLogo){{ target: '_blank' }} for more information.
