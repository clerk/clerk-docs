...
In addition to the application name set for your instance, there will be standard authentication options to choose from: [identifiers](#identifiers), [authentication strategies](#authentication-strategies), [verification methods](#verification-methods), [social login providers](##social-connections-o-auth), [Web3 authentication](#web3-authentication), [multi-factor authentication](#multi-factor-authentication), and [sign-up restrictions](#sign-up-restrictions). This guide will walk you through each of these options.
