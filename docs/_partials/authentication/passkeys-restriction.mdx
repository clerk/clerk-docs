...
> [!IMPORTANT]
**If you're using [satellite domains](/docs/advanced-usage/satellite-domains)**, in both development and production, they do not support passkeys because they are considered different domains. With satellite domains, you should avoid using passkeys as they won't be portable between your primary domain and your satellite domains.
