...
This method in the SDK is a wrapper around the BAPI endpoint `GET/redirect_urls/{id}`. See the [BAPI reference](/docs/reference/backend-api/tag/Redirect-URLs#operation/GetRedirectURL) for more details.
