...
Clerk assigns a stable CSS class to most elements in the markup, allowing you to style elements from your own stylesheet, or by using `appearance.elements` to assign additional classes and styles via JavaScript. To make overriding the style of Clerk's prebuilt components easier, a `simple` theme is also provided out of the box. To totally control styling of Clerk's prebuilt components, use the `simple` theme in conjunction with custom CSS. To learn more about bringing your own CSS

## Simple theme

The `simple` theme is a prebuilt theme that is designed to be a starting point for your own custom CSS. It is a simple theme that is designed to be a starting point for your own custom CSS. It is a simple theme that is designed to be a starting point for your own custom CSS. It is a simple theme that is designed to be a starting point for your own custom CSS. It is a simple theme that is designed to be a starting point for your own custom CSS. It is a simple theme that is designed to be a starting point for your own custom CSS.
