...
### `handleEmailLinkVerification()` params
...
### `handleEmailLinkVerification()` returns
...
| Name | Type | Description |
| --- | --- | --- |
| `afterSignUpUrl` | `string \| undefined \| null` | Full URL or path to navigate after successful sign up. Defaults to `/`. Use [the environment variable](/docs/deployments/clerk-environment-variables#sign-in-and-sign-up-redirects) instead. |
| `afterSignInUrl` | `string \| undefined \| null` | Full URL or path to navigate after successful sign in. Defaults to `/`. Use [the environment variable](/docs/deployments/clerk-environment-variables#sign-in-and-sign-up-redirects) instead. |
| `redirectUrl` | `string \| undefined \| null` | Full URL or path to navigate after successful sign in or sign up. <br />The same as setting `afterSignInUrl` and `afterSignUpUrl` to the same value. Use [the environment variables](/docs/deployments/clerk-environment-variables#sign-in-and-sign-up-redirects) instead. |
