...
<If sdk="expo">
  ...
  ```tsx {{ filename: 'src/app/(protected)/_layout.tsx' }}
  ...
  ```tsx {{ filename: 'src/app/(protected)/_layout.web.tsx' }}
...
<If notSdk={["nextjs", "react", "expo", "react-router", "chrome-extension", "tanstack-react-start", "vue", "nuxt"]}>
