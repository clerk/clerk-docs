...
> [!TIP]
> To learn how to build a custom flow for managing SMS MFA, see the [dedicated guide](/docs/custom-flows/manage-sms-mfa).
    ...
    export default function AddMFaScreen() {
      ...
      return (
        <>
          ...
          <Link href="/account/manage-mfa">Return to Manage MFA</Link>
        </>
      );
    }
    ```
