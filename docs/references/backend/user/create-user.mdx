...
> [!CAUTION]
>
> This endpoint is [rate limited](/docs/backend-requests/resources/rate-limits#backend-api-requests). For development instances, a rate limit rule of **100 requests per 10 seconds** is applied.
