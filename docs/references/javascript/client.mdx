...
<Properties>
  - `signIn`
  - <code>[SignIn](/docs/references/javascript/sign-in/sign-in) | null</code>
  ...
  - `signUp`
  - <code>[SignUp](/docs/references/javascript/sign-up/sign-up) | null</code>
  ...
  Unique identifier of the last active [`Session`](/docs/references/javascript/session) on this client.
