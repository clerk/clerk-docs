---
title: Endpoints
description: Learn how to use Clerk with your Endpoints.
---

# Endpoints

Clerk provides helpers that allow you to protect your [Endpoints](https://docs.astro.build/en/guides/endpoints/#server-endpoints-api-routes), fetch the current user, and interact with the Clerk backend API.
