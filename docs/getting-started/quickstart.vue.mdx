...
<PromptOnly>
  Hand this prompt to your agent to add auth to your app with the [Clerk CLI](/docs/cli). No need to leave your terminal.

  <Prompt variant="card" src="prompts/cli-setup.md" title="Add Clerk to Vue" output="replace" />
...
<ManualSteps>
  > [!NOTE]
  > These steps use [Vue 3](https://vuejs.org/) with [TypeScript](https://www.typescriptlang.org/).
