...
> [!NOTE]
> The examples in this section assume you have completed the [JavaScript quickstart](/docs/references/javascript/quickstart) to set up the Clerk JS SDK in your project.
