...
You must configure your application instance through the Clerk Dashboard for the enterprise connection(s) that you want to use. Visit [the appropriate guide for your platform](/docs/configure/auth-strategies/enterprise-connections/overview) to learn how to configure your instance.
