...
| <a id="attributemapping"></a> `attributeMapping`     | `AttributeMapping`          | Defines the attribute name mapping between the Identity Provider (IdP) and Clerk's [`User`](/docs/reference/javascript/user) properties.  |
