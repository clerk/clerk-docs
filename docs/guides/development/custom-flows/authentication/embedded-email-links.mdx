  ...
  <Steps>
    ...
    <If sdk="ios">
      ...
      struct EmbeddedEmailLinkSignInView: View {
        ...
        @State private var emailLinkURL = ""

        var body: some View {
          VStack {
            TextField("Paste the sign-in link URL", text: $emailLinkURL)
            Button("Continue") {
              guard let url = URL(string: emailLinkURL) else { return }
              Task { await handleSignInToken(url: url) }
            }
          }
        }
      }
      ...
      extension EmbeddedEmailLinkSignInView {
        ...
        func handleSignInToken(url: URL) async {
          guard
