...
The type is an alias for `“strict_mfa” | “strict” | “moderate” | "lax”` or alternative it needs to match [this object](#object-variant-of-reverification-config).
...
#### Object variant of `ReverificationConfig`
