...
You can use `auth()` to verify machine requests by passing in the `acceptsToken` parameter. See detailed examples in the [guide on verifying machine requests](/docs/references/nextjs/verifying-machine-tokens).
