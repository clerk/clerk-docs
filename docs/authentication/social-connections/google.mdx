...
<Steps>
  ...
  1. Keep this modal and page open.
  ...
  Once the OAuth client is created in the Google Cloud Console, a modal will appear with your **Client ID** and **Client Secret**. Save these values somewhere secure.
