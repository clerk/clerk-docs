...
This guide shows you how to use the [`<SignIn />`](/docs/references/components/authentication/sign-in) prebuilt component in order to build custom page that **allows users to sign in or sign up within a single flow**.
...
<Steps>
  ...
  The following example demonstrates how to render the [`<SignIn />`](/docs/references/components/authentication/sign-in) component to allow users to both sign-in or sign-up from a single flow.
...
<Cards>
  ...
  - [Client-side helpers](/docs/references/hooks/use-user)
