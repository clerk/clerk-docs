...
Verified Domains use [domain affiliation](/docs/guides/organizations/domain-verification#domain-affiliation) verification: Clerk sends a verification code to an email that matches the domain, and the user enters it. If the user adding the domain already has a verified email using that domain in their account, Clerk verifies the domain automatically. This is a different, lower bar than the [domain ownership](/docs/guides/organizations/domain-verification#domain-ownership) verification required for enterprise SSO connections.
