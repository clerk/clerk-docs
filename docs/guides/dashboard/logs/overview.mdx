...
| [**Admin Logs**](/docs/guides/dashboard/logs/admin-logs) | Configuration and administrative changes made from the Clerk Dashboard, [Backend API](/docs/reference/backend-api), or [Platform API](/docs/reference/platform-api) | Instance settings, domains, secrets, Roles, Permissions, and integrations |
