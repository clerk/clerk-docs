...
<Cards>
  - [Checkout flow with a new payment method](/docs/guides/development/custom-flows/checkout-new-payment-method)
  - Prompt users to add a new payment method during checkout

  ---

  - [Checkout flow for returning users](/docs/guides/development/custom-flows/checkout-existing-payment-method)
