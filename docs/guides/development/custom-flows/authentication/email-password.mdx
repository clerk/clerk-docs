...
<Steps>
  ...
  <If sdk={["nextjs", "react", "expo", "js-frontend", "react-router", "tanstack-react-start"]}>
    ...
    Then, to sign up a user using their email, password, and email verification code, you must:
  ...
  <If sdk={["nextjs", "react", "expo", "js-frontend", "react-router", "tanstack-react-start"]}>
    ...
    Then, to authenticate a user using their email and password, you must:
