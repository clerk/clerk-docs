...
The [Backend API](/docs/reference/backend-api){{ target: '_blank' }} provides endpoints for managing account credits:
...
See the [BAPI reference](/docs/reference/backend-api/tag/billing){{ target: '_blank' }} for endpoint details and request parameters.
