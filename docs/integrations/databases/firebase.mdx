...
<Tabs type="configuration" items={["Configure automatically (Recommended)", "Configure manually"]}>
  <Tab>
  You should configure your integration automatically by generating a service account key from your Firebase project. To do so:
  ...
  Select the **Manual configuration** tab above these instructions if you don't want to use a service account key.
  </Tab>
  <Tab>
  You should use a service account key to configure your integration automatically.
