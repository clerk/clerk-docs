...
<Steps>
  ...
  <SignedOut>
    1. In the Clerk Dashboard, navigate to the [**API keys**](https://dashboard.clerk.com/~/settings/api-keys){{ track: 'exp_create_account_nextjs_quickstart' }} page.
  ...
  1. Ensure that **Enable waitlist** is toggled on and select **Save**.
