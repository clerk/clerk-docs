...
| `GET /v1/commerce/statements/{statementID}/<br>payment_attempts` | `GET /v1/billing/statements/{statementID}/<br>payment_attempts` |
| `GET /v1/commerce/subscription_items` | `GET /v1/billing/subscription_items` |
| `DELETE /v1/commerce/subscription_items/<br>{subscriptionItemID}` | `DELETE /v1/billing/subscription_items/<br>{subscriptionItemID}` |
| `POST /v1/commerce/subscription_items/<br>{subscriptionItemID}/extend_free_trial` | `POST /v1/billing/subscription_items/<br>{subscriptionItemID}/extend_free_trial` |
