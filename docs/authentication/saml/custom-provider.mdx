...
<Steps>
  ...
  1. Click to **Add connection**. You will be redirected to the connection's configuration page.
  ...
  1. In the Clerk Dashboard, select **Add via metadata** and input the metadata URL or upload the metadata file that you got from your IdP.
