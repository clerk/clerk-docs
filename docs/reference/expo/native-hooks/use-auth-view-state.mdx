...
To learn how a prebuilt authentication flow can enroll a trusted device and sign in a returning user with biometrics, see the [biometric sign-in guide](/docs/guides/development/custom-flows/authentication/biometric-sign-in).
