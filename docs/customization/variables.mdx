...
The following properties are deprecated as of 2025-07-11 and will be removed in the next major version of Clerk.
...
It is also possible to theme Clerk components within your CSS files. Avoiding the need to pass the `variables` prop to the Clerk component. We expose all of the variables as Clerk CSS variables.
