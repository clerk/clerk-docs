...
For more information on the differences between development and production environments, see the [dedicated guide on Clerk environments](/docs/deployments/environments#session-architecture-differences).
