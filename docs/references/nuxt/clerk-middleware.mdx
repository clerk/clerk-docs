...
> [!NOTE]
> To learn how to protect pages, see the [dedicated guide](/docs/guides/secure/protect-pages).
...
To protect routes based on user authorization status, you can use the `has()` helper to check if the user has the required [organization roles or custom permissions](/docs/guides/organizations/roles-and-permissions). It is available on the [`auth`](/docs/references/nuxt/overview#auth-object) object.
