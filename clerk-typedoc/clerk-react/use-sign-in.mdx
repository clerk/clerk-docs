...
| `setActive()` | <code>(setActiveParams: SetActiveParams) => Promise\<void\></code> | A function that sets the active session. See the [reference doc](/docs/reference/javascript/clerk#set-active). |
