...
description: Learn how to allow users to sign up and sign in to your Clerk application with their Hugging Face account using OAuth.
---
...
Enabling OAuth with [Hugging Face](https://huggingface.co/docs/hub/oauth) allows your users to sign up and sign in to your Clerk app with their Hugging Face account.
...
Keep two browser tabs open during setup: one for the [Clerk Dashboard](https://dashboard.clerk.com/~/user-authentication/sso-connections) and one for your [Hugging Face Connected Apps settings](https://huggingface.co/settings/connected-applications).

<Steps>
  ### Enable Hugging Face as a social connection in Clerk
