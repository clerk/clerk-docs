...
By default, the [`<SignIn />`](/docs/references/components/authentication/sign-in) component handles signing in and signing up, but if you'd like to have a dedicated sign-up page, this guide shows you how to use the [`<SignUp />`](/docs/references/components/authentication/sign-up) component to build a custom sign-up page.
