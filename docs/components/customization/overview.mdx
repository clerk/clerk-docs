...
<Properties>
  ...
  A theme used as the base theme for the components. For more information, see [Themes](/docs/components/customization/themes).
  ...
  Configuration options that affect the layout of the components, allowing customizations that are hard to implement with just CSS. For more information, see [Layout](/docs/components/customization/layout).
  ...
  General theme overrides. This styles will be merged with our base theme. Can override global styles like colors, fonts, etc. For more information, see [Variables](/docs/components/customization/variables).
