...
1. In the **Authentication strategies** section of this page, ensure *only* **SMS verification code** is enabled. Ensure **Password** is toggled off, as you are priotirizing passwordless, SMS OTP-only authentication in this guide. If you would like to use email OTP instead, you can enable the **Email verification code** strategy instead of the SMS strategy.
