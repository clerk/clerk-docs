...
> [!NOTE]
> It's important to note that Clerk only charges by _Monthly Retained Users_ (MRUs) and never based on your total number of Users in the user table. A Monthly Retained User is a user who visits your app in a given month at least one day after signing up.
>
