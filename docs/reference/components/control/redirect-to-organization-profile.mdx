---
title: '`<RedirectToOrganizationProfile />` component'
...
sdk: nextjs, nuxt, react, react-router, tanstack-react-start, vue
tag: deprecated
---

> [!DEPRECATED]
> This feature is deprecated. Please use the [`redirectToOrganizationProfile()` method](/docs/reference/objects/clerk#redirect-to-organization-profile) instead.
