...
To enable test mode via the Clerk Dashboard, navigate to the instance's [**Settings**](https://dashboard.clerk.com/~/instance-settings) page in the Clerk Dashboard. Ensure  **Test mode** is toggled on.
