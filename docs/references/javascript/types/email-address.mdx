...
The `EmailAddress` object is a model around an email address. Email addresses are one of the [identifiers](/docs/authentication/sign-up-sign-in-options#identifiers) used to provide identification for users.
