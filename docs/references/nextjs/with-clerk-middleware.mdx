...
<Callout type="warning">
  `withClerkMiddleware()` is Clerk's pervious middleware API and will soon be deprecated. Please use [`authMiddleware()`](/docs/references/nextjs/auth-middleware) going forward.
</Callout>
