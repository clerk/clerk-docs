...
<If is="llm">
  **For AI agents:** Run `npx clerk@latest enable billing --for users` to enable Billing for users instead of navigating to the Billing Settings page in the Dashboard. Install [Clerk's skills](/docs/guides/ai/skills) with `npx skills add clerk/skills` for correct CLI and SDK usage.
</If>
