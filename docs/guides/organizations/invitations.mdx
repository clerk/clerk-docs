...
By default, only [admins](/docs/guides/organizations/roles-and-permissions#default-roles) can invite users to an organization.
...
- [Configure verified domains](/docs/guides/organizations/verified-domains) to automatically invite users based on their email domain
- [Set up enterprise SSO](/docs/guides/organizations/sso) for centralized authentication through an Identity Provider
- [Set up roles and permissions](/docs/guides/organizations/roles-and-permissions) to control what invited users can access
- [Add metadata to invitations](/docs/guides/organizations/set-metadata) for tracking or custom workflows
