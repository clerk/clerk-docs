...
<Steps>
  ...
  Your application URLs should be structured to indicate which sections of your app are scoped to organizations versus [personal workspaces](/docs/organizations/overview#allow-personal-workspaces).
  ...
  - `/me/` indicates the **active personal workspace**
  ...
  | `/me` | Personal workspace | Personal home page |
  | `/me/settings` | Personal workspace | Personal settings page |
  ...
  - Set `hidePersonal` to `false` to allow users to select their personal workspace.
  ...
  - Set `afterSelectPersonalUrl` to `/me` to navigate the user to their personal workspace after selecting it.
  ...
  - When a user selects their personal workspace using either component, they'll be redirected to `/me`.
      ...
      export default function Header() {
        return (
          <OrganizationSwitcher
            ...
            hidePersonal={false} // Allow users to select their personal workspace
            ...
            afterSelectPersonalUrl="/me" // Navigate to the personal workspace after selecting it
          />
        )
      }
      ```
  ...
  With [`clerkMiddleware()`](/docs/references/nextjs/clerk-middleware), you can use the [`organizationSyncOptions`](/docs/references/nextjs/clerk-middleware#organization-sync-options) property to declare URL patterns that determine whether a specific organization or a user's personal workspace should be activated.
  ...
  The same pattern is used with `personalWorkspacePatterns` to match the user's personal workspace.
    ...
    },
    {
      organizationSyncOptions: {
        ...
        personalWorkspacePatterns: [
          '/me', // Match the personal workspace
