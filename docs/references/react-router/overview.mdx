...
The Clerk React Router SDK gives you access to prebuilt components, React hooks, and helpers to make user authentication easier. Refer to the [quickstart guide](/docs/getting-started/quickstart) to get started.
...
- **Framework mode (recommended):** Configure your app using [Clerk's React Router SDK](/docs/getting-started/quickstart).
