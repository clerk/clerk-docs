...
> [!NOTE]
> Clerk Billing does not currently support 3D Secure (3DS). This includes free trial renewals. See [Does Clerk Billing support additional factor authentication like 3D Secure?](/docs/guides/billing/overview#does-clerk-billing-support-additional-factor-authentication-like-3-d-secure)
