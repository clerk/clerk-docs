...
| ---------------------------------- | --------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| <a id="items"></a> `items`         | <code>[BillingPaymentResource](/docs/reference/types/billing-payment-resource)[]</code> | An array of payment resources that belong to this group.                        |
