...
*   [`prepareVerification()`](/docs/references/javascript/web3-wallet/verification#prepareverification)
*   [`attemptVerification()`](/docs/references/javascript/web3-wallet/verification#attemptverification)
