...
<Callout type="info" emoji="🎉">
 ...
 At this point, your application is fully protected by Clerk and uses Clerk's [Account Portal](/features/account-portal.mdx) pages that are available out of box. 
 
 You can start your Next.js application via `npm run dev`, visit `http://localhost:3000`, and sign up to get access to your application.
</Callout>
