...
This method in the SDK is a wrapper around the BAPI endpoint `GET/redirect_urls/{id}`. See the [BAPI reference](/docs/references/backend-api/tag/Redirect-URLs#operation/ListRedirectURLs){{ target: '_blank' }} for more information.
