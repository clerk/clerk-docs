...
> [!NOTE]
> For more information regarding the different session states, see our documentation on [session management](/docs/authentication/configuration/session-options).
