...
> [!IMPORTANT]
> To use Google One Tap with Clerk, you must [enable Google as a social connection in the Clerk Dashboard](/docs/authentication/social-connections/google#configuring-google-social-connection){{ target: '_blank' }} and make sure to use custom credentials.
