...
- [`getOrganization()`](/docs/references/javascript/clerk/organization-methods#getorganization)
- [`createOrganization()`](/docs/references/javascript/clerk/organization-methods#createorganization)
- [`getOrganizationMemberships()`](/docs/references/javascript/clerk/organization-methods#getorganizationmemberships)

### Redirect

- [`navigate()`](/docs/references/javascript/clerk/redirect-methods#navigate)
- [`redirectWithAuth()`](/docs/references/javascript/clerk/redirect-methods#redirectwithauth)
- [`redirectToSignIn()`](/docs/references/javascript/clerk/redirect-methods#redirecttosignin)
- [`redirectToSignUp()`](/docs/references/javascript/clerk/redirect-methods#redirecttosignup)
- [`redirectToUserProfile()`](/docs/references/javascript/clerk/redirect-methods#redirecttouserprofile)
- [`redirectToCreateOrganization()`](/docs/references/javascript/clerk/redirect-methods#redirecttocreateorganization)
- [`redirectToOrganizationProfile()`](/docs/references/javascript/clerk/redirect-methods#redirecttoorganizationprofile)
- [`redirectToHome()`](/docs/references/javascript/clerk/redirect-methods#redirecttohome)

### Build URLs

- [`buildUrlWithAuth()`](/docs/references/javascript/clerk/build-urls#buildurlwithauth)
- [`buildSignInUrl()`](/docs/references/javascript/clerk/build-urls#buildsigninurl)
- [`buildSignUpUrl()`](/docs/references/javascript/clerk/build-urls#buildsignupurl)
- [`buildUserProfileUrl()`](/docs/references/javascript/clerk/build-urls#builduserprofileurl)
- [`buildHomeUrl()`](/docs/references/javascript/clerk/build-urls#buildhomeurl)
- [`buildCreateOrganizationUrl()`](/docs/references/javascript/clerk/build-urls#buildcreateorganizationurl)
- [`buildOrganizationProfileUrl()`](/docs/references/javascript/clerk/build-urls#buildorganizationprofileurl)

### Handle Navigation

- [`handleMagicLinkVerification()`](/docs/references/javascript/clerk/handle-navigation#handlemagiclinkverification)
- [`handleRedirectCallback()`](/docs/references/javascript/clerk/handle-navigation#handleredirectcallback)
- [`handleUnauthenticated()`](/docs/references/javascript/clerk/handle-navigation#handleunauthenticated)

### Session

- [`setSession()`](/docs/references/javascript/clerk/session-methods#setsession)
- [`setActive()`](/docs/references/javascript/clerk/session-methods#setactive)
