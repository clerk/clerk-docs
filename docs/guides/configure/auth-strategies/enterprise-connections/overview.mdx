...
During a [Service Provider-initiated (SP-initiated)](/docs/guides/configure/auth-strategies/enterprise-connections/authentication-flows#service-provider-initiated-flow-recommended) SAML sign-in, Clerk can send your Identity Provider (IdP) a `login_hint` parameter. This can help the IdP identify the user before they sign in.
