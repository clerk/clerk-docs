...
This method in the SDK is a wrapper around the BAPI endpoint `POST/users/{user_id}/lock`. See the [BAPI reference](/docs/references/backend-api/tag/Users#operation/LockUser){{ target: '_blank' }} for more information.
