...
<Steps>
    ...
    var body: some View {
      ...
      SignInWithAppleButton { request in
        ...
        Task {
          ...
          // Access the optional authorization code
  ...
  > [!NOTE]
  > You can use [`SignUp.signUpWithAppleIdToken()`](https://swiftpackageindex.com/clerk/clerk-ios/main/documentation/clerksdk/signup/signupwithappleidtoken\(idtoken:code:firstname:lastname:captchatoken:\)) if you would like to include the `.fullName` properties from your Apple ID Credential.
</Steps>
