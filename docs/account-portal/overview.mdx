...
The Account Portal utilizes our [prebuilt Clerk components](/docs/components/overview), which are embedded into dedicated pages hosted on Clerk servers. 

<Images 
  width={992}
  height={296}
  src="/docs/images/account-portal/account_portal_how_it_works_2.png"
  alt="Account Portal"
/>
...
For each application environment, Clerk provides pages for sign-up, sign-in, user profile, organization profile, and organization creation flow. To integrate the Account Portal with your application, check out our [setup guide](/docs/account-portal/getting-started).