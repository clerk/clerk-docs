...
Below is an example of your Publishable Key file. To get the respective keys go to the API Keys page in the [Clerk dashboard](https://dashboard.clerk.dev).
...
<Callout type="info">
  We are using `expo-auth-session` for session handling for this example. Please
