...
> [!TIP]
> The restrictions on this page control who can **sign up**. If you want to prevent existing users from changing their email, phone, or username **after sign-up**, see [restrict identifier changes](/docs/guides/configure/auth-strategies/overview#restrict-changes).
