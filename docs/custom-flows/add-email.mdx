...
This guide will show you how to use the Clerk API to add a new email address to the user's account and verify it. This is useful when you want to allow users to add multiple email addresses to their account.
