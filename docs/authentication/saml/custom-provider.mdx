...
- **Assertion Consumer Service (ACS) URL** - This is a unique identifier for your SAML connection that your IdP application needs.
...
- [**Metadata configuration**](#metadata-configuration) - This is where you can input the URL to your IdP's metadata file. This is the recommended way to configure your IdP, but not all IdPs support this method.
...
- **Entity ID** - This is your IdP's URL that Clerk will redirect your users to so that they authenticate.
