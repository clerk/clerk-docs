...
<Steps>
  ...
  1. Navigate to the [Convex integration setup](https://dashboard.clerk.com/apps/setup/convex) page in the Clerk Dashboard.
  1. Choose your configuration options, and then select **Activate Convex integration**. This will reveal your application's [Frontend API URL](!frontend-api-url).
  1. Save your [Frontend API URL](!frontend-api-url). In development, its format is `https://verb-noun-00.clerk.accounts.dev`. In production, its format is `https://clerk.<your-domain>.com`.
  ...
  ## Configure Convex with the Clerk Frontend API URL
