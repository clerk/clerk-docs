...
<Tabs items={["Hook", "JavaScript"]}>
  ...
  <Tab>
    <CodeBlockTabs options={["index.html", "main.js"]}>
      ...
      ```js {{ filename: 'main.js', mark: [[57, 63]] }}
