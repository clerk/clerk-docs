...
description: Learn how to allow users to sign up and sign in to your Clerk application with their Vercel account using OAuth.
---
...
Keep two browser tabs open during setup: one for the [Clerk Dashboard](https://dashboard.clerk.com/~/user-authentication/sso-connections) and one for your [Vercel team's Apps settings](https://vercel.com/d?to=%2F%5Bteam%5D%2F~%2Fsettings%2Fapps).
...
<Steps>
  ...
  1. In your [Vercel team's Apps settings](https://vercel.com/d?to=%2F%5Bteam%5D%2F~%2Fsettings%2Fapps), select an existing app or create a new one. To create a new one:
     1. Select **Create**.
