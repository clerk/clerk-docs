...
> [!WARNING]
> This guide is for using Coinbase Wallet for authentication. If you're looking to connect users using [Coinbase.com](https://www.coinbase.com/) as a social provider, see the [dedicated guide](/docs/configure/auth-strategies/social-connections/coinbase).
