...
<Cards>
  ...
  - ![](/docs/images/logos/auth_providers/apple.svg){{ dark: '/docs/images/logos/auth_providers/apple-dark.svg' }}
  ...
  - ![](/docs/images/logos/auth_providers/github.svg){{ dark: '/docs/images/logos/auth_providers/github-dark.svg' }}
  ...
  - ![](/docs/images/logos/auth_providers/x-twitter.svg){{ dark: '/docs/images/logos/auth_providers/x-twitter-dark.svg' }}
