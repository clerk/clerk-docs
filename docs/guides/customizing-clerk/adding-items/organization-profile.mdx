...
- As a modal: When a user selects the [`<OrganizationSwitcher />`](/docs/reference/components/organization/organization-switcher) component and then selects **Manage**, the `<OrganizationProfile />` will open as a modal by default.
