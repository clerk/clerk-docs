...
If you would like to hide personal workspaces and require users to always have an organization set as active, see the [dedicated guide](/docs/organizations/overview).
