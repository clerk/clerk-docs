...
<CodeBlockTabs options={["npm", "yarn", "pnpm"]}>
  ``` bash filename="your-project" copy npm install @clerk/remix ``` ``` bash
  filename="your-project" copy yarn add @clerk/remix ``` ``` bash
  filename="your-project" copy pnpm i @clerk/remix ```
</CodeBlockTabs>
...
<Callout type="info">
  If you are seeing a 401 after a short period of time even though your user is
  logged in. Please verify you have implemented this section.
</Callout>
