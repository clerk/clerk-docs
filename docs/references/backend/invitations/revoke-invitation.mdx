...
This method in the SDK is a wrapper around the BAPI endpoint `POST/invitations/{invitation_id}/revoke`. See the [BAPI reference](/docs/references/backend-api/tag/Invitations#operation/RevokeInvitation){{ target: '_blank' }} for more information.
