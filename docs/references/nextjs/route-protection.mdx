...
Does your application have limited or straightforward route protection needs? Configuring your protection in Middleware and only Middleware could be the right choice for you. Perhaps your application is only available to signed in users, or most of your app is under the `/dashboard` route and only available for signed in users. In this case protecting from Middleware is a central location that enables this protection.
