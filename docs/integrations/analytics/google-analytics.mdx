...
>
> As a workaround, you can implement your own analytics tracking by observing user state changes via Clerk's [`useUser()`](/docs/hooks/use-user) hook and firing events to your analytics provider.
