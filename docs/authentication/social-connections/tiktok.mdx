...
<Steps>
  ...
  1. On the **App details** page, select the icons next to the **Client key** and **Client secret** to reveal them. These are your **Client ID** and **Client Secret** in Clerk, respectively. Save these values somewhere secure.
