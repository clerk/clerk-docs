...
Both `auth()` and `getAuth()` return an Authentication Object. This JavaScript object contains important information like session data, your user's ID, as well as their org ID. Learn more about the Authentication Object [here](/docs/references/nextjs/authentication-object).
