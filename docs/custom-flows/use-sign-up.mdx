...
```
<Callout type="info">
  If you wish to take advantage of "Smart" display for [Bot Protection](/docs/security/bot-protection) for your Sign ups, you will also need to follow [this custom flows guide](/docs/custom-flows/bot-sign-up-protection).
</Callout>
