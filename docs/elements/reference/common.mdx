...
```tsx {{ prettier: false, filename: 'page.tsx', mark: [[3, 5]] }}
<SignIn.Root>
...
```tsx {{ prettier: false, filename: 'page.tsx', mark: [4] }}
<SignIn.Root>
  <SignIn.Step name="start">
    <Clerk.Connection name="google">
      <Clerk.Icon />
...
```tsx {{ prettier: false, filename: 'page.tsx', mark: [[2, 4], [7, 9], [12, 14]] }}
<SignIn.Root>
  <Clerk.Loading>
