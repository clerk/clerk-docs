...
<Tabs items={["Next.js", "JavaScript"]}>
  <Tab>
    ...
    1. Uses the [`useOrganization()`](/docs/reference/general/hooks/use-organization) hook to get `memberships`, which is a list of the active organization's memberships.
