...
By enabling an IdP-Initiated flow, its possible for Clerk to receive unsolicited authentication requests and neither the Service Provider or the Identity Provider will be able to verify that the flow was initiated by the specified user.
