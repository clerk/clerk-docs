  ...
  const config = await createConfig({
    ...
    ignoreWarnings: {
      docs: {
        ...
        'guides/development/upgrading/upgrade-guides/core-3/backend.mdx': ['doc-not-in-manifest'],
        'guides/development/upgrading/upgrade-guides/core-3/chrome-extension.mdx': ['doc-not-in-manifest'],
        'guides/development/upgrading/upgrade-guides/core-3/expo.mdx': ['doc-not-in-manifest'],
        'guides/development/upgrading/upgrade-guides/core-3/fastify.mdx': ['doc-not-in-manifest'],
        'guides/development/upgrading/upgrade-guides/core-3/javascript.mdx': ['doc-not-in-manifest'],
        'guides/development/upgrading/upgrade-guides/core-3/nextjs.mdx': ['doc-not-in-manifest'],
        'guides/development/upgrading/upgrade-guides/core-3/node.mdx': ['doc-not-in-manifest'],
        'guides/development/upgrading/upgrade-guides/core-3/react.mdx': ['doc-not-in-manifest'],
        'guides/development/upgrading/upgrade-guides/core-3/remix.mdx': ['doc-not-in-manifest'],
