...
<Cards variant="plain">
  ...
  - {<svg viewBox="0 0 32 32" fill="none"><path fill="currentColor" fill-opacity=".24" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" d="M24.8 3.2H7.2a4 4 0 0 0-4 4v17.6a4 4 0 0 0 4 4h17.6a4 4 0 0 0 4-4V7.2a4 4 0 0 0-4-4Z"/><path fill="currentColor" fill-rule="evenodd" d="M3.2 7.6a4.4 4.4 0 0 1 4.4-4.4h17.6a3.6 3.6 0 0 1 3.6 3.6V10a1.2 1.2 0 1 1-2.4 0V6.8a1.2 1.2 0 0 0-1.2-1.2H7.6a2 2 0 0 0-2 2v16.8a2 2 0 0 0 2 2h4a1.2 1.2 0 0 1 0 2.4h-4a4.4 4.4 0 0 1-4.4-4.4V7.6Zm19.2 9.2a2.4 2.4 0 0 0-2.4 2.4h4.8a2.4 2.4 0 0 0-2.4-2.4Zm4 4.8h-8V26c0 .22.179.4.4.4H26a.4.4 0 0 0 .4-.4v-4.4Zm-8.8-2.4h-.4a1.2 1.2 0 0 0-1.2 1.2V26a2.8 2.8 0 0 0 2.8 2.8H26a2.8 2.8 0 0 0 2.8-2.8v-5.6a1.2 1.2 0 0 0-1.2-1.2h-.4a4.8 4.8 0 0 0-9.6 0Z" clip-rule="evenodd"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M9 10h14M9 20h4M9 15h7"/></svg>}
</Cards>
