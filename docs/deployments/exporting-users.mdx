...
While we don't expose this via our Backend APIs, if you wish to get your user's data that *includes their hashed passwords*, please [Contact Support](https://clerk.com/contact/support) where we can export a `.csv` file and assist you in a secure data exchange.
