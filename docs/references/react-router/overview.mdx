...
The Clerk React Router SDK gives you access to prebuilt components, React hooks, and helpers to make user authentication easier. Refer to the [quickstart guide](/docs/references/react-router/quickstart) to get started.
...
- As a framework (recommended): Configure your app using [Clerk's React Router SDK](/docs/references/react-router/quickstart)
