...
The Clerk Remix SDK gives you access to prebuilt components, React hooks, and helpers to make user authentication easier. Refer to the [quickstart guide](/docs/getting-started/quickstart) to get started.
...
See the [dedicated guide](/docs/guides/users/reading#server-side) for example usage.
