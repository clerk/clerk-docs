...
The [`useUser()`](/docs/reference/hooks/use-user){{ target: '_blank' }} hook enables you to access the [`User`](/docs/reference/objects/user) object, which contains the current user's data such as their full name.
