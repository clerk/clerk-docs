...
<Tabs items={["Backend SDK", "With other SDKs"]}>
  ...
  <Tab>
    <Tabs items={["Next.js", "Remix", "Fastify", "Astro", "Express", "Nuxt"]}>
      ...
      <Tab>
        Use the following tabs to see examples of how to use the Backend SDK to get the [Backend User object](/docs/references/backend/types/backend-user) in Remix Loader and Action functions.
