...
<Tables
  ...
  rows={[
{cells: [<a href="#totpresource"><code>TOTPResource</code></a>, <>The newly created TOTP object.</>]}
 ]}
  />
...
<Tables
  ...
  headingsMeta={[{}, {maxWidth: "300px"}]}
  rows={[
{cells: [<a href="#totpresource"><code>TOTPResource</code></a>, <>The newly verified TOTP object.</>]}
 ]}
  />
...
<Tables
  ...
  headingsMeta={[{}, {maxWidth: "300px"}]}
  rows={[
{cells: [<a href="/reference-js/types/deleted-object"><code>DeletedObject</code></a>, <>The a reference to the deleted TOTP object.</>]}
 ]}
  />
...
<Tables
  ...
  headingsMeta={[{}, {maxWidth: "300px"}]}
  rows={[
{cells: [<a href="#backupcoderesource"><code>BackupCodeResource</code></a>, <>The newly created backup code.</>]}
 ]}
  />
