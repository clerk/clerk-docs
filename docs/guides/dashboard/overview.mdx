...
You can invite team members to your workspace by selecting the **Invite** button in the top navigation bar, or by navigating to the [**Team**](https://dashboard.clerk.com/~/team) page.
