...
1. The user is asked to provide their phone number.
1. Once the user submits their phone number, a one-time code is sent to them.
1. The user is then prompted to enter the code to complete the sign-in process.
1. If the verification is successful, the user's session is set as active.
