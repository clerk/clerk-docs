...
> [!WARNING]
> You can't delete a role if it's used as the organization's **Default** role. However, you can [reassign the **Default** role to another role](/docs/organizations/roles-permissions#the-default-role-for-members).
