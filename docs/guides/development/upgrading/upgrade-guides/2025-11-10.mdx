...
<Properties>
  ...
  - `payment_source`
  - [BillingPaymentMethodResource](/docs/reference/types/billing-payment-method-resource)
...
<Properties>
  - `plan`
  - [BillingPlanResource](/docs/reference/types/billing-plan-resource) | `null`
  ...
  - `lifetime_paid`
  - [BillingMoneyAmount](/docs/reference/types/billing-money-amount)
  ...
  - `next_invoice`
  - [BillingSubscriptionItemResource](/docs/reference/types/billing-subscription-item-resource)
  ...
  - `payer`
  - [BillingPayerResource](/docs/reference/types/billing-payer-resource)
...
<Properties>
  ...
  - [BillingMoneyAmount](/docs/reference/types/billing-money-amount) | `null`
  ...
  - `proration`
  - [BillingCheckoutTotals](/docs/reference/types/billing-checkout-totals) | `null`
