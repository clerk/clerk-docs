...
<Steps>
  ...
  1. Select **Create**.
  1. Copy the **Client ID** - you'll need this for `EXPO_PUBLIC_CLERK_GOOGLE_WEB_CLIENT_ID`.
  ...
  1. Select **Create**.
  1. Copy the **Client ID** - you'll need this for `EXPO_PUBLIC_CLERK_GOOGLE_IOS_CLIENT_ID`.
  ...
  1. Select **Create**.
  1. Copy the **Client ID** - you'll need this for `EXPO_PUBLIC_CLERK_GOOGLE_ANDROID_CLIENT_ID`.
  ...
  The plugin reads the `EXPO_PUBLIC_CLERK_GOOGLE_IOS_URL_SCHEME` from either:
  1. Environment variable (for EAS builds, set in `eas.json`)
  2. `config.extra` field in your app config
