...
<If sdk={["nextjs", "react", "react-router", "remix", "tanstack-react-start"]}>
  ...
  <If sdk="react-router">
    > [!NOTE]
    > To see the full `root.tsx` setup you need for Clerk with React Router, see the [React Router quickstart](/docs/quickstarts/react-router).
    ...
    The `<TaskChooseOrganization />` component must be used in conjunction with the `<SignIn />` component. See the [dedicated guide on how to self-host the `<SignIn />` component](/docs/references/react-router/custom-sign-in-or-up-page).
  ...
  <If sdk="remix">
    > [!NOTE]
    > To see the full `root.tsx` setup you need for Clerk with Remix, see the [Remix quickstart](/docs/quickstarts/remix).

    ```tsx {{ filename: 'app/root.tsx', mark: [4] }}
    ...
    The `<TaskChooseOrganization />` component must be used in conjunction with the `<SignIn />` component. See the [dedicated guide on how to self-host the `<SignIn />` component](/docs/references/remix/custom-sign-in-or-up-page).
  ...
  <If sdk="tanstack-react-start">
    > [!NOTE]
    > To see the full `__root.tsx` setup you need for Clerk with TanStack React Start, see the [TanStack React Start quickstart](/docs/quickstarts/tanstack-react-start).
    ...
    The `<TaskChooseOrganization />` component must be used in conjunction with the `<SignIn />` component. See the [dedicated guide on how to self-host the `<SignIn />` component](/docs/references/tanstack-react-start/custom-sign-in-or-up-page).
