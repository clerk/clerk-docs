...
This method in the SDK is a wrapper around the BAPI endpoint `POST/sign_in_tokens`. See the [BAPI reference](/docs/references/backend-api/tag/Sign-in-Tokens#operation/CreateSignInToken){{ target: '_blank' }} for more information.
