...
At the moment, you can only create invitations for email addresses via the [Backend API](/docs/reference/backend-api/tag/Invitations#operation/CreateInvitation).
...
At the moment, you can only revoke invitations via the [Backend API](/docs/reference/backend-api/tag/Invitations#operation/RevokeInvitation).
