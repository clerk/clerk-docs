...
To get your Account Portal domain, navigate to the [**Account Portal**](https://dashboard.clerk.com/last-active?path=account-portal) page of the Clerk Dashboard. The domain format should resemble: `https://verb-noun-00.accounts.dev`
