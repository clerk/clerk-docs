...
![The \<CreateOrganization /> component renders an Organization creation UI that allows users to create brand new organizations within your application.](/docs/images/ui-components/create-organization.svg){{ style: { maxWidth: '492px' } }}
