...
Finally, phone numbers are used as part of [multi-factor authentication](/docs/custom-flows/email-password-mfa). Users receive an SMS message with a one-time code that they need to provide as an extra verification step.
