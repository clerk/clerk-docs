...
Sign in via the Clerk-hosted account portal:
...
```kotlin
signIn = signIn.sendCode { email = "user@email.com" }
signIn = signIn.verifyCode("123456")
```
...
```kotlin
signIn = signIn.sendCode { phone = "+1234567890" }
signIn = signIn.verifyCode("123456")
```
...
```kotlin
signIn = signIn.sendMfaCode { phone = "+1234567890" }
...
```kotlin
signIn = signIn.sendMfaCode { email = "user@email.com" }
...
```kotlin
signUp = signUp.sendCode { email = "newuser@email.com" }
...
```kotlin
signUp = signUp.sendCode { phone = "+1234567890" }
