...
<Steps>
  ...
  1. Configure your template:
     ...
     - You can leave all other fields at their default settings or customize them to your needs. See the [JWT template guide](/docs/session-requests/making/jwt-templates#creating-a-template) to learn more about these settings.
