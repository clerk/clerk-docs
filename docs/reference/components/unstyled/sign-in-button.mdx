...
The `<SignInButton>` component is a button that, by default, links to your app's sign-in page. Your sign-in page will be hosted by Clerk using the [Account Portal](/docs/guides/customizing-clerk/account-portal) unless you have set up a dedicated sign-in page.

{/* TODO: Link to /custom-sign-in-or-up-page when it's no longer specific to /reference/nextjs */}
