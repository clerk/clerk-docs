> [!IMPORTANT]
> The Clerk Android SDK supports a minimum Java version of 17. If you're using a version of Java lower than 17, you'll need to update your project's Java version to 17.
