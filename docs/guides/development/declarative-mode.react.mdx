...
<Steps>
  ## Install `react-router` and `@clerk/react`

  Run the following command to install both React Router and the Clerk React SDK:

  ```npm
  npm install react-router @clerk/react
  ```
...
<Cards>
  - [Create a custom sign-in-or-up page](/docs/react/guides/development/custom-sign-in-or-up-page)
  - Learn how to add a custom sign-in-or-up page to your React app with Clerk's components.
