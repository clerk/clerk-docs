...
As soon as a [User](https://clerk.com/docs/reference/clerkjs/user) signs in, Clerk creates a Session for the current [Client](https://clerk.com/docs/reference/clerkjs/client). Clients can have more than one sessions at any point in time, but only one of those sessions will be **active**.
