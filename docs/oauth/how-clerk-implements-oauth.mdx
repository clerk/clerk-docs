...
For detailed examples and instructions on building an MCP server using Clerk's OAuth server, see our framework-specific guides for:

- [Next.js](/docs/references/nextjs/build-mcp-service)
- [Express](/docs/references/express/build-mcp-service)
