...
1. Using the Backend API in JSON Web Key Set (JWKS) format at the following endpoint https://api.clerk.dev/v1/jwks [JWKs ](https://clerk.com/docs/reference/backend-api/tag/JWKS#operation/GetJWKS).
