...
<Steps>
  ...
  > [!NOTE]
  > If you have not [configured a consistent key](/docs/references/chrome-extension/configure-consistent-crx-idy), you will have to repeat this step every time your extension's ID changes.
