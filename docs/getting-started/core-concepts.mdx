...
1. **[Custom flows using the Clerk API](/docs/guides/development/custom-flows/overview)**: Build flows from scratch using the Clerk API. This option provides maximum flexibility and control over the user experience but requires more development effort.
