...
> [!CAUTION]
> This guide helps you build a _custom_ user interface using the Clerk API. To allow users to sign out using a _prebuilt_ UI, you can use Clerk's [Account Portal pages](/docs/customization/account-portal/overview) or [prebuilt components](/docs/components/overview).
