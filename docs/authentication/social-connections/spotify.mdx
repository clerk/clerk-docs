...
description: Learn how to allow users to sign up and sign in to your Clerk app with their Spotify account.
---
...
<Steps>
  ...
  1. On a separate page, go to the [Spotify Developer Dashboard](https://developer.spotify.com/) and sign in to create a new Spotify app.
  ...
  1. In the Spotify app's settings page, save the **Client ID** and **Client secret** somewhere secure. To reveal the **Client secret**, you must select the **View client secret** button.
