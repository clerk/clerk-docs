...
This method in the SDK is a wrapper around the BAPI endpoint `GET/phone_numbers/{phone_number_id}`. See the [BAPI reference](/docs/references/backend-api/tag/Phone-Numbers#operation/GetPhoneNumber){{ target: '_blank' }} for more information.
