...
In order to make your Clerk instance operate as a provider, you will need to create an OAuth app in the Clerk Dashboard. Then, configure the client to work with your Clerk instance, using the necessary data from your Clerk OAuth app.
...
Now that you have set up a Clerk OAuth app, you will need to configure any of the following settings needed in your client. All of these settings can be found in your your Clerk OAuth app's settings.
