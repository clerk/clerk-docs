...
As the application owner, you have full control over the organizations within your application. You can create, update, and delete organizations, as well as manage their members and settings.
...
For managing organizations and their members in your application, Clerk provides a set of [prebuilt components](/docs/components/overview):
