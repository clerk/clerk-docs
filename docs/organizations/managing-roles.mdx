...
> [!CAUTION]
> This guide is for users who want to build a _custom_ user interface using the Clerk API. To manage member roles in an organization using a _prebuilt_ UI, you should use the [prebuilt components](/docs/components/overview).
