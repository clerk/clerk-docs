...
<Tabs items={["JavaScript (Native sign-in optional)", "Native components"]}>
  <Tab>
    ...
    <Steps>
      ...
      > [!TIP]
      > You can skip this step if you used `npx create-expo-app@latest --template blank` to create your app.
  ...
  <Tab>
    ...
    <Steps>
      ...
      Add `@clerk/expo` and `expo-secure-store` to your plugins. This configures the native modules for native components.
