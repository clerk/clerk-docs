...
<Properties>
  ...
  - `organization`
  - <code>Ref\<[Organization](/docs/reference/objects/organization)></code>
  ...
  - `membership`
  - <code>Ref\<[OrganizationMembership](/docs/reference/types/organization-membership)></code>
...
Use `useOrganization()` to access the current active [`Organization`](/docs/reference/objects/organization) object.
