...
This method in the SDK is a wrapper around the BAPI endpoint `GET/organizations`. See the [BAPI reference](/docs/references/backend-api/tag/Organizations#operation/ListOrganizations){{ target: '_blank' }} for more information.
