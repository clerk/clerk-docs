...
<Callout type="info">
  ...
  You might want to check out one of the [migration guides](/docs/deployments/migrate-overview) to help you move your data to Clerk.
</Callout>
...
If you have just created an account for the first time, you will be taken directly to our interactive authentication setup form.
