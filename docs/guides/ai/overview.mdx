...
Skills are installable packages that give AI coding agents specialized knowledge about Clerk. Once installed, agents can help you build authentication features, manage users and organizations, and integrate Clerk into your applications.

Available skills:

- [Next.js Clerk](/docs/guides/ai/skills/nextjs-clerk) - Build Next.js applications with Clerk authentication
- [Clerk API](/docs/guides/ai/skills/clerk-api) - Manage users, organizations, and invitations via the Backend API

Skills support Claude Code, Cursor, Windsurf, OpenCode, Gemini CLI, and Aider. Install all skills with a single command:
