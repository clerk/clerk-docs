...
> ![NOTE]
> Clerk uses [default naming rules](#default-naming-rules) to automatically name the Organization. Default naming rules must also be enabled to use this feature.
...
> ![NOTE] This feature is required to enable [create first organization automatically](#create-first-organization-automatically). If create first organization automatically is disabled, Clerk will prefill the user's first organization name with the result of these naming rules.
