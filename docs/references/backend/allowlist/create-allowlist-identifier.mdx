...
This method in the SDK is a wrapper around the BAPI endpoint `POST/allowlist-identifiers`. See the [BAPI reference](/docs/references/backend-api/tag/Allow-list-Block-list#operation/CreateAllowlistIdentifier){{ target: '_blank' }} for more information.
