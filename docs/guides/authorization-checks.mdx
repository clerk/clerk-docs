...
With [Clerk organizations](/docs/organizations/overview), users can be assigned [roles and permissions](/docs/organizations/roles-permissions#permissions), which can be used in authorization checks.

With [Clerk billing](/docs/billing/overview), users can subscribe to [plans](/docs/billing/overview#create-a-plan) and [features](/docs/billing/overview#add-features-to-a-plan), which can be used in authorization checks.

Clerk organizations and billing can be used separately or together depending on your application's needs.
...
- If you are doing role- or permission-based authorization checks, **it's recommended to do permission-based authorization over role-based authorization**, as it's more flexible, easier to manage, and more secure.
...
- If you are doing plan- or feature-based authorization checks, **it's recommended to do feature-based authorization over plan-based authorization**, as it's more flexible, easier to manage, and more secure.
