...
| Type | Description |
| --- | --- |
| <code>Promise\<[PaginatedResponse](/docs/references/javascript/types/paginated-response)\<OrganizationMembershipResource\>\></code> | The list of active user sessions. |
