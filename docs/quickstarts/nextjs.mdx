...
<Tabs items={["Use your keys", "Keyless (Beta)"]}>
  <Tab>
    <Steps>
  ## Install `@clerk/nextjs`
  ...
  <Tab>
  > [!IMPORTANT]
  > [Keyless is currently on beta](/docs/keyless). If you would like to disable this feature set this environment variable `NEXT_PUBLIC_CLERK_ENABLE_KEYLESS=true`.
    <Steps>
  ## Install `@clerk/nextjs`
