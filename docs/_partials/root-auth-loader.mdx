...
<Properties>
  ...
  Your Clerk [Publishable Key](!publishable-key). It's recommended to use [the environment variable](/docs/guides/development/clerk-environment-variables#clerk-publishable-and-secret-keys) instead.
  ...
  Your Clerk [Secret Key](!secret-key). It's recommended to use [the environment variable](/docs/guides/development/clerk-environment-variables#clerk-publishable-and-secret-keys) instead.
