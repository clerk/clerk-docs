...
<Steps>
  ...
  <CodeBlockTabs options={["npm", "yarn", "pnpm"]}>
    ...
    npm install @clerk/nextjs@6.10.0-snapshot.v20250120185339
    ```

    ```bash {{ filename: 'terminal' }}
    yarn add @clerk/nextjs@6.10.0-snapshot.v20250120185339
    ```

    ```bash {{ filename: 'terminal' }}
    pnpm add @clerk/nextjs@6.10.0-snapshot.v20250120185339
    ```
  </CodeBlockTabs>
