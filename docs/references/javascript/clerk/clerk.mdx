...
<div className="container mx-auto my-4">
  <div className="grid lg:grid-cols-2 lg:grid-rows-4 justify-center gap-x-7">
    ...
    <ComponentPreviewCards title="Organization Profile" image="/docs/images/ui-components/component-org_profile.svg" link="/docs/components/organization/organization-profile" cta="Read docs"/>
    <ComponentPreviewCards title="Organization Switcher" image="/docs/images/ui-components/component-org_switcher.svg" link="/docs/components/organization/organization-switcher" cta="Read docs"/>
