...
<Properties>
  ...
  Optional for `saml` or `enterprise_sso` strategies. The identifier of the enterprise connection to target during sign-in. This is required if there are multiple enterprise connections configured in the instance.
</Properties>
...
<Properties>
  - `strategy?`
  - `'password' | 'email_link' | 'email_code' | 'phone_code' | 'oauth_<provider>' | 'saml' | 'enterprise_sso' | 'passkey' | 'web3_base_signature' | 'web3_metamask_signature' | 'web3_coinbase_wallet_signature' | 'web3_okx_wallet_signature' | 'web3_solana_signature' | 'ticket' | 'google_one_tap'`
...
<Properties>
  - `strategy`
  - `'email_link' | 'email_code' | 'phone_code' | 'web3_base_signature' | 'web3_metamask_signature' | 'web3_coinbase_wallet_signature' | 'web3_okx_wallet_signature' | 'web3_solana_signature' | 'passkey' | 'oauth_<provider>' | 'saml' | 'enterprise_sso' | 'reset_password_phone_code' | 'reset_password_email_code'`
