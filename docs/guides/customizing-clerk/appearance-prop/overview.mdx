...
This applies to all of the React-based packages, like [Next.js](/docs/getting-started/quickstart), as well as [the pure JavaScript ClerkJS package](/docs/references/javascript/overview).
