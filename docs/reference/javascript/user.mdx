...
Adds a Web3 wallet for the user. A new [`Web3WalletResource`](/docs/reference/javascript/types/web3-wallet-resource) will be created and associated with the user.
...
Retrieves a list of Organization invitations for the user. Returns a [`ClerkPaginatedResponse`][pag-ref] of [`UserOrganizationInvitation`](/docs/reference/javascript/types/user-organization-invitation) objects.
...
Retrieves a list of Organization memberships for the user. Returns a [`ClerkPaginatedResponse`][pag-ref] of [`OrganizationMembershipResource`](/docs/reference/javascript/types/organization-membership) objects.
...
Retrieves a list of Organization suggestions for the user. Returns a [`ClerkPaginatedResponse`][pag-ref] of [`OrganizationSuggestion`](/docs/reference/javascript/types/organization-suggestion) objects.
...
Retrieves organization creation defaults for the current user. Returns a [`OrganizationCreationDefaultsResource`](/docs/reference/javascript/types/organization-creation-defaults-resource) object.
...
Leaves an organization that the user is a member of. Returns a [`DeletedObjectResource`](/docs/reference/javascript/types/deleted-object-resource) object.
