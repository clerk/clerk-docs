...
<Steps>
  ...
  [Create an account at Clerk](https://dashboard.clerk.com/sign-up) or [log into your Clerk dasbhoard](https://dashboard.clerk.com/).

  ### Create a Clerk application

  If you've just created an account for the first time, you'll be taken directly to our interactive sign gin form builder.
  ...
  To create a new app, press the **Add application** card to be taken to the interactive sign form builder.
