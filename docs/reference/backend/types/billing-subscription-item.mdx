...
<Properties>
  ...
  - `amount`
  - <code>[BillingMoneyAmount](/docs/reference/types/billing-money-amount) | undefined</code>
  ...
  - `plan`
  - <code>[BillingPlan](/docs/reference/backend/types/billing-plan) | null</code>
  ...
  - `lifetimePaid?`
  - <code>null | [BillingMoneyAmount](/docs/reference/types/billing-money-amount)</code>
