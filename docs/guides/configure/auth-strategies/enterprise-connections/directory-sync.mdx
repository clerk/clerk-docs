...
To ensure users are provisioned only through Directory Sync, [disable JIT Provisioning](/docs/guides/configure/auth-strategies/enterprise-connections/jit-provisioning#disable-jit-provisioning) for the SAML connection. With both configured, users that your IdP hasn't synced to Clerk can't sign in to your application.
