...
<Preview src="http://localhost:3001/nextjs/sign-in" className="mb-24" />

<Project src="http://localhost:3001/r/nextjs-quickstart.json" />
...
If Clerk's prebuilt components don't meet your specific needs or if you require more control over the logic, you can rebuild the existing Clerk flows using the Clerk API. For more information, see the [custom flow guides](/docs/custom-flows/overview).
  ...
  <div className="hidden flex-none xl:block">
      ...
      <div className="w-56 space-y-3 pt-8">

        {/*<Button variant="primary" color="purple" arrow className="w-full">
          View on GitHub
        </Button>*/}
