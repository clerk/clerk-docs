...
- **Admin**: Holds the highest level of control, with comprehensive access and management capabilities across all team and application settings. Admins can:
...
- **Developer**: Specializes in development tasks with the ability to:
  - Manage developer resources
  - Read user and organization data
  - Read access to billing information
  - Developers do not have management permissions for users, organizations, applications, or API keys

- **Support**: Primarily responsible for user and organization support. Support roles can:
  - Read user and organization data
...
- **Member**: Has basic access with read-only permissions for:
  ...
  - Billing information
  - Members cannot manage any settings or resources
