...
- As a framework (recommended): Configure your app using [Clerk's React Router SDK](/docs/getting-started/quickstart)
- As a library: Manually integrate React Router into your React + Vite app using [library mode](/docs/guides/development/library-mode)
