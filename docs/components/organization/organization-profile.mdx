...
<Properties>
  - `appearance`
  - <code>[Appearance](/docs/components/customization/overview) | undefined</code>
  ...
  An array of custom pages to add to the organization profile. Only available for the [JavaScript SDK](/docs/references/javascript/overview). To add custom pages with React-based SDK's, see the [dedicated guide](/docs/components/customization/organization-profile).
</Properties>
