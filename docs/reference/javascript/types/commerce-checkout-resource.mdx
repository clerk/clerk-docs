...
<Properties>
  ...
  - `plan`
  - <code>[CommercePlanResource](/docs/reference/javascript/types/commerce-plan-resource)</code>
  ...
  - `totals`
  - <code>[CommerceCheckoutTotals](/docs/reference/javascript/types/commerce-checkout-totals)</code>
