...
1. In the Clerk Dashboard, navigate to the [**Subscription plans**](https://dashboard.clerk.com/~/billing/plans) page.
...
1. In the Clerk Dashboard, navigate to the [**Billing Settings**](https://dashboard.clerk.com/~/billing/settings) page.
...
> [!NOTE]
> If you disabled the **Verify at sign-up** option for email addresses in the [Clerk Dashboard](https://dashboard.clerk.com/~/user-authentication/user-and-authentication), users with an unverified primary email address can't start a free trial until they verify it.
...
1. In the Clerk Dashboard, navigate to the [**Billing > Subscriptions**](https://dashboard.clerk.com/~/billing/subscriptions) page.
1. Select the user whose trial you want to manage.
1. Under **Subscriptions**, open the three-dot menu to see the available actions for managing the trial.
