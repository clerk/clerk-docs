...
<Steps>
  ...
  1. Add a `.task` modifier that configures Clerk with your Clerk Publishable Key and loads it when the app starts.<SignedOut>You can retrieve your Publishable Key from the [**API keys**](https://dashboard.clerk.com/~/settings/api-keys) page in the Clerk Dashboard.</SignedOut>
