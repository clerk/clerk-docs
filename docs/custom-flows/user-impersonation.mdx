...
The [Clerk Frontend API](/reference/frontend-api/) will redirect you to the `/sign-in` page of your application, where you can continue the flow by consuming the `__clerk_ticket` parameter.
