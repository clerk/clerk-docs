...
The Clerk React SDK is built on top of the [JavaScript SDK](/docs/references/javascript/overview) and gives you access to prebuilt components, hooks, and helpers to make user authentication easier. Refer to the [quickstart guide](/docs/getting-started/quickstart) to get started.
...
Before you can add Clerk to your React application, you must create a Clerk app in the Clerk Dashboard. To get started, follow the [setup guide](/docs/quickstarts/setup-clerk). Then, follow the [quickstart guide](/docs/getting-started/quickstart) to set up the React SDK in your app.
