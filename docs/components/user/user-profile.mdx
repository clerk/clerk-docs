...
<Properties>
  ...
  An array of custom pages to add to the user profile. Only available for the [JavaScript SDK](/docs/references/javascript/overview). To add custom pages with React-based SDK's, see the [dedicated guide](/docs/components/customization/user-profile).
</Properties>
