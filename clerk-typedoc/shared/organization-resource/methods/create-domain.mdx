...
| `params?` | `Pick`\<[`CreateOrganizationDomainParams`](#createorganizationdomainparams), `"enrollmentMode"`\> | Optional parameters, including the `enrollmentMode` to assign to the new domain. |
