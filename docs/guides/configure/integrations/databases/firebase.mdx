...
<Cards>
  - [Use webhooks to sync Firebase data with Clerk](/docs/guides/configure/webhooks/syncing)
  - Learn how to sync Firebase auth or Firestore data with Clerk data using webhooks.

  ---

  - [Create  a custom sign-in-or-up page in your Next.js app](/docs/guides/development/custom-sign-in-or-up-page)
