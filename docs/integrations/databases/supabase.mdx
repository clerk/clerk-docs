...
<Steps>
  ...
  1. In the sidenav, navigate to **Project Settings > Data API**.
  1. Under the **JWT Settings** section, click on **Reveal > Copy**
  1. Save the value of the **JWT Secret** field somewhere secure. This value will be used in the next step.
  ...
  1. In the sidenav of the [Supabase dashboard](https://supabase.com/dashboard/projects), select **Settings** > **Data API**.
  1. Copy the **Project URL** and add to your `.env` file as `SUPABASE_URL`.
