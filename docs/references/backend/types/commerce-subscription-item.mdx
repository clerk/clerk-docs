...
<Properties>
  ...
  - `amount`
  - <code>undefined | null | [BillingMoneyAmount](/docs/references/javascript/types/billing-money-amount)</code>
  ...
  - `lifetimePaid?`
  - <code>null | [BillingMoneyAmount](/docs/references/javascript/types/billing-money-amount)</code>
