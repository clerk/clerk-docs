...
<Tabs items={["<Protect>", "has()"]}>
  <Tab>
    ...
    ```tsx {{ prettier: false, filename: '/app/dashboard/settings/form.tsx' }}
      'use client';
...
<Tabs items={["Next.js Server Actions", "Next.js Route Handlers", "Next.js Pages Router"]}>
  <Tab>
    ...
    ```tsx {{ prettier: false, filename: 'app/components/ExampleServerComponent.tsx' }}
      import { auth } from "@clerk/nextjs/server";
  ...
  <Tab>
    <Tabs items={["has()", "auth().protect()"]}>
      <Tab>
        ...
        ```tsx {{ prettier: false, filename: 'app/api/get-teams/route.tsx' }}
          import { useAuth } from "@clerk/nextjs";
      ...
      <Tab>
        ...
        ```tsx {{ prettier: false, filename: 'app/api/create-team/route.tsx' }}
          import { useAuth } from "@clerk/nextjs";
  ...
  <Tab>
    ...
    ```tsx {{ prettier: false, filename: 'src/pages/api/get-teams.ts' }}
...
<Tabs items={["JavaScript"]}>
  ```tsx {{ prettier: false, filename: 'main.js' }}
