---
title: Add a badge to show the last authentication method
description: Learn how to use the lastAuthenticationStrategy property to highlight the last used OAuth provider with a badge.
---

<Include src="_partials/custom-flows-callout" />

The `Client` object includes a `lastAuthenticationStrategy` property that tracks the last authentication method used by the user. This is useful for improving UX by showing a "Last used" badge on OAuth buttons, helping returning users quickly identify their preferred sign-in method.
