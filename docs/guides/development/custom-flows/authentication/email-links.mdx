...
<If notSdk="expo">
  ...
  <Steps>
    ...
    <If sdk="ios">
      Clerk's iOS SDK doesn't currently support email link sign-up flows. Use [email and password](/docs/guides/development/custom-flows/authentication/email-password) or [email OTP](/docs/guides/development/custom-flows/authentication/email-sms-otp) instead.
    </If>

    <If sdk="android">
      Clerk's Android SDK doesn't currently support email link sign-up flows. Use [email and password](/docs/guides/development/custom-flows/authentication/email-password) or [email OTP](/docs/guides/development/custom-flows/authentication/email-sms-otp) instead.
    </If>
    ...
    <If sdk="ios">
      Clerk's iOS SDK doesn't currently support email link sign-in flows. Use [email and password](/docs/guides/development/custom-flows/authentication/email-password) or [email OTP](/docs/guides/development/custom-flows/authentication/email-sms-otp) instead.
    </If>

    <If sdk="android">
      Clerk's Android SDK doesn't currently support email link sign-in flows. Use [email and password](/docs/guides/development/custom-flows/authentication/email-password) or [email OTP](/docs/guides/development/custom-flows/authentication/email-sms-otp) instead.
    </If>
