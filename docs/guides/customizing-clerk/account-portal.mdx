...
The create organization page hosts the prebuilt [`<CreateOrganization />`](/docs/references/components/prganization/create-organization) component, which provides a streamlined interface for users to create new organizations within your application.
...
The user profile page hosts the prebuilt [`<OrganizationProfile />`](/docs/references/components/prganization/organization-profile) component, which renders a beautiful, full-featured organization management UI that allows users to manage their organization profile and security settings.
