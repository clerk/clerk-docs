...
<If notSdk="js-frontend">
  ...
  <If sdk="expo">
    ...
    ```jsx {{ filename: 'src/components/PricingTable.web.tsx' }}
...
<If sdk="js-frontend">
  ...
  The following methods available on an instance of the [`Clerk`](/docs/reference/objects/clerk) class are used to render and control the `<PricingTable />` component:

  - [`mountPricingTable()`](#mountpricingtable)
  - [`unmountPricingTable()`](#unmountpricingtable)
...
<If sdk="expo">
  ...
  ```jsx {{ filename: 'src/app/pricing.web.tsx' }}
  import { PricingTable } from '@clerk/expo/web'
