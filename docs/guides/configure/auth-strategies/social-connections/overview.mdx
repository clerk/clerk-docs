...
> [!TIP]
> Looking for the reverse? If you want users to sign in to _other_ apps using their Clerk credentials — making Clerk the identity provider — see [Use Clerk as an OAuth provider](/docs/guides/secure/oauth/use-clerk-as-oauth-provider).
