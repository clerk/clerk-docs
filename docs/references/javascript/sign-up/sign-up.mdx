...
What you pass to `params` depends on the [configuration](/docs/authentication/configuration/sign-up-sign-in-options) of the instance; choices on the instance settings affect which `params` options are available to use.
