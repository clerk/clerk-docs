...
| `externalId` | `string \| null` | The unique identifier for the user in the external system. |
...
| `lastActiveAt` | `Date` | Date when the user was last active. |
