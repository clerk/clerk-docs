...
To implement reverification, you need to handle it on both the server and client side.
...
Below you can find a list of all the user actions that require reverification alogn with the required strategy and timeframe for each action.

| Operation | Strategy | Timeframe |
| - | - | - |
