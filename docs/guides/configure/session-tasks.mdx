...
<If sdk={["nextjs", "astro", "nuxt", "react-router", "tanstack-react-start"]}>
  * [Middleware-based redirects](#using-middleware-based-redirects): Protect specific routes or route groups
</If>

<If sdk={["chrome-extension", "nextjs", "nuxt", "react", "react-router", "tanstack-react-start", "vue"]}>
  - [The `<RedirectToTasks />` component](#using-the-redirect-to-tasks-control-component): Protect routes, route groups (in a layout), or individual pages
</If>
...
<If sdk={["nextjs", "astro", "nuxt", "react-router", "tanstack-react-start"]}>
  ...
  The [`createRouteMatcher()`](/docs/reference/nextjs/clerk-middleware#create-route-matcher) helper function can be used in your `clerkMiddleware()` to protect specific routes or route groups from users who have pending session tasks.
  ...
  // Set the routes that require session tasks
  ...
  export default clerkMiddleware(async (auth, req: NextRequest) => {
    ...
    if (sessionStatus === 'pending' && requiresSessionTasks(req)) {
