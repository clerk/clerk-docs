...
import { ClerkProvider, ClerkLoaded } from "@clerk/clerk-expo"
// Slot is imported from expo-router
import { Slot } from "expo-router"
...
export default function Page() {
  ...
  return (
    <View>
      ...
      <SignedOut>
        {/* 
          // unlike Next.js where it will match routes aside from the routes group with expo routes group must be also provided in the context of <Link> 
          // href="/sign-in" Wrong
          // href="/(auth)/sign-in" Right
        */}
