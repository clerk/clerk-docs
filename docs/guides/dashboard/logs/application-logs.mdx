...
Application Logs retention depends on your [plan](/pricing):
...
| `user.checkout.promo_code.applied` | User applied a promo code to their checkout |
| `user.checkout.promo_code.removed` | User removed a promo code from their checkout |
...
| `organization.checkout.promo_code.applied` | Promo code was applied to an Organization checkout |
| `organization.checkout.promo_code.removed` | Promo code was removed from an Organization checkout |
