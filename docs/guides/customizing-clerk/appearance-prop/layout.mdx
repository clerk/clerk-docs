...
The `layout` property can be used to change the layout of the [`<SignIn/>`](/docs/references/general/components/authentication/sign-in) and [`<SignUp/>`](/docs/references/general/components/authentication/sign-up) components, as well as set important links to your support, terms, and privacy pages.
