...
<Steps>
  ...
  The [Clerk Express SDK](/docs/references/express/overview) gives you access to prebuilt components, React hooks, and helpers to make user authentication easier.
