...
To make the setup process easier, it's recommended to keep two browser tabs open: one for the [Clerk Dashboard](https://dashboard.clerk.com/last-active?path=user-authentication/sso-connections) and one for your [Dropbox Developers App Console](https://www.dropbox.com/developers/apps).
...
<Steps>
  ...
  1. In the [Dropbox Developers App Console](https://www.dropbox.com/developers/apps), select an app or select [Create app](https://www.dropbox.com/developers/apps/create). You'll be redirected to **Create a new app on the DBX Platform** page.
  1. Complete the form and select **Create app**. You'll be redirected to your app's **Settings** page.
  1. Save the **App key** and **App secret** somewhere secure.
