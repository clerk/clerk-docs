...
Agent Tasks allow you to create authenticated sessions on behalf of users without going through the standard sign-in flow. This is useful for automated end-to-end testing and AI agent workflows. Read the complete documentation [here](/docs/guides/development/testing/agent-tasks).
