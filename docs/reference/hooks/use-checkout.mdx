...
<Properties>
  ...
  - `plan`
  - <code>[CommercePlanResource](/docs/reference/javascript/types/commerce-plan-resource) | null</code>
  ...
  - `totals`
  - [`CommerceCheckoutTotals`](/docs/reference/javascript/types/commerce-checkout-totals)
    ...
    <Tabs items={["<SubscriptionPage />", "<CheckoutFlow />"]}>
      ...
      <Tab>
        ...
        function PaymentSection() {
          ...
          return (
            <>
              {/* A component that lists a user's payment methods and allows them to select one. See an example: https://clerk.com/docs/references/hooks/use-payment-methods#examples */}
