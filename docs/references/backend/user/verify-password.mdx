...
This method in the SDK is a wrapper around the BAPI endpoint `POST/users/{user_id}/verify_password`. See the [BAPI reference](/docs/references/backend-api/tag/Users#operation/VerifyPassword){{ target: '_blank' }} for more information.
