...
A _custom flow_ refers to a user flow created entirely from scratch using Clerk's API. If [prebuilt components](/docs/components/overview) don't meet your specific needs or if you require more control over the logic, you can rebuild the existing Clerk flows using Clerk's API.
