...
- The [`getToken()`](/docs/reference/objects/session#gettoken) function in the `useAuth()` hook now supports returning cached tokens, minimizing disruptions caused by network failures.
