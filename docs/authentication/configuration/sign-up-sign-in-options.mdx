...
Clerk provides various options for setting up a sign-up and sign-in flow for your application, such as [identifiers](#identifiers), [authentication strategies](#authentication-strategies), [verification methods](#verification-methods), [social providers](##social-connections-o-auth), [Web3 authentication](#web3-authentication), [multi-factor authentication](#multi-factor-authentication), and [sign-up restrictions](#sign-up-restrictions). This guide will walk you through each of these options.
...
<Callout type="Info">
  Passkey authentication is a premium feature and is not available on the Free plan. [Upgrade your plan](https://clerk.com/pricing) to enable this feature.
</Callout>
