...
You can also verify tokens manually via the [Clerk REST API](https://api.clerk.com/docs?access_token=m2m-design-partners#tag/oauth-access-tokens---backend-api/post/oauth_applications/access_tokens/verify) - ensure you have your Client Secret on hand to include in the `Authorization` header:
