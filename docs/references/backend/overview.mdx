...
- [`getPhoneNumber()`](/docs/references/backend/phone-numberes/get-phone-number)

### Phone number `create` operations

- [`createPhoneNumber()`](/docs/references/backend/phone-numberes/create-phone-number)

### Phone number `update` operations

- [`updatePhoneNumber()`](/docs/references/backend/phone-numberes/update-phone-number)
