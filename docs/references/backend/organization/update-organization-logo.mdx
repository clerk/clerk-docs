...
1. A Next.js [Server Action](https://nextjs.org/docs/app/building-your-application/data-fetching/server-actions-and-mutations) that updates the organization's logo.
...
```tsx {{ filename: 'app/actions/update-profile-image.ts', mark: [[33, 36]] }}
'use server';
...
'use client';
import { updateOrgLogo } from '@/app/actions/updateOrgLogo';
