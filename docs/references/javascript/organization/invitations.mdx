...
| Type | Description |
| --- | --- |
| <code>Promise{"<"}<a href="/docs/references/javascript/types/paginated-response">PaginatedResponse</a>{"<"}<a href="/docs/references/javascript/organization-invitation">OrganizationInvitation</a>{">"}</code> | This method returns a <code>Promise</code> which resolves with a list of <code><a href="/docs/references/javascript/organization-invitation">OrganizationInvitation</a></code> objects.|
