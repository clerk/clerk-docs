...
The flow is unchanged from a real domain: call [`prepareOwnershipVerification()`](/docs/reference/objects/organization#prepareownershipverification) and then [`attemptOwnershipVerification()`](/docs/reference/objects/organization#attemptownershipverification), and skip publishing the `TXT` record.
