...
<Steps>
  ...
  In the following example, the user is prompted to enter their email address and then select a button to sign up using an email link. When the user visits the link in the email link, they are redirected to the `/sign-up/verify` page where they can see the result of the email link verification.

  <Tabs items={["Next.js"]}>
    <Tab>
      <CodeBlockTabs options={["/sign-up/page.tsx", "/sign-up/verify/page.tsx"]}>
        ```tsx {{ filename: '/sign-up/page.tsx', collapsible: true }}
        'use client'
        ...
        ```tsx {{ filename: '/sign-up/verify/page.tsx', collapsible: true }}
        'use client'
  ...
  In the following example, the user is prompted to enter their email address and then select a button to sign in using an email link. When the user visits the link in the email link, they are redirected to the `/sign-in/verify` page where they can see the result of the email link verification.

  <Tabs items={["Next.js"]}>
    <Tab>
      <CodeBlockTabs options={["/sign-in/page.tsx", "/sign-in/verify/page.tsx"]}>
        ```tsx {{ filename: '/sign-in/page.tsx', collapsible: true }}
        'use client'
        ...
        ```tsx {{ filename: '/sign-in/verify/page.tsx', collapsible: true }}
        'use client'
