...
description: Learn how to allow users to sign up and sign in to your Clerk application with their Atlassian account using OAuth.
---
...
Enabling OAuth with [Atlassian](https://developer.atlassian.com/cloud/oauth/) allows your users to sign up and sign in to your Clerk app with their Atlassian account.
...
Keep two browser tabs open during setup: one for the [Clerk Dashboard](https://dashboard.clerk.com/~/user-authentication/sso-connections) and one for your [Atlassian Developer console](https://developer.atlassian.com/console/myapps/).

<Steps>
  ### Enable Atlassian as a social connection in Clerk
