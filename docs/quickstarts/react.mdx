...
<Steps>
  ...
  You can control which content signed-in and signed-out users can see with the [prebuilt control components](/docs/reference/general/components/overview#control-components). The following example creates a header using the following components:
...
<Cards>
  ...
  - [Client-side helpers (hooks)](/docs/reference/general/hooks/use-user)
