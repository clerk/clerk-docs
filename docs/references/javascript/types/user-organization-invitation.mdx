...
To see an example of how to use the `accept()` method, see the [custom flow guide for managing invitations](/docs/guides/development/custom-flows/manage-user-org-invitations).
