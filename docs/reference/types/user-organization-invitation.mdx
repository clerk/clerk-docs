...
<Properties>
  ...
  - `publicMetadata`
  - [`UserOrganizationInvitationPublicMetadata`](/docs/reference/types/metadata#user-organization-invitation-public-metadata)
  ...
  - `role`
  - [`OrganizationCustomRoleKey`](/docs/reference/types/organization-custom-role-key)
