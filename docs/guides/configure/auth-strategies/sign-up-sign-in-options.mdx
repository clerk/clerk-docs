...
If you're building a custom user interface instead of using the [Account Portal](/docs/guides/customizing-clerk/account-portal) or [prebuilt components](/docs/references/components/overview), you can use [elements](/docs/guides/customizing-clerk/elements/examples/sign-in#multi-factor-authentication-mfa) or [the Clerk API](/docs/guides/development/custom-flows/authentication/email-password-mfa) to build a custom sign-in flow that allows users to sign in with MFA.
