...
| ---- | ------------------- | ----------------------------------------------------------------- |
| `path?` | `string` | The root path the sign-in flow is mounted at. Default: `/sign-in` |
...
| `navigate?` | `'choose-strategy' \| 'forgot-password' \| 'previous' \| 'start' \| 'back'`  | The name of the step to navigate to. Default: `undefined`                                                                      |
