...
This method in the SDK is a wrapper around the BAPI endpoint `GET/clients/verify`. See the [BAPI reference](/docs/reference/backend-api/tag/Clients#operation/VerifyClient) for more details.
