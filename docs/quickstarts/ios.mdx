...
<Steps>
  ...
  The following example creates a sign-up view that allows users to sign up using email address and password, and sends an email verification code to confirm their email address.
