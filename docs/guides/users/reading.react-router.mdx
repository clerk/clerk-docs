...
description: Learn how to use Clerk's hooks and helpers to read user data in your React Router application.
metadata:
  title: Read session and user data in your React Router app with Clerk
sdk: react-router
---

Clerk provides a set of [hooks and helpers](/docs/reference/react-router/overview#client-side-helpers) that you can use to read user data in your React Router application. This guide demonstrates how to use these helpers in both the client and server-side to get you started.
