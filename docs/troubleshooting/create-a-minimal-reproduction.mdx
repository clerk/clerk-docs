...
Create a new Clerk application through the Clerk Dashboard. You can follow Clerk's [setup guide](https://clerk.com/docs/guides/setup-clerk) to help you get started. 
