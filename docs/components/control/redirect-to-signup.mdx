...
<If sdk="js-frontend">
  ...
  The following method available on an instance of the [`Clerk`](/docs/references/javascript/clerk) class is used to render and control the `<RedirectToSignUp />` component:
