...
Denotes the duration after which a session will expire and the user will have to sign in again, if they haven't been active on your site. By default, this setting is disabled for all newly created instances. To enable it and set your desired value, click on the <DashboardLink path="sessions">Sessions</DashboardLink> page in the side nav of the Clerk Dashboard.
...
Denotes the duration after which a session will expire and the user will have to sign in again, regardless of their activity on your site. By default, this setting is enabled with a default value of 7 days for all newly created instances. To find this setting and change the value, click on the <DashboardLink path="sessions">Sessions</DashboardLink> page in the side nav of the Clerk Dashboard.
...
To enable this feature in your application, click on the <DashboardLink path="sessions">Sessions</DashboardLink> page in the side nav of the Clerk Dashboard. Turn on the **Mutli-session handling** toggle.
...
To add custom claims to the session token, click on the <DashboardLink path="sessions">Sessions</DashboardLink> page in the side nav of the Clerk Dashboard. In the **Customize session token** section, click on the **Edit** button. This will open a modal window where you can add claims and even use our handy shortcodes.
