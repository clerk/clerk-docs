...
When organizations are enabled, personal workspaces are disabled by default. You can enable personal workspaces by visiting the [**Organizations Settings**](https://dashboard.clerk.com/last-active?path=organizations-settings) page and updating the "Allow personal workspaces" setting.
