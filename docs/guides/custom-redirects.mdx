...
To ensure a smooth onboarding and sign-in flow for users, you should set a sign-in fallback redirect URL and a sign-up force redirect URL, as shown in the following example:
...
- `signInFallbackRedirectUrl` – For sign-in related component, such as [`<SignIn>`](/docs/components/authentication/sign-in.mdx), use `fallbackRedirectUrl` instead.
- `signUpFallbackRedirectUrl` – For sign-up related component, such as [`<SignUp>`](/docs/components/authentication/sign-up.mdx), use `fallbackRedirectUrl` instead.
- `fallbackRedirectUrl` – The default "fallback redirect URL" prop used by sign-in and sign-up related components.
...
- `signInForceRedirectUrl` – For sign-in related component, such as [`<SignIn>`](/docs/components/authentication/sign-in.mdx), use `forceRedirectUrl` instead.
- `signUpForceRedirectUrl` – For sign-up related component, such as [`<SignUp>`](/docs/components/authentication/sign-up.mdx), use `forceRedirectUrl` instead.
- `forceRedirectUrl` – The default "force redirect URL" prop used by sign-in and sign-up related components.
...
The following example is written for Next.js App Router, but is supported by any React meta framework, such as Remix or Gatsby.

<CodeBlockTabs type="framework" options={["Next.js"]}>
```jsx filename="app/sign-in/page.js"
"use client";
...
[`<SignIn>`](/docs/components/authentication/sign-in) and [`<SignUp>`](/docs/components/authentication/sign-up) also take these properties.
...
<Tabs type="framework" items={["Next.js", "React", "Remix", "Gatsby"]}>
  ...
  <Tab>
    ```jsx filename="/src/sign-in-sign-up/[[...index]].tsx"
  ...
  <Tab>
    ```jsx filename="app/routes/sign-in-sign-up/$.tsx"
  ...
  <Tab>
    ```jsx filename="/pages/sign-in-sign-up.js"
    import { SignIn, SignUp } from "gatsby-plugin-clerk";
