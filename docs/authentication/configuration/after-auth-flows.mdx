...
- [Personal workspaces disabled (default)](/docs/organizations/overview#allow-personal-workspaces) - requires users to select or create an organization after authenticating.
