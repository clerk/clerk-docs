...
Now that users can sign in with MFA, you need to add the ability for your users to manage their MFA settings. Learn how to build a custom flow for [managing TOTP MFA](/docs/custom-flows/manage-totp-mfa) or for [managing SMS MFA](/docs/custom-flows/manage-sms-mfa).
