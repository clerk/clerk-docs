  ...
  <Tabs items={["Create a new Next.js app with Clerk", "Add Clerk to an existing Next.js app"]}>
    ...
    <Tab>
      <Steps>
        ...
        1. Add the [`<ClerkProvider>`](/docs/reference/general/components/clerk-provider) component to your app's layout. This component provides Clerk's authentication context to your app.
        1. Copy and paste the following file into your `layout.tsx` file. This creates a header with Clerk's [prebuilt components](/docs/reference/general/components/overview) to allow users to sign in and out.
