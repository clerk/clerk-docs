...
| - | - | - |
| Sign-up | [`<RedirectToSignUp />`](/docs/references/general/components/control/redirect-to-sign-up) | [`Clerk.redirectToSignUp()`](/docs/references/javascript/clerk#redirect-to-sign-up) |
| Sign-in | [`<RedirectToSignIn />`](/docs/references/general/components/control/redirect-to-sign-in) | [`Clerk.redirectToSignIn()`](/docs/references/javascript/clerk#redirect-to-sign-in) |
| User profile | [`<RedirectToUserProfile />`](/docs/references/general/components/control/redirect-to-user-profile) | [`Clerk.redirectToUserProfile()`](/docs/references/javascript/clerk#redirect-to-user-profile) |
| Create organization | [`<RedirectToCreateOrganization />`](/docs/references/general/components/control/redirect-to-create-organization) | [`Clerk.redirectToCreateOrganization()`](/docs/references/javascript/clerk#redirect-to-create-organization) |
| Organization profile | [`<RedirectToOrganizationProfile />`](/docs/references/general/components/control/redirect-to-organization-profile) | [`Clerk.redirectToOrganizationProfile()`](/docs/references/javascript/clerk#redirect-to-organization-profile) |
