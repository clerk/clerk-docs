...
| `sign_in.password.pwned` | Pwned password detected during sign-in |
| `sign_in.password.compromised` | Compromised password detected during sign-in |
...
| `organization_membership.deleted` | User left organization |
