...
Attempts to complete the [second factor](!second-factor-verification) verification process. Returns a [`SessionVerification`](/docs/reference/javascript/types/session-verification) instance with its status and supported factors.
