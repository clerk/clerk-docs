...
Clerk's [React Router SDK](/docs/sdk/react-router/methods) provides prebuilt components, hooks, and stores to make it easy to integrate authentication and user management in your React Router app. This guide assumes that you're using [React Router v7 or later](https://api.reactrouter.com/v7).
...
<Steps>
  ...
  To load additional data or configure options, see the [`rootAuthLoader()`](/docs/sdk/react-router/root-auth-loader) reference.
