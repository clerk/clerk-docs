...
The logo used in Clerk emails comes from your application's settings in the Clerk Dashboard. To add or update it, go to [**Settings**](https://dashboard.clerk.com/~/settings) and upload your application logo there.
