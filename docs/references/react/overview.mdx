...
The Clerk React SDK is built on top of the [JavaScript SDK](/docs/references/javascript/overview) and gives you access to prebuilt components, hooks, and helpers to make user authentication easier. Refer to the [quickstart guide](/docs/react/getting-started/quickstart) to get started.
