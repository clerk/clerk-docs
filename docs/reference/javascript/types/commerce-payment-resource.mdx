...
<Properties>
  ...
  - `amount`
  - <code>[CommerceMoneyAmount](/docs/reference/javascript/types/commerce-money-amount)</code>
  ...
  - `paymentSource`
  - <code>[CommercePaymentSourceResource](/docs/reference/javascript/types/commerce-payment-source-resource) | undefined</code>
  ...
  - `subscription`
  - <code>[CommerceSubscriptionResource](/docs/reference/javascript/types/commerce-subscription-resource) | undefined</code>
  ...
  - `subscriptionItem`
  - <code>[CommerceSubscriptionItemResource](/docs/reference/javascript/types/commerce-subscription-item-resource)</code>
