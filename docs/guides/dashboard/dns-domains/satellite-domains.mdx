...
<Steps>
  ...
  To verify it's working, visit your satellite domain and select "Sign in" — you should be redirected to the primary domain and back with an active session. For details on the sync flow, see [How authentication syncing works](#how-authentication-syncing-works).
