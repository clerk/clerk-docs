...
- **Enable Enterprise SSO** with [SAML and OIDC](/docs/guides/organizations/add-members/sso): let customers authenticate through their identity provider (IdP), such as Okta, Entra ID, or Google Workspace, with unlimited connections and no per-connection fees.
