...
This method in the SDK is a wrapper around the BAPI endpoint `DELETE/domains/{domain_id}`. See the [BAPI reference](/docs/references/backend-api/tag/Domains#operation/DeleteDomain){{ target: '_blank' }} for more information.
