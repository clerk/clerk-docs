...
This method in the SDK is a wrapper around the BAPI endpoint `DELETE/users/{user_id}/mfa`. See the [BAPI reference](/docs/references/backend-api/tag/Users#operation/DisableMFA){{ target: '_blank' }} for more information.
