...
description: Learn about the SP-initiated and IdP-initiated flows for SAML, and how OIDC and EASIE connections work.
---

This page covers the sign-in flows available for each enterprise connection type. For a higher-level overview of how SAML, OIDC, and SCIM relate to each other, see the [Enterprise SSO overview](/docs/guides/configure/auth-strategies/enterprise-connections/overview).
