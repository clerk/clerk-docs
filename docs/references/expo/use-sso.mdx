...
<Properties>
  ...
  - `'oauth_<provider>'`: The user will be authenticated with their [social connection account](/docs/guides/configure/auth-strategies/social-connections/oauth). [See a list of supported values for `<provider>`](/docs/references/javascript/types/sso#o-auth-provider).
