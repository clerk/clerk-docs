...
This method in the SDK is a wrapper around the BAPI endpoint `DELETE/redirect_urls/{id}`. See the [BAPI reference](/docs/references/backend-api/tag/Redirect-URLs#operation/DeleteRedirectURL){{ target: '_blank' }} for more information.
