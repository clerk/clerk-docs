...
1. In the top of the Clerk Dashboard, select [**Organizations**](https://dashboard.clerk.com/last-active?path=organizations).
...
If you want to only configure this permission for a specific user, you can override it on a per-user basis on the user's profile page of the Clerk Dashboard:

1. In the top of the Clerk Dashboard, select [**Users**](https://dashboard.clerk.com/last-active?path=users).
...
1. In the top of the Clerk Dashboard, select [**Organizations**](https://dashboard.clerk.com/last-active?path=organizations). Here, you can view and manage all organizations within your application.
