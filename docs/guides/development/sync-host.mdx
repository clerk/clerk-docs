...
> [!WARNING]
> This guide assumes assumes that you have followed the [Chrome Extension Quickstart](/docs/getting-started/quickstart) and then the [Add React Router](/docs/guides/development/add-react-router) guide.
