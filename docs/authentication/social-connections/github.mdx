...
<Steps>
  ...
  1. Complete the form. Under **Authorization callback URL**, paste the **Authorized redirect URI** value you saved from the Clerk Dashboard.
  1. Once you're finished completing the form, select **Register application**. You'll be redirected to your app's **General** page.
