...
Delete the organization domain and removes it from the organization.
...
<Tables
    ...
    headingsMeta={[{maxWidth:'300px'},{maxWidth: '300px'},{maxWidth: '300px'}]}
    rows={[
        {cells: [<code>affiliationEmailAddress</code>, <code>string</code>, <>An email address that is affiliated with the domain name (e.g. user@example.com). </>]},
    ]}
/>
...
<Tables
    ...
    rows={[
        {cells: [<code>Promise{"<"}<a href="/docs/references/javascript/organization-domain">OrganizationDomain</a>{">"}</code>, <>This method returns a <code>Promise</code> which resolves with a <code><a href="/docs/references/javascript/organization-domain">OrganizationDomain</a></code> object.</>]}
    ]}
/>
...
Make sure that a `OrganizationDomain` object already exists before you call this method, by first calling `OrganizationDomain.prepareAffiliationVerification`.
...
<Tables
    ...
    headingsMeta={[{maxWidth:'300px'},{maxWidth: '300px'},{maxWidth: '300px'}]}
    rows={[
        {cells: [<code>code</code>, <code>string</code>, <>The one-time code that was sent to the user as part of this verification step.</>]},
    ]}
/>
