<If sdk={["nextjs", "astro", "expo", "js-frontend", "nuxt", "react", "react-router", "tanstack-react-start", "vue"]}>
  <If sdk="nextjs">
...
<If notSdk={["nextjs", "astro", "expo", "js-frontend", "nuxt", "react", "react-router", "tanstack-react-start", "vue"]}>
  > [!NOTE]
