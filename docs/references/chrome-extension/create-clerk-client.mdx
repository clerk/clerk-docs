...
<Properties>
  ...
  The publishable key for your Clerk instance. This can be found in the Clerk Dashboard on the [**API keys**](https://dashboard.clerk.com/last-active?path=api-keys) page.
