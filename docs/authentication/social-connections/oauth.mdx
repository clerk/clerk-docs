...
The easiest way to add social connections is by using Clerk's [prebuilt components](/docs/components/overview). If you prefer a more custom solution, see the how to [build a completely custom social connection flow](/docs/custom-flows/oauth-connections).
