...
The following example demonstrates how to create a custom OAuth sign-in flow for [Google accounts](/docs/configure/auth-strategies/social-connections/google).
