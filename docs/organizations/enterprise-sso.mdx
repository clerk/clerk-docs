...
1. Collaborate with the customer's IT administrator to obtain the necessary SSO configuration details
1. Configure the SSO connection for the organization via the Dashboard
1. Invite users to the organization, who can sign in using SSO
...
1. After deciding to adopt the application, they create an organization for their company
