...
| - | - | - | - |
| `secretKey` | Server key for `api.clerk.com`. Can be found in the Clerk Dashboard on the [**API keys**](https://dashboard.clerk.com/last-active?path=api-keys) page. | none | `CLERK_SECRET_KEY` |
