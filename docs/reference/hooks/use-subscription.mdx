...
<Properties>
  - `data`
  - <code>[`BillingSubscriptionResource`](/docs/reference/javascript/types/billing-subscription-resource) | null</code>
...
<If sdk="react">
  ```tsx {{ filename: 'src/pricing/subscription-details/page.tsx' }}
  import { useSubscription } from '@clerk/clerk-react/experimental'
