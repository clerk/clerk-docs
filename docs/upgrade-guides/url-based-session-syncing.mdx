...
In URL-based session syncing mode, navigating from your application to your Clerk [Account Portal](/docs/customization/account-portal//overview) pages must be done using the Clerk redirection helpers and Control Components as shown in the following table:
