...
Gets the list of memberships for an Organization.

Returns a [`ClerkPaginatedResponse`](/docs/reference/types/clerk-paginated-response) of [`OrganizationMembershipResource`](/docs/reference/types/organization-membership) objects.
...
| `role?` | <code>[OrganizationCustomRoleKey](/docs/reference/types/organization-custom-role-key)[]</code> | The [Role](/docs/guides/organizations/control-access/roles-and-permissions) to filter the users by. |
