...
| Skill | Description | When to use |
| - | - | - |
| [/clerk-orgs](https://github.com/clerk/skills/blob/main/skills/features/clerk-orgs/SKILL.md) | Multi-tenant B2B organizations | Team workspaces, RBAC, verified domains, enterprise SSO |
...
| [/clerk-testing](https://github.com/clerk/skills/blob/main/skills/features/clerk-testing/SKILL.md) | E2E testing for auth flows | Writing Playwright/Cypress tests |
...
| Skill | Description | When to use |
| - | - | - |
| [/clerk-swift](https://github.com/clerk/skills/blob/main/skills/mobile/clerk-swift/SKILL.md) | Native iOS/SwiftUI authentication | Building native Swift/iOS apps with ClerkKit |
