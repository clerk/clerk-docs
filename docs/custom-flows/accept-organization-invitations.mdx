...
When a user visits an [organization invitation](/docs/guides/organizations/invitations) link, and no custom redirect URL was specified, then they will be redirected to the [Account Portal sign-in page](/docs/account-portal/overview#sign-in).
