...
A ["magic link"](https://clerk.com/blog/magic-links) is a link, that when pressed, will automatically authenticate your user, so that they can quickly perform some action on your site with less friction than if they had to sign in manually.
