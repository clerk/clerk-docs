...
<Properties>
  ...
  - `nextPayment`
  - <code>null | \{ amount: [BillingMoneyAmount](/docs/references/javascript/types/billing-money-amount); date: number; }</code>
