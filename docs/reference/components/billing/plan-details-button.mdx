...
![The \<PlanDetailsButton /> component renders a button that opens the Plan details drawer.](/docs/images/ui-components/plan-details.svg){{ style: { maxWidth: '460px' } }}
...
<If sdk="tanstack-react-start">
  ...
  import { PlanDetailsButton } from '@clerk/tanstack-react-start/experimental'
...
<Properties>
  ...
  - `plan?`
  - [`BillingPlanResource`](/docs/reference/types/billing-plan-resource)
