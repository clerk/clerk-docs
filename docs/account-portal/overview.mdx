...
The waitlist page hosts the prebuilt [`<Waitlist />`](/docs/reference/general/components/waitlist) component which renders a form that allows users to join for early access to your app.
