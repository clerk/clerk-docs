...
![The \<Waitlist /> component renders a waitlist form that allows users to join for early access to your app.](/docs/images/ui-components/waitlist.svg)

The `<Waitlist />` component renders a waitlist form that allows users to join for early access to your app.
