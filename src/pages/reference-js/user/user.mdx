...
<Tables
  ...
  headingsMeta={[{}, {maxWidth: "300px"}]}
  rows={[
{cells: [<a href="#imageresource"><code>ImageResource</code></a>, <>The uploaded image.</>]}
 ]}
  />
...
<Tables
  ...
  headingsMeta={[{}, {maxWidth: "300px"}]}
  rows={[
{cells: [<code><a href="/reference-js/session-with-activities">SessionWithActivities</a>[]</code>, <>The list of active user sessions.</>]}
 ]}
  />
