...
<Steps>
  ...
  <Tabs items={["Next.js"]}>
    <Tab>
      The following example demonstrates how to add the CAPTCHA widget to a custom sign-up form. This example uses the [Email & password custom flow](/docs/guides/development/custom-flows/email-password) but you can add the CAPTCHA widget to _any_ custom sign-up form.
