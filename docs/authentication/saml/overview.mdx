...
For production instances, each active connection costs $50 per month. SAML connections require the Pro plan and the Enhanced Authentication Add-on. Please see [pricing](/pricing) for those costs, and the costs of other add-ons or features.

For development instances, SAML connections will always be free, but capped to 5.

### Can I get a bulk discount?

Yes, [reach out to support](/contact/support) to work out a custom plan.
