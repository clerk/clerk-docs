...
To get started, navigate to the [Integrations](https://dashboard.clerk.com/last-active?path=integrations) page in the Clerk Dashboard and turn on the Google Analytics integration.
...
<Images
  width={2488}
  height={1398}
  src="/docs/images/integrations/firebase/api-secret.gif"
...
<Images
  width={2488}
  height={1398}
  src="/docs/images/integrations/firebase/measurement-id.gif"
...
<Images
  width={2836}
  height={1061}
  src="/docs/images/integrations/firebase/tracking-id.webp"
  alt="A gif showing how to access the measurement ID in the Google Analytics UI."
/>
...
For **Google Analytics 4** properties, this matches the standard [sign_up event](https://developers.google.com/analytics/devguides/collection/ga4/reference/events#sign_up).
