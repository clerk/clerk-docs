...
<Tabs items={['Next.js', 'React', 'React Router', 'Astro', 'TanStack React Start', 'Expo', 'Nuxt', 'Express']}>
  ...
  <Tab>
    ...
    1. If your app uses React Router v7, enable the `v8_middleware` future flag. React Router v8 enables middleware by default and no longer supports this flag.
