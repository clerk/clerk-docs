...
<Tabs items={['Next.js', 'React', 'Remix']}>
    <Tab>
        `<UserProfile.Page />` can be rendered **only on the client**. For Next.js applications using App Router, the `"use client";` flag must be added.
...
<Tabs items={['Next.js', 'React', 'Remix']}>
    <Tab>
        `<UserProfile.Link />` can be rendered **only on the client**. For Next.js applications using App Router, the `"use client";` flag must be added.
...
<Tabs items={['Next.js', 'React', 'Remix']}>
    <Tab>
        `<UserProfile.Page />` and `<UserProfile.Link />` can be rendered **only on the client**. For Next.js applications using App Router, the `"use client";` flag must be added.
...
<Tabs items={['Next.js', 'React', 'Remix']}>
    <Tab>
        `<UserButton.UserProfilePage />` and `<UserButton.UserProfileLink />` can be rendered **only on the client**. For Next.js applications using App Router, the `"use client";` flag must be added.
