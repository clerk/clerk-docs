...
<Tabs items={["Next.js", "JavaScript"]}>
  <Tab>
    The following example uses the [`useOrganizationList()`](/docs/sdk/react/use-organization-list) hook to get the `createOrganization()` method. This method is used to create a new organization with the provided name.
