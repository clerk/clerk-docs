...
If you are using [Tanstack Query](https://tanstack.com/query/latest), formally known as React Query, it will follow a similar pattern composing the `useSession` hook.
