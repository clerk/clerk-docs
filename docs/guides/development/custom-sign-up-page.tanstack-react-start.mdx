...
<Steps>
  ...
  The following example demonstrates how to render the [`<SignUp />`](/docs/references/general/components/authentication/sign-up) component on a dedicated sign-up page using the [TanStack Router catch-all route](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts#splat--catch-all-routes).
