...
description: Learn how to integrate Microsoft Azure Entra ID with Clerk using SAML SSO.
---
...
4. You will be presented with a modal to create a new connection. Fill in the required fields and for the **Identity Provider**, select **Microsoft Azure Entra ID (Formerly AD)**.
