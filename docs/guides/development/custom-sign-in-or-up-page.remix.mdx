...
<Steps>
  ...
  The following example demonstrates how to render the [`<SignIn />`](/docs/references/components/authentication/sign-in) component on a dedicated page using the [Remix optional route](https://reactrouter.com/en/main/route/route#optional-segments).
