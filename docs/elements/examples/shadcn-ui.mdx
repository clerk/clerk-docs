...
export default function SignUpPage() {
  return (
    <div className="grid w-full flex-grow items-center px-4 font-sans antialiased sm:justify-center">
      <SignUp.Root>
        <Clerk.Loading>
          {(isGlobalLoading) => (
            <>
