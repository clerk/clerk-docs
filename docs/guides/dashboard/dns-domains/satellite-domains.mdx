...
<Steps>
  ...
  <Tabs items={["Environment variables (Next.js)", "Properties"]}>
    <Tab>
      To configure satellite domains with environment variables in Next.js, you need to set values in both your primary app and your satellite app. This example is written for Next.js App Router **but can be adapted for any framework/language**.
      ...
      <Tabs items={["Primary app", "Satellite app"]}>
        <Tab>
          Add the following environment variables to your primary domain application:
