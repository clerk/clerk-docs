...
<CodeBlockTabs options={["npm", "yarn", "pnpm"]}>
  ``` bash filename="your-project" copy npm install @clerk/clerk-react ``` ```
  bash filename="your-project" copy yarn add @clerk/clerk-react ``` ``` bash
  filename="your-project" copy pnpm i @clerk/clerk-react ```
</CodeBlockTabs>
