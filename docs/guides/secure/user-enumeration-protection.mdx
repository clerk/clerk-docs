...
1. In the **User enumeration protection** row, select **Manage**.
1. Select **Bulk user enumeration protection** or **Strict user enumeration protection** based on your needs, then select **Save**.
