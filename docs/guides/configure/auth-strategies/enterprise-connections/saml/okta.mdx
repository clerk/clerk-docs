...
When you configure a SAML connection with Okta, your users can sign up and sign in to your application with their Okta account. In this guide, **you** configure the connection in the Clerk Dashboard, while **the customer** (whoever manages the Okta application) configures it on the Okta side.
...
<Steps>
  ...
  <Copyable as="html">
    ...
    **Step 1: Create a SAML application in Okta**
    ...
    1. Click **Next** to open the **Configure SAML** page.
    1. Add the **Single sign-on URL** and **Audience URI (SP Entity ID)** values provided to you.
    1. From the options menu, select **This is an internal app that we have created**, then click **Finish**.
    ...
    **Step 3: Assign users to the application**
    ...
    1. Click **Assign** next to the user or group.
    1. Click **Done**.
