...
- You followed the [quickstart](/docs/references/javascript/quickstart) to add Clerk to your JavaScript app.
- You set your sign-up mode to [**Waitlist**](docs/authentication/configuration/restrictions#waitlist).
