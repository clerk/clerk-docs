...
> [!CAUTION]
> This guide is for users who want to build a _custom_ user interface using the Clerk API. To view the list of a user's organization memberships using a _prebuilt_ UI, you should use the [`<OrganizationList/>`](/docs/components/organization/organization-list) component.
