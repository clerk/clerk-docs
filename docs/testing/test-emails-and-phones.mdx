...
Testing email links in E2E suites is an uphill task. We recommend turning on the [**Email verification code**](/docs/authentication/configuration/sign-up-sign-in-options#email) setting, and using that flow to authenticate your tests. The flows are very similar.
