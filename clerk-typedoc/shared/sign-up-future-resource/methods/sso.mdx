...
| <a id="strategy"></a> `strategy` | `string` | The strategy to use for authentication. Either [`OAuthStrategy`](/docs/reference/types/sso#oauthstrategy) or [`EnterpriseSSOStrategy`](/docs/reference/types/sso#enterprisessostrategy). |
