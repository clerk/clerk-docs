...
> [!NOTE]
> Clerk's `createRouteMatcher()` helper was removed in `@clerk/nuxt` v3. For migration details, see [`createRouteMatcher()`](#createroutematcher).
