...
<Callout>
If you are developing on your localhost, you will need to expose your endpoint to the internet to work with webhooks. See the [Testing the webhook](#testing-the-webhook) section for information on doing this.
</Callout>
