...
See the [Backend API reference](/docs/references/backend-api/tag/Invitations#operation/CreateInvitation){{ target: '_blank' }} for an example of the response.
...
See the [Backend API reference](/docs/references/backend-api/tag/Invitations#operation/RevokeInvitation){{ target: '_blank' }} for an example of the response.
