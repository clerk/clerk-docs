...
<Properties>
  ...
  The username supplied to the current sign-up. Only supported if [username](/docs/authentication/configuration/sign-up-sign-in-options#username) is enabled in the instance settings.
  ...
  The email address supplied to the current sign-up. Only supported if [email address](/docs/authentication/configuration/sign-up-sign-in-options#email) is enabled in the instance settings.
  ...
  The user's phone number in [E.164 format](https://en.wikipedia.org/wiki/E.164). Only supported if [phone number](/docs/authentication/configuration/sign-up-sign-in-options#phone) is enabled in the instance settings.
  ...
  The value of this attribute is true if a password was supplied to the current sign-up. Only supported if [**Password**](/docs/authentication/configuration/sign-up-sign-in-options#password) is enabled in the instance settings.
  ...
  The first name supplied to the current sign-up. Only supported if [**First and last name**](/docs/authentication/configuration/sign-up-sign-in-options#user-model) is enabled in the instance settings.
  ...
  The last name supplied to the current sign-up. Only supported if [**First and last name**](/docs/authentication/configuration/sign-up-sign-in-options#user-model) is enabled in the instance settings.
...
<Properties>
  - `strategy`
  - `'phone_code' | 'email_code' | 'web3_base_wallet_signature' | 'web3_metamask_signature' | 'web3_coinbase_wallet_signature' | 'web3_okx_wallet_signature'`
  ...
  - `'web3_base_wallet_signature'`: The verification will attempt to be completed using the user's Web3 wallet address via [Base Wallet](https://docs.base.org/base-account/guides/authenticate-users). The `web3_wallet_id` parameter can also be specified to select which of the user's known Web3 wallets will be used.
  ...
  **Required** if `strategy` is set to `'web3_base_wallet_signature'`, `'web3_metamask_signature'`, `'web3_coinbase_wallet_signature'`, or `'web3_okx_wallet_signature'`. The signature that was sent to the user via the Web3 verification strategy.
</Properties>
...
### `authenticateWithBaseWallet()`

Initiates an authentication flow using the Base Wallet, allowing users to authenticate via their Web3 wallet address. This method prompts the user to connect their Base Wallet and sign a message to verify ownership of the wallet address.

```typescript
function authenticateWithBaseWallet(
...
<Properties>
  ...
  The user's password. Only supported if [**Password**](/docs/authentication/configuration/sign-up-sign-in-options#password) is enabled.
  ...
  The user's email address. Only supported if [**Email address**](/docs/authentication/configuration/sign-up-sign-in-options#email) is enabled. Keep in mind that the email address requires an extra verification process.
  ...
  The user's phone number in [E.164 format](https://en.wikipedia.org/wiki/E.164). Only supported if [phone number](/docs/authentication/configuration/sign-up-sign-in-options#phone) is enabled. Keep in mind that the phone number requires an extra verification process.
  ...
  **Required** if [Web3 authentication](/docs/authentication/configuration/sign-up-sign-in-options#web3-authentication) is enabled. The Web3 wallet address, made up of 0x + 40 hexadecimal characters.
  ...
  The user's username. Only supported if [**Username**](/docs/authentication/configuration/sign-up-sign-in-options#username) is enabled.
...
<Properties>
  - `strategy`
  - `'phone_code' | 'email_code' | 'email_link' | 'oauth_<provider>' | 'saml' | 'enterprise_sso' | 'web3_base_wallet_signature' | 'web3_metamask_signature' | 'web3_coinbase_wallet_signature' | 'web3_okx_wallet_signature'`
...
<Properties>
  - `strategy`
  - `'web3_base_wallet_signature'` | `'web3_metamask_signature'` | `'web3_coinbase_wallet_signature'` | `'web3_okx_wallet_signature'`
