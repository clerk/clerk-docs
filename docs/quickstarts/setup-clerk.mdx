...
<Steps>
  ...
  <div className="container mx-auto my-4">
    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
      ...
      <FrameworkCards title="Express.js" description="Add authentication and user management to your Express.js application." link="#" cta="Coming Soon" hideArrow={true} icon="/docs/images/logos/express.svg" iconWidth="30" />

      <FrameworkCards title="Ruby / Rails" description="Integrate user management and authentication into your Ruby application." link="#" cta="Coming Soon" hideArrow={true} icon="/docs/images/logos/ruby.svg" />
    </div>
  </div>
</Steps>
