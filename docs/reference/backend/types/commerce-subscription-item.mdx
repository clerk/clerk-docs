...
<Properties>
  ...
  - `amount`
  - <code>undefined | null | [CommerceMoneyAmount](/docs/reference/javascript/types/commerce-money-amount)</code>
  ...
  - `lifetimePaid?`
  - <code>null | [CommerceMoneyAmount](/docs/reference/javascript/types/commerce-money-amount)</code>
