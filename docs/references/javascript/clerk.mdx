...
Returns the configured URL where [`<CreateOrganization />`](/docs/references/general/components/organization/create-organization) is mounted or a custom create-organization page is rendered.
...
Returns the configured URL where [`<OrganizationProfile />`](/docs/references/general/components/organization/organization-profile) is mounted or a custom organization-profile page is rendered.
...
Returns the configured URL where [`<SignIn />`](/docs/references/general/components/authentication/sign-in) is mounted or a custom sign-in page is rendered.
...
Returns the configured URL where [`<SignUp />`](/docs/references/general/components/authentication/sign-up) is mounted or a custom sign-up page is rendered.
...
Returns the URL where [`<UserProfile />`](/docs/references/general/components/user/user-profile) is mounted or a custom user-profile page is rendered.
...
> [!NOTE]
> For React-based apps, consider using the [`<CreateOrganization />`](/docs/references/general/components/organization/create-organization) component.
...
You must call this method before using the `Clerk` object in your code. Refer to the [quickstart guide](/docs/getting-started/quickstart) for more information.
...
Redirects to the configured URL where [`<CreateOrganization />`](/docs/references/general/components/organization/create-organization) is mounted. This method uses the [`navigate()`](#navigate) method under the hood.
...
Redirects to the configured URL where [`<OrganizationProfile />`](/docs/references/general/components/organization/organization-profile) is mounted. This method uses the [`navigate()`](#navigate) method under the hood.
...
A method used to set the current session and/or organization for the client. Accepts a [`SetActiveParams`](/docs/references/javascript/types/set-active-params) object.
...
Another example is when a user switches organizations in a multi-organization application. `setActive()` needs to be used to set the new organization as the active organization. See the implementation of this in the [Custom organization switcher](/docs/guides/development/custom-flows/organizations/organization-switcher) guide.
...
- [`mountSignIn()`](/docs/references/general/components/authentication/sign-in#mount-sign-in)
- [`unmountSignIn()`](/docs/references/general/components/authentication/sign-in#unmount-sign-in)
- [`openSignIn()`](/docs/references/general/components/authentication/sign-in#open-sign-in)
- [`closeSignIn()`](/docs/references/general/components/authentication/sign-in#close-sign-in)

### `<SignUp />`

- [`mountSignUp()`](/docs/references/general/components/authentication/sign-up#mount-sign-up)
- [`unmountSignUp()`](/docs/references/general/components/authentication/sign-up#unmount-sign-up)
- [`openSignUp()`](/docs/references/general/components/authentication/sign-up#open-sign-up)
- [`closeSignUp()`](/docs/references/general/components/authentication/sign-up#close-sign-up)

### `<GoogleOneTap />`

- [`openGoogleOneTap()`](/docs/references/general/components/authentication/google-one-tap#open-google-one-tap)
- [`closeGoogleOneTap()`](/docs/references/general/components/authentication/google-one-tap#close-google-one-tap)
- [`authenticateWithGoogleOneTap()`](/docs/references/general/components/authentication/google-one-tap#authenticate-with-google-one-tap)
- [`handleGoogleOneTapCallback()`](/docs/references/general/components/authentication/google-one-tap#handle-google-one-tap-callback)

### `<UserButton />`

- [`mountUserButton()`](/docs/references/general/components/user/user-button#mount-user-button)
- [`unmountUserButton()`](/docs/references/general/components/user/user-button#unmount-user-button)

### `<UserProfile />`

- [`mountUserProfile()`](/docs/references/general/components/user/user-profile#mount-user-profile)
- [`unmountUserProfile()`](/docs/references/general/components/user/user-profile#unmount-user-profile)
- [`openUserProfile()`](/docs/references/general/components/user/user-profile#open-user-profile)
- [`closeUserProfile()`](/docs/references/general/components/user/user-profile#close-user-profile)

### `<OrganizationProfile />`

- [`mountOrganizationProfile()`](/docs/references/general/components/organization/organization-profile#mount-organization-profile)
- [`unmountOrganizationProfile()`](/docs/references/general/components/organization/organization-profile#unmount-organization-profile)
- [`openOrganizationProfile()`](/docs/references/general/components/organization/organization-profile#open-organization-profile)
- [`closeOrganizationProfile()`](/docs/references/general/components/organization/organization-profile#close-organization-profile)

### `<OrganizationSwitcher />`

- [`mountOrganizationSwitcher()`](/docs/references/general/components/organization/organization-switcher#mount-organization-switcher)
- [`unmountOrganizationSwitcher()`](/docs/references/general/components/organization/organization-switcher#unmount-organization-switcher)

### `<CreateOrganization />`

- [`mountCreateOrganization`](/docs/references/general/components/organization/create-organization#mount-create-organization)
- [`unmountCreateOrganization`](/docs/references/general/components/organization/create-organization#unmount-create-organization)
- [`openCreateOrganization`](/docs/references/general/components/organization/create-organization#open-create-organization)
- [`closeCreateOrganization`](/docs/references/general/components/organization/create-organization#close-create-organization)

### `<OrganizationList />`

- [`mountOrganizationList`](/docs/references/general/components/organization/organization-list#mount-organization-list)
- [`unmountOrganizationList`](/docs/references/general/components/organization/organization-list#unmount-organization-list)

### `<Waitlist />`

- [`mountWaitlist()`](/docs/references/general/components/authentication/waitlist#mount-waitlist)
- [`unmountWaitlist()`](/docs/references/general/components/authentication/waitlist#unmount-waitlist)
- [`openWaitlist()`](/docs/references/general/components/authentication/waitlist#open-waitlist)
- [`closeWaitlist()`](/docs/references/general/components/authentication/waitlist#close-waitlist)
...
[components-ref]: /docs/references/general/components/overview
