...
<If notSdk={["ios", "android"]}>
  ...
  To create a passkey for a user, you must call [`User.createPasskey()`](/docs/reference/objects/user#create-passkey), as shown in the following example:
  ...
  <If sdk="expo">
    ```tsx {{ filename: 'src/components/create-passkeys-button.tsx', collapsible: true }}
...
<If sdk={["ios", "android"]}>
  To create a passkey for a user, you must call [`User.createPasskey()`](/docs/reference/native-mobile/user#create-passkey), as shown in the following example:

  <If sdk="ios">
    ```swift {{ filename: 'CreatePasskeyView.swift', collapsible: true }}
    import SwiftUI
    import ClerkKit
...
<If notSdk={["ios", "android"]}>
  ...
  To sign a user into your Clerk app with a passkey, you must call [`SignIn.authenticateWithPasskey()`](/docs/reference/objects/sign-in#authenticate-with-passkey). This method allows users to choose from their discoverable passkeys, such as hardware keys or passkeys in password managers.
  ...
  <If sdk="expo">
    ```tsx {{ filename: 'src/components/sign-in-with-passkey-button.tsx', collapsible: true }}
    import { ThemedText } from '@/components/themed-text'
...
<If sdk={["ios", "android"]}>
  To sign a user into your Clerk app with a passkey, you must call [`auth.signInWithPasskey()`](/docs/reference/native-mobile/auth#sign-in-with-passkey). This method allows users to choose from their discoverable passkeys, such as hardware keys or passkeys in password managers.

  <If sdk="ios">
    ```swift {{ filename: 'SignInWithPasskeyView.swift', collapsible: true }}
    import SwiftUI
    import ClerkKit
...
<If notSdk={["ios", "android"]}>
  ...
  Clerk generates a name based on the device associated with the passkey when it's created. Sometimes users may want to rename a passkey to make it easier to identify. To rename a user's passkey, you must call the [`update()`](/docs/reference/types/passkey-resource#update) method of the passkey object, as shown in the following example:
  ...
  <If sdk="expo">
    ```tsx {{ filename: 'src/components/rename-passkey.tsx', collapsible: true }}
    import { ThemedText } from '@/components/themed-text'
    import { ThemedView } from '@/components/themed-view'
    import { useUser } from '@clerk/expo'
    import type { PasskeyResource } from '@clerk/expo/types'
...
<If sdk="ios">
  To rename a user's passkey, you must call the [`update()`](https://clerk.github.io/clerk-ios/documentation/clerkkit/passkey/update\(name:\)) method of the passkey object, as shown in the following example:

  ```swift {{ filename: 'RenamePasskeyView.swift', collapsible: true }}
  import SwiftUI
  import ClerkKit
...
<If sdk="android">
  To rename a user's passkey, you must call the [`update()`](https://clerk-android.clerkstage.dev/source/api/com.clerk.api.passkeys/index.html) method of the passkey object, as shown in the following example:
...
<If notSdk={["ios", "android"]}>
  ...
  To delete a user's passkey from your Clerk app, you must call the [`delete()`](/docs/reference/types/passkey-resource#delete) method of the passkey object, as shown in the following example:
  ...
  <If sdk="expo">
    ```tsx {{ filename: 'src/components/delete-passkey.tsx', collapsible: true }}
    import { ThemedText } from '@/components/themed-text'
    import { ThemedView } from '@/components/themed-view'
    import { useUser } from '@clerk/expo'
    import type { PasskeyResource } from '@clerk/expo/types'
...
<If sdk="ios">
  To delete a user's passkey from your Clerk app, you must call the [`delete()`](https://clerk.github.io/clerk-ios/documentation/clerkkit/passkey/delete\(\)) method of the passkey object, as shown in the following example:

  ```swift {{ filename: 'DeletePasskeyView.swift', collapsible: true }}
  import SwiftUI
  import ClerkKit
...
<If sdk="android">
  To delete a user's passkey from your Clerk app, you must call the [`delete()`](https://clerk-android.clerkstage.dev/source/api/com.clerk.api.passkeys/index.html) method of the passkey object, as shown in the following example:
